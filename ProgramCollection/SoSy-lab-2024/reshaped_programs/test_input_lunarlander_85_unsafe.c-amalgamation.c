...
int main() {
    float tensor_input[1][8] = {
        {-0.6758571f, 0.052766f, 0.032504f, -0.044358f,
         0.083835f, -0.0057f, 1.0f, 0.995f}  // Replace with fixed known values.
    };
...
#include "onnx_generated_bits.h" // The auto-generated arrays are omitted here for brevity.
