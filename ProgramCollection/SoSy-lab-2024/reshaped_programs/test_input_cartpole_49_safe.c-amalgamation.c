...
static const float tensor_q_net_0_weight[64][4] = {
  // (Weights initialized as in the original code)
};

static const float tensor_q_net_0_bias[64] = {
  // (Biases initialized as in the original code)
};
...
int main() {
    ...
    printf("Assertion passed: tensor_output[0][1] = %f, tensor_output[0][0] = %f\n", 
           tensor_output[0][1], tensor_output[0][0]);
