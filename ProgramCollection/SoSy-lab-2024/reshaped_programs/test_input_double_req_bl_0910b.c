...
// Function to mimic behavior of arithmetic exceptions
void reach_error() { 
    printf("Reach error executed!\n");
}

// A union which permits us to convert between a double and two 32 bit integers
typedef union {
    double value;
    struct {
        uint32_t lsw;
...
// Constants used in log calculations
...
// Function to compute natural logarithm of double values
