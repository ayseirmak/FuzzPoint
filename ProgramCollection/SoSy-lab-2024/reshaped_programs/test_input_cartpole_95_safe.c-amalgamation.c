...
static const float tensor_q_net_0_weight[64][4] = {
    // [64][4] matrix initialization with the same values
};

static const float tensor_q_net_0_bias[64] = {
    // [64] array initialization with the same values
};

static const float tensor_q_net_2_weight[64][64] = {
    // [64][64] matrix initialization with the same values
};
...
static const float tensor_q_net_4_weight[2][64] = {
    // [2][64] matrix initialization with the same values
};

static const float tensor_q_net_4_bias[2] = {
    // [2] array initialization with the same values
};
...
int main() {
    float tensor_input[1][4] = {
        {0.484, -0.490, 0.012, 0.589}  // Deterministic values within assumed ranges
    };
    ...
    printf("Execution completed with output: [%f, %f]\n", tensor_output[0][0], tensor_output[0][1]);
