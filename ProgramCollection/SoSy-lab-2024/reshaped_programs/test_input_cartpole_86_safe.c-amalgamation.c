...
int main() {
    ...
    // Initialize the deterministic input values
    tensor_input[0][0] = -0.250f;
    tensor_input[0][1] = 0.145f;
    tensor_input[0][2] = -0.060f;
    tensor_input[0][3] = -0.650f;

    entry(tensor_input, tensor_output);

    // Verify the output assertion
    assert(!(tensor_output[0][0] <= tensor_output[0][1]));

    return 0;
}

// Model functions generated by onnx2c
// ...
