...
static const float tensor_q_net_0_weight[64][4] = 
{
  ...
  // ... (same as provided tensor_q_net_0_weight)
};

static const float tensor_q_net_0_bias[64] = 
{
  -0.038480948656797409058f, 0.12814424932003021240f, 0.49260348081588745117f, // ... (same as provided tensor_q_net_0_bias)
};

static const float tensor_q_net_2_weight[64][64] = 
{
  {-0.081372834742069244385f, 0.024248756468296051025f, 0.085219748318195343018f, // ... (same as provided tensor_q_net_2_weight)
};

static const float tensor_q_net_2_bias[64] = 
{
  0.0096521666273474693298f, 0.033651806414127349854f, 0.039734158664941787720f, // ... (same as provided tensor_q_net_2_bias)
};

static const float tensor_q_net_4_weight[2][64] = 
{
  {-0.10003891587257385254f, -0.22389468550682067871f, -0.24801196157932281494f, // ... (same as provided tensor_q_net_4_weight)
};
...
int main() {
    float tensor_input[1][4] = {
        {0.08f, 0.78f, -0.13f, -1.25f}
    };
    float tensor_output[1][2] = {{0.0f, 0.0f}};

    entry(tensor_input, tensor_output);
    
    // Assert to verify the condition
