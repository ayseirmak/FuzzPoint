...
// Union to represent float as integer
typedef union {
  float value;
  __uint32_t word;
...
int main() {
  // Predefined deterministic value for testing instead of using nondeterministic input
  float x = 2.0f; // Chosen to be outside of [-1, 1] to test NaN condition
