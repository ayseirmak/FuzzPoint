...
// Define the constants globally to use in main for deterministic input
static const float tensor_q_net_0_weight[64][4] = {/* ... weights ... */};
static const float tensor_q_net_0_bias[64] = {/* ... biases ... */};
static const float tensor_q_net_2_weight[64][64] = {/* ... weights ... */};
static const float tensor_q_net_2_bias[64] = {/* ... biases ... */};
static const float tensor_q_net_4_weight[2][64] = {/* ... weights ... */};
static const float tensor_q_net_4_bias[2] = {/* ... biases ... */};
...
int main() {
    // Initialized deterministic input for testing purposes
    float tensor_input[1][4] = {
        {-0.26495380459304924f, -0.05314113459304924f, -0.05096166059304924f, -0.36138510459304923f}
    };
