...
// Initialize tensors with fixed values according to the given ranges
void initialize_tensor_input(float tensor_input[1][4]) {
    tensor_input[0][0] = 0.46646264;  // Midpoint of 0.44835436239802035 and 0.4845709176019796
    tensor_input[0][1] = 0.09401047;  // Midpoint of 0.07590218739802035 and 0.11211874260197965
    tensor_input[0][2] = 0.02982513;  // Midpoint of 0.011716852398020342 and 0.04793340760197966
    tensor_input[0][3] = -0.26830740; // Midpoint of -0.2864156776019796 and -0.25019912239802033
}

// Function declarations for compiled neural network nodes
...
int main() {
    ...
    // Initialize the tensor input with deterministic fixed values
    initialize_tensor_input(tensor_input);

    // Execute the neural network entry function
    entry(tensor_input, tensor_output);

    // Use assert to verify the expected output condition
...
// External pre-trained neural network weights and biases are included below
// Note: The constants have been omitted for brevity, include the constants here
...
// Neural Network Functions (Nodes)
