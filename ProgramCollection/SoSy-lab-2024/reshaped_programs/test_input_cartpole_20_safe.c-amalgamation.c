...
// Fixed input values (deterministic)
static const float fixed_input[1][4] = {
    {0.05f, 0.39f, -0.08f, -0.64f}
};

int main() {
    float tensor_output[1][2];

    // Call the entry function with fixed inputs
    entry(fixed_input, tensor_output);
...
// Neural network implementation functions (from the original code)
...
static const float tensor_q_net_0_weight[64][4] = {
    // ... (weights data truncated for brevity)
};

static const float tensor_q_net_0_bias[64] = {
    // ... (bias data truncated for brevity)
};
