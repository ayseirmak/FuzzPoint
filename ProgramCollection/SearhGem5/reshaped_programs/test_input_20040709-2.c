...
unsigned int deterministicValue(void) {
    static unsigned int fixedValue = 123456789;
    fixedValue = (fixedValue * 1103515245 + 12345) % (1 << 31); 
    return (fixedValue / 65536) % 2048;
}
...
int main(void) {
    ...
    testM(); testN(); testO(); testP(); testQ(); testR();
    testS(); testT(); testU(); testV(); testW(); testX();
    testY(); testZ();
