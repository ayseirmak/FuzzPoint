...
int main()
{
    ...
    // Initialize tensor_input with deterministic fixed values
    tensor_input[0][0] = 0.45f; // Within range 0.4353032663189951 to 0.46647019368100495
    tensor_input[0][1] = -1.075f; // Within range -1.091545863681005 to -1.0603789363189953
    tensor_input[0][2] = 0.052f; // Within range 0.03691213631899508 to 0.06807906368100493
    tensor_input[0][3] = 1.472f; // Within range 1.456711936318995 to 1.4878788636810047
...
// Neural network weight and bias arrays go here (truncated for brevity).
...
static inline void node_Gemm_1(const float tensor_7[1][4], const float tensor_q_net_0_weight[64][4], const float tensor_q_net_0_bias[64], float tensor_8[1][64]) {
    ...
    float alpha = 1.0000000000;
    float beta = 1.0000000000;
