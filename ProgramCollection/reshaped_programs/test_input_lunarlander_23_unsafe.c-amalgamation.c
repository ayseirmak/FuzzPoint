...
static const float tensor_q_net_0_bias[64] = {...}; // Truncated for brevity
static const float tensor_q_net_2_weight[64][64] = {...}; // Truncated for brevity
static const float tensor_q_net_2_bias[64] = {...}; // Truncated for brevity
static const float tensor_q_net_4_weight[4][64] = {...}; // Truncated for brevity
static const float tensor_q_net_4_bias[4] = {...}; // Truncated for brevity
...
int main() {
    float tensor_input[1][8] = {
        {-0.89f, 0.05f, 1.10f, -0.35f, -0.40f, 0.00f, 1.00f, 0.00f}
    };
