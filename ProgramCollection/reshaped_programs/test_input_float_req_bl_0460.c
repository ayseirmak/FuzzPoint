...
void reach_error() {
    printf("Error: reached reach_error function\n");
}

// Simulate a non-deterministic float input by using a predefined value
float deterministic_float() {
    return 1.5f; // Example of a value outside the range [-1, 1]
}
...
int main() {
    ...
    printf("Result is NaN as expected for input outside [-1, 1]\n");
    return 0;
}