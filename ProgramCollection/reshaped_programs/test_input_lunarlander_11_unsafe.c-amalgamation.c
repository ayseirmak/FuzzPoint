...
// Define the constant tensors as specified earlier
...
// This union initializes based on the onnx model processing
...
int main() {
    float tensor_input[1][8] = {
        {-0.675, 0.075, 0.028, -0.030, -0.100, -0.056, 1.000, 1.000} // Replacing with deterministic values within given ranges
    };
