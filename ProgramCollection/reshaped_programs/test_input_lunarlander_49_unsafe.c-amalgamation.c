...
int main() {
    float tensor_input[1][8] = {
        {-0.826, 0.081, 0.22, -0.075, -0.03, 0.147, 1.0, 1.0}
    };  
    ...
    printf("Assertion passed: tensor_output[2] > tensor_output[3]\n");

    return 0;
}

// Tensor weights and biases declared here (keeping the large arrays as they are in the original code)
