...
float __ieee754_expf(float x) {
  ...
  if (hx == 0x7f800000L) return xsb == 0 ? x : 0.0f;
  
  if (sx > 0x42b17217) return huge_exp * huge_exp;
  if (sx < 0 && hx > 0x42cff1b5) return twom100_exp * twom100_exp;
