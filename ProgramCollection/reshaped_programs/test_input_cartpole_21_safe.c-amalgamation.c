...
// Custom defined input values within the __VERIFIER_assume range
#define INPUT_0 -0.03342285f
#define INPUT_1 -0.5860145f
#define INPUT_2 0.035305664f
#define INPUT_3 0.8926788f

static const float tensor_q_net_0_weight[64][4] = 
{
  {...} // omitting the matrix elements for brevity
};
