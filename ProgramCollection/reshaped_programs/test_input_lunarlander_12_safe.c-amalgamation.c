...
// Static tensors replaced with sample deterministic values.
static const float tensor_q_net_0_weight[64][8] = { /* ... pre-determined weights ... */ };
static const float tensor_q_net_0_bias[64] = { /* ... pre-determined biases ... */ };
static const float tensor_q_net_2_weight[64][64] = { /* ... pre-determined weights ... */ };
static const float tensor_q_net_2_bias[64] = { /* ... pre-determined biases ... */ };
static const float tensor_q_net_4_weight[4][64] = { /* ... pre-determined weights ... */ };
static const float tensor_q_net_4_bias[4] = { /* ... pre-determined biases ... */ };

// Structures for tensor unions
...
int main() {
    float tensor_input[1][8] = {
        {0.0f, 0.1f, -0.5f, 0.05f, -0.05f, 0.1f, -0.1f, 0.075f}
    };
