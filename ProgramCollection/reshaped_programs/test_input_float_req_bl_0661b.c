...
int main() {
  float x = 1.0f; // Deterministic value
  float y = 0.0f;

  // REQ-BL-0661: The atan2 and atan2f procedures shall return +-0, 
  // if the argument y is +-0 and the argument x > 0.
  ...
  if (x > 0.0f) {
    ...
    if (res != 0.0f) {
      printf("Error: The result should be 0.0f\n");
      return 1;
    }
  }
