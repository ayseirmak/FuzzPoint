...
// Define a union for converting between a double and two 32-bit integers
typedef union {
  double value;
  struct {
    uint32_t lsw;
...
// Constants used in the log functions
...
// Helper function to compute logarithm
...
// Constants used in the log10 function
...
// Helper function for log10 computation
...
int main() {
  double x = 0.0 / 0.0; // Assign NaN to x
