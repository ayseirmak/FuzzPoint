...
void stdarg(void) {
    ...
    myprintf("%hfa13 %hfa14 %hfa13 %hfa13", hfa12, hfa13, hfa13, hfa13);
...
void opi(void) {
    uint64_t x = 1000;
    pll(addip0((uint32_t)x));
    pll(sublp0(x));
    pll(addip123((uint32_t)x));
    pll(addlm123(x));
    pll(sublp4095(x));
    pll(subim503808((uint32_t)x));
    pll(addp12345(x));
    pll(subp12345((uint32_t)x));
    pll(mvni((uint32_t)x));
    pll(negl(x));
    pll(rsbi123((uint32_t)x));
    pll(rsbl123(x));
    pll(andi0((uint32_t)x));
    pll(andlm1(x));
    pll(orrl0(x));
    pll(orrim1((uint32_t)x));
    pll(eori0((uint32_t)x));
    pll(eorlm1(x));
    pll(and0xf0((uint32_t)x));
    pll(orr0xf0(x));
    pll(eor0xf0(x));
    pll(lsli0((uint32_t)x));
    pll(lsri0((uint32_t)x));
    pll(asrl0((int64_t)x));
    pll(lsli1((uint32_t)x));
    pll(lsli31((uint32_t)x));
    pll(lsll1((uint64_t)x));
    pll(lsll63((uint64_t)x));
    pll(lsri1((uint32_t)x));
    pll(lsri31((uint32_t)x));
    pll(lsrl1((uint64_t)x));
    pll(lsrl63((uint64_t)x));
    pll(asri1((int32_t)x));
    pll(asri31((int32_t)x));
    pll(asrl1((int64_t)x));
