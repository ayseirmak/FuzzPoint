...
// Replace random number generator with a deterministic value generator
unsigned int determinist_val(void) {
    static unsigned int values[] = {42, 305, 728, 651, 123, 982};
    static int index = 0;
    unsigned int result = values[index];
