...
// Factory methods to return copies of structures
...
void stdarg(void)
{
    ...
    myprintf("%hfa33 %hfa34 %hfa13 %hfa13", hfa12, hfa13, hfa13, hfa13, hfa13);
...
static int32_t asri31(uint32_t x) { return x >> 31; }
static int64_t asrl1(uint64_t x) { return x >> 1; }
static int64_t asrl63(uint64_t x) { return x >> 63; }
