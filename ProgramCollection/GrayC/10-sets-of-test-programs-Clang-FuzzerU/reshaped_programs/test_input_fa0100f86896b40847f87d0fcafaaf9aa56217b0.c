...
/* Define a fixed sequence of values to replace the random number generator */
const unsigned int fixed_values[] = {
    1024, 512, 256, 128, 64, 32, 16, 8, 4, 2,
    1, 1023, 511, 255, 127, 63, 31, 15, 7, 3
};

unsigned int fixed_index = 0;

/* Replace the random function with fixed sequence generator */
