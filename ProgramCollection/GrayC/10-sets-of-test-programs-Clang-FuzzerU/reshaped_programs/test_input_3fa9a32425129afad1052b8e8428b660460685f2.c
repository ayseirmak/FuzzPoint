...
// Fixed deterministic sequence to replace the random generator
unsigned int sequence[] = {
    1040, 2039, 408, 1023, 499, 738, 1654, 947, 289, 713,
    435, 1948, 1569, 1310, 287, 918, 157, 846, 325, 189
}; 
...
// Macro to define functions for bitfield operations
#define T(S)                               \
struct S s##S;                             \
