...
// Detemining and replacing the random generator with fixed values
unsigned int fixedValues[10] = {1024, 2048, 3072, 4096, 5120, 6144, 7168, 8192, 9216, 10240};
int fixedIndex = 0;

unsigned int myrnd(void) {
    unsigned int result = fixedValues[fixedIndex % 10];
    fixedIndex++;
    return result;
}
