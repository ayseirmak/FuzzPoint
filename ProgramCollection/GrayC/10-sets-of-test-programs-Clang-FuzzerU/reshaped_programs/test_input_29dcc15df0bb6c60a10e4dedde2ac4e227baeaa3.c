...
// Helper function to simulate myrnd function with deterministic behavior
unsigned int myrnd_deterministic(void) {
    static unsigned int sequence[] = {
        1789, 510, 1310, 4000, 750, 940, 1150, 2987, 482, 327
    };
    static size_t index = 0;
    return sequence[index++ % (sizeof(sequence) / sizeof(sequence[0]))];
}

// Macro to define structures and functions for the bitfield cases
#define T(S)                                \
struct S s##S;                               \
...
struct pck Q { signed short k : 12, j : 1, i : 3; unsigned long long l; }; T(Q)
