...
// Define static deterministic "random" values for testing
const unsigned int predetermined_values[] = {
    100, 200, 300, 400, 500, 600, 700, 800,
    123, 234, 345, 456, 567, 678, 789, 890
};
unsigned int value_index = 0;

// Get next predetermined value
unsigned int get_next_value() {
    unsigned int value = predetermined_values[value_index % (sizeof(predetermined_values) / sizeof(predetermined_values[0]))];
    value_index++;
    return value;
}
...
struct pck U { unsigned short j : 8, k : 1, i : 7; unsigned short l; }; T(U)
