...
#define CONST_MYRND 1103515245
#define CONST_MYRND_ADD 12345
#define MOD_VALUE 2048

unsigned int myrnd_static = STATIC_SEED;

unsigned int myrnd (void) {
    myrnd_static *= CONST_MYRND;
    myrnd_static += CONST_MYRND_ADD;
    return (myrnd_static / 65536) % MOD_VALUE;
}
...
struct J { unsigned short k : 7; unsigned short l; }; T(J)
