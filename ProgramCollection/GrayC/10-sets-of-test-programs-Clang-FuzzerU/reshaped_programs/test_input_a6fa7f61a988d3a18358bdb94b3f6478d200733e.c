...
struct H { unsigned long long l; unsigned int j : 13, i : 7, k : 12; }; T(H)
struct I { long double l; unsigned int k : 12, j : 13, i : 7; }; T(I)
struct J { unsigned int k : 12, j : 13, i : 7; long double l; }; T(J)
struct K { unsigned int k : 12, j : 11, i : 9; long double l; }; T(K)
struct L { long double l; unsigned int j : 13, i : 7, k : 12; }; T(L)
