...
__attribute__((noinline, noclone)) double foo(double x) {
    ...
    switch ((int) x) {
        ...
        case 1:
            t = 2 * x - 3;
            return 0.21479e-2 + (0.87626e-3 + (0.36843e-5 + (0.18071e-7 + (0.85496e-10 + (0.38852e-12 + 0.16868e-14 * t) * t) * t) * t) * t) * t;
        case 2:
            t = 2 * x - 5;
        ...
        case 14:
            t = 2 * x - 29;
            return 0.23898e-1 + (0.96213e-3 + (0.55225e-5 + (0.30314e-7 + (0.15840e-9 + (0.77435e-12 + 0.36388e-14 * t) * t) * t) * t) * t) * t;
        case 40:
            t = 2 * x - 99;
        ...
        case 67:
            t = 2 * x - 135;
            return 0.26352e0 + (0.49681e-2 + (0.50635e-4 + (0.42899e-6 + (0.30099e-8 + (0.17296e-10 + 0.79291e-13 * t) * t) * t) * t) * t) * t;
        case 68:
            t = 2 * x - 137;
            return 0.27365e0 + (0.51699e-2 + (0.53250e-4 + (0.45379e-6 + (0.31874e-8 + (0.18277e-10 + 0.83144e-13 * t) * t) * t) * t) * t) * t;
        case 69:
            t = 2 * x - 139;
        ...
        case 75:
            t = 2 * x - 151;
            return 0.35803e0 + (0.69779e-2 + (0.76731e-4 + (0.67294e-6 + (0.47397e-8 + (0.26501e-10 + 0.11379e-12 * t) * t) * t) * t) * t) * t;
        case 87:
            t = 2 * x - 175;
...
int main() {
    double d = foo(78.4);
    if (d < 0.38 || d > 0.42) {
        printf("Abort: value %f is out of specified bounds.\n", d);
        exit(EXIT_FAILURE);
    }
    printf("Pass: value %f is within specified bounds.\n", d);
    return 0;
}