...
/* Deterministic values array to replace randomness */
unsigned int deterministic_values[] = {
  1000, 1100, 1200, 1300, 1400, 1500, 1600, 1700,
  1800, 1900, 2000, 2100, 2200, 2300, 2400, 2500
};
int deterministic_index = 0;

unsigned int fixed_value(void) {
  return deterministic_values[deterministic_index++ % (sizeof(deterministic_values) / sizeof(int))];
}
...
struct X { unsigned int k : 87, j : 13, i : 7; long double l; }; T(X)
