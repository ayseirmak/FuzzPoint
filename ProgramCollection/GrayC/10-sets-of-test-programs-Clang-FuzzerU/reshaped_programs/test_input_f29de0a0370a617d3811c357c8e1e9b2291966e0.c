...
// Fixed pseudo-random seed generator replacement with deterministic values
unsigned int myFixedValues(int index) {
    static unsigned int values[] = { 123, 456, 789, 321, 654, 987, 213, 546, 879, 132 };
