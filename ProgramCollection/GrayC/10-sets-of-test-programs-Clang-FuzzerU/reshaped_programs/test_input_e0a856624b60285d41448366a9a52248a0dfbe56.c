...
static void setStatPointers(ShrPcStatsSType *statsPtr, long sessionId) {
    ...
    *RDbf3 = 1;
    ...
    Workspace.p1 = &statsPtr->u.gem.a7;
    Workspace.p2 = &statsPtr->u.gem.a8;
    Workspace.p3 = &statsPtr->u.gem.a9;
    Workspace.p4 = &statsPtr->u.gem.a10;
    Workspace.p5 = &statsPtr->u.gem.a11;
    Workspace.p6 = &statsPtr->u.gem.a12;
    Workspace.p7 = &statsPtr->u.gem.a13;
    Workspace.p8 = &statsPtr->u.gem.a14;
    Workspace.p9 = &statsPtr->u.gem.a15;
    Workspace.p10 = &statsPtr->u.gem.a16;
    Workspace.p11 = &statsPtr->u.gem.a17;
...
static void initPte(void *shrpcPtr, long sessionId) {
    (void)shrpcPtr;  // Avoid unused parameter warning
    ShrPcPteSType *ptePtr = &MyPte;
    setStatPointers(&ptePtr->stats, sessionId);
}

void InitCache(int sessionId) {
    initPte(NULL, sessionId);
}
