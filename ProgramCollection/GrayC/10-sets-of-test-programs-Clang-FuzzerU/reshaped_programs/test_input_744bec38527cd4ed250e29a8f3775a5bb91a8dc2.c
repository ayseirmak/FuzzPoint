...
// Initialize deterministic values to ensure ARM compatibility and simplicity.
#define FIXED_VALUES_COUNT 16
unsigned int fixed_values[FIXED_VALUES_COUNT] = {
    54321, 12345, 67890, 54321, 12345, 67890,
    54321, 12345, 67890, 54321, 12345, 67890,
    54321, 12345, 67890, 54321
};

unsigned int myrnd_index = 0;
unsigned int myrnd(void) {
    if (myrnd_index >= FIXED_VALUES_COUNT) myrnd_index = 0;
    return fixed_values[myrnd_index++];
}
