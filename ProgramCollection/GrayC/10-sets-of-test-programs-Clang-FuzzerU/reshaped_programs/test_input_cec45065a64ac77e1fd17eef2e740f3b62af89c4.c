...
// Define complex volatile variables to ensure they are properly initialized
...
void abort_program(void) {
    printf("Abort called: complex value mismatch detected!\n");
    exit(1);
}
...
int main(void) {
    // Perform checks with defined fixed complex variables
