...
// Deterministic version of myrnd
unsigned int myrnd_fixed(void) {
    static unsigned int sequence[] = {1000, 1500, 123, 765, 432, 876, 678, 980, 256, 345};
    static unsigned int idx = 0;
    unsigned int value = sequence[idx];
    idx = (idx + 1) % (sizeof(sequence) / sizeof(sequence[0]));
    return value;
}
