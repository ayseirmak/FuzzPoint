...
/* The function `myrnd` is replaced with deterministic behavior. */
unsigned int myrnd(void) {
    static unsigned int sequence[] = {1000, 2000, 3000, 4000, 5000};
...
struct G { unsigned int i : 13, j : 13, k : 7; unsigned long long l; }; T(G)
