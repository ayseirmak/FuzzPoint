...
#define STATIC_RND_VALUES_LENGTH 10

unsigned int static_rnd_values[STATIC_RND_VALUES_LENGTH] = {100, 200, 300, 400, 500, 600, 700, 800, 900, 1023};
int rnd_index = 0;

unsigned int myrnd(void) {
    unsigned int value = static_rnd_values[rnd_index];
    rnd_index = (rnd_index + 1) % STATIC_RND_VALUES_LENGTH;
    return value;
}
...
struct pck U { unsigned short k : 1, j : 6, i : 9; unsigned long long l; }; T(U)
