...
// Define fixed complex float values
...
// Define fixed complex double values
...
// Define fixed complex long double values
...
void check_float(int dummy, _Complex float a1, _Complex float a2, _Complex float a3, _Complex float a4, _Complex float a5) {
    assert(a1 == f1 && a2 == f2 && a3 == f3 && a4 == f4 && a5 == f5);
}

void check_double(int dummy, _Complex double a1, _Complex double a2, _Complex double a3, _Complex double a4, _Complex double a5) {
    assert(a1 == d1 && a2 == d2 && a3 == d3 && a4 == d4 && a5 == d5);
}

void check_long_double(int dummy, _Complex long double a1, _Complex long double a2, _Complex long double a3, _Complex long double a4, _Complex long double a5) {
