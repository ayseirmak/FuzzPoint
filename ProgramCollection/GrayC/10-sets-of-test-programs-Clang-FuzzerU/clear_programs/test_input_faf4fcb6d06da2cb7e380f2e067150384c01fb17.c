...
// Define structures with initialized values.
// Each structure stores a string of different lengths.
...
// Define floating-point structure arrays
...
// Functions to print structure values
...
void arg(void)
{
    // Example function calls with predefined values.
    fa_s1(s1);
    fa_s2(s2);
    fa_s3(s3);
    fa_s4(s4);
