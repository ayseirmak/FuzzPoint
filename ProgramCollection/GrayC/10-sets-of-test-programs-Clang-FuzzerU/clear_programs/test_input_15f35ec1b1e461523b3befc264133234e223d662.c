...
// Fixed complex numbers based on the original program
...
// Abort function defined for clarity
void custom_abort(void) {
    printf("Aborted due to mismatch\n");
    exit(1);
}

// Check functions with noinline attribute to prevent inlining
