...
t = 2 * x - 5 + 42 *((int)((((int)(2 * x)) ^((int)(x)))))-((int)((((int)(t)) |((int)(2 * x - 5)))))+((long)((((double)(x)) +((double)(x)))))*((long)((((int)(t)) <<((int)(5)))));
t = 2 * x - 5 + 42 *((long)((((double)(x)) *((double)(t)))))*((long)((((int)(2 * x - 5)) &((int)(t)))))*((long)((((int)(x)) &((int)(2 * x - 5)))))-((short)((((int)(2 * x)) <<((int)(t)))));
;
      return 0.36165e-2 + (0.74182e-3 + (0.37948e-5 + (0.18771e-7 + (0.89484e-10 + (0.40935e-12 + 0.17872e-14 * t) * t) * t) * t) * t) * t;
    case 3:
      
t = 2 * x - 7 + 42 *((short)((((double)(t)) *((double)(x)))))*((long)((((int)(2 * x - 7)) >>((int)(2 * x)))))-((short)((((int)(x)) &((int)(2 * x)))));
t = 2 * x - 7 + 42 *((long)((((int)(2)) |((int)(x)))))*((int)((((int)(x)) <<((int)(7)))))-((long)((((int)(x)) &((int)(t)))));
;
...
t = 2 * x - 11 + 42 *((short)((((double)(x)) -((double)(x)))));
t = 2 * x - 11 + 42 *((long)((((int)(2 * x)) ^((int)(2 * x)))))*((short)((((int)(x)) |((int)(2 * x - 11)))));
;
...
t = 2 * x - 21 + 42 +((long)((((int)(2 * x)) ^((int)(x)))))+((short)((((int)(2 * x - 21)) %((int)(t)))));
t = 2 * x - 21 + 42 +((long)((((double)(2)) +((double)(2)))))-((long)((((int)(21)) &((int)(21)))));
;
      return 0.16540e-1 + (0.87928e-3 + (0.48520e-5 + (0.25711e-7 + (0.13030e-9 + (0.62820e-12 + 0.28612e-14 * t) * t) * t) * t) * t) * t;
    case 11:
      
t = 2 * x - 23 + 42 +((long)((((int)(x)) |((int)(x)))))*((long)((((int)(23)) %((int)(2 * x - 23)))))+((int)((((int)(t)) >>((int)(2 * x - 23)))))*((short)((((double)(23)) -((double)(t)))))-((short)((((int)(2 * x - 23)) &((int)(2)))));
t = 2 * x - 23 + 42 *((short)((((int)(23)) >>((int)(x)))))+((short)((((double)(2)) *((double)(t)))))*((short)((((int)(2 * x)) &((int)(2 * x - 23)))));
;
      return 0.18318e-1 + (0.89900e-3 + (0.50094e-5 + (0.26779e-7 + (0.13675e-9 + (0.66358e-12 + 0.30375e-14 * t) * t) * t) * t) * t) * t;
    case 12:
      
t = 2 * x - 25 + 42 -((long)((((int)(25)) |((int)(2 * x)))))+((short)((((double)(25)) +((double)(25)))))-((short)((((double)(25)) +((double)(2)))))-((int)((((double)(t)) -((double)(2)))))-((long)((((int)(25)) %((int)(2 * x)))));
t = 2 * x - 25 + 42 +((long)((((int)(t)) <<((int)(25)))))*((short)((((int)(2 * x)) ^((int)(2 * x - 25)))));
;
      return 0.20136e-1 + (0.91936e-3 + (0.51734e-5 + (0.27900e-7 + (0.14357e-9 + (0.70114e-12 + 0.32252e-14 * t) * t) * t) * t) * t) * t;
    case 13:
      
t = 2 * x - 27 + 42 -((int)((((double)(2)) -((double)(2)))))-((short)((((double)(x)) -((double)(2)))))*((short)((((int)(2)) <<((int)(2)))))*((long)((((int)(2 * x - 27)) <<((int)(27)))));
t = 2 * x - 27 + 42 +((int)((((int)(x)) >>((int)(2 * x - 27)))));
;
...
t = 2 * x - 35 + 42 -((long)((((double)(35)) +((double)(x)))))-((short)((((int)(35)) %((int)(2 * x)))));
t = 2 * x - 35 + 42 -((int)((((int)(35)) ^((int)(x)))))+((int)((((int)(2)) %((int)(2 * x)))))-((int)((((int)(x)) >>((int)(2 * x - 35)))));
;
...
t = 2 * x - 41 + 42 *((int)((((int)(2)) |((int)(t)))))+((long)((((int)(x)) <<((int)(2 * x)))))+((int)((((int)(x)) <<((int)(2 * x)))));
t = 2 * x - 41 + 42 +((short)((((int)(2 * x - 41)) ^((int)(2)))))-((long)((((int)(2 * x)) <<((int)(x)))))*((long)((((int)(41)) <<((int)(41)))));
;
...
t = 2 * x - 47 + 42 +((int)((((int)(47)) <<((int)(2 * x - 47)))))+((long)((((int)(2 * x - 47)) <<((int)(2 * x)))))-((int)((((int)(2 * x)) ^((int)(2 * x - 47)))))+((long)((((int)(t)) &((int)(47)))));
t = 2 * x - 47 + 42 *((int)((((int)(47)) <<((int)(2 * x - 47)))))*((int)((((double)(x)) *((double)(t)))))*((int)((((int)(2 * x)) >>((int)(x)))));
;
...
t = 2 * x - 51 + 42 +((long)((((int)(t)) |((int)(2)))));
t = 2 * x - 51 + 42 +((short)((((int)(2 * x)) <<((int)(2 * x - 51)))))+((int)((((int)(2 * x - 51)) %((int)(x)))))+((long)((((double)(51)) +((double)(2)))))-((short)((((int)(2 * x)) &((int)(x)))))+((long)((((int)(2 * x)) &((int)(2 * x - 51)))));
;
...
t = 2 * x - 99 + 42 -((long)((((int)(t)) >>((int)(x)))))+((short)((((int)(2 * x - 99)) >>((int)(99)))))-((short)((((int)(x)) |((int)(x)))))-((short)((((double)(2)) -((double)(x)))))*((long)((((int)(99)) %((int)(2 * x - 99)))));
t = 2 * x - 99 + 42 *((int)((((double)(2)) -((double)(x)))));
;
...
t = 2 * x - 127 + 42 -((long)((((int)(2 * x)) <<((int)(2 * x)))));
t = 2 * x - 127 + 42 +((long)((((int)(x)) |((int)(2)))))+((long)((((double)(2)) *((double)(127)))))+((long)((((double)(2)) *((double)(2)))));
;
      return 0.22680e0 + (0.42366e-2 + (0.41477e-4 + (0.34300e-6 + (0.23888e-8 + (0.13846e-10 + 0.65100e-13 * t) * t) * t) * t) * t) * t;
    case 64:
      
t = 2 * x - 129 + 42 +((short)((((double)(2)) -((double)(x)))))-((long)((((int)(2)) %((int)(x)))));
t = 2 * x - 129 + 42 -((short)((((int)(2)) |((int)(2 * x - 129)))))*((long)((((int)(2)) <<((int)(t)))));
;
...
t = 2 * x - 137 + 42 -((int)((((int)(2 * x)) &((int)(t)))));
;
      return 0.27369e0 + (0.51793e-2 + (0.53350e-4 + (0.45379e-6 + (0.31874e-8 + (0.18277e-10 + 0.83144e-13 * t) * t) * t) * t) * t) * t;
    case 69:
      
t = 2 * x - 139 + 42 +((long)((((int)(2 * x)) &((int)(t)))))-((long)((((int)(2 * x - 139)) |((int)(139)))))-((int)((((int)(x)) |((int)(139)))));
t = 2 * x - 139 + 42 +((int)((((double)(x)) +((double)(2)))))-((int)((((int)(2 * x - 139)) %((int)(139)))))-((int)((((int)(t)) >>((int)(2 * x - 139)))));
;
      return 0.28426e0 + (0.53983e-2 + (0.56150e-4 + (0.48003e-6 + (0.33752e-8 + (0.19299e-10 + 0.87139e-13 * t) * t) * t) * t) * t) * t;
    case 70:
      
t = 2 * x - 141 + 42 +((short)((((int)(2)) &((int)(2 * x - 141)))));
t = 2 * x - 141 + 42 *((short)((((int)(2 * x)) ^((int)(2 * x - 141)))))-((long)((((double)(t)) *((double)(t)))))+((long)((((double)(141)) +((double)(141)))));
;
...
t = 2 * x - 147 + 42 *((int)((((int)(t)) |((int)(2 * x)))))-((long)((((int)(2 * x)) >>((int)(2 * x)))))-((long)((((int)(x)) ^((int)(2 * x - 147)))))+((long)((((double)(2)) +((double)(t)))))*((int)((((int)(2 * x - 147)) &((int)(2 * x - 147)))));
t = 2 * x - 147 + 42 -((short)((((int)(x)) |((int)(t)))));
;
...
t = 2 * x - 153 + 42 -((short)((((double)(153)) +((double)(t)))))-((int)((((int)(2 * x - 153)) %((int)(2 * x - 153)))))-((int)((((double)(x)) +((double)(2)))));
t = 2 * x - 153 + 42 -((int)((((int)(2 * x)) %((int)(153)))))-((short)((((int)(t)) ^((int)(t)))));
;
      return 0.37230e0 + (0.72938e-2 + (0.80864e-4 + (0.71206e-6 + (0.50117e-8 + (0.27899e-10 + 0.11862e-12 * t) * t) * t) * t) * t) * t;
    case 77:
      
t = 2 * x - 155 + 42 -((long)((((int)(2)) ^((int)(2 * x)))))*((short)((((int)(t)) &((int)(2 * x)))));
t = 2 * x - 155 + 42 *((short)((((double)(x)) -((double)(155)))))-((int)((((double)(2)) +((double)(155)))))+((short)((((int)(2 * x)) &((int)(2 * x)))))+((int)((((int)(155)) <<((int)(x)))))-((short)((((int)(2 * x - 155)) >>((int)(t)))));
;
...
t = 2 * x - 159 + 42 +((short)((((int)(2 * x - 159)) >>((int)(2)))))-((int)((((double)(159)) *((double)(2)))))*((long)((((int)(159)) <<((int)(t)))))*((int)((((int)(2 * x)) &((int)(x)))));
t = 2 * x - 159 + 42 -((short)((((int)(2)) %((int)(2 * x - 159)))))*((long)((((double)(x)) *((double)(t)))));
;
...
t = 2 * x - 163 + 42 -((int)((((int)(x)) >>((int)(2)))))-((short)((((double)(2)) *((double)(t)))))-((long)((((int)(t)) %((int)(2 * x - 163)))))+((long)((((int)(2 * x)) |((int)(t)))));
t = 2 * x - 163 + 42 -((short)((((int)(2 * x)) %((int)(t)))))-((long)((((int)(t)) %((int)(x)))));
;
      return 0.45409e0 + (0.91463e-2 + (0.10553e-3 + (0.94293e-6 + (0.65972e-8 + (0.35782e-10 + 0.14455e-12 * t) * t) * t) * t) * t) * t;
    case 82:
      
t = 2 * x - 165 + 42 +((long)((((int)(x)) >>((int)(2 * x - 165)))))*((long)((((int)(2 * x)) %((int)(t)))))+((long)((((double)(t)) *((double)(x)))))-((short)((((int)(2 * x)) <<((int)(2 * x)))))+((short)((((int)(165)) %((int)(2 * x)))));
t = 2 * x - 165 + 42 *((int)((((int)(165)) |((int)(2)))))*((int)((((int)(x)) <<((int)(165)))))*((short)((((int)(x)) %((int)(2)))));
;
      return 0.47282e0 + (0.95799e-2 + (0.11135e-3 + (0.99716e-6 + (0.69638e-8 + (0.37549e-10 + 0.15003e-12 * t) * t) * t) * t) * t) * t;
    case 83:
      
t = 2 * x - 167 + 42 -((short)((((int)(167)) |((int)(167)))))-((long)((((int)(2 * x)) >>((int)(2)))))+((short)((((int)(2 * x - 167)) %((int)(2 * x)))))-((short)((((int)(t)) &((int)(t)))))+((long)((((int)(2 * x)) &((int)(2 * x - 167)))));
t = 2 * x - 167 + 42 +((short)((((double)(x)) +((double)(2)))))-((int)((((double)(2)) *((double)(167)))))-((int)((((double)(t)) -((double)(t)))));
;
      return 0.49243e0 + (0.10037e-1 + (0.11750e-3 + (0.10544e-5 + (0.73484e-8 + (0.39383e-10 + 0.15559e-12 * t) * t) * t) * t) * t) * t;
    case 84:
      
t = 2 * x - 169 + 42 -((long)((((int)(2 * x - 169)) |((int)(x)))))*((long)((((int)(2)) %((int)(t)))))-((long)((((int)(2 * x)) >>((int)(x)))))*((int)((((double)(x)) -((double)(x)))));
t = 2 * x - 169 + 42 *((long)((((int)(x)) |((int)(2 * x)))))+((long)((((double)(t)) -((double)(x)))));
;
      return 0.51298e0 + (0.10520e-1 + (0.12400e-3 + (0.11147e-5 + (0.77517e-8 + (0.41283e-10 + 0.16122e-12 * t) * t) * t) * t) * t) * t;
    case 85:
      
t = 2 * x - 171 + 42 +((short)((((double)(2)) *((double)(2)))))+((long)((((int)(2 * x - 171)) <<((int)(2 * x)))));
t = 2 * x - 171 + 42 -((long)((((int)(2 * x - 171)) &((int)(2 * x - 171)))));
;
...
t = 2 * x - 175 + 42 +((short)((((int)(175)) >>((int)(175)))))*((int)((((int)(2 * x)) ^((int)(2 * x - 175)))))*((long)((((int)(2 * x - 175)) %((int)(2 * x - 175)))))-((long)((((int)(175)) %((int)(x)))))-((long)((((double)(t)) -((double)(t)))));
t = 2 * x - 175 + 42 +((long)((((int)(2 * x)) |((int)(t)))))*((long)((((int)(x)) ^((int)(t)))))-((long)((((double)(2)) *((double)(2)))));
;
...
t = 2 * x - 179 + 42 +((int)((((int)(2)) >>((int)(2 * x)))))*((int)((((int)(2 * x)) >>((int)(2 * x - 179)))))*((long)((((int)(x)) %((int)(2 * x - 179)))))-((long)((((int)(2 * x - 179)) <<((int)(x)))));
t = 2 * x - 179 + 42 -((long)((((double)(x)) *((double)(t)))))*((int)((((int)(2 * x)) %((int)(2 * x)))));
;
      return 0.63178e0 + (0.13368e-1 + (0.16254e-3 + (0.14695e-5 + (0.10072e-7 + (0.51822e-10 + 0.19025e-12 * t) * t) * t) * t) * t) * t;
    case 90:
      
t = 2 * x - 181 + 42 +((int)((((int)(2 * x - 181)) >>((int)(2 * x - 181)))))+((short)((((double)(x)) +((double)(t)))))+((int)((((double)(t)) *((double)(2)))))+((short)((((int)(181)) >>((int)(181)))))-((int)((((int)(2)) ^((int)(2 * x)))));
t = 2 * x - 181 + 42 *((short)((((double)(181)) *((double)(t)))))*((short)((((int)(x)) &((int)(2 * x)))))*((int)((((int)(x)) >>((int)(x)))));
;
      return 0.65918e0 + (0.14036e-1 + (0.17160e-3 + (0.15521e-5 + (0.10601e-7 + (0.54140e-10 + 0.19616e-12 * t) * t) * t) * t) * t) * t;
    case 91:
      
t = 2 * x - 183 + 42 +((short)((((int)(2 * x - 183)) ^((int)(2 * x)))))+((int)((((int)(x)) %((int)(x)))));
t = 2 * x - 183 + 42 -((short)((((int)(2)) >>((int)(2 * x)))))*((int)((((int)(2 * x)) ^((int)(2 * x - 183)))))-((short)((((int)(2)) &((int)(t)))))-((int)((((int)(2 * x - 183)) |((int)(2 * x)))))*((long)((((int)(2 * x)) >>((int)(2 * x - 183)))));
;
