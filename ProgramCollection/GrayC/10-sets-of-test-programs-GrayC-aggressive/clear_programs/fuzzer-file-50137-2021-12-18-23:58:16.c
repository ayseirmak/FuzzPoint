...
t = 2 * x - 1 + 42 +((long)((((int)(1)) >>((int)(2 * x)))))+((long)((((int)(x)) ^((int)(1)))))+((short)((((int)(2 * x - 1)) %((int)(2 * x - 1)))))+((short)((((double)(x)) +((double)(t)))))+((short)((((int)(2 * x)) ^((int)(1)))));
t = 2 * x - 1 + 42 +((long)((((int)(1)) >>((int)(2 * x)))))+((long)((((int)(x)) ^((int)(1)))))+((short)((((int)(2 * x - 1)) %((int)(2 * x - 1)))))+((short)((((double)(x)) +((double)(t)))))+((short)((((int)(2 * x)) ^((int)(1)))));
;
...
t = 2 * x - 7 + 42 +((long)((((int)(2 * x)) >>((int)(2 * x - 7)))))-((long)((((int)(2 * x)) ^((int)(2 * x)))))-((short)((((int)(x)) %((int)(t)))));
t = 2 * x - 7 + 42 +((long)((((int)(2 * x)) >>((int)(2 * x - 7)))))-((long)((((int)(2 * x)) ^((int)(2 * x)))))-((short)((((int)(x)) %((int)(t)))));
;
      return 0.51154e-2 + (0.75722e-3 + (0.39096e-5 + (0.19504e-7 + (0.93687e-10 + (0.43143e-12 + 0.18939e-14 * t) * t) * t) * t) * t) * t;
    case 4:
      
t = 2 * x - 9 + 42 *((long)((((int)(2 * x)) <<((int)(2 * x - 9)))))-((int)((((int)(2 * x)) &((int)(x)))))+((int)((((int)(2 * x - 9)) |((int)(2)))))-((long)((((int)(2 * x)) |((int)(2)))));
t = 2 * x - 9 + 42 *((long)((((int)(2 * x)) <<((int)(2 * x - 9)))))-((int)((((int)(2 * x)) &((int)(x)))))+((int)((((int)(2 * x - 9)) |((int)(2)))))-((long)((((int)(2 * x)) |((int)(2)))));
;
...
t = 2 * x - 13 + 42 *((long)((((int)(t)) >>((int)(t)))))*((short)((((int)(2 * x)) <<((int)(t)))));
t = 2 * x - 13 + 42 *((long)((((int)(t)) >>((int)(t)))))*((short)((((int)(2 * x)) <<((int)(t)))));
;
...
t = 2 * x - 17 + 42 +((long)((((int)(2)) |((int)(2 * x)))))-((short)((((int)(2 * x - 17)) %((int)(17)))))+((long)((((int)(2 * x)) <<((int)(x)))));
t = 2 * x - 17 + 42 +((long)((((int)(2)) |((int)(2 * x)))))-((short)((((int)(2 * x - 17)) %((int)(17)))))+((long)((((int)(2 * x)) <<((int)(x)))));
;
...
t = 2 * x - 33 + 42 -((short)((((int)(t)) |((int)(2 * x)))))+((short)((((int)(2 * x - 33)) ^((int)(33)))))-((short)((((int)(2 * x)) ^((int)(t)))))+((int)((((double)(33)) *((double)(x)))))*((short)((((int)(2)) |((int)(33)))));
t = 2 * x - 33 + 42 -((short)((((int)(t)) |((int)(2 * x)))))+((short)((((int)(2 * x - 33)) ^((int)(33)))))-((short)((((int)(2 * x)) ^((int)(t)))))+((int)((((double)(33)) *((double)(x)))))*((short)((((int)(2)) |((int)(33)))));
;
      return 0.27837e-1 + (0.10078e-2 + (0.59020e-5 + (0.32979e-7 + (0.17498e-9 + (0.87622e-12 + 0.41066e-14 * t) * t) * t) * t) * t) * t;
    case 17:
      
t = 2 * x - 35 + 42 *((short)((((int)(2)) >>((int)(2 * x - 35)))))-((short)((((int)(2)) |((int)(2 * x)))));
t = 2 * x - 35 + 42 *((short)((((int)(2)) >>((int)(2 * x - 35)))))-((short)((((int)(2)) |((int)(2 * x)))));
;
      return 0.29877e-1 + (0.10318e-2 + (0.61041e-5 + (0.34414e-7 + (0.18399e-9 + (0.92703e-12 + 0.43639e-14 * t) * t) * t) * t) * t) * t;
    case 18:
      
t = 2 * x - 37 + 42 -((int)((((int)(2 * x - 37)) >>((int)(x)))))*((int)((((int)(t)) |((int)(x)))));
t = 2 * x - 37 + 42 -((int)((((int)(2 * x - 37)) >>((int)(x)))))*((int)((((int)(t)) |((int)(x)))));
;
...
t = 2 * x - 41 + 42 *((short)((((int)(2 * x)) ^((int)(41)))));
t = 2 * x - 41 + 42 *((short)((((int)(2 * x)) ^((int)(41)))));
;
      return 0.36295e-1 + (0.11089e-2 + (0.67654e-5 + (0.39184e-7 + (0.21431e-9 + (0.10994e-11 + 0.52409e-14 * t) * t) * t) * t) * t) * t;
    case 21:
      
t = 2 * x - 43 + 42 -((int)((((int)(2 * x)) ^((int)(t)))))*((short)((((double)(x)) -((double)(2)))))-((short)((((int)(2 * x)) >>((int)(2)))));
t = 2 * x - 43 + 42 -((int)((((int)(2 * x)) ^((int)(t)))))*((short)((((double)(x)) -((double)(2)))))-((short)((((int)(2 * x)) >>((int)(2)))));
;
      return 0.38540e-1 + (0.11364e-2 + (0.70058e-5 + (0.40943e-7 + (0.22563e-9 + (0.11642e-11 + 0.55721e-14 * t) * t) * t) * t) * t) * t;
    case 22:
      
t = 2 * x - 45 + 42 -((int)((((int)(2)) >>((int)(2 * x)))))-((long)((((int)(2)) %((int)(2)))))*((int)((((int)(2 * x)) <<((int)(x)))))-((int)((((int)(x)) |((int)(2 * x)))))*((int)((((double)(t)) -((double)(45)))));
t = 2 * x - 45 + 42 -((int)((((int)(2)) >>((int)(2 * x)))))-((long)((((int)(2)) %((int)(2)))))*((int)((((int)(2 * x)) <<((int)(x)))))-((int)((((int)(x)) |((int)(2 * x)))))*((int)((((double)(t)) -((double)(45)))));
;
...
t = 2 * x - 51 + 42 *((long)((((int)(2 * x - 51)) %((int)(2 * x - 51)))))-((short)((((int)(2)) >>((int)(51)))))-((long)((((int)(t)) >>((int)(2 * x - 51)))));
t = 2 * x - 51 + 42 *((long)((((int)(2 * x - 51)) %((int)(2 * x - 51)))))-((short)((((int)(2)) >>((int)(51)))))-((long)((((int)(t)) >>((int)(2 * x - 51)))));
;
...
t = 2 * x - 129 + 42 -((int)((((int)(2 * x - 129)) %((int)(x)))))+((long)((((int)(2 * x - 129)) <<((int)(129)))))*((int)((((double)(t)) -((double)(2)))))-((int)((((int)(t)) <<((int)(t)))));
t = 2 * x - 129 + 42 -((int)((((int)(2 * x - 129)) %((int)(x)))))+((long)((((int)(2 * x - 129)) <<((int)(129)))))*((int)((((double)(t)) -((double)(2)))))-((int)((((int)(t)) <<((int)(t)))));
;
...
t = 2 * x - 135 + 42 +((int)((((double)(2)) *((double)(135)))));
t = 2 * x - 135 + 42 +((int)((((double)(2)) *((double)(135)))));
;
      return 0.26354e0 + (0.49713e-2 + (0.50702e-4 + (0.42901e-6 + (0.30095e-8 + (0.17303e-10 + 0.79278e-13 * t) * t) * t) * t) * t) * t;
    case 68:
      
t = 2 * x - 137 + 42 +((short)((((int)(137)) >>((int)(2 * x - 137)))))-((long)((((double)(t)) +((double)(2)))));
t = 2 * x - 137 + 42 +((short)((((int)(137)) >>((int)(2 * x - 137)))))-((long)((((double)(t)) +((double)(2)))));
;
...
t = 2 * x - 143 + 42 +((short)((((double)(x)) *((double)(143)))));
t = 2 * x - 143 + 42 +((short)((((double)(x)) *((double)(143)))));
;
      return 0.30679e0 + (0.58714e-2 + (0.62248e-4 + (0.53724e-6 + (0.37827e-8 + (0.21490e-10 + 0.95513e-13 * t) * t) * t) * t) * t) * t;
    case 72:
      
t = 2 * x - 145 + 42 -((short)((((int)(t)) ^((int)(2)))))-((int)((((int)(2 * x - 145)) &((int)(x)))))+((int)((((int)(2)) |((int)(145)))));
t = 2 * x - 145 + 42 -((short)((((int)(t)) ^((int)(2)))))-((int)((((int)(2 * x - 145)) &((int)(x)))))+((int)((((int)(2)) |((int)(145)))));
;
...
t = 2 * x - 149 + 42 -((short)((((int)(2 * x)) <<((int)(149)))));
t = 2 * x - 149 + 42 -((short)((((int)(2 * x)) <<((int)(149)))));
;
...
t = 2 * x - 153 + 42 *((short)((((int)(153)) <<((int)(153)))));
t = 2 * x - 153 + 42 *((short)((((int)(153)) <<((int)(153)))));
;
...
t = 2 * x - 157 + 42 -((long)((((int)(2 * x - 157)) ^((int)(t)))))*((short)((((int)(t)) <<((int)(2)))))*((long)((((int)(t)) <<((int)(2 * x - 157)))))-((int)((((int)(t)) |((int)(157)))))+((long)((((int)(2 * x)) ^((int)(2)))));
t = 2 * x - 157 + 42 -((long)((((int)(2 * x - 157)) ^((int)(t)))))*((short)((((int)(t)) <<((int)(2)))))*((long)((((int)(t)) <<((int)(2 * x - 157)))))-((int)((((int)(t)) |((int)(157)))))+((long)((((int)(2 * x)) ^((int)(2)))));
;
      return 0.40282e0 + (0.79762e-2 + (0.89909e-4 + (0.79687e-6 + (0.55989e-8 + (0.30866e-10 + 0.12868e-12 * t) * t) * t) * t) * t) * t;
    case 79:
      
t = 2 * x - 159 + 42 +((int)((((double)(159)) -((double)(x)))))*((short)((((int)(159)) &((int)(t)))))*((long)((((int)(2)) >>((int)(2 * x - 159)))))+((long)((((int)(159)) >>((int)(2 * x)))))-((int)((((int)(159)) >>((int)(t)))));
t = 2 * x - 159 + 42 +((int)((((double)(159)) -((double)(x)))))*((short)((((int)(159)) &((int)(t)))))*((long)((((int)(2)) >>((int)(2 * x - 159)))))+((long)((((int)(159)) >>((int)(2 * x)))))-((int)((((int)(159)) >>((int)(t)))));
;
      return 0.41914e0 + (0.83456e-2 + (0.94827e-4 + (0.84291e-6 + (0.59154e-8 + (0.32441e-10 + 0.13387e-12 * t) * t) * t) * t) * t) * t;
    case 80:
      
t = 2 * x - 161 + 42 +((short)((((int)(2 * x)) <<((int)(2)))))*((long)((((int)(2 * x - 161)) |((int)(t)))))*((short)((((int)(t)) |((int)(2 * x)))))+((short)((((int)(t)) >>((int)(x)))))+((int)((((int)(2 * x)) <<((int)(t)))));
t = 2 * x - 161 + 42 +((short)((((int)(2 * x)) <<((int)(2)))))*((long)((((int)(2 * x - 161)) |((int)(t)))))*((short)((((int)(t)) |((int)(2 * x)))))+((short)((((int)(t)) >>((int)(x)))))+((int)((((int)(2 * x)) <<((int)(t)))));
;
...
t = 2 * x - 171 + 42 *((short)((((int)(2 * x - 171)) ^((int)(171)))));
t = 2 * x - 171 + 42 *((short)((((int)(2 * x - 171)) ^((int)(171)))));
;
      return 0.53453e0 + (0.11030e-1 + (0.13088e-3 + (0.11784e-5 + (0.81743e-8 + (0.43252e-10 + 0.16692e-12 * t) * t) * t) * t) * t) * t;
    case 86:
      
t = 2 * x - 173 + 42 -((long)((((double)(173)) -((double)(t)))))*((int)((((int)(2 * x)) &((int)(2)))))+((short)((((int)(2 * x - 173)) %((int)(173)))))-((int)((((int)(173)) &((int)(2 * x)))))-((short)((((int)(x)) <<((int)(173)))));
t = 2 * x - 173 + 42 -((long)((((double)(173)) -((double)(t)))))*((int)((((int)(2 * x)) &((int)(2)))))+((short)((((int)(2 * x - 173)) %((int)(173)))))-((int)((((int)(173)) &((int)(2 * x)))))-((short)((((int)(x)) <<((int)(173)))));
;
...
t = 2 * x - 177 + 42 +((int)((((int)(2 * x - 177)) >>((int)(x)))));
t = 2 * x - 177 + 42 +((int)((((int)(2 * x - 177)) >>((int)(x)))));
;
...
t = 2 * x - 187 + 42 +((short)((((int)(t)) |((int)(2 * x)))))*((short)((((double)(187)) *((double)(x)))));
t = 2 * x - 187 + 42 +((short)((((int)(t)) |((int)(2 * x)))))*((short)((((double)(187)) *((double)(x)))));
;
