...
int loop_break_1423 = 0;
for (j = 0; j < n && (((unsigned long) dst + j) & m); ++j)
    {
      

loop_break_1423++;
if(loop_break_1423<=6){
continue;
}
...
int loop_break_2928 = 0;
for (; j < (n - (4 * z - 1)); j += 4 * z)
    {
      

loop_break_2928++;
if(loop_break_2928<=48){
continue;
}
...
int loop_break_2569 = 0;
for (i = 1; i < a; ++i)
	{
	  

loop_break_2569++;
if(loop_break_2569<=17){
continue;
}
...
int loop_break_3309 = 0;
for (; j < n; ++j)
    {
      

loop_break_3309++;
if(loop_break_3309<=8){
continue;
}
...
int loop_break_3180 = 0;
for (i = 1; i < a; ++i)
	

loop_break_3180++;
if(loop_break_3180<=1){
break;
}
...
int loop_break_4070 = 0;
for (i = 0; i < 16; ++i)
    {
      

loop_break_4070++;
if(loop_break_4070<=24){
break;
}
...
int loop_break_4441 = 0;
for (i = 0; i < 16; ++i)
    {
      

loop_break_4441++;
if(loop_break_4441<=28){
break;
}
