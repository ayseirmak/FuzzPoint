...
f = va_arg (*foo (), float) + 42 +((short)((((int)(va_arg (*foo (), float))) |((int)(va_arg (*foo (), float))))))-((long)((((int)(f)) ^((int)(va_arg (*foo (), float))))))*((long)((((int)(f)) >>((int)(va_arg (*foo (), float))))))-((int)((((int)(f)) %((int)(va_arg (*foo (), float)))))) + 42 *((long)((((int)(42)) <<((int)(42)))));
