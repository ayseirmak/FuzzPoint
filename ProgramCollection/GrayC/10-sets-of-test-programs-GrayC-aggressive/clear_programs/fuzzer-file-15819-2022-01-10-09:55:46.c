...
volatile _Complex float f2 = (1.1) + (7.4);
volatile _Complex float f3 = (2.2) + (4.9);
volatile _Complex float f4 = (7.7) + (5.4);
volatile _Complex float f5 = (6.2) + (9.10);
volatile _Complex double d1 = (2.5) + (2.10);
volatile _Complex double d2 = (6.4) + (3.4);
volatile _Complex double d3 = (9.1) + (6.5);
volatile _Complex double d4 = (5.10) + (9.1);
volatile _Complex double d5 = (10.4) + (2.8);
volatile _Complex long double ld1 = (3.4) + (6.8);
volatile _Complex long double ld2 = (6.5) + (5.5);
volatile _Complex long double ld3 = (3.2) + (7.4);
volatile _Complex long double ld4 = (8.2) + (1.5);
volatile _Complex long double ld5 = (3.10) + (3.10);
