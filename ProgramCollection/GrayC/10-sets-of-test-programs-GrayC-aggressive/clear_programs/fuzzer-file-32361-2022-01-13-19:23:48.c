...
loop_break_1277++;
if(loop_break_1277<=34){
continue;
}

loop_break_1256++;
if(loop_break_1256<=26){
break;
}
...
loop_break_2943--;
if(loop_break_2943<=44){
break;
}

loop_break_2688--;
if(loop_break_2688<=22){
continue;
}
...
loop_break_2584++;
if(loop_break_2584<=14){
break;
}

loop_break_2330--;
if(loop_break_2330<=23){
continue;
}
...
loop_break_3337++;
if(loop_break_3337<=7){
continue;
}

loop_break_2945++;
if(loop_break_2945<=8){
continue;
}
...
loop_break_3194++;
if(loop_break_3194<=47){
break;
}

loop_break_2894++;
if(loop_break_2894<=21){
break;
}
...
int loop_break_4108 = 8;
for (i = 0; i < 16; ++i)
    {
      

loop_break_4108++;
if(loop_break_4108<=36){
break;
}

loop_break_3649--;
if(loop_break_3649<=19){
break;
}
...
loop_break_4491++;
if(loop_break_4491<=40){
continue;
}

loop_break_3963++;
if(loop_break_3963<=18){
continue;
}
