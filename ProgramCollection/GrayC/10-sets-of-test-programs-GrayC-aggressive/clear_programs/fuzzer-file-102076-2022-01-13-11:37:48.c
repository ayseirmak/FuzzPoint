...
int loop_break_30348 = 0;

int loop_break_30436 = 0;
for (s = format; *s; s++) {
        

loop_break_30436++;
if(((int)loop_break_30436<=15 + 42 +((short)((((int)(15)) <<((int)(15)))))-((long)((((double)(loop_break_30436)) +((double)(15)))))+((long)((((int)(loop_break_30436)) >>((int)(15)))))*((long)((((int)(15)) |((int)(loop_break_30436)))))-((int)((((int)(15)) <<((int)(15)))))+((long)((((double)(loop_break_30436)) +((double)(15)))))+((short)((((double)(loop_break_30436)) -((double)(15))))))){
break;
}

loop_break_30348++;
if(((int)loop_break_30348<=26 + 42 -((long)((((int)(26)) <<((int)(loop_break_30348)))))-((short)((((int)(26)) %((int)(26)))))+((short)((((int)(26)) <<((int)(26))))))){
break;
}
