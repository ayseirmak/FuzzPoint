...
int loop_break_2584 = 8;
for (i = 1; i < a; ++i)
	{
	  

loop_break_2584++;
if(loop_break_2584<=1){
continue;
}
...
int loop_break_3337 = 8;
for (; j < n; ++j)
    {
      

loop_break_3337++;
if(loop_break_3337<=10){
continue;
}
...
int loop_break_3194 = 8;
for (i = 1; i < a; ++i)
	

loop_break_3194++;
if(loop_break_3194<=28){
continue;
}
...
int loop_break_4491 = 8;
for (i = 0; i < 16; ++i)
    {
      

loop_break_4491++;
if(loop_break_4491<=45){
continue;
}
