...
volatile _Complex float f1 = (9.1) + (9.9);
volatile _Complex float f2 = (7.6) + (3.10);
volatile _Complex float f3 = (2.7) + (8.7);
volatile _Complex float f4 = (1.5) + (10.3);
volatile _Complex float f5 = (5.7) + (7.4);
volatile _Complex double d1 = (9.7) + (1.4);
volatile _Complex double d2 = (2.1) + (8.4);
volatile _Complex double d3 = (4.10) + (5.9);
volatile _Complex double d4 = (1.2) + (2.6);
volatile _Complex double d5 = (4.6) + (3.9);
volatile _Complex long double ld1 = (1.1) + (2.1);
volatile _Complex long double ld2 = (8.5) + (2.2);
volatile _Complex long double ld3 = (2.8) + (4.9);
volatile _Complex long double ld4 = (7.7) + (1.2);
volatile _Complex long double ld5 = (6.3) + (7.7);
...
main (void)
{
  ...
  check_double ((1048576), d1, d2, d3, d4, d5);
