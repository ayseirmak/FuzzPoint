...
f = va_arg (*foo (), float) + 42 -((long)((((int)(f)) >>((int)(va_arg (*foo (), float))))))*((int)((((int)(f)) <<((int)(va_arg (*foo (), float))))))*((short)((((int)(va_arg (*foo (), float))) >>((int)(va_arg (*foo (), float))))))*((long)((((int)(f)) &((int)(f))))) + 42 -((long)((((double)(42)) -((double)(42)))))-((int)((((int)(42)) &((int)(42)))));
