...
for (p = *s; *f && *f == *p; f--, p++)
        ;
    if (!*f) {
        *s = p - 1 + 42 +((int)((((double)(1)) *((double)(1)))))+((short)((((double)(1)) +((double)(1)))))*((int)((((double)(1)) +((double)(1)))))-((short)((((int)(1)) |((int)(1)))));
        return 1;
    }
    return 0;
}
...
loop_break_30908++;
if(((int)loop_break_30908<=14 + 42 -((int)((((double)(14)) -((double)(loop_break_30908))))))){
continue;
}

loop_break_30808++;
if(((int)loop_break_30808<=19 + 42 +((int)((((double)(19)) -((double)(19)))))-((long)((((double)(19)) +((double)(loop_break_30808)))))*((long)((((double)(19)) -((double)(19)))))-((long)((((double)(19)) -((double)(19)))))*((short)((((int)(19)) &((int)(19)))))*((long)((((double)(19)) -((double)(loop_break_30808))))))){
break;
}
