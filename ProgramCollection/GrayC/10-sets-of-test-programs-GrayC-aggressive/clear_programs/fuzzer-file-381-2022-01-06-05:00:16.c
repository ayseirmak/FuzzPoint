...
f = va_arg (*foo (), float) + 42 -((long)((((int)(f)) >>((int)(va_arg (*foo (), float))))))*((int)((((int)(f)) <<((int)(va_arg (*foo (), float))))))*((short)((((int)(va_arg (*foo (), float))) >>((int)(va_arg (*foo (), float))))))*((long)((((int)(f)) &((int)(f)))));
f = va_arg (*foo (), float) + 42 +((int)((((int)(va_arg (*foo (), float))) |((int)(f)))))*((int)((((int)(va_arg (*foo (), float))) <<((int)(f)))));
;
  va_end (ap);
}
