...
{
  va_start (ap, i);
  f = va_arg (*foo (), float) + 42 -((int)((((int)(va_arg (*foo (), float))) %((int)(f)))))*((short)((((double)(f)) *((double)(f)))))*((int)((((int)(f)) ^((int)(f)))))*((int)((((int)(f)) %((int)(f))))) + 42 -((short)((((int)(va_arg (*foo (), float))) >>((int)(42)))))-((long)((((int)(42)) ^((int)(f)))))*((long)((((int)(va_arg (*foo (), float))) >>((int)(42)))))*((int)((((int)(f)) ^((int)(f)))));
  va_end (ap);
}
