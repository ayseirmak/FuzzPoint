...
t = 2 * x - 1 + 42 +((long)((((int)(t)) &((int)(2 * x - 1)))))*((int)((((int)(2 * x - 1)) >>((int)(x)))));
t = 2 * x - 1 + 42 -((int)((((double)(x)) -((double)(x)))))-((long)((((double)(1)) *((double)(t)))))+((short)((((int)(x)) %((int)(2 * x)))));
;
...
t = 2 * x - 7 + 42 +((short)((((int)(7)) |((int)(2 * x)))));
t = 2 * x - 7 + 42 +((int)((((int)(2 * x)) >>((int)(2 * x - 7)))))-((long)((((int)(t)) <<((int)(2)))))-((int)((((int)(x)) >>((int)(x)))))-((long)((((double)(7)) *((double)(t)))))-((long)((((int)(t)) %((int)(7)))));
;
      return 0.51154e-2 + (0.75722e-3 + (0.39096e-5 + (0.19504e-7 + (0.93687e-10 + (0.43143e-12 + 0.18939e-14 * t) * t) * t) * t) * t) * t;
    case 4:
      
t = 2 * x - 9 + 42 *((long)((((int)(t)) &((int)(2)))))-((int)((((int)(t)) %((int)(2 * x - 9)))))+((long)((((int)(2 * x)) &((int)(2 * x - 9)))));
t = 2 * x - 9 + 42 -((short)((((double)(t)) *((double)(9)))))*((short)((((int)(2 * x)) <<((int)(2 * x - 9)))))+((int)((((int)(2)) &((int)(2 * x - 9)))))-((int)((((int)(2 * x)) <<((int)(2 * x)))));
;
      return 0.66457e-2 + (0.77310e-3 + (0.40289e-5 + (0.20271e-7 + (0.98117e-10 + (0.45484e-12 + 0.20076e-14 * t) * t) * t) * t) * t) * t;
    case 5:
      
t = 2 * x - 11 + 42 +((long)((((int)(x)) |((int)(2 * x - 11)))))+((long)((((double)(11)) -((double)(2)))));
t = 2 * x - 11 + 42 *((int)((((double)(11)) *((double)(2)))))-((int)((((int)(11)) >>((int)(11)))))+((int)((((int)(2)) <<((int)(x)))));
;
...
t = 2 * x - 15 + 42 -((long)((((int)(2)) <<((int)(x)))))+((int)((((double)(15)) *((double)(x)))));
t = 2 * x - 15 + 42 *((long)((((double)(2)) *((double)(15)))))+((long)((((int)(2)) <<((int)(2 * x)))))+((int)((((double)(x)) +((double)(2)))))+((long)((((int)(x)) |((int)(2 * x - 15)))))+((int)((((int)(2 * x)) >>((int)(2 * x)))));
;
...
t = 2 * x - 19 + 42 *((short)((((int)(2 * x)) <<((int)(2 * x - 19)))))*((int)((((double)(19)) *((double)(t)))))+((long)((((int)(19)) |((int)(2 * x)))))*((long)((((double)(x)) *((double)(t)))));
t = 2 * x - 19 + 42 -((long)((((int)(19)) %((int)(2 * x - 19)))))+((long)((((int)(2 * x - 19)) ^((int)(19)))))+((int)((((int)(2 * x - 19)) %((int)(2 * x)))));
;
      return 0.14800e-1 + (0.86018e-3 + (0.47008e-5 + (0.24694e-7 + (0.12418e-9 + (0.59486e-12 + 0.26957e-14 * t) * t) * t) * t) * t) * t;
    case 10:
      
t = 2 * x - 21 + 42 -((long)((((int)(21)) &((int)(2 * x)))))+((int)((((int)(2 * x)) &((int)(t)))))-((int)((((int)(21)) &((int)(2)))));
t = 2 * x - 21 + 42 *((int)((((double)(x)) -((double)(x)))));
;
...
t = 2 * x - 27 + 42 +((long)((((int)(2 * x)) %((int)(27)))))-((long)((((int)(2 * x - 27)) >>((int)(t)))))+((short)((((double)(2)) -((double)(2)))));
t = 2 * x - 27 + 42 *((short)((((int)(t)) >>((int)(2 * x - 27)))))+((long)((((int)(t)) <<((int)(x)))));
;
      return 0.21996e-1 + (0.94040e-3 + (0.53443e-5 + (0.29078e-7 + (0.15078e-9 + (0.74103e-12 + 0.34251e-14 * t) * t) * t) * t) * t) * t;
    case 14:
      
t = 2 * x - 29 + 42 +((short)((((double)(2)) -((double)(x)))))*((short)((((int)(2 * x)) <<((int)(29)))))*((short)((((double)(x)) +((double)(2)))))+((long)((((int)(2)) %((int)(2 * x - 29)))))-((int)((((int)(t)) ^((int)(2 * x)))));
t = 2 * x - 29 + 42 *((short)((((int)(29)) |((int)(2 * x)))))-((short)((((double)(29)) *((double)(29)))))*((int)((((int)(2 * x - 29)) ^((int)(t)))))*((long)((((int)(x)) %((int)(2 * x - 29)))))-((int)((((int)(t)) %((int)(2 * x - 29)))));
;
      return 0.23898e-1 + (0.96213e-3 + (0.55225e-5 + (0.30314e-7 + (0.15840e-9 + (0.78340e-12 + 0.36381e-14 * t) * t) * t) * t) * t) * t;
    case 15:
      
t = 2 * x - 31 + 42 *((long)((((double)(x)) -((double)(x)))))+((int)((((int)(2 * x)) ^((int)(2 * x)))))+((long)((((int)(2 * x - 31)) &((int)(2 * x)))));
t = 2 * x - 31 + 42 +((int)((((int)(31)) ^((int)(2 * x)))));
;
...
t = 2 * x - 35 + 42 -((short)((((double)(35)) -((double)(x)))))-((short)((((int)(x)) >>((int)(2 * x)))))+((long)((((int)(2)) <<((int)(2 * x - 35)))))*((int)((((double)(2)) *((double)(2)))));
t = 2 * x - 35 + 42 *((int)((((double)(35)) -((double)(x)))))*((long)((((double)(t)) -((double)(35)))));
;
...
t = 2 * x - 43 + 42 -((short)((((double)(t)) *((double)(2)))))+((long)((((int)(t)) %((int)(43)))))-((int)((((int)(2 * x - 43)) |((int)(43)))));
t = 2 * x - 43 + 42 *((short)((((double)(t)) *((double)(2)))))*((long)((((double)(t)) +((double)(x)))))*((long)((((double)(t)) -((double)(x)))));
;
...
t = 2 * x - 49 + 42 *((long)((((double)(2)) -((double)(2)))))-((long)((((int)(2 * x)) ^((int)(49)))))*((int)((((double)(49)) *((double)(x)))));
t = 2 * x - 49 + 42 +((int)((((int)(2 * x)) %((int)(49)))))*((int)((((int)(2 * x)) &((int)(2)))));
;
...
t = 2 * x - 59 + 42 +((int)((((int)(2 * x - 59)) ^((int)(2 * x)))))-((int)((((int)(t)) ^((int)(x)))))-((short)((((double)(x)) *((double)(59)))))-((int)((((int)(2 * x - 59)) %((int)(2 * x)))));
t = 2 * x - 59 + 42 *((long)((((int)(t)) <<((int)(2 * x - 59)))))*((short)((((int)(2)) &((int)(2)))))+((short)((((double)(x)) +((double)(2)))))-((short)((((int)(2 * x - 59)) |((int)(59)))))-((short)((((double)(2)) +((double)(x)))));
;
...
t = 2 * x - 119 + 42 -((long)((((int)(t)) |((int)(119)))))*((int)((((int)(2 * x)) ^((int)(2 * x)))))-((long)((((int)(t)) >>((int)(2 * x - 119)))))+((long)((((int)(119)) &((int)(2 * x - 119)))));
t = 2 * x - 119 + 42 +((int)((((int)(x)) %((int)(x)))))+((short)((((int)(2 * x)) ^((int)(x)))))+((short)((((int)(119)) %((int)(2 * x - 119)))))*((long)((((int)(119)) %((int)(2 * x)))))*((long)((((double)(t)) -((double)(x)))));
;
...
t = 2 * x - 125 + 42 +((short)((((double)(t)) *((double)(t)))))+((short)((((int)(2 * x - 125)) &((int)(2 * x - 125)))));
t = 2 * x - 125 + 42 +((long)((((int)(t)) %((int)(t)))));
;
      return 0.21849e0 + (0.40747e-2 + (0.39476e-4 + (0.32443e-6 + (0.22542e-8 + (0.13084e-10 + 0.61873e-13 * t) * t) * t) * t) * t) * t;
    case 63:
      
t = 2 * x - 127 + 42 -((long)((((int)(2 * x)) <<((int)(t)))))-((short)((((int)(t)) |((int)(2 * x)))));
t = 2 * x - 127 + 42 -((long)((((int)(t)) <<((int)(t)))));
;
...
t = 2 * x - 135 + 42 *((int)((((int)(135)) &((int)(2 * x - 135)))))-((long)((((int)(x)) <<((int)(t)))))*((short)((((int)(2 * x)) ^((int)(2 * x)))))*((short)((((int)(x)) ^((int)(2 * x)))))+((long)((((double)(x)) *((double)(2)))));
t = 2 * x - 135 + 42 *((int)((((double)(135)) -((double)(2)))))+((long)((((int)(t)) ^((int)(x)))));
;
...
t = 2 * x - 145 + 42 -((long)((((double)(145)) -((double)(t)))))*((long)((((int)(2 * x - 145)) <<((int)(145)))))+((short)((((int)(2)) <<((int)(2 * x)))))*((int)((((int)(t)) &((int)(145)))));
t = 2 * x - 145 + 42 +((long)((((int)(t)) %((int)(2 * x)))))-((long)((((int)(x)) &((int)(x)))));
;
...
t = 2 * x - 149 + 42 *((short)((((int)(2 * x)) %((int)(2 * x)))))*((long)((((int)(x)) |((int)(2)))))+((int)((((int)(2 * x - 149)) ^((int)(149)))));
t = 2 * x - 149 + 42 -((int)((((int)(149)) %((int)(2 * x - 149)))))*((long)((((int)(149)) ^((int)(x)))))*((long)((((int)(2)) %((int)(2 * x)))))+((long)((((double)(149)) +((double)(149)))))+((long)((((int)(x)) &((int)(2 * x - 149)))));
;
...
t = 2 * x - 155 + 42 *((long)((((int)(2 * x - 155)) <<((int)(2)))))+((long)((((int)(x)) <<((int)(155)))))-((short)((((int)(x)) &((int)(2 * x - 155)))))+((short)((((int)(2 * x - 155)) &((int)(2 * x - 155)))));
t = 2 * x - 155 + 42 -((short)((((double)(t)) -((double)(2)))))-((long)((((double)(t)) *((double)(155)))));
;
...
t = 2 * x - 159 + 42 *((int)((((double)(x)) +((double)(x)))))+((int)((((int)(2 * x)) <<((int)(2)))))-((short)((((int)(x)) |((int)(2 * x)))))+((long)((((int)(t)) <<((int)(x)))));
t = 2 * x - 159 + 42 *((short)((((double)(2)) *((double)(159)))));
;
      return 0.41914e0 + (0.83456e-2 + (0.94827e-4 + (0.84291e-6 + (0.59154e-8 + (0.32441e-10 + 0.13387e-12 * t) * t) * t) * t) * t) * t;
    case 80:
      
t = 2 * x - 161 + 42 +((int)((((double)(x)) *((double)(t)))))+((int)((((int)(t)) <<((int)(2)))))+((int)((((double)(t)) +((double)(t)))))*((short)((((int)(t)) <<((int)(2)))));
t = 2 * x - 161 + 42 -((int)((((double)(t)) -((double)(2)))))-((short)((((double)(161)) -((double)(161)))))-((long)((((int)(2 * x - 161)) ^((int)(t)))));
;
...
t = 2 * x - 167 + 42 +((int)((((int)(x)) &((int)(2 * x)))))-((long)((((int)(t)) &((int)(2 * x)))))-((int)((((int)(t)) <<((int)(167)))));
t = 2 * x - 167 + 42 -((int)((((int)(2)) ^((int)(x)))))+((short)((((int)(x)) &((int)(167)))));
;
      return 0.49243e0 + (0.10037e-1 + (0.11750e-3 + (0.10544e-5 + (0.73484e-8 + (0.39383e-10 + 0.15559e-12 * t) * t) * t) * t) * t) * t;
    case 84:
      
t = 2 * x - 169 + 42 -((long)((((int)(2 * x - 169)) ^((int)(2 * x)))))+((long)((((double)(t)) +((double)(t)))))*((long)((((int)(t)) &((int)(2 * x)))));
t = 2 * x - 169 + 42 *((long)((((int)(2 * x)) %((int)(169)))));
;
...
t = 2 * x - 173 + 42 +((long)((((int)(2 * x)) >>((int)(2 * x - 173)))))+((long)((((int)(2)) <<((int)(2 * x)))))+((int)((((int)(2)) <<((int)(2 * x - 173)))))-((short)((((double)(t)) *((double)(173)))));
t = 2 * x - 173 + 42 +((long)((((int)(x)) %((int)(t)))))*((int)((((int)(2 * x)) ^((int)(x)))))+((int)((((int)(2 * x - 173)) ^((int)(2 * x)))))+((long)((((int)(173)) |((int)(2 * x)))))*((short)((((int)(173)) ^((int)(2 * x - 173)))));
;
...
t = 2 * x - 177 + 42 +((short)((((int)(2 * x - 177)) >>((int)(x)))))-((short)((((int)(177)) >>((int)(2)))))*((int)((((int)(2)) <<((int)(2 * x)))))-((short)((((int)(2)) <<((int)(2 * x - 177)))))-((short)((((double)(2)) -((double)(x)))));
t = 2 * x - 177 + 42 -((short)((((int)(2 * x - 177)) ^((int)(x)))))-((short)((((int)(177)) |((int)(177)))))-((int)((((int)(177)) %((int)(2)))))-((long)((((double)(177)) *((double)(177)))))*((short)((((int)(2 * x - 177)) %((int)(177)))));
;
...
t = 2 * x - 187 + 42 *((long)((((int)(2)) <<((int)(2 * x - 187)))))+((short)((((int)(187)) &((int)(187)))))*((int)((((int)(2 * x - 187)) <<((int)(t)))))+((long)((((double)(x)) +((double)(187)))));
t = 2 * x - 187 + 42 +((short)((((int)(x)) >>((int)(t)))))+((int)((((int)(t)) |((int)(2)))))+((int)((((int)(t)) ^((int)(2)))))-((long)((((int)(t)) ^((int)(2 * x - 187)))));
;
