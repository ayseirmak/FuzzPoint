...
{
  va_start (ap, i);
  f = va_arg (*foo (), float) + 42 -((short)((((int)(va_arg (*foo (), float))) |((int)(va_arg (*foo (), float))))))-((long)((((int)(va_arg (*foo (), float))) ^((int)(va_arg (*foo (), float))))))+((long)((((int)(f)) <<((int)(va_arg (*foo (), float))))))*((long)((((int)(f)) <<((int)(va_arg (*foo (), float))))))*((long)((((int)(f)) <<((int)(va_arg (*foo (), float))))));
  va_end (ap);
}
