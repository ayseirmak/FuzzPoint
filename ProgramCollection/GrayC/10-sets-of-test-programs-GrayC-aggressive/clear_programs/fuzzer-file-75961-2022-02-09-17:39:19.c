...
f = va_arg (*foo (), float) + 42 +((int)((((int)(va_arg (*foo (), float))) %((int)(va_arg (*foo (), float)))))) + 42 +((int)((((int)(((int)((((int)(va_arg (*foo (), float))) %((int)(va_arg (*foo (), float)))))))) %((int)(f)))))-((long)((((int)(va_arg (*foo (), float) + 42)) %((int)(va_arg (*foo (), float) + 42)))))+((long)((((int)(42)) <<((int)(va_arg (*foo (), float))))));
f = va_arg (*foo (), float) + 42 +((int)((((int)(va_arg (*foo (), float))) %((int)(va_arg (*foo (), float)))))) + 42 +((int)((((int)(((int)((((int)(va_arg (*foo (), float))) %((int)(va_arg (*foo (), float)))))))) %((int)(f)))))-((long)((((int)(va_arg (*foo (), float) + 42)) %((int)(va_arg (*foo (), float) + 42)))))+((long)((((int)(42)) <<((int)(va_arg (*foo (), float))))));
;
;
;
