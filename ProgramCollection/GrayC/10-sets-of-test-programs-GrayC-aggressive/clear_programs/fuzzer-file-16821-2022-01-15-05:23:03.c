...
for (p = *s; *f && *f == *p; f++, p++)
        ;
    if (0) {
        *s = p - 1 + 42 +((short)((((int)(1)) ^((int)(1)))))-((long)((((double)(1)) *((double)(1)))))*((short)((((double)(1)) *((double)(1)))))+((int)((((int)(1)) |((int)(1)))))-((long)((((double)(1)) -((double)(1)))));
        return 1;
    }
    return 0;
}
...
int loop_break_30964 = 0;
for (s = format; *s; s++) {
        
loop_break_30964++;
if(loop_break_30964<=41){
break;
}
