...
f = va_arg (*foo (), float) + 42 *((int)((((double)(f)) *((double)(f)))))+((short)((((int)(va_arg (*foo (), float))) &((int)(va_arg (*foo (), float))))))+((int)((((double)(f)) *((double)(f)))));
f = va_arg (*foo (), float) + 42 +((long)((((int)(f)) |((int)(f)))))-((long)((((double)(f)) +((double)(f)))));
;
  va_end (ap);
}
