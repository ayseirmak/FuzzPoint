...
int loop_break_20426 = 0;

int loop_break_20452 = 0;
...
int loop_break_21443 = 0;

int loop_break_21534 = 0;

int loop_break_21615 = 0;
for (;;)
      {
...
loop_break_21615++;
if(loop_break_21615<=35){
break;
}

loop_break_21534++;
if(loop_break_21534<=17){
break;
}
...
int loop_break_22184 = 0;

int loop_break_22301 = 0;

int loop_break_22409 = 0;
for (i = 0; i < 2; i++)
    ;
