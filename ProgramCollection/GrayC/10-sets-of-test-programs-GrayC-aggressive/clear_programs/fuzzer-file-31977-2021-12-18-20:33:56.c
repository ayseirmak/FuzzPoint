...
for (p = *s; *f && *f == *p; f++, p++)
        ;
    if (0) {
        *s = p - 1 + 42 +((int)((((double)(1)) -((double)(1)))))*((int)((((int)(1)) &((int)(1))))) + 42 -((long)((((int)(((int)((((double)(1)) -((double)(1))))))) >>((int)(1)))))*((short)((((int)(((int)((((double)(1)) -((double)(1)))))*((int)((((int)(1)) &((int)(1))))))) ^((int)(((int)((((double)(1)) -((double)(1)))))*((int)((((int)(1)) &((int)(1))))))))))+((long)((((int)(((int)((((double)(1)) -((double)(1)))))*((int)((((int)(1)) &((int)(1))))))) |((int)(42)))))*((short)((((int)(1)) &((int)(((int)((((double)(1)) -((double)(1))))))))));
        return 1;
    }
    return 0;
}
...
int loop_break_30726 = 0;
for (s = format; *s; s++) {
        

loop_break_30726++;
if(((int)loop_break_30726<=29 + 42 +((long)((((int)(loop_break_30726)) |((int)(loop_break_30726)))))-((long)((((double)(29)) +((double)(loop_break_30726))))))){
continue;
}

loop_break_30808--;
if(((int)loop_break_30808<=32 + 42 -((short)((((int)(loop_break_30808)) &((int)(32)))))-((long)((((double)(32)) +((double)(loop_break_30808)))))-((short)((((double)(32)) *((double)(32))))))){
continue;
}
