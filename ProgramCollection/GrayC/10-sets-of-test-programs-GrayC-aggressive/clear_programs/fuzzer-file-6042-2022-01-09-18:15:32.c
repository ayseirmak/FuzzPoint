...
{
  va_start (ap, i);
  f = va_arg (*foo (), float) + 42 -((int)((((int)(va_arg (*foo (), float))) %((int)(f)))))*((short)((((double)(f)) *((double)(f)))))*((int)((((int)(f)) ^((int)(f)))))*((int)((((int)(f)) %((int)(f))))) + 42 +((int)((((int)(42)) %((int)(va_arg (*foo (), float) + 42)))))-((short)((((int)(42)) ^((int)(f)))))-((int)((((int)(va_arg (*foo (), float))) &((int)(va_arg (*foo (), float))))));
  va_end (ap);
}
