...
;
;
  if (((int)test2 ((void *)&s) != (-4) + (-43) *((long)((((int)(test2 ((void *)&s))) <<((int)(test2 ((void *)&s))))))+((short)((((int)((0x72B))) %((int)(test2 ((void *)&s))))))-((int)((((int)(test2 ((void *)&s))) <<((int)(test2 ((void *)&s))))))*((int)((((int)(test2 ((void *)&s))) <<((int)(test2 ((void *)&s))))))+((short)((((int)((0xCD22))) %((int)(test2 ((void *)&s))))))-((short)((((int)((131))) %((int)(test2 ((void *)&s))))))+((int)((((int)(test2 ((void *)&s))) |((int)(test2 ((void *)&s))))))))
    { abort (); }
