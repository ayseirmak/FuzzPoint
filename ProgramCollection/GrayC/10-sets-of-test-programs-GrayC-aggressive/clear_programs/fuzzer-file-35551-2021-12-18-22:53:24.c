...
int loop_break_31360 = 8;
for (s = format; *s; s++) {
        

loop_break_31360++;
if(loop_break_31360<=30){
break;
}

loop_break_30808++;
if(((int)loop_break_30808<=32 + 42 *((short)((((double)(loop_break_30808)) *((double)(loop_break_30808)))))-((long)((((int)(loop_break_30808)) %((int)(32)))))-((int)((((double)(32)) *((double)(32)))))*((short)((((int)(loop_break_30808)) ^((int)(32)))))-((long)((((int)(loop_break_30808)) |((int)(32)))))-((int)((((double)(loop_break_30808)) +((double)(32)))))*((long)((((int)(32)) <<((int)(loop_break_30808)))))+((int)((((double)(loop_break_30808)) *((double)(32))))))){
continue;
}
