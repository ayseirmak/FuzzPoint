...
volatile _Complex float f1 = (7.1) + (7.8);
volatile _Complex float f2 = (4.5) + (6.2);
volatile _Complex float f3 = (5.3) + (10.4);
volatile _Complex float f4 = (9.9) + (4.6);
volatile _Complex float f5 = (8.6) + (1.9);
volatile _Complex double d1 = (7.4) + (5.8);
volatile _Complex double d2 = (7.8) + (3.7);
volatile _Complex double d3 = (2.10) + (7.5);
volatile _Complex double d4 = (2.8) + (9.9);
volatile _Complex double d5 = (1.5) + (8.4);
volatile _Complex long double ld1 = (8.7) + (1.3);
volatile _Complex long double ld2 = (1.2) + (7.1);
volatile _Complex long double ld3 = (8.4) + (9.6);
volatile _Complex long double ld4 = (6.2) + (4.2);
volatile _Complex long double ld5 = (5.3) + (4.1);
