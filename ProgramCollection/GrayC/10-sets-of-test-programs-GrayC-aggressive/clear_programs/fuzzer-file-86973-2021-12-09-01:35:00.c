...
;
  ;
  if (((int)test1 ((void *)&s) != ((3)) + (0x86FA76) +((long)((((double)(((34)))) *((double)(((0x41D)))))))-((long)((((int)(((19)))) &((int)((-(36)))))))*((long)((((int)(test1 ((void *)&s))) ^((int)(test1 ((void *)&s))))))-((int)((((int)(((7)))) %((int)(((0x48)))))))-((int)((((int)((-(4)))) <<((int)((0x81))))))*((long)((((int)(test1 ((void *)&s))) <<((int)((0x2B))))))*((long)((((int)(test1 ((void *)&s))) |((int)(test1 ((void *)&s))))))-((long)((((double)((-(-5)))) *((double)(((11)))))))+((long)((((int)((-(0x3)))) <<((int)(test1 ((void *)&s))))))*((short)((((int)(test1 ((void *)&s))) |((int)(((-20)))))))))
    { abort (); }
  ;
