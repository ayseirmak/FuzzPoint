...
int main (void)
{
  ...
  if (((int)__builtin_types_compatible_p (char *, int)
      ...
      || __builtin_types_compatible_p (char *, char **) + 42 *((short)((((int)(__builtin_types_compatible_p (char, int))) &((int)(__builtin_types_compatible_p (char *, char **))))))-((short)((((int)(__builtin_types_compatible_p (char *, const char *))) |((int)(__builtin_types_compatible_p (char *, int)
      || __builtin_types_compatible_p (char *, const char *))))))+((int)((((int)(__builtin_types_compatible_p (char *, char **))) ^((int)(__builtin_types_compatible_p (char *, int)
      || __builtin_types_compatible_p (char *, const char *)
      || __builtin_types_compatible_p (long double, double))))))))
    { abort (); }
  exit (0);
