...
int loop_break_20436 = 0;

int loop_break_20462 = 0;

int loop_break_20491 = 0;
for (i = 0; i < what; i++)
...
int loop_break_21681 = 0;

int loop_break_21729 = 0;

int loop_break_21831 = 0;
for (;;)
      {
...
loop_break_21831++;
if(loop_break_21831<=14){
continue;
}

loop_break_21729++;
if(loop_break_21729<=26){
continue;
}
...
int loop_break_22563 = 0;

int loop_break_22629 = 0;

int loop_break_22759 = 0;
for (i = 0; i < 2; i++)
