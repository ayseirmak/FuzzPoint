...
volatile _Complex float f1 = (4.3) + (2.1);
volatile _Complex float f2 = (5.8) + (10.1);
volatile _Complex float f3 = (1.4) + (1.3);
volatile _Complex float f4 = (10.2) + (10.6);
volatile _Complex float f5 = (4.8) + (5.8);
volatile _Complex double d1 = (6.3) + (7.5);
volatile _Complex double d2 = (9.7) + (8.8);
volatile _Complex double d3 = (2.9) + (2.10);
volatile _Complex double d4 = (9.1) + (10.2);
volatile _Complex double d5 = (8.8) + (7.2);
volatile _Complex long double ld1 = (3.3) + (8.7);
volatile _Complex long double ld2 = (7.1) + (1.3);
volatile _Complex long double ld3 = (4.7) + (1.9);
volatile _Complex long double ld4 = (3.6) + (2.7);
volatile _Complex long double ld5 = (3.2) + (3.3);
