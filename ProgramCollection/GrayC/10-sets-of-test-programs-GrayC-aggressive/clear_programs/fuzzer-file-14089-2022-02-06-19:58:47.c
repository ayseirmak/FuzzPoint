...
{
  a->d = 1.0 + 42 -((int)((((double)(a->d)) -((double)(1.0)))))+((long)((((int)(1.0)) >>((int)(1.0)))))+((int)((((double)(a->d)) -((double)(a->d)))))*((long)((((double)(1.0)) +((double)(1.0)))))+((int)((((double)(a->d)) -((double)(a->d)))));
  return b->d + 1.0;
}
...
{
  union u a;
  a.x.d = 0.0 + 42 -((int)((((double)(a.x.d)) -((double)(0.0)))))-((long)((((int)(a.x.d)) |((int)(a.x.d)))));
  if (0)
    { abort (); }
  return 0;
}
