...
{
  va_start (ap, i);
  f = va_arg (*foo (), float) + 42 +((int)((((int)(va_arg (*foo (), float))) %((int)(va_arg (*foo (), float))))))+((short)((((int)(f)) &((int)(va_arg (*foo (), float))))))+((short)((((int)(f)) |((int)(va_arg (*foo (), float))))))-((int)((((double)(f)) -((double)(f)))))-((short)((((double)(f)) +((double)(f)))));
  va_end (ap);
}
