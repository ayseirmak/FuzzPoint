...
t = 2 * x - 3 + 42 +((short)((((int)(2 * x)) >>((int)(t)))))*((short)((((int)(2)) ^((int)(t)))))-((int)((((double)(3)) +((double)(2)))));
t = 2 * x - 3 + 42 +((short)((((int)(2 * x)) >>((int)(t)))))*((short)((((int)(2)) ^((int)(t)))))-((int)((((double)(3)) +((double)(2)))));
;
...
t = 2 * x - 11 + 42 *((long)((((int)(11)) <<((int)(t)))))+((int)((((int)(11)) %((int)(t)))))*((long)((((double)(11)) -((double)(t)))));
t = 2 * x - 11 + 42 *((long)((((int)(11)) <<((int)(t)))))+((int)((((int)(11)) %((int)(t)))))*((long)((((double)(11)) -((double)(t)))));
;
      return 0.82082e-2 + (0.78946e-3 + (0.41529e-5 + (0.21074e-7 + (0.10278e-9 + (0.47965e-12 + 0.21285e-14 * t) * t) * t) * t) * t) * t;
    case 6:
      
t = 2 * x - 13 + 42 -((long)((((double)(t)) +((double)(2)))))-((int)((((int)(2 * x - 13)) %((int)(13)))))*((short)((((double)(t)) -((double)(2)))));
t = 2 * x - 13 + 42 -((long)((((double)(t)) +((double)(2)))))-((int)((((int)(2 * x - 13)) %((int)(13)))))*((short)((((double)(t)) -((double)(2)))));
;
      return 0.98039e-2 + (0.80633e-3 + (0.42819e-5 + (0.21916e-7 + (0.10771e-9 + (0.50595e-12 + 0.22573e-14 * t) * t) * t) * t) * t) * t;
    case 7:
      
t = 2 * x - 15 + 42 -((long)((((double)(2)) -((double)(15)))))+((long)((((int)(15)) ^((int)(15)))))*((int)((((double)(x)) *((double)(15)))))-((int)((((int)(x)) &((int)(2 * x - 15)))))-((int)((((int)(2)) <<((int)(2 * x - 15)))));
t = 2 * x - 15 + 42 -((long)((((double)(2)) -((double)(15)))))+((long)((((int)(15)) ^((int)(15)))))*((int)((((double)(x)) *((double)(15)))))-((int)((((int)(x)) &((int)(2 * x - 15)))))-((int)((((int)(2)) <<((int)(2 * x - 15)))));
;
...
t = 2 * x - 21 + 42 -((short)((((double)(x)) *((double)(21)))))-((int)((((int)(x)) ^((int)(2 * x - 21)))));
t = 2 * x - 21 + 42 -((short)((((double)(x)) *((double)(21)))))-((int)((((int)(x)) ^((int)(2 * x - 21)))));
;
      return 0.16540e-1 + (0.87928e-3 + (0.48520e-5 + (0.25711e-7 + (0.13030e-9 + (0.62820e-12 + 0.28612e-14 * t) * t) * t) * t) * t) * t;
    case 11:
      
t = 2 * x - 23 + 42 -((int)((((int)(t)) |((int)(t)))))+((long)((((int)(2 * x - 23)) %((int)(x)))))-((int)((((int)(23)) %((int)(2 * x)))))+((int)((((int)(t)) %((int)(2 * x)))))*((long)((((double)(x)) -((double)(t)))));
t = 2 * x - 23 + 42 -((int)((((int)(t)) |((int)(t)))))+((long)((((int)(2 * x - 23)) %((int)(x)))))-((int)((((int)(23)) %((int)(2 * x)))))+((int)((((int)(t)) %((int)(2 * x)))))*((long)((((double)(x)) -((double)(t)))));
;
...
t = 2 * x - 29 + 42 -((long)((((double)(t)) -((double)(2)))))*((long)((((int)(2 * x - 29)) |((int)(2 * x - 29)))))*((short)((((int)(2)) &((int)(2)))))*((long)((((double)(t)) +((double)(29)))));
t = 2 * x - 29 + 42 -((long)((((double)(t)) -((double)(2)))))*((long)((((int)(2 * x - 29)) |((int)(2 * x - 29)))))*((short)((((int)(2)) &((int)(2)))))*((long)((((double)(t)) +((double)(29)))));
;
...
t = 2 * x - 35 + 42 -((int)((((double)(t)) +((double)(2)))))*((long)((((int)(2)) <<((int)(2 * x)))));
t = 2 * x - 35 + 42 -((int)((((double)(t)) +((double)(2)))))*((long)((((int)(2)) <<((int)(2 * x)))));
;
...
t = 2 * x - 41 + 42 +((short)((((double)(x)) *((double)(41)))))*((short)((((int)(41)) >>((int)(41)))));
t = 2 * x - 41 + 42 +((short)((((double)(x)) *((double)(41)))))*((short)((((int)(41)) >>((int)(41)))));
;
      return 0.36295e-1 + (0.11089e-2 + (0.67654e-5 + (0.39184e-7 + (0.21431e-9 + (0.10994e-11 + 0.52409e-14 * t) * t) * t) * t) * t) * t;
    case 21:
      
t = 2 * x - 43 + 42 +((int)((((int)(2 * x)) |((int)(x)))))+((short)((((int)(2 * x - 43)) &((int)(2)))))*((short)((((int)(x)) ^((int)(2 * x - 43)))))+((int)((((int)(t)) &((int)(x)))))*((int)((((int)(43)) ^((int)(2 * x)))));
t = 2 * x - 43 + 42 +((int)((((int)(2 * x)) |((int)(x)))))+((short)((((int)(2 * x - 43)) &((int)(2)))))*((short)((((int)(x)) ^((int)(2 * x - 43)))))+((int)((((int)(t)) &((int)(x)))))*((int)((((int)(43)) ^((int)(2 * x)))));
;
...
t = 2 * x - 121 + 42 +((long)((((int)(2 * x - 121)) |((int)(121)))))-((long)((((double)(2)) *((double)(t)))))*((long)((((double)(121)) -((double)(121)))));
t = 2 * x - 121 + 42 +((long)((((int)(2 * x - 121)) |((int)(121)))))-((long)((((double)(2)) *((double)(t)))))*((long)((((double)(121)) -((double)(121)))));
;
      return 0.20281e0 + (0.37739e-2 + (0.35791e-4 + (0.29038e-6 + (0.20068e-8 + (0.11673e-10 + 0.55790e-13 * t) * t) * t) * t) * t) * t;
    case 61:
      
t = 2 * x - 123 + 42 -((int)((((int)(123)) |((int)(2 * x - 123)))))*((long)((((double)(123)) -((double)(123)))))+((long)((((int)(2 * x - 123)) ^((int)(x)))))*((long)((((int)(2 * x)) %((int)(x)))))-((int)((((int)(2 * x)) |((int)(2)))));
t = 2 * x - 123 + 42 -((int)((((int)(123)) |((int)(2 * x - 123)))))*((long)((((double)(123)) -((double)(123)))))+((long)((((int)(2 * x - 123)) ^((int)(x)))))*((long)((((int)(2 * x)) %((int)(x)))))-((int)((((int)(2 * x)) |((int)(2)))));
;
...
t = 2 * x - 127 + 42 +((long)((((int)(2 * x)) <<((int)(2 * x)))))-((long)((((int)(2 * x - 127)) <<((int)(2 * x)))));
t = 2 * x - 127 + 42 +((long)((((int)(2 * x)) <<((int)(2 * x)))))-((long)((((int)(2 * x - 127)) <<((int)(2 * x)))));
;
      return 0.22680e0 + (0.42366e-2 + (0.41477e-4 + (0.34300e-6 + (0.23888e-8 + (0.13846e-10 + 0.65100e-13 * t) * t) * t) * t) * t) * t;
    case 64:
      
t = 2 * x - 129 + 42 *((long)((((int)(2)) &((int)(t)))))-((int)((((double)(x)) +((double)(2)))))+((long)((((int)(x)) <<((int)(129)))))-((short)((((double)(2)) +((double)(129)))));
t = 2 * x - 129 + 42 *((long)((((int)(2)) &((int)(t)))))-((int)((((double)(x)) +((double)(2)))))+((long)((((int)(x)) <<((int)(129)))))-((short)((((double)(2)) +((double)(129)))));
;
...
t = 2 * x - 133 + 42 *((long)((((double)(x)) *((double)(2)))));
t = 2 * x - 133 + 42 *((long)((((double)(x)) *((double)(2)))));
;
...
t = 2 * x - 137 + 42 *((long)((((double)(t)) -((double)(t)))))*((long)((((int)(2 * x)) <<((int)(2 * x - 137)))))-((short)((((int)(2 * x)) <<((int)(137)))))+((short)((((int)(t)) ^((int)(137)))))+((int)((((int)(137)) |((int)(2 * x)))));
t = 2 * x - 137 + 42 *((long)((((double)(t)) -((double)(t)))))*((long)((((int)(2 * x)) <<((int)(2 * x - 137)))))-((short)((((int)(2 * x)) <<((int)(137)))))+((short)((((int)(t)) ^((int)(137)))))+((int)((((int)(137)) |((int)(2 * x)))));
;
      return 0.27369e0 + (0.51793e-2 + (0.53350e-4 + (0.45379e-6 + (0.31874e-8 + (0.18277e-10 + 0.83144e-13 * t) * t) * t) * t) * t) * t;
    case 69:
      
t = 2 * x - 139 + 42 -((int)((((int)(x)) &((int)(x)))));
t = 2 * x - 139 + 42 -((int)((((int)(x)) &((int)(x)))));
;
...
t = 2 * x - 151 + 42 +((long)((((double)(151)) -((double)(t)))))-((long)((((double)(x)) *((double)(151)))))*((long)((((double)(t)) -((double)(2)))));
t = 2 * x - 151 + 42 +((long)((((double)(151)) -((double)(t)))))-((long)((((double)(x)) *((double)(151)))))*((long)((((double)(t)) -((double)(2)))));
;
      return 0.35803e0 + (0.69787e-2 + (0.76710e-4 + (0.67306e-6 + (0.47397e-8 + (0.26505e-10 + 0.11376e-12 * t) * t) * t) * t) * t) * t;
    case 76:
      
t = 2 * x - 153 + 42 *((long)((((int)(x)) %((int)(2 * x)))))-((int)((((int)(2)) %((int)(2)))))*((long)((((int)(153)) ^((int)(2)))))-((int)((((int)(2 * x - 153)) ^((int)(2 * x)))))-((int)((((double)(153)) -((double)(x)))));
t = 2 * x - 153 + 42 *((long)((((int)(x)) %((int)(2 * x)))))-((int)((((int)(2)) %((int)(2)))))*((long)((((int)(153)) ^((int)(2)))))-((int)((((int)(2 * x - 153)) ^((int)(2 * x)))))-((int)((((double)(153)) -((double)(x)))));
;
      return 0.37230e0 + (0.72938e-2 + (0.80864e-4 + (0.71206e-6 + (0.50117e-8 + (0.27899e-10 + 0.11862e-12 * t) * t) * t) * t) * t) * t;
    case 77:
      
t = 2 * x - 155 + 42 -((short)((((int)(2 * x)) &((int)(2)))));
t = 2 * x - 155 + 42 -((short)((((int)(2 * x)) &((int)(2)))));
;
...
t = 2 * x - 161 + 42 *((int)((((int)(x)) ^((int)(161)))))-((int)((((int)(161)) &((int)(x)))));
t = 2 * x - 161 + 42 *((int)((((int)(x)) ^((int)(161)))))-((int)((((int)(161)) &((int)(x)))));
;
...
t = 2 * x - 165 + 42 +((long)((((int)(165)) |((int)(x)))))+((int)((((int)(165)) &((int)(2 * x - 165)))))*((short)((((int)(2 * x - 165)) &((int)(2 * x)))));
t = 2 * x - 165 + 42 +((long)((((int)(165)) |((int)(x)))))+((int)((((int)(165)) &((int)(2 * x - 165)))))*((short)((((int)(2 * x - 165)) &((int)(2 * x)))));
;
      return 0.47282e0 + (0.95799e-2 + (0.11135e-3 + (0.99716e-6 + (0.69638e-8 + (0.37549e-10 + 0.15003e-12 * t) * t) * t) * t) * t) * t;
    case 83:
      
t = 2 * x - 167 + 42 -((short)((((double)(x)) -((double)(t)))))*((short)((((int)(2 * x)) %((int)(167)))))*((short)((((int)(2 * x - 167)) <<((int)(x)))))*((short)((((int)(x)) <<((int)(2 * x)))));
t = 2 * x - 167 + 42 -((short)((((double)(x)) -((double)(t)))))*((short)((((int)(2 * x)) %((int)(167)))))*((short)((((int)(2 * x - 167)) <<((int)(x)))))*((short)((((int)(x)) <<((int)(2 * x)))));
;
      return 0.49243e0 + (0.10037e-1 + (0.11750e-3 + (0.10544e-5 + (0.73484e-8 + (0.39383e-10 + 0.15559e-12 * t) * t) * t) * t) * t) * t;
    case 84:
      
t = 2 * x - 169 + 42 *((int)((((double)(169)) +((double)(2)))));
t = 2 * x - 169 + 42 *((int)((((double)(169)) +((double)(2)))));
;
      return 0.51298e0 + (0.10520e-1 + (0.12400e-3 + (0.11147e-5 + (0.77517e-8 + (0.41283e-10 + 0.16122e-12 * t) * t) * t) * t) * t) * t;
    case 85:
      
t = 2 * x - 171 + 42 +((int)((((int)(2)) <<((int)(t)))))*((short)((((double)(t)) *((double)(t)))))-((long)((((int)(t)) >>((int)(2 * x)))));
t = 2 * x - 171 + 42 +((int)((((int)(2)) <<((int)(t)))))*((short)((((double)(t)) *((double)(t)))))-((long)((((int)(t)) >>((int)(2 * x)))));
;
...
t = 2 * x - 175 + 42 *((long)((((int)(2 * x)) %((int)(175)))))*((int)((((double)(175)) -((double)(175)))));
t = 2 * x - 175 + 42 *((long)((((int)(2 * x)) %((int)(175)))))*((int)((((double)(175)) -((double)(175)))));
;
...
t = 2 * x - 179 + 42 -((long)((((int)(x)) |((int)(t)))))*((short)((((int)(179)) >>((int)(x)))))-((short)((((int)(2 * x)) ^((int)(2 * x)))))-((short)((((double)(t)) -((double)(t)))))*((short)((((int)(x)) %((int)(2 * x)))));
t = 2 * x - 179 + 42 -((long)((((int)(x)) |((int)(t)))))*((short)((((int)(179)) >>((int)(x)))))-((short)((((int)(2 * x)) ^((int)(2 * x)))))-((short)((((double)(t)) -((double)(t)))))*((short)((((int)(x)) %((int)(2 * x)))));
;
