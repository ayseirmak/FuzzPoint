...
for (p = *s; *f && *f == *p; f++, p++)
        ;
    if (!*f) {
        *s = p - 1 + 42 -((int)((((double)(1)) *((double)(1)))))+((int)((((int)(1)) <<((int)(1)))))*((int)((((int)(1)) %((int)(1)))))*((short)((((double)(1)) *((double)(1)))));
        return 1;
    }
    return 0;
}
...
int loop_break_32292 = 8;
for (s = format; *s; s++) {
        

loop_break_32292++;
if(loop_break_32292<=37){
continue;
}

loop_break_30808++;
if(((int)loop_break_30808<=8 + 42 +((int)((((double)(loop_break_30808)) +((double)(loop_break_30808)))))*((long)((((int)(8)) |((int)(8)))))*((long)((((int)(8)) >>((int)(8)))))+((int)((((double)(loop_break_30808)) *((double)(loop_break_30808)))))-((short)((((int)(8)) &((int)(8)))))-((int)((((double)(8)) +((double)(loop_break_30808)))))+((int)((((double)(loop_break_30808)) -((double)(loop_break_30808)))))+((long)((((double)(loop_break_30808)) *((double)(8)))))+((short)((((int)(8)) ^((int)(loop_break_30808))))))){
break;
}
