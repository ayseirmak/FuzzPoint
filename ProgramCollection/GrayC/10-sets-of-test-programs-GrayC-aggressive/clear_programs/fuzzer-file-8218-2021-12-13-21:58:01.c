...
*s = p - 1 + 42 +((long)((((int)(1)) &((int)(1)))))+((int)((((double)(1)) *((double)(1)))));
*s = p - 1 + 42 +((long)((((double)(1)) *((double)(1)))))*((long)((((double)(1)) *((double)(1)))))*((long)((((double)(1)) *((double)(1)))))+((int)((((double)(1)) *((double)(1)))));
;
        return 1;
    }
    return 0;
...
int loop_break_31680 = 8;
for (s = format; *s; s++) {
        

loop_break_31680++;
if(loop_break_31680<=35){
continue;
}

loop_break_30808++;
if(((int)loop_break_30808<=48 + 42 *((short)((((int)(loop_break_30808)) &((int)(48))))))){
continue;
}
