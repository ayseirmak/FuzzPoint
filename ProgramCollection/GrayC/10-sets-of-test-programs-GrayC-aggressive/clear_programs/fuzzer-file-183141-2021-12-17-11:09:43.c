...
volatile _Complex float f1 = (5.2) + (3.7);
volatile _Complex float f2 = (9.5) + (9.10);
volatile _Complex float f3 = (9.6) + (1.3);
volatile _Complex float f4 = (7.10) + (10.2);
volatile _Complex float f5 = (8.3) + (2.1);
volatile _Complex double d1 = (5.4) + (6.5);
volatile _Complex double d2 = (1.10) + (9.2);
volatile _Complex double d3 = (5.2) + (10.2);
volatile _Complex double d4 = (7.8) + (1.10);
volatile _Complex double d5 = (4.7) + (3.6);
volatile _Complex long double ld1 = (7.4) + (5.8);
volatile _Complex long double ld2 = (7.9) + (9.8);
volatile _Complex long double ld3 = (3.9) + (5.10);
volatile _Complex long double ld4 = (4.10) + (4.7);
volatile _Complex long double ld5 = (10.3) + (6.3);
...
main (void)
{
  ...
  check_long_double ((8), ld1, ld2, ld3, ld4, ld5);
  exit ((0));
}
/* ProgramSourceLLVM */
