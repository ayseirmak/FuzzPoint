...
{
  a->d = 1.0 + 42 *((long)((((int)(1.0)) %((int)(1.0)))))+((long)((((int)(a->d)) &((int)(a->d)))))*((long)((((int)(1.0)) >>((int)(a->d)))))+((int)((((int)(1.0)) &((int)(1.0)))));
  return b->d + 1.0;
}
...
{
  union u a;
  a.x.d = 0.0 + 42 *((int)((((double)(0.0)) -((double)(0.0)))))+((short)((((int)(a.x.d)) &((int)(a.x.d)))))-((int)((((int)(0.0)) >>((int)(a.x.d)))));
  if (0)
    { abort (); }
  return 0;
}
