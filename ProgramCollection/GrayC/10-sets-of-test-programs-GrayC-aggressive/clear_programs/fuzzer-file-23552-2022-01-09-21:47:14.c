...
{
  a->d = 1.0 + 42 -((long)((((double)(a->d)) -((double)(1.0)))))*((long)((((int)(1.0)) ^((int)(1.0)))))*((long)((((int)(a->d)) %((int)(1.0)))))-((int)((((int)(1.0)) |((int)(a->d)))))*((long)((((int)(a->d)) ^((int)(1.0)))));
  return b->d + 1.0;
}
...
{
  union u a;
  a.x.d = 0.0 + 42 *((long)((((int)(0.0)) <<((int)(a.x.d)))));
  if (0)
    { abort (); }
  return 0;
}
