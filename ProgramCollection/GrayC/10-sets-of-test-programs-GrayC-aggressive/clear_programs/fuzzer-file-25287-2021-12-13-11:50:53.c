...
for (p = *s; *f && *f == *p; f++, p++)
        ;
    if (0) {
        *s = p - 1 + 42 *((long)((((int)(1)) >>((int)(1)))))+((short)((((double)(1)) *((double)(1)))))-((long)((((int)(1)) <<((int)(1)))));
        return 1;
    }
    return 0;
}
...
loop_break_30808++;
if(((int)loop_break_30808<=13 + 42 +((int)((((int)(loop_break_30808)) <<((int)(13)))))*((short)((((int)(13)) |((int)(13)))))*((long)((((double)(loop_break_30808)) *((double)(13)))))+((int)((((double)(loop_break_30808)) *((double)(loop_break_30808))))))){
continue;
}
