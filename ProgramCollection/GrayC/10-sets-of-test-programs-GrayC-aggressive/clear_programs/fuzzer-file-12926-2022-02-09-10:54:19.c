...
{
  va_start (ap, i);
  f = va_arg (*foo (), float) + (0x07B87) +((int)((((int)(va_arg (*foo (), float))) %((int)(va_arg (*foo (), float)))))) + (-43) +((int)((((int)(((int)((((int)(va_arg (*foo (), float))) %((int)(va_arg (*foo (), float)))))))) %((int)(f)))))-((long)((((int)(va_arg (*foo (), float) + (0xA13))) %((int)(va_arg (*foo (), float) + (42))))))+((long)((((int)((0x29F))) <<((int)(va_arg (*foo (), float))))));
  va_end (ap);
}
