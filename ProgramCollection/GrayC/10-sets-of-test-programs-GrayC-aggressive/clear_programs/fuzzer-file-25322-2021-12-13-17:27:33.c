...
volatile _Complex float f1 = (3.7) + (2.10);
volatile _Complex float f2 = (2.7) + (2.5);
volatile _Complex float f3 = (2.3) + (3.5);
volatile _Complex float f4 = (7.9) + (8.10);
volatile _Complex float f5 = (7.3) + (8.2);
volatile _Complex double d1 = (6.9) + (4.10);
volatile _Complex double d2 = (5.4) + (4.5);
volatile _Complex double d3 = (10.2) + (9.1);
volatile _Complex double d4 = (5.1) + (9.3);
volatile _Complex double d5 = (3.8) + (3.10);
volatile _Complex long double ld1 = (3.9) + (2.2);
volatile _Complex long double ld2 = (2.3) + (6.10);
volatile _Complex long double ld3 = (8.1) + (10.2);
volatile _Complex long double ld4 = (6.10) + (10.2);
volatile _Complex long double ld5 = (7.10) + (2.5);
