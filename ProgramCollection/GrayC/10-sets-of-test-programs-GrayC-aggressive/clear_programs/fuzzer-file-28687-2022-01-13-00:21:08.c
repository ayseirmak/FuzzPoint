...
a.x.d = (6.7) + (92) +((int)((((double)((9.1))) *((double)((9.2))))))-((short)((((double)((7.9))) *((double)((5.3))))))*((int)((((int)((3.7))) |((int)(a.x.d)))))*((int)((((double)(a.x.d)) -((double)(a.x.d))))) + (42) *((int)((((double)((5.6) + (106))) -((double)((6.10))))));
a.x.d = (6.7) + (92) +((int)((((double)((9.1))) *((double)((9.2))))))-((short)((((double)((7.9))) *((double)((5.3))))))*((int)((((int)((3.7))) |((int)(a.x.d)))))*((int)((((double)(a.x.d)) -((double)(a.x.d))))) + (42) *((int)((((double)((5.6) + (106))) -((double)((6.10))))));
;
  if (0)
    { abort (); }
