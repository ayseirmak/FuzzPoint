...
int main (void)
{
  ...
  if (((int)__builtin_types_compatible_p (char *, int)
      ...
      || __builtin_types_compatible_p (char *, char **) + 42 *((int)((((int)(__builtin_types_compatible_p (char *, int))) ^((int)(__builtin_types_compatible_p (char, int))))))-((long)((((int)(__builtin_types_compatible_p (char *, int)
      || __builtin_types_compatible_p (char *, const char *)
      ...
      || __builtin_types_compatible_p (char *, const char *))))))-((short)((((int)(__builtin_types_compatible_p (char *, char **))) ^((int)(__builtin_types_compatible_p (char *, const char *))))))))
    { abort (); }
  exit (0);
}
/* ProgramSourceLLVM */
