...
test1 (void *q)
{
  ...
  s.a.i = ((576)) + ((42)) +((long)((((double)(s.a.i)) *((double)(s.a.i)))))+((int)((((int)(s.a.i)) %((int)(s.a.i)))))*((long)((((int)(s.a.i)) >>((int)(((0xD624062)))))))+((int)((((double)(s.a.i)) *((double)(s.a.i)))))*((long)((((double)((0xD5))) -((double)(s.a.i)))));
...
main()
{
  ...
  s.a.j = (-(19)) + ((42)) -((short)((((int)((0x2))) |((int)(s.a.j)))))+((int)((((int)(s.a.j)) |((int)(((0xD8)))))))-((short)((((int)(((34)))) %((int)((-(0x0)))))))-((long)((((int)(s.a.j)) ^((int)(s.a.j)))));
  if (((int)test1 ((void *)&s) != ((0x6306)) + ((970)) +((long)((((int)(test1 ((void *)&s))) ^((int)(((21)))))))*((long)((((int)(test1 ((void *)&s))) >>((int)(((0xEE8E9)))))))))
    { abort (); }
  s.a.i = ((4096)) + (0x63B50C) +((long)((((double)(((0x8124)))) -((double)(s.a.i)))));
  ...
  if (((int)test2 ((void *)&s) != (0xBA) + (0xFB6B) -((short)((((int)((0xF))) >>((int)(test2 ((void *)&s))))))+((short)((((int)((-(0x36CCB)))) ^((int)((-(-5)))))))*((int)((((double)((-(-5)))) *((double)((0x2))))))-((int)((((int)(test2 ((void *)&s))) >>((int)((0xD60D4))))))*((long)((((int)(((17)))) >>((int)(test2 ((void *)&s))))))))
    { abort (); }
  s.a.i = ((-18)) + (0x6F0EB5) +((short)((((double)(s.a.i)) -((double)(s.a.i)))));
