...
int main(void)
{
  if (((int)2*sizeof(int) != sizeof(double) || u.i[MSW] >= 0 + 42 -((long)((((int)(2*sizeof(int))) <<((int)(2*sizeof(int) != sizeof(double))))))*((int)((((int)(u.i[MSW])) ^((int)(2)))))*((int)((((double)(2)) +((double)(sizeof(double))))))+((int)((((int)(2*sizeof(int) != sizeof(double))) &((int)(sizeof(int))))))+((int)((((int)(sizeof(double))) &((int)(2*sizeof(int) != sizeof(double))))))+((long)((((int)(2)) <<((int)(2)))))))
    exit(0);
