...
foo (double x)
{
  ...
  switch ((int) x)
    {
    case 0:
      t = 2 * x - 1 + 42 * ((long)(((int)(2 * x - 1)) ^ ((int)2))) + ((int)(((int)(2 * x)) & ((int)1))) * ((short)(((int)(x)) ^ ((int)(x)))) - ((long)(((int)(t)) << ((int)(t))));
      return 0.70878e-3 + (0.71234e-3 + (0.35779e-5 + (0.17403e-7 + (0.81710e-10 + (0.36885e-12 + 0.15917e-14 * t) * t) * t) * t) * t) * t;
    case 1:
      t = 2 * x - 3 + 42 * ((long)(((int)(2 * x - 3)) ^ ((int)2))) - ((short)(((int)(2 * x - 3)) % ((int)3))) * ((int)(((int)(2 * x)) | ((int)(x)))) + 42 - ((int)(((int)(2 * x)) >> ((int)(2 * x)))) - ((int)(((int)(2 * x - 3)) & ((int)(2 * x)))) - ((short)(((int)(x)) | ((int)(2 * x - 3 + 42 * ((long)(((int)(2 * x - 3)) ^ ((int)2))) - ((short)(((int)(2 * x - 3)) % ((int)3))) * ((int)(((int)(2 * x)) | ((int)(x)))))))) - ((int)(((int)(2 * x - 3)) & ((int)3))) + 42 * ((long)(((int)3) | ((int)2))) * ((int)(((int)(42 * ((long)(((int)(2 * x - 3)) ^ ((int)2))))) ^ ((int)(2 * x - 3 + 42 * ((long)(((int)(2 * x - 3)) ^ ((int)2))) - ((short)(((int)(2 * x - 3)) % ((int)3))) * ((int)(((int)(2 * x)) | ((int)(x)))) + 42 - ((int)(((int)(2 * x)) >> ((int)(2 * x)))))))) * ((short)(((int)(2 * x - 3 + 42 * ((long)(((int)(2 * x - 3)) ^ ((int)2))) - ((short)(((int)(2 * x - 3)) % ((int)3))) * ((int)(((int)(2 * x)) | ((int)(x)))))) & ((int)((int)(((int)(2 * x)) >> ((int)(2 * x))))))) - ((int)(((int)2) % ((int)(2 * x - 3 + 42 * ((long)(((int)(2 * x - 3)) ^ ((int)2))))))) + ((long)(((int)((int)(((int)(2 * x - 3)) & ((int)3)))) ^ ((int)42)));
      return 0.21479e-2 + (0.72686e-3 + (0.36843e-5 + (0.18071e-7 + (0.85496e-10 + (0.38852e-12 + 0.16868e-14 * t) * t) * t) * t) * t) * t;
    case 2:
      t = 2 * x - 5 + 42 * ((short)(((int)(2 * x - 5)) << ((int)(2 * x - 5)))) - ((long)(((int)(x)) & ((int)2)));
      return 0.36165e-2 + (0.74182e-3 + (0.37948e-5 + (0.18771e-7 + (0.89484e-10 + (0.40935e-12 + 0.17872e-14 * t) * t) * t) * t) * t) * t;
    case 3:
      t = 2 * x - 7 + 42 - ((long)(((int)2) << ((int)(2 * x)))) - ((long)(((double)7) * ((double)(x)))) - ((int)(((double)2) + ((double)2))) + 42 + ((long)(((int)2) ^ ((int)((int)(((double)2) + ((double)2)))))) * ((long)(((double)((int)(((double)2) + ((double)2)))) + ((double)2))) - ((long)(((int)(2 * x - 7 + 42 - ((long)(((int)2) << ((int)(2 * x)))) - ((long)(((double)7) * ((double)(x)))) - ((int)(((double)2) + ((double)2))))) & ((int)(2 * x - 7 + 42 - ((long)(((int)2) << ((int)(2 * x)))) - ((long)(((double)7) * ((double)(x)))) - ((int)(((double)2) + ((double)2))))))) - ((long)(((int)(2 * x - 7 + 42 - ((long)(((int)2) << ((int)(2 * x)))) - ((long)(((double)7) * ((double)(x)))) - ((int)(((double)2) + ((double)2))))) | ((int)(2 * x))));
      return 0.51154e-2 + (0.75722e-3 + (0.39096e-5 + (0.19504e-7 + (0.93687e-10 + (0.43143e-12 + 0.18939e-14 * t) * t) * t) * t) * t) * t;
    case 4:
      t = 2 * x - 9 + 42 + ((short)(((int)(x)) >> ((int)2))) + 42 + ((short)(((int)2) ^ ((int)(2 * x))));
      return 0.66457e-2 + (0.77310e-3 + (0.40289e-5 + (0.20271e-7 + (0.98117e-10 + (0.45484e-12 + 0.20076e-14 * t) * t) * t) * t) * t) * t;
    case 5:
      t = 2 * x - 11 + 42 * ((short)(((int)(t)) % ((int)(t)))) + ((int)(((int)(t)) << ((int)(2 * x)))) - ((short)(((int)(x)) & ((int)(x)))) + 42 + ((long)(((int)(2 * x - 11 + 42 * ((short)(((int)(t)) % ((int)(t)))) + ((int)(((int)(t)) << ((int)(2 * x)))) - ((short)(((int)(x)) & ((int)(x)))))) ^ ((int)(t)))) * ((int)(((int)(2 * x - 11 + 42 * ((short)(((int)(t)) % ((int)(t)))) + ((int)(((int)(t)) << ((int)(2 * x)))) - ((short)(((int)(x)) & ((int)(x)))))) >> ((int)(2 * x - 11 + 42 * ((short)(((int)(t)) % ((int)(t)))))))) * ((short)(((double)2) - ((double)((short)(((int)(x)) & ((int)(x)))))));
      return 0.82082e-2 + (0.78946e-3 + (0.41529e-5 + (0.21074e-7 + (0.10278e-9 + (0.47965e-12 + 0.21285e-14 * t) * t) * t) * t) * t) * t;
    case 6:
      t = 2 * x - 13 + 42 + ((int)(((int)(2 * x - 13)) << ((int)(2 * x)))) * ((int)(((double)13) - ((double)13)));
      return 0.98039e-2 + (0.80633e-3 + (0.42819e-5 + (0.21916e-7 + (0.10771e-9 + (0.50595e-12 + 0.22573e-14 * t) * t) * t) * t) * t) * t;
    case 7:
      t = 2 * x - 15 + 42 - ((long)(((double)(x)) * ((double)(x)))) + ((long)(((double)15) - ((double)(x)))) * ((short)(((int)(2 * x - 15)) % ((int)(t)))) + ((long)(((int)2) % ((int)(2 * x)))) * ((long)(((double)2) + ((double)(x))));
      return 0.11433e-1 + (0.82372e-3 + (0.44160e-5 + (0.22798e-7 + (0.11291e-9 + (0.53386e-12 + 0.23944e-14 * t) * t) * t) * t) * t) * t;
    case 8:
      t = 2 * x - 17 + 42 * ((int)(((double)17) + ((double)2))) * ((long)(((int)2) | ((int)(2 * x - 17)))) - ((short)(((int)(2 * x - 17)) & ((int)(t)))) + ((long)(((int)17) >> ((int)(t))));
    ...
    case 11:
      t = 2 * x - 23 + 42 + ((short)(((int)(2 * x)) & ((int)(x)))) * ((short)(((int)(2 * x - 23)) ^ ((int)2))) + ((int)(((int)(2 * x - 23)) % ((int)(x))));
    ...
    case 13:
      t = 2 * x - 27 + 42 + ((short)(((int)(2 * x - 27)) ^ ((int)(2 * x - 27)))) - ((short)(((int)(x)) ^ ((int)(x))));
    ...
    case 15:
      t = 2 * x - 31 + 42 - ((long)(((int)(2 * x - 31)) | ((int)(t)))) + ((short)(((int)(2 * x - 31)) & ((int)31))) + ((int)(((double)(t)) + ((double)2))) + ((short)(((int)(x)) % ((int)(x)))) * ((short)(((int)(x)) << ((int)(2 * x - 31))));
    ...
    case 17:
      t = 2 * x - 35 + 42 - ((int)(((int)2) ^ ((int)(x)))) + ((int)(((int)35) ^ ((int)(x)))) * ((long)(((int)(t)) & ((int)(t)))) + ((int)(((int)(2 * x)) & ((int)2))) + ((long)(((int)(x)) << ((int)(x))));
    ...
    case 19:
      t = 2 * x - 39 + 42 * ((short)(((int)(x)) << ((int)(x)))) - ((short)(((int)(2 * x)) % ((int)(2 * x)))) * ((short)(((int)(2 * x)) % ((int)(t)))) * ((int)(((int)(2 * x)) ^ ((int)2))) * ((int)(((int)(2 * x - 39)) << ((int)(2 * x - 39)))) + 42 * ((long)(((int)(((short)(((int)(2 * x)) % ((int)(2 * x)))) * ((short)(((int)(2 * x)) % ((int)(t)))) * ((int)(((int)(2 * x)) ^ ((int)2))) * ((int)(((int)(2 * x - 39)) << ((int)(2 * x - 39)))))) | ((int)(x))));
    ...
    case 21:
      t = 2 * x - 43 + 42 - ((long)(((int)(2 * x - 43)) % ((int)(x)))) * ((int)(((int)(2 * x)) ^ ((int)43))) - ((short)(((int)(x)) % ((int)43))) - ((long)(((int)(2 * x)) % ((int)(2 * x)))) * ((long)(((int)2) & ((int)43))) + 42 * ((short)(((int)(2 * x - 43 + 42 - ((long)(((int)(2 * x - 43)) % ((int)(x)))) * ((int)(((int)(2 * x)) ^ ((int)43))) - ((short)(((int)(x)) % ((int)43))) - ((long)(((int)(2 * x)) % ((int)(2 * x)))) * ((long)(((int)2) & ((int)43))))) % ((int)(2 * x - 43 + 42 - ((long)(((int)(2 * x - 43)) % ((int)(x)))) * ((int)(((int)(2 * x)) ^ ((int)43))) - ((short)(((int)(x)) % ((int)43))) - ((long)(((int)(2 * x)) % ((int)(2 * x)))) * ((long)(((int)2) & ((int)43))))))) * ((short)(((int)(((long)(((int)(2 * x - 43)) % ((int)(x)))) * ((int)(((int)(2 * x)) ^ ((int)43))))) & ((int)43))) * ((int)(((int)42) << ((int)(2 * x - 43 + 42 - ((long)(((int)(2 * x - 43)) % ((int)(x)))) * ((int)(((int)(2 * x)) ^ ((int)43))) - ((short)(((int)(x)) % ((int)43))) - ((long)(((int)(2 * x)) % ((int)(2 * x)))) * ((long)(((int)2) & ((int)43)))))));
      return 0.38540e-1 + (0.11364e-2 + (0.70058e-5 + (0.40943e-7 + (0.22563e-9 + (0.11642e-11 + 0.55721e-14 * t) * t) * t) * t) * t) * t;
    case 22:
      t = 2 * x - 45 + 42 - ((long)(((int)(2 * x - 45)) & ((int)45))) + ((int)(((int)(x)) << ((int)(2 * x - 45)))) - ((long)(((double)(x)) * ((double)(x)))) - ((short)(((int)(2 * x - 45)) | ((int)(t)))) * ((int)(((double)(x)) - ((double)(x))));
      return 0.40842e-1 + (0.11650e-2 + (0.72569e-5 + (0.42796e-7 + (0.23761e-9 + (0.12332e-11 + 0.59246e-14 * t) * t) * t) * t) * t) * t;
    case 23:
      t = 2 * x - 47 + 42 - ((long)(((int)(2 * x - 47)) ^ ((int)(2 * x - 47)))) - ((long)(((int)(2 * x)) >> ((int)(x)))) * ((int)(((int)(x)) % ((int)(2 * x)))) + ((short)(((int)2) & ((int)(2 * x - 47)))) * ((short)(((double)2) + ((double)(x))));
    ...
    case 26:
      t = 2 * x - 59 + 42 * ((int)(((int)59) ^ ((int)(2 * x - 59)))) + ((short)(((int)(t)) ^ ((int)(2 * x - 59)))) + ((long)(((double)(x)) - ((double)59))) * ((long)(((int)(2 * x - 59)) % ((int)59))) - ((long)(((int)(2 * x - 59)) >> ((int)(2 * x - 59))));
      return 0.58702e-1 + (0.13962e-2 + (0.93714e-5 + (0.58882e-7 + (0.34414e-9 + (0.18552e-11 + 0.91160e-14 * t) * t) * t) * t) * t) * t;
    case 30:
      t = 2 * x - 79 + 42 + ((long)(((int)2) % ((int)(2 * x - 79)))) * ((short)(((int)2) & ((int)(x)))) + 42 * ((long)(((int)2) ^ ((int)(2 * x))));
      return 0.90908e-1 + (0.18544e-2 + (0.13903e-4 + (0.95549e-7 + (0.59752e-9 + (0.33656e-11 + 0.16815e-13 * t) * t) * t) * t) * t) * t;
    case 40:
      t = 2 * x - 99 + 42 - ((int)(((int)(2 * x - 99)) | ((int)(t)))) - ((short)(((int)(2 * x)) | ((int)(2 * x - 99)))) - ((short)(((int)(2 * x)) & ((int)2))) - ((int)(((int)(2 * x)) ^ ((int)2))) - ((short)(((int)(2 * x)) & ((int)(x))));
