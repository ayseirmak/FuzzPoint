...
;
;t = 2 * x - 5 + 42 + ((long)(((double)(t)) * ((double)(t))));
2 * x - 7;
t = 2 * x - 5 + 42 * ((long)(((int)(x)) % ((int)(2 * x)))) - ((long)(((double)2) + ((double)(t)))) - ((int)(((int)2) << ((int)(2 * x - 5)))) - ((long)(((int)(2 * x)) & ((int)2)));
...
;
;t = 2 * x - 15 + 42 * ((short)(((int)(t)) & ((int)(2 * x)))) * ((long)(((int)(t)) & ((int)15))) + ((int)(((int)2) % ((int)2))) + 42 + ((short)(((int)(2 * x - 15)) << ((int)(x)))) + ((short)(((double)(t)) * ((double)(x))));
2 * x - 13;
2 * x - 11;
...
;
;t = 2 * x - 13 + 42 - ((int)(((int)(2 * x - 13)) | ((int)(t)))) - ((short)(((double)2) * ((double)(x)))) * ((int)(((int)(2 * x)) ^ ((int)(x)))) + ((int)(((int)(2 * x - 13)) & ((int)(2 * x)))) - ((int)(((double)(x)) + ((double)(x))));
t = 2 * x - 15 + 42 * ((int)(((double)2) + ((double)(t))));

;t = 2 * x - 15 + 42 - ((int)(((double)(t)) * ((double)2))) + ((long)(((int)(2 * x - 15)) | ((int)(2 * x - 15))));
t = 2 * x - 13;
      return 0.98039e-2 + (0.80633e-3 + (0.42819e-5 + (0.21916e-7 + (0.10771e-9 + (0.50595e-12 + 0.22573e-14 * t) * t) * t) * t) * t) * t;
    case 7:
      t = 2 * x - 15 + 42 + ((int)(((double)15) * ((double)(t)))) + ((short)(((int)2) & ((int)(x)))) + ((int)(((int)2) | ((int)(2 * x)))) + ((int)(((int)(x)) % ((int)15))) - ((short)(((double)15) * ((double)2)));
      return 0.11433e-1 + (0.82372e-3 + (0.44160e-5 + (0.22798e-7 + (0.11291e-9 + (0.53386e-12 + 0.23944e-14 * t) * t) * t) * t) * t) * t;
    case 8:
      
;
;t = 2 * x - 21 + 42 * ((short)(((int)2) | ((int)21))) - ((int)(((int)(2 * x)) ^ ((int)21)));
2 * x - 19;
t;
...
;
;t = 2 * x - 29 + 42 - ((long)(((int)(2 * x - 29)) >> ((int)(t)))) - ((int)(((int)29) >> ((int)29))) * ((int)(((int)(2 * x - 29)) ^ ((int)(t))));
2 * x - 27;
2 * x - 25;
...
;
;t = 2 * x - 27 + 42 - ((short)(((double)27) - ((double)(t)))) + ((long)(((int)27) | ((int)(2 * x - 27))));
t = 2 * x - 29;

;t = 2 * x - 29 + 42 - ((short)(((int)(x)) ^ ((int)(2 * x)))) - ((int)(((double)29) + ((double)(t)))) - ((long)(((int)(t)) >> ((int)(x))));
t = 2 * x - 27 + 42 - ((short)(((int)(2 * x - 27)) << ((int)(t)))) * ((short)(((int)(2 * x)) ^ ((int)(x))));
      return 0.21996e-1 + (0.94040e-3 + (0.53443e-5 + (0.29078e-7 + (0.15078e-9 + (0.74103e-12 + 0.34251e-14 * t) * t) * t) * t) * t) * t;
    case 14:
      
;t = 2 * x - 33;
t = 2 * x - 29 + 42 * ((short)(((int)(x)) ^ ((int)(x)))) * ((short)(((int)29) & ((int)(2 * x - 29)))) * ((int)(((double)29) + ((double)(x))));
      return 0.23898e-1 + (0.96213e-3 + (0.55225e-5 + (0.30314e-7 + (0.15840e-9 + (0.78340e-12 + 0.36381e-14 * t) * t) * t) * t) * t) * t;
    case 15:
      
;
;t = 2 * x - 33 + 42 - ((int)(((int)(2 * x - 33)) & ((int)33))) * ((short)(((double)(t)) - ((double)(t)))) + ((short)(((double)(x)) * ((double)33))) * ((short)(((double)2) - ((double)(x)))) + 42 - ((short)(((int)(((short)(((double)(x)) * ((double)33))) * ((short)(((double)2) - ((double)(x)))))) % ((int)(2 * x - 33)))) - ((short)(((int)2) << ((int)(2 * x - 33 + 42))));
t = 2 * x - 33 + 42 - ((long)(((double)2) - ((double)2))) - ((int)(((int)(2 * x - 33)) >> ((int)2))) + ((short)(((int)(2 * x)) % ((int)2)));
2 * x - 31;
      return 0.25845e-1 + (0.98459e-3 + (0.57082e-5 + (0.31613e-7 + (0.16646e-9 + (0.82840e-12 + 0.38649e-14 * t) * t) * t) * t) * t) * t;
    case 16:
      t = 2 * x - 33 + 42 - ((short)(((int)(x)) | ((int)(t)))) * ((short)(((int)33) ^ ((int)2))) - ((long)(((int)2) % ((int)(2 * x)))) * ((short)(((int)(2 * x)) ^ ((int)(2 * x)))) + ((int)(((int)(2 * x - 33)) % ((int)(t))));
...
;t = 2 * x - 43 + 42 - ((long)(((int)(x)) % ((int)(2 * x)))) + ((int)(((int)(t)) % ((int)43))) - ((short)(((int)(2 * x)) >> ((int)(2 * x))));
2 * x - 41;
      return 0.36295e-1 + (0.11089e-2 + (0.67654e-5 + (0.39184e-7 + (0.21431e-9 + (0.10994e-11 + 0.52409e-14 * t) * t) * t) * t) * t) * t;
    case 21:
      
;t = 2 * x - 49 + 42 + ((long)(((double)49) * ((double)(x)))) * ((short)(((double)(t)) + ((double)(t)))) + 42 - ((int)(((int)(2 * x - 49 + 42)) | ((int)(2 * x - 49 + 42)))) - ((int)(((int)(t)) >> ((int)(t))));
2 * x - 43;
...
;
;t = 2 * x - 49 + 42 - ((short)(((double)49) + ((double)2))) * ((int)(((int)49) | ((int)2))) * ((long)(((double)2) + ((double)49))) - ((long)(((double)49) + ((double)(t))));
t = 2 * x - 49 + 42 * ((short)(((double)(t)) + ((double)(t)))) - ((long)(((int)49) | ((int)(2 * x)))) - ((int)(((int)(t)) & ((int)2))) + ((int)(((int)(2 * x)) & ((int)(t))));
2 * x - 47;
      return 0.43201e-1 + (0.11945e-2 + (0.75195e-5 + (0.44747e-7 + (0.25030e-9 + (0.13065e-11 + 0.63000e-14 * t) * t) * t) * t) * t) * t;
    case 24:
      
;t = 2 * x - 79;
t = 2 * x - 49 + 42 * ((long)(((int)(2 * x - 49)) >> ((int)(2 * x - 49)))) - ((short)(((double)(t)) + ((double)(t)))) * ((long)(((double)(x)) * ((double)(x)))) + 42 + ((long)(((int)(2 * x - 49)) << ((int)(2 * x - 49 + 42 * ((long)(((int)(2 * x - 49)) >> ((int)(2 * x - 49)))) - ((short)(((double)(t)) + ((double)(t)))) * ((long)(((double)(x)) * ((double)(x)))))))) + ((int)(((int)(t)) % ((int)49))) + ((long)(((int)(x)) ^ ((int)(((short)(((double)(t)) + ((double)(t)))) * ((long)(((double)(x)) * ((double)(x))))))));
...
;t = 2 * x - 79 + 42 + ((int)(((int)2) | ((int)79))) - ((long)(((int)(2 * x - 79)) ^ ((int)(x)))) * ((short)(((double)79) + ((double)2))) + 42 + ((int)(((double)((int)(((int)2) | ((int)79)))) - ((double)(t)))) * ((short)(((int)((int)(((int)2) | ((int)79)))) % ((int)(2 * x - 79)))) * ((int)(((int)(2 * x - 79 + 42 + ((int)(((int)2) | ((int)79))) - ((long)(((int)(2 * x - 79)) ^ ((int)(x)))) * ((short)(((double)79) + ((double)2))))) % ((int)2))) - ((long)(((int)((int)(((int)2) | ((int)79)))) & ((int)((int)(((int)2) | ((int)79)))))) + ((long)(((int)(t)) << ((int)79)));
t;
      return 0.58702e-1 + (0.13962e-2 + (0.93714e-5 + (0.58882e-7 + (0.34414e-9 + (0.18552e-11 + 0.91160e-14 * t) * t) * t) * t) * t) * t;
    case 30:
      
;
;t = 2 * x - 79 + 42 * ((int)(((int)(2 * x)) & ((int)(x)))) + ((long)(((int)(2 * x - 79)) << ((int)(t)))) * ((int)(((int)2) << ((int)(2 * x))));
2 * x - 99;

;t = 2 * x - 99;
t = 2 * x - 79 + 42 * ((int)(((int)(2 * x - 79)) % ((int)(2 * x)))) * ((short)(((double)(t)) - ((double)2))) * ((int)(((int)(t)) | ((int)79))) * ((short)(((int)(x)) << ((int)(2 * x - 79)))) * ((int)(((int)79) ^ ((int)2)));
      return 0.90908e-1 + (0.18544e-2 + (0.13903e-4 + (0.95549e-7 + (0.59752e-9 + (0.33656e-11 + 0.16815e-13 * t) * t) * t) * t) * t) * t;
    case 40:
      t = 2 * x - 99 + 42 - ((int)(((int)(2 * x - 99)) ^ ((int)99))) + ((long)(((double)2) + ((double)(t)))) - ((short)(((double)(x)) + ((double)(x))));
...
;
;t = 2 * x - 123 + 42 + ((long)(((int)(2 * x - 123)) ^ ((int)(2 * x)))) * ((long)(((int)(t)) | ((int)(x)))) - ((long)(((int)(2 * x)) % ((int)(t)))) * ((int)(((int)(x)) & ((int)(2 * x - 123)))) + 42 * ((long)(((int)(2 * x - 123)) % ((int)(x)))) + ((int)(((int)(2 * x - 123 + 42 + ((long)(((int)(2 * x - 123)) ^ ((int)(2 * x)))) * ((long)(((int)(t)) | ((int)(x)))) - ((long)(((int)(2 * x)) % ((int)(t)))) * ((int)(((int)(x)) & ((int)(2 * x - 123)))))) << ((int)2))) + ((long)(((int)2) % ((int)(t))));
2 * x - 123;
2 * x - 121;
...
;t = 2 * x - 143 + 42 * ((short)(((int)(x)) << ((int)(2 * x - 143)))) + ((int)(((int)(2 * x - 143)) % ((int)(2 * x - 143)))) + ((long)(((int)143) % ((int)(t)))) - ((long)(((double)2) - ((double)(t))));
t;
...
;
;t = 2 * x - 161 + 42 + ((long)(((double)161) * ((double)2))) - ((long)(((double)2) + ((double)2))) * ((long)(((int)(x)) | ((int)(2 * x)))) + ((int)(((int)161) << ((int)(2 * x))));
t = 2 * x - 161 + 42 - ((long)(((int)(2 * x)) & ((int)(t))));
2 * x - 159;
...
;
;t = 2 * x - 165 + 42 * ((short)(((int)(2 * x)) | ((int)2))) + ((long)(((double)(t)) - ((double)(x)))) - ((int)(((int)(2 * x - 165)) ^ ((int)2)));
2 * x - 165;
2 * x - 163;
...
;t = 2 * x - 187 + 42 + ((short)(((int)187) | ((int)2)));
2 * x - 185;
