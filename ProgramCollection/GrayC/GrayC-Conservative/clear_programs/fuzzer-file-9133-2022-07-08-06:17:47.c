...
foo (double x)
{
  ...
  switch ((int) x)
    ...
    case 2:
      t = 2 * x - 5 + 42 + ((long)(((int)(2 * x - 5)) >> ((int)(t)))) - ((int)(((double)(t)) * ((double)5)));
      return 0.36165e-2 + (0.74182e-3 + (0.37948e-5 + (0.18771e-7 + (0.89484e-10 + (0.40935e-12 + 0.17872e-14 * t) * t) * t) * t) * t) * t;
    case 3:
      t = 2 * x - 7 + 42 * ((long)(((int)(2 * x - 7)) << ((int)(2 * x - 7)))) + ((short)(((int)(2 * x)) >> ((int)(t)))) - ((long)(((double)(t)) + ((double)(t)))) - ((int)(((int)(x)) % ((int)7))) - ((int)(((double)2) - ((double)2)));
    ...
    case 8:
      t = 2 * x - 17 + 42 - ((short)(((int)2) ^ ((int)2))) + ((short)(((int)(2 * x)) & ((int)(2 * x))));
    ...
    case 10:
      t = 2 * x - 21 + 42 + ((int)(((int)(2 * x - 21)) >> ((int)(t)))) + ((int)(((int)21) % ((int)(x))));
    ...
    case 13:
      t = 2 * x - 27 + 42 * ((int)(((int)(x)) | ((int)(x)))) * ((int)(((int)(t)) >> ((int)(2 * x))));
    ...
    case 16:
      t = 2 * x - 33 + 42 * ((short)(((int)(2 * x)) | ((int)33))) * ((short)(((int)(x)) & ((int)(2 * x - 33)))) * ((short)(((int)33) ^ ((int)(x)))) * ((long)(((int)33) << ((int)(2 * x)))) - ((int)(((int)(2 * x - 33)) << ((int)(t))));
    ...
    case 18:
      t = 2 * x - 37 + 42 - ((long)(((int)(t)) | ((int)(x)))) * ((long)(((int)(x)) << ((int)(x)))) * ((short)(((int)2) % ((int)(x)))) - ((long)(((int)(2 * x)) | ((int)(x)))) * ((short)(((int)(2 * x - 37)) & ((int)(x))));
      return 0.31965e-1 + (0.10566e-2 + (0.63151e-5 + (0.35924e-7 + (0.19353e-9 + (0.98102e-12 + 0.46381e-14 * t) * t) * t) * t) * t) * t;
    case 19:
      t = 2 * x - 39 + 42 + ((short)(((int)(x)) >> ((int)2))) + ((long)(((double)(x)) + ((double)39)));
    ...
    case 22:
      t = 2 * x - 45 + 42 * ((long)(((int)(2 * x - 45)) | ((int)45))) + ((long)(((int)(t)) >> ((int)(2 * x - 45)))) - ((short)(((int)(2 * x - 45)) % ((int)(t)))) - ((long)(((int)(t)) | ((int)(2 * x))));
    ...
    case 30:
      t = 2 * x - 79 + 42 + ((int)(((int)2) % ((int)(2 * x - 79))));
    ...
    case 60:
      t = 2 * x - 121 + 42 * ((long)(((int)(x)) | ((int)(2 * x - 121)))) - ((long)(((int)2) ^ ((int)(t)))) * ((short)(((int)121) | ((int)(2 * x - 121)))) * ((int)(((int)2) >> ((int)121))) - ((long)(((int)(2 * x - 121)) << ((int)(2 * x - 121))));
      return 0.20281e0 + (0.37739e-2 + (0.35791e-4 + (0.29038e-6 + (0.20068e-8 + (0.11673e-10 + 0.55790e-13 * t) * t) * t) * t) * t) * t;
    case 61:
      t = 2 * x - 123 + 42 - ((short)(((int)(2 * x - 123)) >> ((int)(2 * x - 123)))) * ((int)(((int)(x)) % ((int)2))) + ((short)(((int)123) | ((int)123))) * ((short)(((int)2) & ((int)(2 * x - 123)))) + ((long)(((int)(t)) ^ ((int)(t))));
      return 0.21050e0 + (0.39206e-2 + (0.37582e-4 + (0.30691e-6 + (0.21270e-8 + (0.12361e-10 + 0.58770e-13 * t) * t) * t) * t) * t) * t;
    case 62:
      t = 2 * x - 125 + 42 - ((long)(((int)(2 * x - 125)) & ((int)(t)))) + ((short)(((int)125) << ((int)(x)))) + ((long)(((int)125) << ((int)125)));
    ...
    case 67:
      t = 2 * x - 135 + 42 - ((int)(((double)(x)) + ((double)(t)))) - ((long)(((int)(2 * x)) >> ((int)(2 * x - 135))));
    ...
    case 77:
      t = 2 * x - 155 + 42 - ((short)(((int)(2 * x - 155)) ^ ((int)2))) * ((short)(((int)2) & ((int)(x)))) - ((long)(((int)155) | ((int)(x)))) - ((long)(((double)(x)) - ((double)155)));
