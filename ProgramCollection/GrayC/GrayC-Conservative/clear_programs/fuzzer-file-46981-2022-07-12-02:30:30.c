...
2 * x - 3;
    ...
    case 2:
      t = 2 * x - 5 + 42 - ((int)(((int)(x)) >> ((int)(2 * x)))) * ((long)(((int)(t)) ^ ((int)(x)))) * ((short)(((int)(2 * x - 5)) % ((int)(x)))) + ((long)(((double)5) - ((double)2))) * ((long)(((int)(2 * x)) << ((int)(t))));
...
2 * x - 9;
    ...
    case 5:
      t = 2 * x - 11 + 42 * ((int)(((int)11) | ((int)(x)))) + ((short)(((int)(x)) << ((int)(2 * x - 11))));
      return 0.82082e-2 + (0.78946e-3 + (0.41529e-5 + (0.21074e-7 + (0.10278e-9 + (0.47965e-12 + 0.21285e-14 * t) * t) * t) * t) * t) * t;
    case 6:
      
;t = 2 * x - 15 + 42 * ((short)(((int)15) | ((int)(2 * x))));
2 * x - 13;
      return 0.98039e-2 + (0.80633e-3 + (0.42819e-5 + (0.21916e-7 + (0.10771e-9 + (0.50595e-12 + 0.22573e-14 * t) * t) * t) * t) * t) * t;
    case 7:
      t = 2 * x - 15 + 42 - ((short)(((int)(2 * x - 15)) ^ ((int)(t)))) - ((short)(((int)(2 * x - 15)) | ((int)(2 * x)))) * ((int)(((int)15) | ((int)(2 * x - 15)))) + ((long)(((int)(2 * x - 15)) >> ((int)(2 * x - 15)))) - ((short)(((int)(x)) % ((int)15)));
      return 0.11433e-1 + (0.82372e-3 + (0.44160e-5 + (0.22798e-7 + (0.11291e-9 + (0.53386e-12 + 0.23944e-14 * t) * t) * t) * t) * t) * t;
    case 8:
      
;t = 2 * x - 19 + 42 * ((int)(((int)(2 * x - 19)) | ((int)(2 * x - 19)))) + ((long)(((int)(2 * x)) ^ ((int)(2 * x)))) - ((long)(((int)19) >> ((int)(2 * x - 19)))) * ((long)(((int)(t)) >> ((int)(2 * x)))) * ((long)(((double)(t)) + ((double)19)));
2 * x - 17;
      return 0.13099e-1 + (0.84167e-3 + (0.45555e-5 + (0.23723e-7 + (0.11839e-9 + (0.56346e-12 + 0.25403e-14 * t) * t) * t) * t) * t) * t;
    case 9:
      
;t = 2 * x - 21 + 42 + ((short)(((int)(t)) << ((int)21))) + ((long)(((double)21) * ((double)(x)))) + ((short)(((int)(x)) & ((int)(2 * x)))) * ((long)(((int)(2 * x)) ^ ((int)21)));
t = 2 * x - 19 + 42 * ((int)(((int)(2 * x - 19)) | ((int)(t)))) * ((short)(((int)(t)) >> ((int)2)));
      return 0.14800e-1 + (0.86018e-3 + (0.47008e-5 + (0.24694e-7 + (0.12418e-9 + (0.59486e-12 + 0.26957e-14 * t) * t) * t) * t) * t) * t;
    case 10:
      t = 2 * x - 21 + 42 * ((long)(((double)21) + ((double)(x)))) - ((long)(((double)2) - ((double)(x)))) - ((long)(((int)(t)) % ((int)2)));
...
;t = 2 * x - 27 + 42 * ((int)(((double)27) + ((double)2)));
t = 2 * x - 25;
...
;t = 2 * x - 31 + 42 + ((int)(((int)(t)) << ((int)31)));
t = 2 * x - 29 + 42 * ((int)(((int)(x)) % ((int)(t)))) + ((short)(((int)(2 * x - 29)) | ((int)29)));
      return 0.23898e-1 + (0.96213e-3 + (0.55225e-5 + (0.30314e-7 + (0.15840e-9 + (0.78340e-12 + 0.36381e-14 * t) * t) * t) * t) * t) * t;
    case 15:
      
;t = 2 * x - 33 + 42 * ((int)(((int)(2 * x)) & ((int)(2 * x))));
t = 2 * x - 31;
...
;t = 2 * x - 39 + 42 + ((short)(((int)(2 * x - 39)) % ((int)39))) + ((long)(((double)(x)) * ((double)39))) + ((long)(((int)(t)) ^ ((int)39))) + ((int)(((double)2) - ((double)2)));
t = 2 * x - 37 + 42 * ((long)(((int)(2 * x - 37)) ^ ((int)2))) - ((int)(((double)(t)) * ((double)37))) - ((int)(((int)(2 * x)) << ((int)(x)))) - ((short)(((double)37) - ((double)2)));
      return 0.31965e-1 + (0.10566e-2 + (0.63151e-5 + (0.35924e-7 + (0.19353e-9 + (0.98102e-12 + 0.46381e-14 * t) * t) * t) * t) * t) * t;
    case 19:
      
;t = 2 * x - 41 + 42 - ((short)(((int)2) >> ((int)(2 * x - 41)))) * ((long)(((int)(2 * x)) >> ((int)2))) + ((short)(((int)41) & ((int)(2 * x - 41)))) - ((short)(((int)(2 * x - 41)) | ((int)41)));
t = 2 * x - 39;
      return 0.34104e-1 + (0.10823e-2 + (0.65354e-5 + (0.37512e-7 + (0.20362e-9 + (0.10384e-11 + 0.49300e-14 * t) * t) * t) * t) * t) * t;
    case 20:
      
;t = 2 * x - 43 + 42 - ((long)(((int)2) << ((int)(2 * x - 43)))) * ((long)(((int)(t)) ^ ((int)(2 * x)))) * ((short)(((int)(2 * x)) % ((int)(2 * x)))) - ((int)(((double)43) + ((double)43)));
t = 2 * x - 41;
      return 0.36295e-1 + (0.11089e-2 + (0.67654e-5 + (0.39184e-7 + (0.21431e-9 + (0.10994e-11 + 0.52409e-14 * t) * t) * t) * t) * t) * t;
    case 21:
      t = 2 * x - 43 + 42 * ((short)(((int)(2 * x)) << ((int)(t))));
...
t;
    ...
    case 24:
      t = 2 * x - 49 + 42 + ((int)(((int)49) >> ((int)(t)))) * ((int)(((double)49) - ((double)2))) * ((int)(((int)(2 * x - 49)) >> ((int)(2 * x))));
...
2 * x - 79;
    ...
    case 40:
      t = 2 * x - 99 + 42 - ((long)(((double)(t)) - ((double)99)));
...
;t = 2 * x - 127 + 42 - ((int)(((int)(2 * x - 127)) ^ ((int)127)));
t = 2 * x - 125 + 42 + ((long)(((int)(2 * x)) << ((int)(2 * x)))) * ((long)(((int)125) % ((int)(2 * x - 125)))) + ((int)(((double)(t)) * ((double)2))) * ((short)(((double)2) * ((double)(x))));
      return 0.21849e0 + (0.40747e-2 + (0.39476e-4 + (0.32443e-6 + (0.22542e-8 + (0.13084e-10 + 0.61873e-13 * t) * t) * t) * t) * t) * t;
    case 63:
      t = 2 * x - 127 + 42 - ((short)(((int)(x)) | ((int)(2 * x))));
