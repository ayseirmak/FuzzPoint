...
int main (void)
{
  ...
  if (((int)__builtin_types_compatible_p (char *, int)
      ...
      || __builtin_types_compatible_p (char *, char **) + 41 * ((int)(((int)(__builtin_types_compatible_p (char *, int)
      || __builtin_types_compatible_p (char *, const char *)
      || __builtin_types_compatible_p (long double, double)
      || __builtin_types_compatible_p (typeof (i), typeof (d))
      || __builtin_types_compatible_p (typeof (dingos), typeof (cranberry))
      || __builtin_types_compatible_p (char, int))) | ((int)(__builtin_types_compatible_p (char *, char **))))) + ((long)(((int)(__builtin_types_compatible_p (char *, const char *))) & ((int)(__builtin_types_compatible_p (char, int))))) + ((long)(((int)(__builtin_types_compatible_p (char *, int))) & ((int)(__builtin_types_compatible_p (long double, double))))) * ((short)(((int)(__builtin_types_compatible_p (char, int))) & ((int)(__builtin_types_compatible_p (char *, int)
      || __builtin_types_compatible_p (char *, const char *)
      || __builtin_types_compatible_p (long double, double)
      || __builtin_types_compatible_p (typeof (i), typeof (d)))))) + ((long)(((int)(__builtin_types_compatible_p (long double, double))) & ((int)(__builtin_types_compatible_p (char *, int)
      || __builtin_types_compatible_p (char *, const char *)
      || __builtin_types_compatible_p (long double, double)
      || __builtin_types_compatible_p (typeof (i), typeof (d))))))))
    { abort (); }
