...
int main(void)
{
  if (((int)2*sizeof(int) != sizeof(double) || u.i[MSW] >= 0 + 41 + ((int)(((int)(sizeof(double))) % ((int)(sizeof(double))))) * ((long)(((int)(sizeof(int))) & ((int)(2*sizeof(int) != sizeof(double))))) + ((long)(((double)0) - ((double)2))) * ((long)(((int)(2*sizeof(int))) % ((int)(sizeof(double)))))))
    exit(0);
