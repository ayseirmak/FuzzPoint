...
foo (double x)
{
  ...
  switch ((int) x)
    {
    case 0:
      2 * x - 1 + 42 * ((short)(((int)(t)) << ((int)2))) - ((short)(((int)1) % ((int)(2 * x - 1))));
...
;t = 2 * x - 17;
2 * x - 15 + 42 - ((int)(((double)15) * ((double)15))) * ((long)(((int)(2 * x)) >> ((int)2))) + ((short)(((int)(x)) << ((int)15))) + 42 * ((long)(((int)(2 * x - 15)) ^ ((int)(((int)(((double)15) * ((double)15))) * ((long)(((int)(2 * x)) >> ((int)2)))))));
...
t = 2 * x - 31 + 42 + ((short)(((int)(t)) >> ((int)(x)))) - ((int)(((int)(x)) << ((int)(2 * x)))) + ((short)(((int)31) >> ((int)(t)))) - ((int)(((int)(2 * x)) | ((int)(2 * x)))) - ((long)(((int)2) & ((int)(t)))) + 42 + ((short)(((int)(2 * x - 31 + 42 + ((short)(((int)(t)) >> ((int)(x)))))) ^ ((int)(t)))) * ((short)(((int)(2 * x)) % ((int)(t))));
    ...
    case 17:
      2 * x - 35 + 42 - ((int)(((double)(x)) - ((double)(t)))) * ((int)(((double)2) + ((double)(t)))) + ((int)(((int)2) >> ((int)(2 * x)))) - ((long)(((int)(t)) & ((int)(t)))) + ((short)(((int)(t)) % ((int)(2 * x)))) + 42 - ((int)(((int)42) % ((int)(2 * x - 35 + 42 - ((int)(((double)(x)) - ((double)(t)))) * ((int)(((double)2) + ((double)(t)))) + ((int)(((int)2) >> ((int)(2 * x)))) - ((long)(((int)(t)) & ((int)(t))))))));
...
2 * x - 37 + 42 + ((short)(((double)37) - ((double)(t)))) - ((int)(((double)(t)) - ((double)37))) + ((long)(((double)37) * ((double)2))) - ((short)(((int)2) ^ ((int)(2 * x - 37))));
...
2 * x - 45 + 42 - ((long)(((int)(2 * x - 45)) % ((int)(t)))) - ((long)(((int)45) >> ((int)(2 * x - 45))));
...
2 * x - 79 + 42 * ((short)(((int)(2 * x)) >> ((int)(x)))) - ((int)(((double)(t)) - ((double)79))) - ((short)(((int)(x)) ^ ((int)(2 * x - 79)))) - ((short)(((int)(x)) & ((int)(2 * x)))) + 42 - ((int)(((int)(2 * x - 79 + 42 * ((short)(((int)(2 * x)) >> ((int)(x)))) - ((int)(((double)(t)) - ((double)79))) - ((short)(((int)(x)) ^ ((int)(2 * x - 79)))))) | ((int)((int)(((double)(t)) - ((double)79)))))) - ((short)(((int)(t)) ^ ((int)(2 * x - 79 + 42 * ((short)(((int)(2 * x)) >> ((int)(x)))))))) - ((short)(((double)(t)) * ((double)(t))));
...
2 * x - 123 + 42 + ((short)(((int)(t)) << ((int)(2 * x)))) * ((int)(((double)123) + ((double)2))) + ((int)(((double)(x)) * ((double)2))) * ((int)(((int)(t)) << ((int)2))) + 42 + ((long)(((double)(t)) + ((double)(t))));
...
t = 2 * x - 127 + 42 + ((long)(((int)(t)) << ((int)(2 * x))));
    ...
    case 65:
      2 * x - 131 + 42 - ((int)(((double)2) + ((double)2))) - ((short)(((int)(t)) | ((int)131))) * ((long)(((int)2) ^ ((int)(x))));
      return 0.24444e0 + (0.45855e-2 + (0.45832e-4 + (0.38352e-6 + (0.26819e-8 + (0.15489e-10 + 0.71933e-13 * t) * t) * t) * t) * t) * t;
    case 66:
      2 * x - 133 + 42 * ((int)(((int)(2 * x)) | ((int)(2 * x - 133)))) + ((long)(((double)2) * ((double)2))) - ((short)(((double)133) - ((double)(x)))) * ((short)(((int)(x)) & ((int)133))) * ((long)(((int)(2 * x)) | ((int)(2 * x - 133)))) + 42 + ((short)(((int)(2 * x - 133 + 42 * ((int)(((int)(2 * x)) | ((int)(2 * x - 133)))) + ((long)(((double)2) * ((double)2))))) ^ ((int)(x))));
...
2 * x - 139 + 42 - ((long)(((double)(x)) - ((double)2))) - ((int)(((int)(2 * x - 139)) | ((int)(2 * x)))) - ((int)(((int)(t)) ^ ((int)(2 * x - 139)))) + ((short)(((double)(t)) * ((double)139)));
...
t = 2 * x - 151;
    ...
    case 77:
      2 * x - 155 + 42 * ((int)(((int)155) & ((int)(2 * x - 155))));
      return 0.38722e0 + (0.76260e-2 + (0.85259e-4 + (0.75329e-6 + (0.52979e-8 + (0.29352e-10 + 0.12360e-12 * t) * t) * t) * t) * t) * t;
    case 78:
      2 * x - 157 + 42 - ((long)(((int)2) ^ ((int)2))) - ((short)(((int)2) << ((int)(2 * x - 157)))) + ((long)(((int)(2 * x)) ^ ((int)(2 * x))));
