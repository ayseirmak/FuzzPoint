...
foo (double x)
{
  ...
  switch ((int) x)
    ...
    case 8:
      t = 2 * x - 17 + 42 * ((short)(((double)2) - ((double)(x)))) - ((short)(((int)(2 * x - 17)) ^ ((int)(2 * x - 17)))) - ((long)(((int)(x)) << ((int)(2 * x))));
    ...
    case 10:
      t = 2 * x - 21 + 42 * ((int)(((int)(2 * x - 21)) >> ((int)21))) * ((long)(((int)(2 * x - 21)) | ((int)(x))));
    ...
    case 13:
      t = 2 * x - 27 + 42 * ((long)(((int)2) % ((int)(2 * x - 27)))) * ((long)(((int)(x)) % ((int)(x)))) - ((long)(((int)(2 * x - 27)) | ((int)(2 * x - 27)))) - ((int)(((int)(2 * x - 27)) | ((int)(x)))) * ((int)(((double)(x)) + ((double)(t))));
    ...
    case 16:
      t = 2 * x - 33 + 42 + ((short)(((int)(2 * x - 33)) >> ((int)33))) + ((long)(((double)2) + ((double)33))) - ((long)(((int)2) << ((int)(2 * x - 33))));
      return 0.27837e-1 + (0.10078e-2 + (0.59020e-5 + (0.32979e-7 + (0.17498e-9 + (0.87622e-12 + 0.41066e-14 * t) * t) * t) * t) * t) * t;
    case 17:
      t = 2 * x - 35 + 42 + ((short)(((double)2) * ((double)35)));
      return 0.29877e-1 + (0.10318e-2 + (0.61041e-5 + (0.34414e-7 + (0.18399e-9 + (0.92703e-12 + 0.43639e-14 * t) * t) * t) * t) * t) * t;
    case 18:
      t = 2 * x - 37 + 42 * ((long)(((int)(2 * x - 37)) >> ((int)2))) * ((long)(((double)(t)) * ((double)(x)))) * ((short)(((int)(2 * x - 37)) & ((int)37)));
    ...
    case 22:
      t = 2 * x - 45 + 42 * ((int)(((double)(t)) * ((double)2))) * ((long)(((int)45) | ((int)(2 * x))));
      return 0.40842e-1 + (0.11650e-2 + (0.72569e-5 + (0.42796e-7 + (0.23761e-9 + (0.12332e-11 + 0.59246e-14 * t) * t) * t) * t) * t) * t;
    case 23:
      t = 2 * x - 47 + 42 - ((int)(((int)47) & ((int)(2 * x)))) * ((long)(((double)47) + ((double)(t)))) + ((int)(((int)(t)) >> ((int)(x)))) - ((long)(((int)47) | ((int)(2 * x)))) * ((int)(((double)2) - ((double)47)));
    ...
    case 40:
      t = 2 * x - 99 + 42 + ((int)(((int)(x)) & ((int)(x)))) - ((long)(((double)2) + ((double)(x))));
    ...
    case 63:
      t = 2 * x - 127 + 42 * ((long)(((int)2) << ((int)(2 * x - 127)))) - ((long)(((int)(x)) >> ((int)(x)))) + ((long)(((int)(2 * x - 127)) >> ((int)(2 * x))));
    ...
    case 66:
      t = 2 * x - 133 + 42 + ((int)(((int)(2 * x)) | ((int)133))) - ((short)(((int)(2 * x)) ^ ((int)(2 * x - 133)))) * ((long)(((int)(t)) ^ ((int)(x)))) * ((long)(((int)(2 * x - 133)) << ((int)(2 * x - 133))));
    ...
    case 73:
      t = 2 * x - 147 + 42 - ((int)(((double)(t)) * ((double)147))) * ((short)(((int)2) << ((int)(2 * x - 147)))) + ((int)(((int)147) % ((int)(2 * x - 147)))) + ((short)(((double)(x)) - ((double)(x)))) + ((short)(((double)147) + ((double)(t))));
    ...
    case 75:
      t = 2 * x - 151 + 42 + ((long)(((int)2) >> ((int)(2 * x - 151)))) + ((long)(((int)151) % ((int)151))) + ((long)(((int)(2 * x)) | ((int)(x))));
      return 0.35803e0 + (0.69787e-2 + (0.76710e-4 + (0.67306e-6 + (0.47397e-8 + (0.26505e-10 + 0.11376e-12 * t) * t) * t) * t) * t) * t;
    case 76:
      t = 2 * x - 153 + 42 * ((long)(((int)(x)) ^ ((int)(2 * x)))) + ((int)(((int)(x)) % ((int)(2 * x)))) * ((long)(((int)(x)) & ((int)(2 * x)))) * ((long)(((int)(2 * x)) << ((int)(t)))) - ((int)(((double)(t)) * ((double)(t))));
    ...
    case 81:
      t = 2 * x - 163 + 42 * ((int)(((int)(2 * x)) ^ ((int)(t)))) * ((int)(((int)(2 * x)) | ((int)(2 * x - 163)))) * ((long)(((int)(t)) & ((int)(2 * x - 163))));
    ...
    case 84:
      t = 2 * x - 169 + 42 - ((int)(((int)(2 * x)) & ((int)2))) * ((short)(((int)169) >> ((int)2))) - ((long)(((int)(x)) | ((int)(2 * x - 169))));
