...
;
;t = 2 * x - 5 + 42 * ((long)(((int)(2 * x - 5)) % ((int)2))) * ((int)(((int)(t)) >> ((int)(2 * x - 5)))) + ((int)(((double)(t)) + ((double)5))) + 42 * ((short)(((double)(x)) * ((double)((int)(((double)(t)) + ((double)5))))));
...
;
;t = 2 * x - 33 + 42 + ((short)(((double)(x)) + ((double)(x)))) * ((short)(((int)33) & ((int)33))) - ((short)(((double)(x)) + ((double)(t)))) * ((long)(((int)(2 * x)) | ((int)(2 * x - 33))));
...
t = 2 * x - 33 + 42 * ((short)(((int)33) ^ ((int)(2 * x)))) * ((short)(((int)(2 * x - 33)) ^ ((int)(2 * x))));
...
;t = 2 * x - 49 + 42 + ((long)(((int)(2 * x - 49)) | ((int)(t))));
