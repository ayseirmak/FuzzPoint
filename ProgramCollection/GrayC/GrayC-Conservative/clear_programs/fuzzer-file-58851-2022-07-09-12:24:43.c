...
int main(void)
{
  if (((int)2*sizeof(int) != sizeof(double) || u.i[MSW] >= 0 + 41 * ((long)(((int)(2*sizeof(int) != sizeof(double))) & ((int)(2*sizeof(int) != sizeof(double))))) * ((int)(((int)(sizeof(double))) & ((int)(u.i[MSW])))) - ((short)(((double)(sizeof(double))) + ((double)(sizeof(double))))) + ((int)(((int)(sizeof(int))) % ((int)2)))))
    exit(0);
