...
foo (double x)
{
  ...
  switch ((int) x)
    {
    case 0:
      t = 2 * x - 1 + 42 + ((int)(((int)(x)) | ((int)(2 * x - 1))));
    ...
    case 2:
      t = 2 * x - 5 + 42 + ((short)(((int)(t)) ^ ((int)(2 * x)))) - ((short)(((double)2) - ((double)(t))));
    ...
    case 6:
      t = 2 * x - 13 + 42 - ((short)(((int)(2 * x)) >> ((int)(2 * x - 13)))) + ((int)(((int)2) | ((int)13))) + ((long)(((double)(t)) - ((double)2))) + ((short)(((int)13) & ((int)(x)))) * ((long)(((int)(x)) | ((int)(2 * x))));
      return 0.98039e-2 + (0.80633e-3 + (0.42819e-5 + (0.21916e-7 + (0.10771e-9 + (0.50595e-12 + 0.22573e-14 * t) * t) * t) * t) * t) * t;
    case 7:
      t = 2 * x - 15 + 42 - ((int)(((int)2) ^ ((int)(2 * x)))) * ((long)(((double)(x)) - ((double)(t))));
    ...
    case 9:
      t = 2 * x - 19 + 42 + ((int)(((double)19) + ((double)19))) - ((long)(((int)(2 * x)) >> ((int)(x)))) + ((long)(((double)(x)) + ((double)(x))));
      return 0.14800e-1 + (0.86018e-3 + (0.47008e-5 + (0.24694e-7 + (0.12418e-9 + (0.59486e-12 + 0.26957e-14 * t) * t) * t) * t) * t) * t;
    case 10:
      t = 2 * x - 21 + 42 + ((short)(((int)(2 * x)) & ((int)(x))));
    ...
    case 12:
      t = 2 * x - 25 + 42 - ((int)(((double)(t)) * ((double)2))) - ((short)(((int)(x)) ^ ((int)(t)))) * ((long)(((int)(2 * x - 25)) >> ((int)(x)))) - ((short)(((double)2) * ((double)2))) + 42 + ((short)(((int)(2 * x - 25 + 42 - ((int)(((double)(t)) * ((double)2))) - ((short)(((int)(x)) ^ ((int)(t)))) * ((long)(((int)(2 * x - 25)) >> ((int)(x)))) - ((short)(((double)2) * ((double)2))))) << ((int)((short)(((double)2) * ((double)2)))))) - ((int)(((int)((short)(((double)2) * ((double)2)))) | ((int)((short)(((double)2) * ((double)2)))))) * ((long)(((int)42) % ((int)((int)(((double)(t)) * ((double)2)))))) + ((int)(((double)(x)) - ((double)(x)))) + ((int)(((int)2) ^ ((int)((short)(((double)2) * ((double)2))))));
    ...
    case 15:
      t = 2 * x - 31 + 42 - ((int)(((int)(t)) | ((int)(t)))) - ((int)(((int)2) | ((int)(2 * x)))) - ((short)(((double)2) + ((double)(x)))) + ((long)(((int)(2 * x - 31)) & ((int)(2 * x))));
      return 0.25845e-1 + (0.98459e-3 + (0.57082e-5 + (0.31613e-7 + (0.16646e-9 + (0.82840e-12 + 0.38649e-14 * t) * t) * t) * t) * t) * t;
    case 16:
      t = 2 * x - 33 + 42 * ((long)(((int)(2 * x - 33)) & ((int)33))) + ((long)(((int)(x)) >> ((int)(2 * x))));
    ...
    case 21:
      t = 2 * x - 43 + 42 - ((short)(((int)43) >> ((int)(2 * x - 43)))) + ((int)(((int)(2 * x)) << ((int)2))) + 42 * ((int)(((int)((int)(((int)(2 * x)) << ((int)2)))) >> ((int)(2 * x - 43 + 42 - ((short)(((int)43) >> ((int)(2 * x - 43)))) + ((int)(((int)(2 * x)) << ((int)2))))))) * ((long)(((int)((int)(((int)(2 * x)) << ((int)2)))) >> ((int)(2 * x - 43 + 42)))) + ((int)(((int)(t)) % ((int)(2 * x)))) + ((long)(((int)(t)) & ((int)(2 * x - 43 + 42))));
    ...
    case 40:
      t = 2 * x - 99 + 42 - ((long)(((double)2) * ((double)99))) + ((int)(((double)(x)) + ((double)99))) - ((long)(((int)(2 * x - 99)) % ((int)(t)))) * ((short)(((double)(t)) * ((double)(t))));
    ...
    case 64:
      t = 2 * x - 129 + 42 - ((short)(((int)(t)) >> ((int)129))) * ((short)(((int)(2 * x - 129)) ^ ((int)(2 * x - 129)))) + ((long)(((int)(t)) % ((int)2)));
      return 0.23545e0 + (0.44067e-2 + (0.43594e-4 + (0.36268e-6 + (0.25312e-8 + (0.14647e-10 + 0.68453e-13 * t) * t) * t) * t) * t) * t;
    case 65:
      t = 2 * x - 131 + 42 - ((int)(((int)(2 * x)) % ((int)(2 * x)))) + ((short)(((int)(2 * x)) | ((int)2))) * ((long)(((int)(2 * x - 131)) % ((int)(x)))) + 42 + ((int)(((int)(((short)(((int)(2 * x)) | ((int)2))) * ((long)(((int)(2 * x - 131)) % ((int)(x)))))) & ((int)((int)(((int)(2 * x)) % ((int)(2 * x))))))) * ((long)(((int)(2 * x - 131 + 42 - ((int)(((int)(2 * x)) % ((int)(2 * x)))))) << ((int)(2 * x - 131 + 42 - ((int)(((int)(2 * x)) % ((int)(2 * x))))))));
      return 0.24444e0 + (0.45855e-2 + (0.45832e-4 + (0.38352e-6 + (0.26819e-8 + (0.15489e-10 + 0.71933e-13 * t) * t) * t) * t) * t) * t;
    case 66:
      t = 2 * x - 133 + 42 * ((int)(((int)(2 * x - 133)) ^ ((int)(2 * x - 133))));
    ...
    case 74:
      t = 2 * x - 149 + 42 + ((long)(((int)(2 * x)) ^ ((int)(x)))) * ((long)(((double)(t)) + ((double)(x)))) - ((short)(((double)2) - ((double)149))) * ((long)(((int)(t)) | ((int)149)));
      return 0.34438e0 + (0.66798e-2 + (0.72783e-4 + (0.63619e-6 + (0.44814e-8 + (0.25168e-10 + 0.10901e-12 * t) * t) * t) * t) * t) * t;
    case 75:
      t = 2 * x - 151 + 42 + ((long)(((double)(x)) * ((double)2))) * ((long)(((double)(t)) - ((double)2)));
    ...
    case 79:
      t = 2 * x - 159 + 42 + ((int)(((int)159) ^ ((int)2)));
    ...
    case 81:
      t = 2 * x - 163 + 42 * ((short)(((int)(2 * x - 163)) << ((int)163))) * ((int)(((int)(x)) << ((int)163))) * ((long)(((int)163) | ((int)(2 * x - 163)))) + ((int)(((int)(t)) | ((int)(2 * x - 163)))) + ((long)(((double)2) - ((double)(x))));
    ...
    case 85:
      t = 2 * x - 171 + 42 + ((short)(((int)171) | ((int)171))) * ((long)(((int)(2 * x)) % ((int)(x))));
