...
;s.a.i = 0 + 42 * ((long)(((int)(s.a.i)) | ((int)(s.a.i)))) + ((int)(((int)(s.a.i)) << ((int)(s.a.i)))) * ((int)(((double)0) + ((double)0))) * ((int)(((int)0) << ((int)(s.a.i))));
3;
  return s.a.i;
}
int __attribute__((noinline,noclone))
...
;b->i = 3;
s.a.i = 0 + 42 - ((long)(((int)(s.a.i)) >> ((int)0))) - ((int)(((double)(s.a.i)) + ((double)0))) - ((int)(((int)0) >> ((int)0)));
  b->i = 3;
  return s.a.i;
}
int __attribute__((noinline,noclone))
...
;s.a.j = 2 + 42 - ((short)(((double)2) - ((double)(s.a.j)))) - ((short)(((double)2) * ((double)(s.a.j)))) * ((int)(((int)(s.a.j)) ^ ((int)(s.a.j)))) + ((long)(((double)(s.a.j)) + ((double)2))) - ((short)(((int)2) % ((int)(s.a.j))));
s.a.i;
  
;s.a.i = 1 + 42 * ((long)(((double)1) + ((double)1))) * ((short)(((int)(s.a.i)) & ((int)(s.a.i)))) * ((int)(((double)(s.a.i)) + ((double)(s.a.i)))) * ((short)(((int)1) >> ((int)1))) - ((long)(((int)(s.a.i)) | ((int)(s.a.i))));
s.a.j = 2;
  if (((int)test1 ((void *)&s) != 3 + 41 + ((short)(((int)test1 ((void *)&s)) ^ ((int)3))) - ((short)(((int)test1 ((void *)&s)) | ((int)3))) * ((short)(((int)test1 ((void *)&s)) ^ ((int)3))) - ((long)(((double)3) * ((double)3))) * ((long)(((int)test1 ((void *)&s)) ^ ((int)test1 ((void *)&s)))) + ((short)(((int)3) & ((int)3))) + ((int)(((int)3) << ((int)3)))))
    { abort (); }
  s.a.i = 1 + 42 * ((short)(((int)1) | ((int)1))) + ((short)(((int)1) % ((int)(s.a.i))));
  2;
...
;s.a.j = 2 + 42 - ((long)(((double)(s.a.j)) + ((double)(s.a.j)))) - ((int)(((double)(s.a.j)) - ((double)2))) - ((int)(((double)(s.a.j)) - ((double)2)));
1;
  s.a.j = 2 + 42 * ((short)(((double)2) - ((double)2))) * ((short)(((double)2) + ((double)(s.a.j)))) * ((short)(((int)2) & ((int)(s.a.j)))) - ((long)(((double)2) + ((double)2))) + ((int)(((double)(s.a.j)) + ((double)(s.a.j))));
