...
;
;
;t = 2 * x - 13 + 42 * ((long)(((int)13) % ((int)13))) + ((short)(((double)(x)) + ((double)(t)))) - ((long)(((int)(t)) ^ ((int)(t)))) - ((int)(((int)(2 * x)) | ((int)13)));
2 * x - 5;
2 * x - 7;
2 * x - 5;
...
;
;
;t = 2 * x - 13 + 42 + ((short)(((int)13) << ((int)2))) - ((long)(((int)(2 * x)) % ((int)(2 * x))));
t = 2 * x - 15 + 42 * ((int)(((int)(2 * x)) | ((int)(2 * x)))) - ((short)(((int)(x)) >> ((int)(t)))) - ((int)(((int)(t)) & ((int)(t)))) * ((short)(((int)(t)) ^ ((int)(2 * x))));
t = 2 * x - 13;
...
;
;
;t = 2 * x - 21 + 42 - ((int)(((int)(2 * x)) & ((int)(t)))) + ((long)(((int)2) << ((int)(t)))) * ((int)(((int)(2 * x - 21)) & ((int)(2 * x))));
2 * x - 21;
2 * x - 19;
t;
...
;
;t = 2 * x - 27 + 42 - ((int)(((int)2) & ((int)27))) + ((int)(((int)(2 * x - 27)) | ((int)(2 * x - 27)))) * ((short)(((int)(2 * x - 27)) << ((int)2))) - ((short)(((int)(2 * x - 27)) & ((int)(t)))) + ((int)(((double)27) + ((double)2)));
t;
2 * x - 19;
...
;
;t = 2 * x - 27;
t = 2 * x - 27 + 42 - ((long)(((int)(2 * x)) << ((int)27))) * ((int)(((int)(x)) | ((int)(x))));
2 * x - 29;
2 * x - 27;
2 * x - 25;
...
;t = 2 * x - 33 + 42 * ((long)(((int)(t)) >> ((int)(2 * x))));
t;
...
;
;
;t = 2 * x - 79 + 42 + ((short)(((int)(2 * x)) ^ ((int)2)));
2 * x - 79;
...
;
;
;t = 2 * x - 99 + 42 * ((long)(((int)2) % ((int)(2 * x - 99)))) * ((long)(((int)(2 * x)) ^ ((int)(x)))) + ((long)(((int)(2 * x - 99)) ^ ((int)(2 * x)))) - ((int)(((double)(t)) - ((double)2)));
2 * x - 79;
2 * x - 99;
...
;
;t = 2 * x - 133 + 42 + ((short)(((int)2) >> ((int)(x))));
2 * x - 129;
t;
...
;t = 2 * x - 161 + 42 + ((short)(((int)(x)) >> ((int)161))) + ((short)(((int)161) | ((int)(t)))) - ((int)(((int)2) ^ ((int)(2 * x - 161)))) + ((short)(((int)2) | ((int)(2 * x - 161))));
t = 2 * x - 143;
2 * x - 141;
...
;
;
;t = 2 * x - 161 + 42 - ((int)(((int)(2 * x - 161)) | ((int)(2 * x))));
t = 2 * x - 161;
t = 2 * x - 161 + 42 * ((short)(((int)(x)) ^ ((int)(x)))) * ((int)(((int)2) | ((int)2)));
t;
2 * x - 159;
...
;
;t = 2 * x - 169;
t = 2 * x - 169 + 42 + ((long)(((int)169) & ((int)(t))));
2 * x - 165;
...
;t = 2 * x - 169 + 42 * ((int)(((int)(x)) >> ((int)(x)))) * ((short)(((double)2) - ((double)(x)))) * ((long)(((int)(2 * x - 169)) << ((int)169))) - ((int)(((int)(x)) & ((int)(2 * x - 169))));
2 * x - 169;
2 * x - 167;
...
;t = 2 * x - 175 + 42 * ((short)(((int)(2 * x)) % ((int)175))) + ((int)(((int)(2 * x - 175)) ^ ((int)(2 * x))));
t = 2 * x - 175;
...
;t = 2 * x - 175;
t = 2 * x - 171 + 42 * ((int)(((int)(2 * x)) & ((int)(2 * x)))) + ((long)(((int)2) >> ((int)171)));
