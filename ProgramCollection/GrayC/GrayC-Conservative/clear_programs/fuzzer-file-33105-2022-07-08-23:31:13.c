...
foo (double x)
{
  ...
  switch ((int) x)
    {
    case 0:
      t = 2 * x - 1 + 42 * ((long)(((int)(2 * x - 1)) ^ ((int)2))) + ((int)(((int)(2 * x)) & ((int)1))) * ((short)(((int)(x)) ^ ((int)(x)))) - ((long)(((int)(t)) << ((int)(t)))) + 42 * ((short)(((int)2) & ((int)(2 * x)))) + ((int)(((int)(2 * x - 1 + 42 * ((long)(((int)(2 * x - 1)) ^ ((int)2))) + ((int)(((int)(2 * x)) & ((int)1))) * ((short)(((int)(x)) ^ ((int)(x)))) - ((long)(((int)(t)) << ((int)(t)))))) ^ ((int)1))) - ((int)(((int)1) & ((int)(42 * ((long)(((int)(2 * x - 1)) ^ ((int)2)))))));
    ...
    case 2:
      t = 2 * x - 5 + 42 * ((long)(((int)(2 * x)) ^ ((int)(2 * x - 5)))) * ((long)(((int)(x)) ^ ((int)2))) * ((short)(((int)2) >> ((int)5)));
    ...
    case 4:
      t = 2 * x - 9 + 42 + ((short)(((int)(x)) >> ((int)2))) + 42 - ((short)(((int)(t)) | ((int)(2 * x - 9 + 42)))) - ((short)(((int)9) & ((int)(2 * x))));
    ...
    case 9:
      t = 2 * x - 19 + 42 + ((short)(((int)19) | ((int)(2 * x)))) + ((short)(((int)19) | ((int)(2 * x - 19)))) - ((short)(((int)(x)) ^ ((int)(t))));
      return 0.14800e-1 + (0.86018e-3 + (0.47008e-5 + (0.24694e-7 + (0.12418e-9 + (0.59486e-12 + 0.26957e-14 * t) * t) * t) * t) * t) * t;
    case 10:
      t = 2 * x - 21 + 42 * ((short)(((int)(x)) << ((int)(2 * x)))) + ((int)(((int)(2 * x - 21)) << ((int)(2 * x)))) - ((short)(((double)21) - ((double)(x)))) - ((short)(((int)(t)) % ((int)2))) + 42 + ((int)(((int)21) | ((int)(2 * x - 21 + 42 * ((short)(((int)(x)) << ((int)(2 * x)))) + ((int)(((int)(2 * x - 21)) << ((int)(2 * x)))) - ((short)(((double)21) - ((double)(x)))) - ((short)(((int)(t)) % ((int)2))))))) - ((int)(((int)(2 * x)) ^ ((int)(2 * x - 21 + 42 * ((short)(((int)(x)) << ((int)(2 * x)))) + ((int)(((int)(2 * x - 21)) << ((int)(2 * x)))))))) - ((long)(((int)(2 * x - 21)) & ((int)((short)(((int)(t)) % ((int)2)))))) * ((long)(((double)(t)) * ((double)21)));
      return 0.16540e-1 + (0.87928e-3 + (0.48520e-5 + (0.25711e-7 + (0.13030e-9 + (0.62820e-12 + 0.28612e-14 * t) * t) * t) * t) * t) * t;
    case 11:
      t = 2 * x - 23 + 42 + ((short)(((double)23) * ((double)2)));
    ...
    case 16:
      t = 2 * x - 33 + 42 * ((short)(((int)(x)) >> ((int)(2 * x)))) - ((long)(((int)33) >> ((int)(2 * x)))) + ((short)(((int)(2 * x - 33)) | ((int)(2 * x)))) * ((long)(((double)(t)) + ((double)(t))));
      return 0.27837e-1 + (0.10078e-2 + (0.59020e-5 + (0.32979e-7 + (0.17498e-9 + (0.87622e-12 + 0.41066e-14 * t) * t) * t) * t) * t) * t;
    case 17:
      t = 2 * x - 35 + 42 - ((int)(((double)(t)) * ((double)(x))));
    ...
    case 21:
      t = 2 * x - 43 + 42 - ((long)(((int)(2 * x - 43)) % ((int)(x)))) * ((int)(((int)(2 * x)) ^ ((int)43))) - ((short)(((int)(x)) % ((int)43))) - ((long)(((int)(2 * x)) % ((int)(2 * x)))) * ((long)(((int)2) & ((int)43))) + 42 - ((int)(((int)(2 * x - 43 + 42 - ((long)(((int)(2 * x - 43)) % ((int)(x)))) * ((int)(((int)(2 * x)) ^ ((int)43))) - ((short)(((int)(x)) % ((int)43))) - ((long)(((int)(2 * x)) % ((int)(2 * x)))) * ((long)(((int)2) & ((int)43))))) & ((int)(((long)(((int)(2 * x - 43)) % ((int)(x)))) * ((int)(((int)(2 * x)) ^ ((int)43))))))) * ((long)(((int)2) << ((int)((short)(((int)(x)) % ((int)43)))))) * ((short)(((int)(2 * x - 43 + 42 - ((long)(((int)(2 * x - 43)) % ((int)(x)))) * ((int)(((int)(2 * x)) ^ ((int)43))))) % ((int)(2 * x - 43 + 42 - ((long)(((int)(2 * x - 43)) % ((int)(x)))) * ((int)(((int)(2 * x)) ^ ((int)43))) - ((short)(((int)(x)) % ((int)43)))))));
      return 0.38540e-1 + (0.11364e-2 + (0.70058e-5 + (0.40943e-7 + (0.22563e-9 + (0.11642e-11 + 0.55721e-14 * t) * t) * t) * t) * t) * t;
    case 22:
      t = 2 * x - 45 + 42 - ((long)(((int)2) ^ ((int)2))) - ((short)(((int)45) >> ((int)(2 * x - 45)))) + ((short)(((int)(2 * x - 45)) ^ ((int)(x)))) + ((long)(((int)(2 * x - 45)) | ((int)(x))));
      return 0.40842e-1 + (0.11650e-2 + (0.72569e-5 + (0.42796e-7 + (0.23761e-9 + (0.12332e-11 + 0.59246e-14 * t) * t) * t) * t) * t) * t;
    case 23:
      t = 2 * x - 47 + 42 - ((long)(((int)(2 * x - 47)) >> ((int)(2 * x - 47))));
      return 0.43201e-1 + (0.11945e-2 + (0.75195e-5 + (0.44747e-7 + (0.25030e-9 + (0.13065e-11 + 0.63000e-14 * t) * t) * t) * t) * t) * t;
    case 24:
      t = 2 * x - 49 + 42 * ((int)(((double)2) * ((double)2))) * ((short)(((int)2) % ((int)(x)))) - ((short)(((int)2) << ((int)(2 * x)))) + ((short)(((int)(2 * x - 49)) << ((int)(2 * x - 49)))) * ((short)(((int)(2 * x)) & ((int)(2 * x))));
    ...
    case 26:
      t = 2 * x - 59 + 42 + ((long)(((int)(t)) % ((int)(2 * x)))) * ((long)(((double)(t)) - ((double)(t)))) * ((short)(((int)(2 * x)) & ((int)(2 * x)))) - ((long)(((double)(t)) - ((double)59)));
      return 0.58702e-1 + (0.13962e-2 + (0.93714e-5 + (0.58882e-7 + (0.34414e-9 + (0.18552e-11 + 0.91160e-14 * t) * t) * t) * t) * t) * t;
    case 30:
      t = 2 * x - 79 + 42 * ((short)(((int)2) << ((int)(x)))) - ((int)(((int)2) | ((int)(2 * x)))) * ((short)(((int)2) << ((int)(2 * x)))) + ((int)(((int)2) << ((int)(2 * x - 79)))) * ((short)(((int)(x)) << ((int)(x))));
    ...
    case 50:
      t = 2 * x - 119 + 42 * ((long)(((int)(2 * x - 119)) & ((int)(t))));
      return 0.19540e0 + (0.36342e-2 + (0.34096e-4 + (0.27479e-6 + (0.18934e-8 + (0.11021e-10 + 0.52931e-13 * t) * t) * t) * t) * t) * t;
    case 60:
      t = 2 * x - 121 + 42 * ((int)(((int)(t)) & ((int)(2 * x)))) * ((long)(((int)(t)) ^ ((int)(2 * x)))) * ((long)(((int)(2 * x)) ^ ((int)(2 * x - 121))));
    ...
    case 64:
      t = 2 * x - 129 + 42 - ((int)(((int)(2 * x - 129)) << ((int)(2 * x - 129)))) * ((long)(((int)(2 * x)) | ((int)(x)))) - ((long)(((double)(x)) * ((double)129)));
    ...
    case 66:
      t = 2 * x - 133 + 42 - ((short)(((double)2) - ((double)(t))));
