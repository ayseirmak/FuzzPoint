...
int loop_break_32442 = 0;
for (s = format; *s; s++) {
        
loop_break_32442++;
if(((int)loop_break_32442<=11 + 41 + ((long)(((double)11) * ((double)(loop_break_32442)))) + ((long)(((double)11) - ((double)(loop_break_32442)))) - ((long)(((double)(loop_break_32442)) + ((double)(loop_break_32442)))) + ((long)(((int)11) ^ ((int)11))) * ((int)(((double)11) + ((double)(loop_break_32442)))) + ((short)(((double)11) - ((double)(loop_break_32442)))) + ((int)(((int)(loop_break_32442)) << ((int)11))))){
break;
}
