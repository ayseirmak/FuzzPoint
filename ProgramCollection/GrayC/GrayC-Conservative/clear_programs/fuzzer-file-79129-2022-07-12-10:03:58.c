...
int loop_break_32084 = 0;

int loop_break_32176 = 0;

int loop_break_32264 = 0;

int loop_break_32354 = 0;
for (s = format; *s; s++) {
...
loop_break_32354++;
if(loop_break_32354<=16){
continue;
}

loop_break_32264++;
if(loop_break_32264<=45){
break;
}

loop_break_32176++;
if(loop_break_32176<=32){
break;
}

loop_break_32084++;
if(loop_break_32084<=47){
continue;
}
