...
foo (double x)
{
  ...
  switch ((int) x)
    ...
    case 12:
      t = 2 * x - 25 + 42 - ((long)(((double)(x)) + ((double)(t)))) * ((int)(((double)(x)) - ((double)(x)))) * ((int)(((int)(2 * x - 25)) >> ((int)2))) - ((long)(((int)25) & ((int)(t)))) + ((long)(((int)25) % ((int)(2 * x)))) + 42 * ((int)(((int)(t)) & ((int)(2 * x - 25 + 42)))) + ((short)(((int)42) << ((int)(2 * x - 25 + 42 - ((long)(((double)(x)) + ((double)(t)))) * ((int)(((double)(x)) - ((double)(x)))) * ((int)(((int)(2 * x - 25)) >> ((int)2))) - ((long)(((int)25) & ((int)(t)))))))) * ((short)(((int)(2 * x - 25 + 42 - ((long)(((double)(x)) + ((double)(t)))) * ((int)(((double)(x)) - ((double)(x)))) * ((int)(((int)(2 * x - 25)) >> ((int)2))))) >> ((int)(2 * x - 25 + 42 - ((long)(((double)(x)) + ((double)(t)))) * ((int)(((double)(x)) - ((double)(x)))) * ((int)(((int)(2 * x - 25)) >> ((int)2))) - ((long)(((int)25) & ((int)(t)))) + ((long)(((int)25) % ((int)(2 * x))))))));
      return 0.20136e-1 + (0.91936e-3 + (0.51734e-5 + (0.27900e-7 + (0.14357e-9 + (0.70114e-12 + 0.32252e-14 * t) * t) * t) * t) * t) * t;
    case 13:
      t = 2 * x - 27 + 42 + ((short)(((int)(t)) & ((int)27)));
    ...
    case 22:
      t = 2 * x - 45 + 42 - ((short)(((int)(x)) << ((int)(x)))) * ((int)(((int)2) >> ((int)(2 * x - 45)))) + ((short)(((int)(t)) >> ((int)(2 * x - 45)))) + ((short)(((int)(x)) % ((int)(2 * x))));
      return 0.40842e-1 + (0.11650e-2 + (0.72569e-5 + (0.42796e-7 + (0.23761e-9 + (0.12332e-11 + 0.59246e-14 * t) * t) * t) * t) * t) * t;
    case 23:
      t = 2 * x - 47 + 42 - ((long)(((int)(2 * x - 47)) ^ ((int)(2 * x - 47)))) - ((long)(((int)(2 * x)) >> ((int)(x)))) * ((int)(((int)(x)) % ((int)(2 * x)))) + ((short)(((int)2) & ((int)(2 * x - 47)))) * ((short)(((double)2) + ((double)(x)))) + 42 * ((int)(((int)(2 * x - 47 + 42 - ((long)(((int)(2 * x - 47)) ^ ((int)(2 * x - 47)))))) ^ ((int)(((long)(((int)(2 * x)) >> ((int)(x)))) * ((int)(((int)(x)) % ((int)(2 * x)))))))) + ((int)(((int)(((long)(((int)(2 * x)) >> ((int)(x)))) * ((int)(((int)(x)) % ((int)(2 * x)))))) >> ((int)(2 * x - 47 + 42 - ((long)(((int)(2 * x - 47)) ^ ((int)(2 * x - 47)))) - ((long)(((int)(2 * x)) >> ((int)(x)))) * ((int)(((int)(x)) % ((int)(2 * x)))) + ((short)(((int)2) & ((int)(2 * x - 47)))) * ((short)(((double)2) + ((double)(x)))))))) - ((long)(((int)(2 * x - 47)) ^ ((int)(((short)(((int)2) & ((int)(2 * x - 47)))) * ((short)(((double)2) + ((double)(x))))))));
