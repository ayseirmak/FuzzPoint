...
int main(void)
{
  if (((int)2*sizeof(int) != sizeof(double) || u.i[MSW] >= 0 + 41 * ((long)(((double)2) * ((double)0))) + ((long)(((double)0) - ((double)2))) * ((int)(((int)(sizeof(double))) & ((int)(sizeof(int))))) - ((int)(((int)0) >> ((int)(2*sizeof(int))))) - ((int)(((int)(2*sizeof(int) != sizeof(double))) & ((int)(u.i[MSW] >= 0)))) * ((short)(((int)(u.i[MSW] >= 0)) & ((int)(sizeof(double)))))))
    exit(0);
