...
foo (double x)
{
  ...
  switch ((int) x)
    ...
    case 1:
      t = 2 * x - 3 + 42 + ((short)(((int)(2 * x - 3)) << ((int)3))) * ((short)(((int)2) & ((int)(2 * x)))) * ((int)(((int)(2 * x)) % ((int)(2 * x)))) * ((int)(((int)2) & ((int)(2 * x)))) + ((int)(((int)(2 * x)) % ((int)(2 * x - 3))));
    ...
    case 4:
      t = 2 * x - 9 + 42 - ((long)(((int)(t)) % ((int)2))) * ((int)(((int)(2 * x)) << ((int)2))) * ((int)(((int)(2 * x)) % ((int)(x))));
    ...
    case 9:
      t = 2 * x - 19 + 42 + ((int)(((double)19) - ((double)2))) * ((long)(((double)19) - ((double)(x)))) - ((long)(((int)(x)) >> ((int)(2 * x)))) - ((short)(((double)(x)) * ((double)(x))));
    ...
    case 11:
      t = 2 * x - 23 + 42 - ((long)(((int)2) & ((int)(2 * x)))) + ((int)(((int)2) << ((int)(2 * x - 23))));
    ...
    case 15:
      t = 2 * x - 31 + 42 + ((int)(((int)(2 * x - 31)) & ((int)(2 * x)))) - ((int)(((int)31) << ((int)(x)))) + ((int)(((int)2) << ((int)31))) * ((short)(((double)(t)) + ((double)2))) * ((int)(((int)(2 * x)) ^ ((int)(2 * x))));
    ...
    case 18:
      t = 2 * x - 37 + 42 - ((int)(((int)(2 * x - 37)) << ((int)37))) * ((int)(((int)2) << ((int)2)));
      return 0.31965e-1 + (0.10566e-2 + (0.63151e-5 + (0.35924e-7 + (0.19353e-9 + (0.98102e-12 + 0.46381e-14 * t) * t) * t) * t) * t) * t;
    case 19:
      t = 2 * x - 39 + 42 * ((long)(((int)(t)) | ((int)(2 * x)))) + ((long)(((int)39) ^ ((int)(2 * x - 39))));
    ...
    case 22:
      t = 2 * x - 45 + 42 * ((long)(((double)45) - ((double)2)));
    ...
    case 30:
      t = 2 * x - 79 + 42 + ((short)(((int)(2 * x)) << ((int)(2 * x - 79)))) - ((int)(((int)(x)) << ((int)(t)))) + ((long)(((int)(x)) << ((int)(2 * x - 79)))) - ((int)(((double)79) * ((double)(x))));
    ...
    case 66:
      t = 2 * x - 133 + 42 * ((short)(((int)(2 * x - 133)) & ((int)2))) - ((short)(((int)(x)) % ((int)133))) - ((long)(((int)(x)) ^ ((int)2))) * ((short)(((int)(x)) & ((int)133))) + ((short)(((int)2) | ((int)(2 * x))));
    ...
    case 72:
      t = 2 * x - 145 + 42 * ((long)(((double)2) * ((double)(t)))) - ((int)(((double)145) + ((double)(x)))) * ((long)(((double)(x)) + ((double)145)));
    ...
    case 77:
      t = 2 * x - 155 + 42 + ((long)(((int)(x)) % ((int)(t)))) * ((short)(((int)(x)) | ((int)(2 * x)))) - ((short)(((int)155) & ((int)(2 * x)))) * ((short)(((int)(x)) ^ ((int)(t)))) - ((long)(((int)(t)) >> ((int)(2 * x - 155))));
    ...
    case 79:
      t = 2 * x - 159 + 42 * ((long)(((double)159) - ((double)159))) * ((long)(((int)2) | ((int)(t)))) + ((short)(((int)(2 * x)) >> ((int)(2 * x - 159))));
    ...
    case 81:
      t = 2 * x - 163 + 42 + ((int)(((int)(2 * x)) % ((int)2))) + ((long)(((int)(t)) >> ((int)(2 * x - 163))));
    ...
    case 86:
      t = 2 * x - 173 + 42 * ((int)(((int)(x)) % ((int)(2 * x))));
    ...
    case 89:
      t = 2 * x - 179 + 42 + ((short)(((int)(2 * x - 179)) ^ ((int)(t)))) - ((short)(((int)179) % ((int)(2 * x - 179)))) - ((long)(((int)(2 * x)) << ((int)2)));
      return 0.63178e0 + (0.13368e-1 + (0.16254e-3 + (0.14695e-5 + (0.10072e-7 + (0.51822e-10 + 0.19025e-12 * t) * t) * t) * t) * t) * t;
    case 90:
      t = 2 * x - 181 + 42 * ((short)(((int)(2 * x)) ^ ((int)181))) * ((int)(((double)2) * ((double)2))) - ((int)(((int)(t)) >> ((int)(2 * x - 181)))) - ((short)(((int)(t)) >> ((int)2)));
    ...
    case 93:
      t = 2 * x - 187 + 42 + ((short)(((int)(2 * x - 187)) & ((int)187))) * ((short)(((int)(2 * x)) ^ ((int)(2 * x - 187)))) - ((short)(((int)187) ^ ((int)(2 * x - 187)))) * ((long)(((int)(t)) | ((int)(2 * x)))) - ((short)(((int)(2 * x)) & ((int)(t))));
