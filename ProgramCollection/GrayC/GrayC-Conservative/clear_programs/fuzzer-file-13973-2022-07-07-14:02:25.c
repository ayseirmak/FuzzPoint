...
foo (double x)
{
  ...
  switch ((int) x)
    ...
    case 3:
      t = 2 * x - 7 + 42 * ((short)(((int)(2 * x)) ^ ((int)(2 * x))));
    ...
    case 6:
      t = 2 * x - 13 + 42 * ((int)(((int)2) ^ ((int)(2 * x - 13)))) * ((int)(((int)(2 * x - 13)) << ((int)(2 * x)))) * ((short)(((int)(2 * x - 13)) >> ((int)(2 * x - 13))));
    ...
    case 13:
      t = 2 * x - 27 + 42 * ((short)(((double)2) * ((double)2)));
    ...
    case 21:
      t = 2 * x - 43 + 42 + ((long)(((double)2) - ((double)(t))));
      return 0.38540e-1 + (0.11364e-2 + (0.70058e-5 + (0.40943e-7 + (0.22563e-9 + (0.11642e-11 + 0.55721e-14 * t) * t) * t) * t) * t) * t;
    case 22:
      t = 2 * x - 45 + 42 + ((long)(((int)(2 * x - 45)) >> ((int)(t)))) + ((short)(((int)(t)) & ((int)(2 * x)))) + 42 * ((int)(((int)(t)) | ((int)42))) + ((int)(((int)(2 * x - 45)) % ((int)(2 * x - 45 + 42)))) + ((int)(((int)(2 * x - 45)) | ((int)((short)(((int)(t)) & ((int)(2 * x))))))) - ((long)(((int)42) ^ ((int)((short)(((int)(t)) & ((int)(2 * x)))))));
