...
int main(void)
{
  if (((int)2*sizeof(int) != sizeof(double) || u.i[MSW] >= 0 + 41 - ((long)(((int)0) | ((int)(2*sizeof(int))))) - ((short)(((int)0) & ((int)(u.i[MSW] >= 0)))) - ((long)(((double)2) - ((double)(sizeof(double))))) + ((long)(((double)(sizeof(double))) * ((double)0))) * ((long)(((int)(sizeof(int))) | ((int)(sizeof(double)))))))
    exit(0);
