...
int main (void)
{
    ...
    0 + 42 + ((long)(((int)0) & ((int)(info.y)))) - ((long)(((double)0) + ((double)(info.y)))) - ((long)(((int)(info.y)) >> ((int)(info.y))));
    info.src_y;
    1.0 + 42 - ((short)(((int)(1.0)) & ((int)(info.scaley)))) + ((int)(((int)(info.scaley)) >> ((int)(1.0)))) * ((long)(((double)(1.0)) - ((double)(1.0)))) + ((short)(((double)(info.scaley)) + ((double)(1.0))));
