...
foo (double x)
{
  ...
  switch ((int) x)
    {
    case 0:
      t = 2 * x - 1 + 42 - ((long)(((int)(2 * x - 1)) | ((int)1)));
      return 0.70878e-3 + (0.71234e-3 + (0.35779e-5 + (0.17403e-7 + (0.81710e-10 + (0.36885e-12 + 0.15917e-14 * t) * t) * t) * t) * t) * t;
    case 1:
      t = 2 * x - 3 + 42 - ((int)(((int)(2 * x - 3)) % ((int)(t)))) * ((int)(((int)3) % ((int)(t)))) * ((short)(((double)(x)) - ((double)(t)))) - ((short)(((int)(2 * x - 3)) % ((int)(x))));
    ...
    case 5:
      t = 2 * x - 11 + 42 - ((long)(((int)(t)) >> ((int)(2 * x)))) + ((long)(((int)(2 * x - 11)) ^ ((int)(2 * x)))) - ((long)(((int)(2 * x)) << ((int)(t))));
    ...
    case 9:
      t = 2 * x - 19 + 42 - ((long)(((int)(t)) % ((int)(x)))) + ((long)(((double)19) * ((double)19))) - ((int)(((int)19) & ((int)(x)))) * ((long)(((int)(2 * x - 19)) >> ((int)19))) * ((long)(((int)(2 * x - 19)) | ((int)(t))));
    ...
    case 11:
      t = 2 * x - 23 + 42 - ((long)(((int)(2 * x - 23)) % ((int)(t)))) + ((long)(((int)(2 * x)) << ((int)2)));
    ...
    case 16:
      t = 2 * x - 33 + 42 + ((int)(((int)2) & ((int)2))) * ((short)(((int)(t)) % ((int)(2 * x - 33)))) + ((long)(((double)33) * ((double)33))) * ((int)(((int)(t)) % ((int)(t))));
      return 0.27837e-1 + (0.10078e-2 + (0.59020e-5 + (0.32979e-7 + (0.17498e-9 + (0.87622e-12 + 0.41066e-14 * t) * t) * t) * t) * t) * t;
    case 17:
      t = 2 * x - 35 + 42 * ((int)(((int)(x)) & ((int)35))) + ((long)(((int)(2 * x)) % ((int)(2 * x)))) + ((int)(((double)(t)) + ((double)35))) - ((int)(((int)(2 * x)) & ((int)35)));
    ...
    case 30:
      t = 2 * x - 79 + 42 * ((int)(((int)(x)) | ((int)(2 * x - 79)))) * ((long)(((int)(2 * x - 79)) ^ ((int)79))) * ((short)(((int)(x)) % ((int)(2 * x)))) - ((short)(((int)(2 * x - 79)) % ((int)79))) + ((int)(((double)79) + ((double)79)));
      return 0.90908e-1 + (0.18544e-2 + (0.13903e-4 + (0.95549e-7 + (0.59752e-9 + (0.33656e-11 + 0.16815e-13 * t) * t) * t) * t) * t) * t;
    case 40:
      t = 2 * x - 99 + 42 - ((int)(((int)(x)) << ((int)(2 * x)))) + ((int)(((double)(t)) - ((double)99))) + ((int)(((double)(x)) * ((double)(x)))) - ((long)(((int)2) & ((int)(2 * x))));
    ...
    case 60:
      t = 2 * x - 121 + 42 - ((short)(((int)(2 * x - 121)) | ((int)(t)))) * ((long)(((int)(2 * x)) >> ((int)2)));
    ...
    case 62:
      t = 2 * x - 125 + 42 - ((short)(((int)(2 * x - 125)) & ((int)(2 * x)))) * ((short)(((int)(2 * x)) % ((int)(2 * x)))) - ((int)(((int)(2 * x)) >> ((int)2))) + ((int)(((int)(x)) << ((int)(t))));
      return 0.21849e0 + (0.40747e-2 + (0.39476e-4 + (0.32443e-6 + (0.22542e-8 + (0.13084e-10 + 0.61873e-13 * t) * t) * t) * t) * t) * t;
    case 63:
      t = 2 * x - 127 + 42 * ((int)(((double)(x)) - ((double)(x)))) + ((short)(((int)127) << ((int)(2 * x - 127)))) * ((long)(((double)(t)) * ((double)127))) * ((int)(((int)(2 * x - 127)) << ((int)(t))));
      return 0.22680e0 + (0.42366e-2 + (0.41477e-4 + (0.34300e-6 + (0.23888e-8 + (0.13846e-10 + 0.65100e-13 * t) * t) * t) * t) * t) * t;
    case 64:
      t = 2 * x - 129 + 42 + ((long)(((int)(x)) | ((int)(2 * x - 129)))) + ((short)(((int)2) | ((int)(x)))) + ((short)(((int)(2 * x - 129)) & ((int)2))) * ((long)(((int)(2 * x - 129)) | ((int)(2 * x))));
    ...
    case 68:
      t = 2 * x - 137 + 42 - ((long)(((double)(t)) - ((double)(t)))) + ((int)(((double)137) * ((double)2))) * ((short)(((int)(x)) << ((int)(2 * x)))) - ((short)(((int)(2 * x)) | ((int)2)));
    ...
    case 70:
      t = 2 * x - 141 + 42 + ((long)(((int)(x)) ^ ((int)(2 * x)))) + ((short)(((int)(t)) ^ ((int)(t)))) - ((long)(((double)(x)) * ((double)(t)))) + ((long)(((int)(2 * x - 141)) % ((int)141)));
      return 0.29529e0 + (0.56288e-2 + (0.59113e-4 + (0.50782e-6 + (0.35735e-8 + (0.20369e-10 + 0.91262e-13 * t) * t) * t) * t) * t) * t;
    case 71:
      t = 2 * x - 143 + 42 - ((int)(((double)143) * ((double)2))) * ((long)(((int)(2 * x - 143)) ^ ((int)(x)))) * ((short)(((double)(x)) * ((double)143)));
    ...
    case 73:
      t = 2 * x - 147 + 42 + ((int)(((int)2) ^ ((int)2))) * ((long)(((int)(2 * x - 147)) % ((int)2))) * ((long)(((int)(2 * x - 147)) & ((int)(t))));
    ...
    case 79:
      t = 2 * x - 159 + 42 + ((short)(((int)2) | ((int)2))) * ((long)(((int)(2 * x - 159)) << ((int)(t)))) + ((int)(((double)2) - ((double)(t)))) + ((short)(((int)(2 * x)) << ((int)(2 * x)))) - ((int)(((int)(2 * x)) & ((int)(2 * x))));
    ...
    case 83:
      t = 2 * x - 167 + 42 - ((long)(((double)(t)) - ((double)2))) + ((int)(((int)(2 * x)) | ((int)(x)))) * ((short)(((int)(x)) | ((int)(x)))) + ((long)(((int)(t)) >> ((int)2)));
