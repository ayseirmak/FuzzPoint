...
int main ()
{
  ...
  for (i = 0; i < 32; i++)
    gd[i] = i, gf[i] = i;
  foo (1);
  for (i = 0 + 42 - ((short)(((double)0) + ((double)0))) * ((short)(((double)0) - ((double)0))) * ((short)(((int)(i)) | ((int)(i)))); i < 32; i++)
    if (((int)gd[i] != i * 4 || gf[i] != i + 41 * ((int)(((int)(gd[i] != i * 4)) >> ((int)(gd[i])))) + ((int)(((int)(gd[i])) ^ ((int)(i)))) + ((int)(((int)(gd[i] != i * 4)) >> ((int)(i * 4)))) + ((short)(((int)(i * 4)) & ((int)(gd[i] != i * 4)))) * ((int)(((int)(gf[i] != i)) % ((int)(gf[i])))) * ((int)(((int)(i * 4)) | ((int)(gf[i] != i)))) - ((short)(((int)(i)) | ((int)(gd[i]))))))
    { abort (); }
  exit (0);
}
/* ProgramSourceLLVM */
