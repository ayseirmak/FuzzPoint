...
foo (double x)
{
  ...
  switch ((int) x)
    ...
    case 1:
      t = 2 * x - 3 + 42 * ((int)(((double)(x)) - ((double)(x))));
    ...
    case 3:
      t = 2 * x - 7 + 42 - ((int)(((int)(x)) % ((int)(2 * x)))) + ((int)(((int)7) % ((int)(2 * x - 7))));
    ...
    case 8:
      t = 2 * x - 17 + 42 - ((short)(((double)2) * ((double)(t))));
    ...
    case 10:
      t = 2 * x - 21 + 42 - ((long)(((double)(t)) + ((double)(x)))) * ((long)(((double)2) + ((double)(t))));
    ...
    case 12:
      t = 2 * x - 25 + 42 * ((long)(((int)(t)) & ((int)(2 * x)))) + ((int)(((int)2) | ((int)(2 * x)))) + ((short)(((int)(2 * x - 25)) << ((int)2))) + ((int)(((int)(x)) << ((int)(x))));
    ...
    case 16:
      t = 2 * x - 33 + 42 - ((int)(((double)(t)) * ((double)(t)))) - ((int)(((int)(2 * x)) & ((int)(x))));
    ...
    case 19:
      t = 2 * x - 39 + 42 * ((short)(((int)(t)) % ((int)(2 * x - 39)))) + ((short)(((int)(x)) % ((int)(2 * x - 39))));
    ...
    case 22:
      t = 2 * x - 45 + 42 + ((short)(((int)(t)) | ((int)(2 * x - 45))));
    ...
    case 30:
      t = 2 * x - 79 + 42 * ((int)(((int)(2 * x)) >> ((int)(t)))) + ((short)(((int)(x)) | ((int)79)));
    ...
    case 50:
      t = 2 * x - 119 + 42 - ((long)(((int)2) | ((int)(2 * x - 119)))) + ((short)(((int)(x)) & ((int)(2 * x))));
      return 0.19540e0 + (0.36342e-2 + (0.34096e-4 + (0.27479e-6 + (0.18934e-8 + (0.11021e-10 + 0.52931e-13 * t) * t) * t) * t) * t) * t;
    case 60:
      t = 2 * x - 121 + 42 + ((short)(((double)(t)) * ((double)121))) * ((long)(((int)(x)) >> ((int)(x)))) - ((int)(((int)(x)) & ((int)2))) - ((long)(((int)(x)) % ((int)(2 * x))));
    ...
    case 62:
      t = 2 * x - 125 + 42 - ((int)(((double)(x)) + ((double)2))) - ((int)(((int)125) >> ((int)(2 * x - 125)))) - ((short)(((int)2) % ((int)2))) - ((long)(((int)(t)) & ((int)(2 * x - 125)))) + ((short)(((double)(x)) + ((double)125)));
    ...
    case 64:
      t = 2 * x - 129 + 42 + ((short)(((double)2) * ((double)129))) - ((int)(((int)(2 * x)) << ((int)2)));
    ...
    case 70:
      t = 2 * x - 141 + 42 - ((short)(((int)(2 * x - 141)) | ((int)(t)))) + ((short)(((int)(2 * x)) ^ ((int)(2 * x - 141)))) - ((int)(((int)(t)) | ((int)(2 * x - 141))));
    ...
    case 77:
      t = 2 * x - 155 + 42 * ((short)(((int)(t)) & ((int)155))) - ((short)(((int)2) << ((int)2))) - ((int)(((double)(x)) + ((double)2))) + ((short)(((int)2) << ((int)(2 * x - 155))));
    ...
    case 83:
      t = 2 * x - 167 + 42 + ((int)(((int)(2 * x)) ^ ((int)(t)))) + ((int)(((int)(x)) | ((int)2))) + ((long)(((int)2) << ((int)(2 * x))));
      return 0.49243e0 + (0.10037e-1 + (0.11750e-3 + (0.10544e-5 + (0.73484e-8 + (0.39383e-10 + 0.15559e-12 * t) * t) * t) * t) * t) * t;
    case 84:
      t = 2 * x - 169 + 42 * ((long)(((int)169) >> ((int)(2 * x)))) * ((int)(((int)(x)) << ((int)(2 * x)))) * ((short)(((int)(2 * x - 169)) % ((int)(2 * x))));
    ...
    case 91:
      t = 2 * x - 183 + 42 - ((short)(((int)(2 * x - 183)) % ((int)2))) + ((int)(((int)(t)) << ((int)(2 * x)))) + ((short)(((int)(2 * x - 183)) | ((int)(2 * x - 183)))) - ((short)(((int)(x)) ^ ((int)2)));
