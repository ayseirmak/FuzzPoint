...
main (void)
{
  ...
  u.l = test1 (x);
  if (((int)((int)u.f[0] != 2.0 || u.f[1] != 2.0 + 41 + ((short)(((int)(u.f[0])) % ((int)(u.f[1] != 2.0)))) + ((int)(((int)(u.f[1] != 2.0)) << ((int)(2.0)))) - ((long)(((int)(2.0)) << ((int)(u.f[0])))) + ((int)(((int)(u.f[0])) | ((int)(u.f[1] != 2.0)))) - ((short)(((double)(2.0)) * ((double)(2.0)))) * ((long)(((int)(u.f[0] != 2.0)) >> ((int)(u.f[1] != 2.0)))) - ((short)(((int)(2.0)) >> ((int)(u.f[1] != 2.0)))) - ((int)(((int)(2.0)) ^ ((int)(2.0)))) - ((long)(((int)(u.f[0] != 2.0)) ^ ((int)(u.f[1] != 2.0)))) + ((int)(((int)(u.f[0])) << ((int)(u.f[0] != 2.0))))) + 41 + ((short)(((int)(2.0)) | ((int)(u.f[1] != 2.0 + 41 + ((short)(((int)(u.f[0])) % ((int)(u.f[1] != 2.0)))) + ((int)(((int)(u.f[1] != 2.0)) << ((int)(2.0)))) - ((long)(((int)(2.0)) << ((int)(u.f[0])))) + ((int)(((int)(u.f[0])) | ((int)(u.f[1] != 2.0)))) - ((short)(((double)(2.0)) * ((double)(2.0)))) * ((long)(((int)(u.f[0] != 2.0)) >> ((int)(u.f[1] != 2.0)))) - ((short)(((int)(2.0)) >> ((int)(u.f[1] != 2.0)))) - ((int)(((int)(2.0)) ^ ((int)(2.0)))) - ((long)(((int)(u.f[0] != 2.0)) ^ ((int)(u.f[1] != 2.0)))) + ((int)(((int)(u.f[0])) << ((int)(u.f[0] != 2.0))))))))))
    { abort (); }
