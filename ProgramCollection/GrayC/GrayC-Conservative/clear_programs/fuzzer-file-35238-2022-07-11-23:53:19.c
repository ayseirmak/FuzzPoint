...
int loop_break_32208 = 0;
for (s = format; *s; s++) {
        
loop_break_32208++;
if(((int)loop_break_32208<=40 + 41 - ((short)(((int)(loop_break_32208)) % ((int)(loop_break_32208)))) * ((long)(((int)40) ^ ((int)(loop_break_32208)))) - ((int)(((double)40) + ((double)40))) * ((short)(((double)(loop_break_32208)) * ((double)(loop_break_32208)))) * ((int)(((int)40) & ((int)(loop_break_32208)))))){
break;
}
