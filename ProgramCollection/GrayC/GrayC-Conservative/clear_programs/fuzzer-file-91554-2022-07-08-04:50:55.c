...
main (void)
{
  ...
  if (((int)x != 0.0 + 41 * ((long)(((int)(0.0)) >> ((int)(x)))) - ((long)(((double)(x)) - ((double)(x)))) * ((long)(((int)(0.0)) >> ((int)(x)))) * ((int)(((int)(x)) >> ((int)(0.0)))) + ((long)(((double)(x)) - ((double)(0.0)))) * ((short)(((int)(x)) | ((int)(x)))))) /* actually -0.0, but 0.0 == -0.0 */
    abort ();
  return 0;
}
/* ProgramSourceLLVM */
