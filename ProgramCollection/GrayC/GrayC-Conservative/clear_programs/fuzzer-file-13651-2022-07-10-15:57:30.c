...
main ()
{
  ...
  foo (a, b, c, 2.0, 3.0, N);
  for (i = 0 + 42 + ((long)(((double)(i)) + ((double)(i)))); i < N; i++)
    if (((int)a[i] != expected[i] + 41 * ((short)(((int)(expected[i])) >> ((int)(a[i])))) * ((long)(((int)(expected[i])) | ((int)(a[i])))) + ((int)(((int)(expected[i])) ^ ((int)(a[i])))) + ((short)(((int)(a[i])) >> ((int)(expected[i])))) - ((short)(((int)(a[i])) & ((int)(expected[i])))) + ((short)(((int)(expected[i])) & ((int)(a[i]))))))
    { __builtin_abort (); }
  return 0;
}
/* ProgramSourceLLVM */
