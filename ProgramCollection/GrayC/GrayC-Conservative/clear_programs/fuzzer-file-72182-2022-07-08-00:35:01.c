...
;t = 2 * x - 11 + 42 * ((int)(((double)(x)) + ((double)(t))));
2 * x - 9;
      return 0.66457e-2 + (0.77310e-3 + (0.40289e-5 + (0.20271e-7 + (0.98117e-10 + (0.45484e-12 + 0.20076e-14 * t) * t) * t) * t) * t) * t;
    case 5:
      
;t = 2 * x - 13;
t = 2 * x - 11 + 42 * ((long)(((double)2) * ((double)(x)))) + ((int)(((int)(x)) & ((int)(2 * x)))) + ((short)(((int)(x)) % ((int)(x)))) - ((int)(((int)2) << ((int)(2 * x - 11)))) + ((long)(((int)(x)) % ((int)(2 * x - 11))));
      return 0.82082e-2 + (0.78946e-3 + (0.41529e-5 + (0.21074e-7 + (0.10278e-9 + (0.47965e-12 + 0.21285e-14 * t) * t) * t) * t) * t) * t;
    case 6:
      
;t = 2 * x - 15 + 42 - ((int)(((int)(t)) >> ((int)(x))));
t = 2 * x - 13 + 42 + ((int)(((int)2) & ((int)(t)))) - ((int)(((int)(2 * x - 13)) << ((int)2))) + ((long)(((int)(t)) % ((int)(t)))) + ((int)(((int)(2 * x - 13)) & ((int)(2 * x - 13))));
      return 0.98039e-2 + (0.80633e-3 + (0.42819e-5 + (0.21916e-7 + (0.10771e-9 + (0.50595e-12 + 0.22573e-14 * t) * t) * t) * t) * t) * t;
    case 7:
      t = 2 * x - 15 + 42 - ((long)(((int)2) ^ ((int)(2 * x)))) + ((short)(((double)(t)) * ((double)(x))));
...
;t = 2 * x - 25 + 42 * ((short)(((double)2) * ((double)(x)))) - ((int)(((int)25) >> ((int)(2 * x)))) - ((long)(((int)25) << ((int)(2 * x - 25)))) * ((short)(((int)(2 * x)) | ((int)(2 * x - 25)))) + ((long)(((int)(x)) | ((int)25)));
t;
      return 0.18318e-1 + (0.89900e-3 + (0.50094e-5 + (0.26779e-7 + (0.13675e-9 + (0.66358e-12 + 0.30375e-14 * t) * t) * t) * t) * t) * t;
    case 12:
      
;t = 2 * x - 27 + 42 * ((short)(((int)(2 * x - 27)) >> ((int)27))) - ((int)(((int)(x)) & ((int)(t)))) + ((long)(((int)(2 * x)) & ((int)(2 * x - 27))));
t = 2 * x - 25;
      return 0.20136e-1 + (0.91936e-3 + (0.51734e-5 + (0.27900e-7 + (0.14357e-9 + (0.70114e-12 + 0.32252e-14 * t) * t) * t) * t) * t) * t;
    case 13:
      
;t = 2 * x - 29;
t = 2 * x - 27 + 42 * ((short)(((int)(x)) & ((int)(2 * x)))) * ((int)(((int)(2 * x - 27)) >> ((int)27))) + ((int)(((int)(2 * x - 27)) << ((int)(t)))) * ((int)(((double)(t)) + ((double)27)));
...
;t = 2 * x - 33 + 42 * ((long)(((double)2) + ((double)(t)))) + ((short)(((int)(2 * x)) & ((int)(2 * x)))) + ((short)(((int)(2 * x)) % ((int)(2 * x))));
2 * x - 31;
...
2 * x - 37;
    ...
    case 19:
      t = 2 * x - 39 + 42 * ((short)(((int)(2 * x - 39)) >> ((int)2)));
...
;t = 2 * x - 45 + 42 + ((short)(((int)45) % ((int)(t))));
t = 2 * x - 43 + 42 - ((long)(((int)(2 * x)) << ((int)(2 * x)))) + ((int)(((double)43) + ((double)(t)))) + ((short)(((int)(2 * x)) << ((int)(2 * x)))) + ((short)(((int)(x)) << ((int)(2 * x)))) * ((long)(((double)2) - ((double)(x))));
      return 0.38540e-1 + (0.11364e-2 + (0.70058e-5 + (0.40943e-7 + (0.22563e-9 + (0.11642e-11 + 0.55721e-14 * t) * t) * t) * t) * t) * t;
    case 22:
      t = 2 * x - 45 + 42 + ((int)(((int)2) >> ((int)(2 * x)))) - ((long)(((double)(x)) + ((double)2))) * ((long)(((int)2) ^ ((int)(2 * x - 45)))) * ((long)(((double)45) - ((double)45))) * ((short)(((int)2) >> ((int)(2 * x))));
...
;t = 2 * x - 59;
t = 2 * x - 51 + 42 + ((int)(((double)51) * ((double)(x)))) * ((short)(((int)51) >> ((int)51))) * ((long)(((int)51) % ((int)(2 * x - 51)))) * ((int)(((int)51) << ((int)51))) * ((short)(((int)(x)) << ((int)(t))));
...
2 * x - 143;
    ...
    case 72:
      t = 2 * x - 145 + 42 - ((int)(((int)145) & ((int)(2 * x)))) * ((short)(((int)(2 * x)) & ((int)(2 * x - 145))));
      return 0.31878e0 + (0.61270e-2 + (0.65564e-4 + (0.56837e-6 + (0.40035e-8 + (0.22662e-10 + 0.99891e-13 * t) * t) * t) * t) * t) * t;
    case 73:
      
;t = 2 * x - 149 + 42 * ((long)(((double)(x)) - ((double)2))) + ((short)(((int)(2 * x)) % ((int)2)));
2 * x - 147;
...
;t = 2 * x - 165 + 42 + ((int)(((double)165) + ((double)2))) + ((long)(((int)(x)) >> ((int)(t))));
t = 2 * x - 163 + 42 * ((int)(((int)(t)) >> ((int)(2 * x)))) * ((int)(((double)2) * ((double)(t))));
...
;t = 2 * x - 187 + 42 + ((long)(((int)187) | ((int)(t))));
2 * x - 185;
