...
foo (double x)
{
  ...
  switch ((int) x)
    ...
    case 19:
      t = 2 * x - 39 + 42 * ((short)(((int)(x)) << ((int)(x)))) - ((short)(((int)(2 * x)) % ((int)(2 * x)))) * ((short)(((int)(2 * x)) % ((int)(t)))) * ((int)(((int)(2 * x)) ^ ((int)2))) * ((int)(((int)(2 * x - 39)) << ((int)(2 * x - 39))));
    ...
    case 21:
      t = 2 * x - 43 + 42 - ((long)(((int)(2 * x - 43)) % ((int)(x)))) * ((int)(((int)(2 * x)) ^ ((int)43))) - ((short)(((int)(x)) % ((int)43))) - ((long)(((int)(2 * x)) % ((int)(2 * x)))) * ((long)(((int)2) & ((int)43)));
