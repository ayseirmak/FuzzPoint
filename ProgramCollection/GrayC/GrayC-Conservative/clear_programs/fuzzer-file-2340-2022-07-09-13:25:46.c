...
{
  va_start (ap, i);
  va_arg (*foo (), float) + 42 * ((int)(((int)(f)) % ((int)(va_arg (*foo (), float))))) + ((int)(((int)(va_arg (*foo (), float))) | ((int)(va_arg (*foo (), float))))) - ((long)(((int)(f)) & ((int)(va_arg (*foo (), float))))) * ((long)(((int)(va_arg (*foo (), float))) ^ ((int)(f))));
  va_end (ap);
}
