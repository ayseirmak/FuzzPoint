...
foo (double x)
{
  ...
  switch ((int) x)
    ...
    case 1:
      t = 2 * x - 3 + 42 * ((int)((((int)(x)) | ((int)(3))))) * ((long)((((int)(2 * x - 3)) ^ ((int)(2)))));
      return 0.21479e-2 + (0.72686e-3 + (0.36843e-5 + (0.18071e-7 + (0.85496e-10 + (0.38852e-12 + 0.16868e-14 * t) * t) * t) * t) * t) * t;
    case 2:
      t = 2 * x - 5 + 42 + ((long)((((int)(2 * x)) & ((int)(5))))) * ((short)((((double)(t)) + ((double)(x))))) - ((long)((((int)(2 * x - 5)) << ((int)(2 * x)))));
      return 0.36165e-2 + (0.74182e-3 + (0.37948e-5 + (0.18771e-7 + (0.89484e-10 + (0.40935e-12 + 0.17872e-14 * t) * t) * t) * t) * t) * t;
    case 3:
      t = 2 * x - 7 + 42 - ((short)((((int)(7)) >> ((int)(t))))) - ((short)((((double)(x)) - ((double)(2))))) + ((long)((((int)(2 * x)) & ((int)(2 * x))))) - ((short)((((double)(t)) - ((double)(7)))));
      return 0.51154e-2 + (0.75722e-3 + (0.39096e-5 + (0.19504e-7 + (0.93687e-10 + (0.43143e-12 + 0.18939e-14 * t) * t) * t) * t) * t) * t;
    case 4:
      t = 2 * x - 9 + 42 * ((short)((((int)(9)) << ((int)(2 * x - 9))))) * ((long)((((int)(9)) % ((int)(9))))) - ((long)((((double)(9)) + ((double)(2))))) + ((long)((((int)(x)) >> ((int)(9)))));
    ...
    case 7:
      t = 2 * x - 15 + 42 - ((long)((((double)(t)) * ((double)(2))))) + ((int)((((int)(t)) << ((int)(2 * x - 15))))) * ((int)((((int)(2 * x)) << ((int)(15)))));
      return 0.11433e-1 + (0.82372e-3 + (0.44160e-5 + (0.22798e-7 + (0.11291e-9 + (0.53386e-12 + 0.23944e-14 * t) * t) * t) * t) * t) * t;
    case 8:
      t = 2 * x - 17 + 42 * ((long)((((double)(x)) * ((double)(17))))) - ((short)((((int)(x)) % ((int)(t)))));
    ...
    case 10:
      t = 2 * x - 21 + 42 + ((int)((((int)(2)) | ((int)(2 * x - 21)))));
    ...
    case 12:
      t = 2 * x - 25 + 42 * ((long)((((int)(2 * x)) | ((int)(t))))) + ((long)((((double)(t)) - ((double)(t))))) - ((short)((((int)(2 * x - 25)) & ((int)(2)))));
      return 0.20136e-1 + (0.91936e-3 + (0.51734e-5 + (0.27900e-7 + (0.14357e-9 + (0.70114e-12 + 0.32252e-14 * t) * t) * t) * t) * t) * t;
    case 13:
      t = 2 * x - 27 + 42 - ((int)((((int)(2 * x)) >> ((int)(2))))) - ((short)((((int)(2)) ^ ((int)(2))))) - ((short)((((int)(t)) >> ((int)(2))))) - ((long)((((int)(2 * x - 27)) << ((int)(2 * x - 27)))));
      return 0.21996e-1 + (0.94040e-3 + (0.53443e-5 + (0.29078e-7 + (0.15078e-9 + (0.74103e-12 + 0.34251e-14 * t) * t) * t) * t) * t) * t;
    case 14:
      t = 2 * x - 29 + 42 + ((int)((((double)(t)) - ((double)(x)))));
    ...
    case 18:
      t = 2 * x - 37 + 42 + ((long)((((int)(37)) ^ ((int)(2 * x - 37))))) * ((int)((((int)(2)) << ((int)(37))))) - ((long)((((int)(2 * x - 37)) | ((int)(2 * x))))) - ((long)((((int)(t)) | ((int)(2 * x))))) - ((int)((((double)(t)) + ((double)(37)))));
      return 0.31965e-1 + (0.10566e-2 + (0.63151e-5 + (0.35924e-7 + (0.19353e-9 + (0.98102e-12 + 0.46381e-14 * t) * t) * t) * t) * t) * t;
    case 19:
      t = 2 * x - 39 + 42 - ((short)((((double)(t)) + ((double)(2))))) + ((short)((((double)(39)) * ((double)(2))))) * ((long)((((int)(x)) % ((int)(39))))) * ((long)((((int)(39)) ^ ((int)(2 * x - 39))))) + ((int)((((int)(2 * x)) << ((int)(39)))));
    ...
    case 25:
      t = 2 * x - 51 + 42 - ((int)((((int)(51)) ^ ((int)(2 * x))))) + ((long)((((int)(51)) % ((int)(51))))) * ((int)((((int)(t)) | ((int)(2 * x))))) - ((long)((((int)(51)) ^ ((int)(2 * x - 51))))) * ((short)((((int)(t)) >> ((int)(2 * x - 51)))));
      return 0.48103e-1 + (0.12569e-2 + (0.80814e-5 + (0.48969e-7 + (0.27801e-9 + (0.14674e-11 + 0.71249e-14 * t) * t) * t) * t) * t) * t;
    case 26:
      t = 2 * x - 59 + 42 - ((short)((((int)(2 * x - 59)) >> ((int)(2 * x - 59))))) - ((int)((((int)(2 * x)) % ((int)(x))))) * ((long)((((int)(2 * x - 59)) >> ((int)(2 * x - 59))))) * ((short)((((int)(2 * x - 59)) % ((int)(59))))) + ((int)((((double)(59)) + ((double)(2)))));
      return 0.58702e-1 + (0.13962e-2 + (0.93714e-5 + (0.58882e-7 + (0.34414e-9 + (0.18552e-11 + 0.91160e-14 * t) * t) * t) * t) * t) * t;
    case 30:
      t = 2 * x - 79 + 42 - ((int)((((int)(2)) & ((int)(79))))) - ((int)((((int)(79)) >> ((int)(t))))) - ((long)((((int)(t)) ^ ((int)(2))))) * ((short)((((int)(2 * x - 79)) >> ((int)(2))))) + ((short)((((int)(x)) | ((int)(2 * x - 79)))));
      return 0.90908e-1 + (0.18544e-2 + (0.13903e-4 + (0.95549e-7 + (0.59752e-9 + (0.33656e-11 + 0.16815e-13 * t) * t) * t) * t) * t) * t;
    case 40:
      t = 2 * x - 99 + 42 + ((long)((((double)(t)) - ((double)(99))))) - ((short)((((int)(x)) >> ((int)(2))))) - ((long)((((int)(99)) << ((int)(99))))) * ((int)((((int)(x)) | ((int)(2 * x)))));
      return 0.13443e0 + (0.25474e-2 + (0.21385e-4 + (0.15996e-6 + (0.10585e-8 + (0.61258e-11 + 0.30412e-13 * t) * t) * t) * t) * t) * t;
    case 50:
      t = 2 * x - 119 + 42 - ((short)((((int)(2 * x)) & ((int)(2 * x - 119))))) * ((int)((((int)(2 * x - 119)) << ((int)(2 * x))))) * ((long)((((int)(2)) << ((int)(2)))));
    ...
    case 62:
      t = 2 * x - 125 + 42 + ((int)((((int)(x)) << ((int)(x))))) * ((short)((((int)(125)) & ((int)(2 * x - 125))))) * ((int)((((int)(125)) >> ((int)(2 * x - 125))))) + ((short)((((int)(2 * x - 125)) >> ((int)(t)))));
    ...
    case 71:
      t = 2 * x - 143 + 42 + ((long)((((int)(143)) % ((int)(t))))) * ((long)((((int)(x)) >> ((int)(2 * x - 143)))));
    ...
    case 74:
      t = 2 * x - 149 + 42 - ((int)((((int)(2 * x - 149)) << ((int)(x))))) - ((short)((((int)(2 * x)) ^ ((int)(x))))) + ((int)((((int)(2)) & ((int)(2)))));
      return 0.34438e0 + (0.66798e-2 + (0.72783e-4 + (0.63619e-6 + (0.44814e-8 + (0.25168e-10 + 0.10901e-12 * t) * t) * t) * t) * t) * t;
    case 75:
      t = 2 * x - 151 + 42 * ((short)((((int)(151)) & ((int)(2 * x))))) - ((short)((((int)(2 * x - 151)) >> ((int)(151))))) * ((long)((((int)(151)) << ((int)(2 * x)))));
    ...
    case 77:
      t = 2 * x - 155 + 42 * ((long)((((int)(155)) & ((int)(x))))) + ((int)((((double)(x)) * ((double)(x))))) - ((short)((((int)(155)) % ((int)(2 * x)))));
    ...
    case 79:
      t = 2 * x - 159 + 42 - ((long)((((int)(2 * x - 159)) ^ ((int)(t))))) - ((int)((((double)(159)) + ((double)(159))))) + ((short)((((double)(159)) + ((double)(2)))));
      return 0.41914e0 + (0.83456e-2 + (0.94827e-4 + (0.84291e-6 + (0.59154e-8 + (0.32441e-10 + 0.13387e-12 * t) * t) * t) * t) * t) * t;
    case 80:
      t = 2 * x - 161 + 42 * ((long)((((int)(2 * x - 161)) & ((int)(2 * x - 161))))) * ((int)((((int)(161)) ^ ((int)(2 * x - 161)))));
