...
foo (double x)
{
  ...
  switch ((int) x)
    ...
    case 20:
      t = 2 * x - 41 + 42 + ((int)((((int)(t)) | ((int)(2 * x - 41)))));
      return 0.36295e-1 + (0.11089e-2 + (0.67654e-5 + (0.39184e-7 + (0.21431e-9 + (0.10994e-11 + 0.52409e-14 * t) * t) * t) * t) * t) * t;
    case 21:
      t = 2 * x - 43 + 42 + ((long)((((double)(x)) + ((double)(t))))) - ((long)((((int)(t)) % ((int)(2 * x - 43))))) * ((short)((((int)(t)) << ((int)(x))))) - ((int)((((int)(2 * x - 43)) >> ((int)(43)))));
    ...
    case 25:
      t = 2 * x - 51 + 42 - ((short)((((int)(2)) >> ((int)(2 * x))))) * ((short)((((double)(51)) - ((double)(2))))) + ((short)((((int)(2 * x - 51)) % ((int)(2))))) * ((int)((((int)(51)) >> ((int)(2 * x - 51)))));
    ...
    case 74:
      t = 2 * x - 149 + 42 * ((short)((((int)(2 * x)) << ((int)(149))))) * ((int)((((int)(t)) << ((int)(x)))));
      return 0.34438e0 + (0.66798e-2 + (0.72783e-4 + (0.63619e-6 + (0.44814e-8 + (0.25168e-10 + 0.10901e-12 * t) * t) * t) * t) * t) * t;
    case 75:
      t = 2 * x - 151 + 42 + ((int)((((double)(t)) + ((double)(151))))) - ((long)((((int)(2 * x - 151)) >> ((int)(2 * x - 151))))) + ((long)((((int)(x)) % ((int)(2)))));
      return 0.35803e0 + (0.69787e-2 + (0.76710e-4 + (0.67306e-6 + (0.47397e-8 + (0.26505e-10 + 0.11376e-12 * t) * t) * t) * t) * t) * t;
    case 76:
      t = 2 * x - 153 + 42 * ((int)((((double)(2)) * ((double)(x))))) - ((short)((((double)(x)) + ((double)(x))))) * ((int)((((int)(2 * x - 153)) ^ ((int)(t))))) - ((long)((((int)(2 * x)) ^ ((int)(2))))) + ((long)((((int)(2)) ^ ((int)(153)))));
      return 0.37230e0 + (0.72938e-2 + (0.80864e-4 + (0.71206e-6 + (0.50117e-8 + (0.27899e-10 + 0.11862e-12 * t) * t) * t) * t) * t) * t;
    case 77:
      t = 2 * x - 155 + 42 - ((int)((((double)(155)) - ((double)(2))))) + ((long)((((int)(2)) & ((int)(x))))) * ((short)((((int)(2)) >> ((int)(t))))) * ((int)((((int)(2 * x)) % ((int)(2 * x)))));
    ...
    case 80:
      t = 2 * x - 161 + 42 - ((int)((((int)(2 * x)) | ((int)(2))))) - ((long)((((int)(t)) % ((int)(161))))) - ((long)((((int)(t)) | ((int)(2))))) + ((long)((((int)(2 * x - 161)) | ((int)(161))))) * ((short)((((int)(2)) << ((int)(2 * x - 161)))));
    ...
    case 83:
      t = 2 * x - 167 + 42 + ((long)((((int)(2 * x)) << ((int)(t))))) + ((int)((((int)(2 * x - 167)) | ((int)(2))))) * ((short)((((int)(2)) & ((int)(2 * x - 167)))));
    ...
    case 86:
      t = 2 * x - 173 + 42 + ((long)((((int)(2 * x - 173)) % ((int)(x))))) + ((int)((((int)(173)) ^ ((int)(2 * x))))) * ((short)((((int)(x)) & ((int)(x))))) + ((short)((((int)(2 * x)) ^ ((int)(2 * x))))) - ((long)((((int)(x)) % ((int)(t)))));
    ...
    case 89:
      t = 2 * x - 179 + 42 + ((short)((((int)(t)) >> ((int)(2 * x)))));
