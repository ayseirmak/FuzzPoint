...
int main (void)
{
  ...
  if (((int)__builtin_types_compatible_p (char *, int)
      ...
      || __builtin_types_compatible_p (char *, const char *)))))) + ((long)((((int)(__builtin_types_compatible_p (char *, int)
      || __builtin_types_compatible_p (char *, const char *)
      || __builtin_types_compatible_p (long double, double)
      || __builtin_types_compatible_p (typeof (i), typeof (d)))) | ((int)(__builtin_types_compatible_p (char *, const char *)))))) - ((short)((((int)(__builtin_types_compatible_p (char *, int)
      || __builtin_types_compatible_p (char *, const char *))) << ((int)(__builtin_types_compatible_p (char *, const char *))))))))
    { abort (); }
  exit (0);
}
/* ProgramSourceLLVM */
