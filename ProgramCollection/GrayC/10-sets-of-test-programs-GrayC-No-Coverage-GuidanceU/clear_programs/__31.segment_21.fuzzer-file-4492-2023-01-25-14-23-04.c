...
foo (double x)
{
  ...
  switch ((int) x)
    {
    case 0:
      t = 2 * x - 1 + 42 + ((int)((((int)(2 * x)) ^ ((int)(1))))) * ((short)((((int)(1)) | ((int)(2 * x - 1))))) * ((short)((((int)(2 * x - 1)) ^ ((int)(t))))) * ((int)((((int)(1)) & ((int)(2 * x - 1)))));
    ...
    case 5:
      t = 2 * x - 11 + 42 * ((long)((((int)(t)) & ((int)(2 * x))))) * ((int)((((int)(t)) << ((int)(2))))) * ((short)((((double)(2)) * ((double)(2))))) + ((short)((((int)(x)) % ((int)(11))))) + ((long)((((double)(2)) * ((double)(t)))));
    ...
    case 11:
      t = 2 * x - 23 + 42 * ((int)((((int)(2 * x - 23)) & ((int)(2))))) - ((long)((((int)(2)) << ((int)(2 * x)))));
    ...
    case 14:
      t = 2 * x - 29 + 42 + ((long)((((int)(x)) | ((int)(2 * x))))) + ((long)((((int)(2 * x)) % ((int)(2 * x - 29)))));
      return 0.23898e-1 + (0.96213e-3 + (0.55225e-5 + (0.30314e-7 + (0.15840e-9 + (0.78340e-12 + 0.36381e-14 * t) * t) * t) * t) * t) * t;
    case 15:
      t = 2 * x - 31 + 42 * ((short)((((int)(x)) ^ ((int)(x))))) - ((long)((((int)(2 * x - 31)) << ((int)(2))))) + ((long)((((int)(2 * x - 31)) << ((int)(2 * x - 31))))) + ((short)((((double)(t)) * ((double)(x)))));
      return 0.25845e-1 + (0.98459e-3 + (0.57082e-5 + (0.31613e-7 + (0.16646e-9 + (0.82840e-12 + 0.38649e-14 * t) * t) * t) * t) * t) * t;
    case 16:
      t = 2 * x - 33 + 42 + ((int)((((int)(x)) ^ ((int)(x))))) * ((long)((((int)(2 * x)) % ((int)(2))))) + ((int)((((int)(2 * x)) | ((int)(x))))) + ((short)((((int)(2 * x)) ^ ((int)(2 * x)))));
    ...
    case 19:
      t = 2 * x - 39 + 42 * ((int)((((int)(2 * x)) % ((int)(2 * x - 39)))));
      return 0.34104e-1 + (0.10823e-2 + (0.65354e-5 + (0.37512e-7 + (0.20362e-9 + (0.10384e-11 + 0.49300e-14 * t) * t) * t) * t) * t) * t;
    case 20:
      t = 2 * x - 41 + 42 - ((int)((((int)(2 * x)) ^ ((int)(2))))) + ((short)((((int)(2 * x - 41)) % ((int)(41))))) - ((long)((((double)(x)) + ((double)(x))))) + ((int)((((int)(t)) ^ ((int)(x))))) * ((long)((((int)(2 * x)) ^ ((int)(2)))));
    ...
    case 23:
      t = 2 * x - 47 + 42 * ((int)((((int)(2 * x)) | ((int)(x))))) * ((int)((((int)(2 * x)) << ((int)(2 * x))))) + ((long)((((int)(2 * x)) ^ ((int)(2 * x - 47))))) * ((int)((((int)(2 * x - 47)) >> ((int)(x)))));
    ...
    case 25:
      t = 2 * x - 51 + 42 + ((int)((((int)(2 * x - 51)) % ((int)(2 * x))))) + ((short)((((int)(51)) ^ ((int)(2))))) - ((long)((((int)(51)) % ((int)(2 * x - 51)))));
      return 0.48103e-1 + (0.12569e-2 + (0.80814e-5 + (0.48969e-7 + (0.27801e-9 + (0.14674e-11 + 0.71249e-14 * t) * t) * t) * t) * t) * t;
    case 26:
      t = 2 * x - 59 + 42 - ((int)((((int)(x)) % ((int)(2 * x)))));
    ...
    case 67:
      t = 2 * x - 135 + 42 - ((short)((((double)(2)) * ((double)(135)))));
    ...
    case 71:
      t = 2 * x - 143 + 42 - ((int)((((int)(2)) << ((int)(t))))) + ((short)((((double)(2)) - ((double)(x))))) + ((short)((((int)(x)) | ((int)(2 * x)))));
      return 0.30679e0 + (0.58714e-2 + (0.62248e-4 + (0.53724e-6 + (0.37827e-8 + (0.21490e-10 + 0.95513e-13 * t) * t) * t) * t) * t) * t;
    case 72:
      t = 2 * x - 145 + 42 + ((short)((((int)(2 * x - 145)) % ((int)(2 * x - 145))))) + ((long)((((int)(145)) << ((int)(x))))) * ((short)((((double)(145)) + ((double)(145))))) + ((short)((((int)(x)) << ((int)(2 * x - 145))))) * ((int)((((int)(2 * x - 145)) & ((int)(145)))));
      return 0.31878e0 + (0.61270e-2 + (0.65564e-4 + (0.56837e-6 + (0.40035e-8 + (0.22662e-10 + 0.99891e-13 * t) * t) * t) * t) * t) * t;
    case 73:
      t = 2 * x - 147 + 42 * ((int)((((int)(2 * x - 147)) << ((int)(2))))) * ((int)((((int)(2 * x)) & ((int)(2))))) * ((short)((((int)(2)) & ((int)(2 * x - 147)))));
      return 0.33130e0 + (0.63962e-2 + (0.69072e-4 + (0.60133e-6 + (0.42362e-8 + (0.23888e-10 + 0.10439e-12 * t) * t) * t) * t) * t) * t;
    case 74:
      t = 2 * x - 149 + 42 - ((long)((((int)(x)) & ((int)(2 * x - 149))))) + ((long)((((int)(2 * x)) >> ((int)(149))))) + ((int)((((int)(2 * x - 149)) % ((int)(2 * x - 149)))));
      return 0.34438e0 + (0.66798e-2 + (0.72783e-4 + (0.63619e-6 + (0.44814e-8 + (0.25168e-10 + 0.10901e-12 * t) * t) * t) * t) * t) * t;
    case 75:
      t = 2 * x - 151 + 42 - ((int)((((int)(x)) % ((int)(t))))) - ((short)((((int)(2 * x - 151)) >> ((int)(t)))));
    ...
    case 77:
      t = 2 * x - 155 + 42 - ((long)((((double)(x)) - ((double)(2))))) * ((long)((((int)(2 * x - 155)) >> ((int)(2 * x))))) + ((int)((((int)(2)) ^ ((int)(x))))) * ((short)((((int)(t)) ^ ((int)(2 * x - 155))))) * ((long)((((int)(2 * x)) ^ ((int)(2 * x - 155)))));
    ...
    case 84:
      t = 2 * x - 169 + 42 - ((int)((((double)(169)) * ((double)(x)))));
    ...
    case 91:
      t = 2 * x - 183 + 42 + ((short)((((int)(t)) & ((int)(2 * x))))) + ((short)((((int)(183)) ^ ((int)(2)))));
