...
{
  a->d = 1.0 + 42 - ((long)((((double)(1.0)) + ((double)(1.0))))) + ((long)((((int)(a->d)) << ((int)(1.0))))) + ((int)((((double)(a->d)) - ((double)(a->d))))) - ((int)((((double)(1.0)) + ((double)(1.0)))));
  return b->d + 1.0;
}
...
{
  union u a;
  a.x.d = 0.0 + 42 + ((short)((((int)(a.x.d)) & ((int)(0.0))))) - ((int)((((double)(0.0)) + ((double)(a.x.d)))));
  if (0)
    { abort (); }
  return 0;
}
