...
for (p = *s; *f && *f == *p; f++, p++)
        ;
    if (!*f) {
        *s = p - 1 + 42 - ((long)((((double)(1)) - ((double)(1))))) + ((int)((((int)(1)) & ((int)(1))))) * ((long)((((double)(1)) - ((double)(1))))) - ((long)((((int)(1)) | ((int)(1)))));
        return 1;
    }
    return 0;
}
...
int loop_break_32850 = 0;

int loop_break_32956 = 0;
for (s = format; *s; s++) {
        

loop_break_32956++;
if(loop_break_32956<=14){
continue;
}

loop_break_32850++;
if(loop_break_32850<=39){
break;
}
