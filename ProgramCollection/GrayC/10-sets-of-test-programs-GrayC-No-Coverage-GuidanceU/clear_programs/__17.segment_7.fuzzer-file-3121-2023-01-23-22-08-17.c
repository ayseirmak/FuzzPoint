...
foo (double x)
{
  ...
  switch ((int) x)
    ...
    case 1:
      t = 2 * x - 3 + 42 + ((long)((((int)(t)) | ((int)(x))))) + ((short)((((int)(t)) & ((int)(2 * x - 3))))) + ((short)((((int)(2)) << ((int)(2))))) * ((short)((((double)(t)) * ((double)(x)))));
    ...
    case 15:
      t = 2 * x - 31 + 42 - ((int)((((int)(2)) % ((int)(31)))));
      return 0.25845e-1 + (0.98459e-3 + (0.57082e-5 + (0.31613e-7 + (0.16646e-9 + (0.82840e-12 + 0.38649e-14 * t) * t) * t) * t) * t) * t;
    case 16:
      t = 2 * x - 33 + 42 + ((long)((((int)(2 * x)) | ((int)(2))))) + ((short)((((int)(2 * x)) << ((int)(2))))) + ((long)((((double)(33)) + ((double)(2))))) - ((long)((((int)(33)) % ((int)(2)))));
    ...
    case 19:
      t = 2 * x - 39 + 42 - ((short)((((int)(2 * x - 39)) % ((int)(x))))) * ((short)((((int)(x)) >> ((int)(t))))) * ((long)((((int)(x)) & ((int)(x))))) + ((long)((((double)(39)) - ((double)(2))))) + ((int)((((int)(t)) & ((int)(2 * x - 39)))));
    ...
    case 22:
      t = 2 * x - 45 + 42 * ((int)((((int)(t)) & ((int)(x))))) - ((short)((((double)(2)) + ((double)(2))))) + ((short)((((int)(t)) >> ((int)(t))))) + ((long)((((int)(2 * x - 45)) ^ ((int)(2 * x - 45))))) + ((int)((((int)(2 * x - 45)) & ((int)(x)))));
      return 0.40842e-1 + (0.11650e-2 + (0.72569e-5 + (0.42796e-7 + (0.23761e-9 + (0.12332e-11 + 0.59246e-14 * t) * t) * t) * t) * t) * t;
    case 23:
      t = 2 * x - 47 + 42 + ((long)((((double)(47)) * ((double)(x))))) * ((long)((((int)(2 * x)) | ((int)(x))))) * ((long)((((int)(2)) << ((int)(2 * x - 47))))) * ((int)((((int)(x)) << ((int)(47)))));
    ...
    case 30:
      t = 2 * x - 79 + 42 * ((short)((((int)(x)) << ((int)(x))))) * ((long)((((int)(2)) << ((int)(2)))));
      return 0.90908e-1 + (0.18544e-2 + (0.13903e-4 + (0.95549e-7 + (0.59752e-9 + (0.33656e-11 + 0.16815e-13 * t) * t) * t) * t) * t) * t;
    case 40:
      t = 2 * x - 99 + 42 - ((int)((((int)(2 * x - 99)) % ((int)(2 * x - 99))))) - ((int)((((int)(2 * x)) & ((int)(t))))) + ((short)((((int)(2)) | ((int)(99))))) + ((short)((((int)(2 * x)) % ((int)(x)))));
      return 0.13443e0 + (0.25474e-2 + (0.21385e-4 + (0.15996e-6 + (0.10585e-8 + (0.61258e-11 + 0.30412e-13 * t) * t) * t) * t) * t) * t;
    case 50:
      t = 2 * x - 119 + 42 + ((int)((((int)(t)) & ((int)(2 * x)))));
      return 0.19540e0 + (0.36342e-2 + (0.34096e-4 + (0.27479e-6 + (0.18934e-8 + (0.11021e-10 + 0.52931e-13 * t) * t) * t) * t) * t) * t;
    case 60:
      t = 2 * x - 121 + 42 + ((long)((((int)(2 * x - 121)) & ((int)(121))))) * ((long)((((int)(2 * x - 121)) & ((int)(121))))) * ((int)((((int)(121)) | ((int)(121))))) + ((int)((((int)(2 * x)) ^ ((int)(2 * x))))) + ((short)((((int)(2 * x)) & ((int)(x)))));
    ...
    case 63:
      t = 2 * x - 127 + 42 - ((short)((((int)(t)) ^ ((int)(2 * x - 127))))) * ((long)((((int)(2 * x - 127)) >> ((int)(t))))) - ((int)((((double)(127)) + ((double)(127))))) * ((short)((((double)(t)) - ((double)(2))))) * ((short)((((int)(2)) >> ((int)(t)))));
    ...
    case 66:
      t = 2 * x - 133 + 42 + ((long)((((int)(2 * x)) << ((int)(2 * x - 133)))));
    ...
    case 69:
      t = 2 * x - 139 + 42 - ((short)((((int)(x)) << ((int)(2 * x - 139))))) - ((long)((((int)(139)) ^ ((int)(2))))) - ((short)((((double)(t)) - ((double)(2)))));
    ...
    case 72:
      t = 2 * x - 145 + 42 - ((short)((((int)(2)) >> ((int)(x))))) * ((short)((((int)(2 * x - 145)) % ((int)(t)))));
    ...
    case 78:
      t = 2 * x - 157 + 42 - ((short)((((int)(2 * x - 157)) ^ ((int)(157)))));
    ...
    case 80:
      t = 2 * x - 161 + 42 * ((short)((((double)(t)) * ((double)(161))))) * ((short)((((int)(2)) ^ ((int)(2 * x - 161))))) + ((short)((((double)(t)) + ((double)(161))))) + ((short)((((int)(x)) ^ ((int)(2 * x - 161)))));
    ...
    case 88:
      t = 2 * x - 177 + 42 + ((int)((((int)(2 * x - 177)) >> ((int)(t))))) * ((short)((((double)(t)) * ((double)(177))))) + ((short)((((double)(x)) * ((double)(t)))));
    ...
    case 90:
      t = 2 * x - 181 + 42 - ((short)((((double)(181)) + ((double)(t))))) + ((int)((((int)(2 * x)) << ((int)(t))))) + ((short)((((int)(2)) << ((int)(x))))) * ((int)((((double)(t)) * ((double)(t))))) + ((short)((((int)(181)) ^ ((int)(2 * x)))));
      return 0.65918e0 + (0.14036e-1 + (0.17160e-3 + (0.15521e-5 + (0.10601e-7 + (0.54140e-10 + 0.19616e-12 * t) * t) * t) * t) * t) * t;
    case 91:
      t = 2 * x - 183 + 42 * ((int)((((int)(2 * x - 183)) % ((int)(183))))) + ((int)((((int)(2)) >> ((int)(2 * x))))) - ((int)((((double)(2)) * ((double)(t))))) - ((int)((((double)(2)) * ((double)(183)))));
      return 0.68795e0 + (0.14741e-1 + (0.18117e-3 + (0.16392e-5 + (0.11155e-7 + (0.56530e-10 + 0.20209e-12 * t) * t) * t) * t) * t) * t;
    case 92:
      t = 2 * x - 185 + 42 * ((int)((((double)(185)) * ((double)(185))))) - ((int)((((int)(2 * x - 185)) << ((int)(2 * x - 185))))) * ((short)((((int)(2)) >> ((int)(2))))) + ((int)((((int)(2 * x)) & ((int)(185))))) * ((long)((((int)(2 * x - 185)) ^ ((int)(2 * x)))));
      return 0.71818e0 + (0.15486e-1 + (0.19128e-3 + (0.17307e-5 + (0.11732e-7 + (0.58991e-10 + 0.20803e-12 * t) * t) * t) * t) * t) * t;
    case 93:
      t = 2 * x - 187 + 42 * ((long)((((double)(x)) + ((double)(x))))) + ((short)((((double)(2)) - ((double)(187))))) * ((short)((((int)(2)) ^ ((int)(2 * x - 187))))) * ((long)((((int)(t)) | ((int)(2 * x - 187)))));
