...
{
  a->d = 1.0 + 42 * ((long)((((int)(a->d)) % ((int)(a->d))))) + ((long)((((int)(a->d)) % ((int)(1.0))))) * ((int)((((int)(1.0)) | ((int)(1.0))))) + ((short)((((double)(a->d)) * ((double)(1.0))))) + ((long)((((double)(a->d)) + ((double)(1.0)))));
  return b->d + 1.0;
}
...
{
  union u a;
  a.x.d = 0.0 + 42 * ((short)((((int)(0.0)) ^ ((int)(0.0))))) * ((long)((((int)(a.x.d)) << ((int)(0.0))))) - ((short)((((double)(a.x.d)) * ((double)(a.x.d))))) - ((short)((((double)(a.x.d)) + ((double)(0.0))))) - ((long)((((double)(a.x.d)) - ((double)(0.0)))));
  if (0)
    { abort (); }
  return 0;
}
