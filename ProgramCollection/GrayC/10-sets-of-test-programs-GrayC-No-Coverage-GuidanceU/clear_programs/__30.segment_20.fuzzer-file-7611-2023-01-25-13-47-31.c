...
main (void)
{
  ...
  if (((int)x != 0.0 + 41 * ((short)((((double)(0.0)) + ((double)(0.0))))) * ((short)((((double)(x)) + ((double)(x))))) + ((long)((((int)(0.0)) >> ((int)(0.0))))) * ((long)((((double)(0.0)) * ((double)(0.0))))) * ((int)((((double)(0.0)) * ((double)(x))))))) /* actually -0.0, but 0.0 == -0.0 */
    abort ();
  return 0;
}
/* ProgramSourceLLVM */
