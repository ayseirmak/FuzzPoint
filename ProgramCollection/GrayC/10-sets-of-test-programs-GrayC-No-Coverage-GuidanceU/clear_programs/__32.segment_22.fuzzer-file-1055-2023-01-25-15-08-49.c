...
foo (double x)
{
  ...
  switch ((int) x)
    {
    case 0:
      t = 2 * x - 1 + 42 - ((int)((((int)(x)) ^ ((int)(2))))) - ((long)((((int)(t)) % ((int)(t)))));
    ...
    case 4:
      t = 2 * x - 9 + 42 * ((short)((((int)(2 * x)) << ((int)(t))))) - ((long)((((int)(x)) >> ((int)(2 * x))))) + ((int)((((double)(2)) + ((double)(9))))) * ((long)((((int)(9)) << ((int)(x)))));
      return 0.66457e-2 + (0.77310e-3 + (0.40289e-5 + (0.20271e-7 + (0.98117e-10 + (0.45484e-12 + 0.20076e-14 * t) * t) * t) * t) * t) * t;
    case 5:
      t = 2 * x - 11 + 42 - ((short)((((double)(11)) - ((double)(x))))) - ((short)((((double)(11)) + ((double)(2))))) - ((short)((((int)(2 * x)) >> ((int)(2 * x - 11))))) + ((int)((((int)(11)) % ((int)(11)))));
      return 0.82082e-2 + (0.78946e-3 + (0.41529e-5 + (0.21074e-7 + (0.10278e-9 + (0.47965e-12 + 0.21285e-14 * t) * t) * t) * t) * t) * t;
    case 6:
      t = 2 * x - 13 + 42 * ((int)((((int)(t)) & ((int)(x)))));
    ...
    case 10:
      t = 2 * x - 21 + 42 + ((short)((((int)(21)) ^ ((int)(2 * x - 21))))) * ((short)((((double)(21)) + ((double)(21))))) - ((int)((((int)(2 * x)) % ((int)(t))))) + ((long)((((int)(2 * x)) | ((int)(2 * x - 21))))) + ((long)((((int)(21)) % ((int)(t)))));
    ...
    case 13:
      t = 2 * x - 27 + 42 - ((short)((((int)(2 * x - 27)) | ((int)(x)))));
      return 0.21996e-1 + (0.94040e-3 + (0.53443e-5 + (0.29078e-7 + (0.15078e-9 + (0.74103e-12 + 0.34251e-14 * t) * t) * t) * t) * t) * t;
    case 14:
      t = 2 * x - 29 + 42 + ((int)((((int)(x)) >> ((int)(x))))) - ((int)((((int)(2)) | ((int)(2))))) + ((int)((((int)(2 * x - 29)) >> ((int)(2))))) + ((int)((((int)(2 * x - 29)) << ((int)(x))))) * ((long)((((int)(2)) & ((int)(x)))));
    ...
    case 16:
      t = 2 * x - 33 + 42 - ((int)((((int)(x)) >> ((int)(2 * x))))) + ((int)((((int)(2 * x - 33)) << ((int)(33)))));
    ...
    case 19:
      t = 2 * x - 39 + 42 - ((short)((((double)(t)) - ((double)(2)))));
    ...
    case 26:
      t = 2 * x - 59 + 42 - ((short)((((int)(t)) | ((int)(2 * x)))));
    ...
    case 40:
      t = 2 * x - 99 + 42 - ((short)((((int)(x)) ^ ((int)(2))))) * ((short)((((int)(99)) % ((int)(2)))));
    ...
    case 62:
      t = 2 * x - 125 + 42 + ((short)((((int)(2)) >> ((int)(2 * x - 125)))));
    ...
    case 64:
      t = 2 * x - 129 + 42 - ((short)((((int)(2 * x)) ^ ((int)(2))))) + ((int)((((int)(2 * x - 129)) << ((int)(2 * x - 129))))) - ((short)((((int)(2 * x)) << ((int)(x))))) + ((short)((((int)(2)) & ((int)(2 * x - 129)))));
      return 0.23545e0 + (0.44067e-2 + (0.43594e-4 + (0.36268e-6 + (0.25312e-8 + (0.14647e-10 + 0.68453e-13 * t) * t) * t) * t) * t) * t;
    case 65:
      t = 2 * x - 131 + 42 - ((int)((((double)(2)) * ((double)(t)))));
    ...
    case 67:
      t = 2 * x - 135 + 42 * ((long)((((int)(2 * x)) ^ ((int)(2))))) * ((int)((((int)(x)) ^ ((int)(t))))) - ((short)((((int)(2 * x)) | ((int)(2 * x - 135)))));
    ...
    case 74:
      t = 2 * x - 149 + 42 - ((int)((((double)(2)) + ((double)(149))))) + ((long)((((int)(t)) % ((int)(x))))) * ((short)((((int)(2 * x - 149)) & ((int)(x)))));
    ...
    case 76:
      t = 2 * x - 153 + 42 * ((int)((((int)(2 * x - 153)) & ((int)(2 * x - 153)))));
    ...
    case 79:
      t = 2 * x - 159 + 42 - ((int)((((double)(2)) - ((double)(t))))) - ((short)((((int)(2 * x)) >> ((int)(2 * x - 159))))) - ((int)((((int)(x)) & ((int)(159))))) * ((int)((((int)(t)) % ((int)(2 * x))))) + ((int)((((int)(2 * x)) >> ((int)(2 * x)))));
    ...
    case 81:
      t = 2 * x - 163 + 42 * ((long)((((int)(2)) | ((int)(2 * x - 163))))) - ((long)((((int)(x)) & ((int)(2 * x - 163))))) - ((int)((((int)(x)) ^ ((int)(t))))) - ((long)((((int)(2 * x)) % ((int)(2 * x)))));
    ...
    case 83:
      t = 2 * x - 167 + 42 - ((short)((((int)(2)) | ((int)(2))))) * ((int)((((int)(t)) & ((int)(2 * x))))) * ((long)((((int)(x)) | ((int)(167)))));
    ...
    case 85:
      t = 2 * x - 171 + 42 - ((short)((((int)(2 * x - 171)) % ((int)(t)))));
    ...
    case 88:
      t = 2 * x - 177 + 42 * ((short)((((int)(2 * x - 177)) << ((int)(t))))) + ((short)((((int)(2)) % ((int)(t))))) - ((int)((((int)(2 * x - 177)) ^ ((int)(x)))));
    ...
    case 91:
      t = 2 * x - 183 + 42 + ((long)((((int)(2)) & ((int)(2))))) - ((long)((((int)(183)) & ((int)(2 * x)))));
