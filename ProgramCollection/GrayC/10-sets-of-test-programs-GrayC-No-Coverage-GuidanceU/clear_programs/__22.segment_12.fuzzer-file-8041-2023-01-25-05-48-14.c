...
foo (double x)
{
  ...
  switch ((int) x)
    {
    case 0:
      t = 2 * x - 1 + 42 - ((long)((((int)(2 * x)) | ((int)(1))))) + ((short)((((double)(2)) - ((double)(x))))) + ((short)((((int)(x)) % ((int)(2 * x))))) * ((long)((((int)(t)) >> ((int)(x)))));
      return 0.70878e-3 + (0.71234e-3 + (0.35779e-5 + (0.17403e-7 + (0.81710e-10 + (0.36885e-12 + 0.15917e-14 * t) * t) * t) * t) * t) * t;
    case 1:
      t = 2 * x - 3 + 42 + ((short)((((double)(t)) + ((double)(x))))) - ((int)((((int)(2)) >> ((int)(2 * x))))) * ((int)((((int)(3)) ^ ((int)(2 * x - 3))))) * ((int)((((double)(t)) * ((double)(2)))));
    ...
    case 7:
      t = 2 * x - 15 + 42 - ((int)((((int)(x)) ^ ((int)(2 * x - 15))))) + ((int)((((double)(2)) - ((double)(x))))) + ((int)((((int)(2)) & ((int)(2 * x - 15))))) * ((long)((((int)(2 * x - 15)) ^ ((int)(2 * x)))));
      return 0.11433e-1 + (0.82372e-3 + (0.44160e-5 + (0.22798e-7 + (0.11291e-9 + (0.53386e-12 + 0.23944e-14 * t) * t) * t) * t) * t) * t;
    case 8:
      t = 2 * x - 17 + 42 * ((short)((((int)(17)) >> ((int)(2 * x - 17))))) - ((long)((((double)(2)) + ((double)(x)))));
      return 0.13099e-1 + (0.84167e-3 + (0.45555e-5 + (0.23723e-7 + (0.11839e-9 + (0.56346e-12 + 0.25403e-14 * t) * t) * t) * t) * t) * t;
    case 9:
      t = 2 * x - 19 + 42 + ((long)((((double)(19)) + ((double)(19))))) - ((short)((((int)(2 * x)) & ((int)(19))))) * ((int)((((double)(x)) * ((double)(2)))));
    ...
    case 15:
      t = 2 * x - 31 + 42 * ((long)((((int)(t)) | ((int)(2 * x))))) + ((short)((((double)(t)) - ((double)(31))))) - ((short)((((int)(2 * x - 31)) | ((int)(2 * x - 31)))));
    ...
    case 17:
      t = 2 * x - 35 + 42 - ((int)((((int)(2 * x - 35)) ^ ((int)(2 * x - 35))))) * ((int)((((int)(2)) >> ((int)(2))))) - ((int)((((int)(2 * x)) % ((int)(2))))) - ((short)((((double)(35)) * ((double)(x)))));
    ...
    case 19:
      t = 2 * x - 39 + 42 + ((short)((((int)(2)) | ((int)(2 * x - 39))))) + ((long)((((int)(2 * x)) | ((int)(t))))) - ((int)((((double)(2)) * ((double)(39)))));
    ...
    case 21:
      t = 2 * x - 43 + 42 * ((long)((((int)(t)) % ((int)(2 * x))))) * ((long)((((int)(t)) << ((int)(x))))) - ((int)((((int)(2 * x - 43)) ^ ((int)(x))))) * ((long)((((int)(2 * x - 43)) ^ ((int)(43))))) - ((int)((((int)(x)) ^ ((int)(x)))));
    ...
    case 24:
      t = 2 * x - 49 + 42 + ((long)((((int)(2 * x - 49)) ^ ((int)(2 * x - 49))))) - ((int)((((double)(2)) + ((double)(t))))) - ((short)((((int)(2 * x)) << ((int)(2))))) - ((int)((((int)(2 * x - 49)) << ((int)(2)))));
      return 0.45621e-1 + (0.12251e-2 + (0.77941e-5 + (0.46803e-7 + (0.26375e-9 + (0.13845e-11 + 0.66996e-14 * t) * t) * t) * t) * t) * t;
    case 25:
      t = 2 * x - 51 + 42 - ((long)((((double)(t)) - ((double)(51))))) - ((int)((((int)(2 * x - 51)) ^ ((int)(2 * x - 51))))) * ((int)((((int)(51)) << ((int)(2 * x - 51))))) * ((int)((((int)(2)) & ((int)(2 * x - 51)))));
    ...
    case 62:
      t = 2 * x - 125 + 42 - ((long)((((int)(t)) << ((int)(x))))) - ((short)((((int)(2 * x)) & ((int)(125))))) + ((int)((((int)(2)) % ((int)(2 * x))))) * ((int)((((int)(x)) ^ ((int)(125)))));
    ...
    case 65:
      t = 2 * x - 131 + 42 + ((long)((((int)(2 * x - 131)) & ((int)(t))))) + ((short)((((double)(2)) + ((double)(x)))));
    ...
    case 69:
      t = 2 * x - 139 + 42 - ((short)((((int)(2 * x - 139)) ^ ((int)(2 * x))))) - ((int)((((int)(x)) ^ ((int)(139))))) * ((long)((((int)(2 * x - 139)) ^ ((int)(x)))));
    ...
    case 71:
      t = 2 * x - 143 + 42 - ((short)((((double)(2)) - ((double)(143))))) - ((int)((((int)(2 * x - 143)) << ((int)(2))))) * ((short)((((int)(x)) | ((int)(143))))) - ((long)((((int)(2 * x - 143)) >> ((int)(2))))) + ((int)((((int)(2 * x - 143)) << ((int)(143)))));
      return 0.30679e0 + (0.58714e-2 + (0.62248e-4 + (0.53724e-6 + (0.37827e-8 + (0.21490e-10 + 0.95513e-13 * t) * t) * t) * t) * t) * t;
    case 72:
      t = 2 * x - 145 + 42 - ((short)((((double)(145)) * ((double)(145))))) * ((long)((((int)(2)) << ((int)(2)))));
      return 0.31878e0 + (0.61270e-2 + (0.65564e-4 + (0.56837e-6 + (0.40035e-8 + (0.22662e-10 + 0.99891e-13 * t) * t) * t) * t) * t) * t;
    case 73:
      t = 2 * x - 147 + 42 + ((short)((((int)(x)) | ((int)(2))))) + ((int)((((int)(x)) >> ((int)(2 * x))))) + ((int)((((int)(2 * x - 147)) << ((int)(2))))) + ((int)((((double)(x)) - ((double)(147))))) - ((short)((((int)(2 * x)) << ((int)(x)))));
      return 0.33130e0 + (0.63962e-2 + (0.69072e-4 + (0.60133e-6 + (0.42362e-8 + (0.23888e-10 + 0.10439e-12 * t) * t) * t) * t) * t) * t;
    case 74:
      t = 2 * x - 149 + 42 * ((int)((((int)(x)) >> ((int)(t))))) + ((long)((((int)(2 * x - 149)) & ((int)(t))))) * ((short)((((int)(2 * x - 149)) | ((int)(t)))));
    ...
    case 77:
      t = 2 * x - 155 + 42 - ((long)((((int)(2 * x - 155)) >> ((int)(x))))) + ((long)((((int)(2)) | ((int)(2 * x))))) - ((long)((((int)(t)) >> ((int)(2 * x))))) - ((long)((((int)(2)) ^ ((int)(t))))) + ((short)((((int)(155)) | ((int)(2)))));
    ...
    case 81:
      t = 2 * x - 163 + 42 + ((long)((((double)(163)) - ((double)(163))))) + ((short)((((int)(2 * x - 163)) >> ((int)(t))))) * ((int)((((int)(2 * x - 163)) | ((int)(2 * x - 163))))) - ((long)((((int)(2)) >> ((int)(x)))));
    ...
    case 86:
      t = 2 * x - 173 + 42 * ((short)((((int)(x)) | ((int)(2 * x))))) - ((long)((((int)(2)) % ((int)(173)))));
      return 0.55712e0 + (0.11568e-1 + (0.13815e-3 + (0.12456e-5 + (0.86169e-8 + (0.45290e-10 + 0.17268e-12 * t) * t) * t) * t) * t) * t;
    case 87:
      t = 2 * x - 175 + 42 + ((short)((((int)(175)) & ((int)(2 * x - 175))))) + ((int)((((int)(t)) >> ((int)(175))))) * ((short)((((int)(2 * x)) | ((int)(2)))));
    ...
    case 89:
      t = 2 * x - 179 + 42 + ((short)((((double)(t)) + ((double)(t)))));
    ...
    case 91:
      t = 2 * x - 183 + 42 - ((long)((((double)(183)) * ((double)(x)))));
