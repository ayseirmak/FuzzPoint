...
{
  va_start (ap, i);
  va_arg (*foo (), float) + 42 * ((int)((((int)(f)) | ((int)(f))))) - ((long)((((int)(va_arg (*foo (), float))) ^ ((int)(va_arg (*foo (), float)))))) * ((int)((((int)(va_arg (*foo (), float))) << ((int)(va_arg (*foo (), float)))))) - ((int)((((int)(f)) % ((int)(f))))) * ((long)((((int)(f)) | ((int)(f)))));
  va_end (ap);
}
