...
foo (double x)
{
  ...
  switch ((int) x)
    ...
    case 1:
      t = 2 * x - 3 + 42 + ((int)((((int)(t)) << ((int)(2 * x))))) * ((short)((((int)(t)) ^ ((int)(3))))) * ((long)((((int)(2 * x)) | ((int)(3)))));
      return 0.21479e-2 + (0.72686e-3 + (0.36843e-5 + (0.18071e-7 + (0.85496e-10 + (0.38852e-12 + 0.16868e-14 * t) * t) * t) * t) * t) * t;
    case 2:
      t = 2 * x - 5 + 42 - ((short)((((int)(t)) | ((int)(5))))) + ((int)((((int)(t)) >> ((int)(2 * x - 5))))) + ((short)((((int)(x)) << ((int)(2 * x)))));
    ...
    case 4:
      t = 2 * x - 9 + 42 * ((long)((((int)(2 * x)) ^ ((int)(2 * x))))) * ((long)((((int)(9)) & ((int)(2)))));
    ...
    case 6:
      t = 2 * x - 13 + 42 + ((long)((((int)(2 * x - 13)) << ((int)(2))))) + ((long)((((int)(t)) >> ((int)(2 * x)))));
    ...
    case 10:
      t = 2 * x - 21 + 42 * ((int)((((int)(2 * x)) >> ((int)(2 * x - 21))))) - ((long)((((int)(t)) | ((int)(2))))) - ((long)((((int)(2 * x)) | ((int)(21))))) * ((long)((((double)(t)) * ((double)(21))))) * ((long)((((int)(t)) >> ((int)(2)))));
      return 0.16540e-1 + (0.87928e-3 + (0.48520e-5 + (0.25711e-7 + (0.13030e-9 + (0.62820e-12 + 0.28612e-14 * t) * t) * t) * t) * t) * t;
    case 11:
      t = 2 * x - 23 + 42 + ((long)((((int)(t)) >> ((int)(2 * x - 23))))) - ((int)((((int)(2)) >> ((int)(x))))) * ((long)((((int)(t)) | ((int)(2 * x))))) * ((short)((((double)(23)) * ((double)(t))))) - ((long)((((double)(23)) * ((double)(23)))));
      return 0.18318e-1 + (0.89900e-3 + (0.50094e-5 + (0.26779e-7 + (0.13675e-9 + (0.66358e-12 + 0.30375e-14 * t) * t) * t) * t) * t) * t;
    case 12:
      t = 2 * x - 25 + 42 - ((long)((((int)(2)) & ((int)(2 * x))))) * ((long)((((int)(2 * x - 25)) % ((int)(2 * x - 25))))) - ((int)((((double)(25)) * ((double)(2))))) - ((long)((((int)(2 * x - 25)) ^ ((int)(25))))) + ((int)((((int)(25)) | ((int)(2 * x)))));
    ...
    case 14:
      t = 2 * x - 29 + 42 - ((short)((((int)(2 * x - 29)) ^ ((int)(t)))));
    ...
    case 16:
      t = 2 * x - 33 + 42 - ((int)((((double)(33)) + ((double)(33))))) * ((short)((((int)(x)) | ((int)(t))))) * ((short)((((int)(2)) >> ((int)(2 * x)))));
    ...
    case 18:
      t = 2 * x - 37 + 42 * ((long)((((int)(2 * x - 37)) ^ ((int)(37))))) * ((long)((((int)(37)) & ((int)(2 * x))))) * ((short)((((double)(t)) * ((double)(x))))) + ((int)((((double)(2)) - ((double)(t)))));
    ...
    case 20:
      t = 2 * x - 41 + 42 + ((long)((((int)(2 * x - 41)) & ((int)(2 * x - 41))))) + ((short)((((double)(x)) * ((double)(t)))));
      return 0.36295e-1 + (0.11089e-2 + (0.67654e-5 + (0.39184e-7 + (0.21431e-9 + (0.10994e-11 + 0.52409e-14 * t) * t) * t) * t) * t) * t;
    case 21:
      t = 2 * x - 43 + 42 - ((short)((((int)(2)) << ((int)(2 * x - 43))))) * ((int)((((int)(t)) & ((int)(2 * x - 43))))) + ((short)((((int)(2 * x - 43)) ^ ((int)(43))))) * ((long)((((int)(2 * x - 43)) >> ((int)(t)))));
    ...
    case 24:
      t = 2 * x - 49 + 42 * ((short)((((int)(2 * x - 49)) << ((int)(t))))) + ((int)((((double)(t)) * ((double)(x)))));
    ...
    case 26:
      t = 2 * x - 59 + 42 * ((short)((((int)(2)) & ((int)(59))))) * ((int)((((int)(2)) % ((int)(2 * x - 59))))) - ((long)((((int)(x)) & ((int)(2))))) * ((int)((((int)(x)) % ((int)(2))))) - ((int)((((int)(59)) ^ ((int)(2 * x - 59)))));
      return 0.58702e-1 + (0.13962e-2 + (0.93714e-5 + (0.58882e-7 + (0.34414e-9 + (0.18552e-11 + 0.91160e-14 * t) * t) * t) * t) * t) * t;
    case 30:
      t = 2 * x - 79 + 42 * ((short)((((int)(2)) << ((int)(2 * x - 79)))));
    ...
    case 50:
      t = 2 * x - 119 + 42 + ((long)((((int)(x)) & ((int)(2 * x)))));
    ...
    case 61:
      t = 2 * x - 123 + 42 + ((int)((((int)(123)) | ((int)(2 * x)))));
    ...
    case 63:
      t = 2 * x - 127 + 42 * ((int)((((double)(t)) - ((double)(2))))) + ((short)((((int)(127)) ^ ((int)(2))))) * ((short)((((int)(2 * x - 127)) & ((int)(127))))) * ((long)((((int)(2 * x)) & ((int)(127)))));
      return 0.22680e0 + (0.42366e-2 + (0.41477e-4 + (0.34300e-6 + (0.23888e-8 + (0.13846e-10 + 0.65100e-13 * t) * t) * t) * t) * t) * t;
    case 64:
      t = 2 * x - 129 + 42 * ((short)((((int)(2 * x - 129)) >> ((int)(t))))) * ((long)((((int)(129)) << ((int)(2))))) - ((short)((((double)(x)) * ((double)(t))))) + ((long)((((int)(x)) | ((int)(2 * x - 129)))));
      return 0.23545e0 + (0.44067e-2 + (0.43594e-4 + (0.36268e-6 + (0.25312e-8 + (0.14647e-10 + 0.68453e-13 * t) * t) * t) * t) * t) * t;
    case 65:
      t = 2 * x - 131 + 42 - ((short)((((int)(2 * x)) >> ((int)(2 * x - 131))))) + ((int)((((int)(2 * x - 131)) % ((int)(x))))) - ((int)((((double)(t)) + ((double)(t))))) + ((int)((((double)(t)) - ((double)(x))))) * ((int)((((int)(x)) % ((int)(2 * x)))));
    ...
    case 67:
      t = 2 * x - 135 + 42 * ((short)((((int)(135)) ^ ((int)(2 * x - 135))))) * ((int)((((int)(2 * x - 135)) ^ ((int)(2 * x)))));
      return 0.26354e0 + (0.49713e-2 + (0.50702e-4 + (0.42901e-6 + (0.30095e-8 + (0.17303e-10 + 0.79278e-13 * t) * t) * t) * t) * t) * t;
    case 68:
      t = 2 * x - 137 + 42 * ((int)((((int)(2 * x)) & ((int)(x))))) - ((short)((((int)(2 * x - 137)) % ((int)(t))))) * ((short)((((int)(2 * x)) ^ ((int)(137))))) + ((short)((((int)(2)) % ((int)(137)))));
