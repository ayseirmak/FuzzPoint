...
foo (double x)
{
  ...
  switch ((int) x)
    ...
    case 1:
      t = 2 * x - 3 + 42 - ((long)((((double)(t)) - ((double)(2))))) + ((int)((((int)(x)) & ((int)(t))))) * ((long)((((int)(2 * x)) % ((int)(2 * x))))) - ((long)((((int)(2 * x - 3)) | ((int)(2)))));
      return 0.21479e-2 + (0.72686e-3 + (0.36843e-5 + (0.18071e-7 + (0.85496e-10 + (0.38852e-12 + 0.16868e-14 * t) * t) * t) * t) * t) * t;
    case 2:
      t = 2 * x - 5 + 42 * ((long)((((int)(2 * x - 5)) | ((int)(t))))) - ((short)((((double)(2)) - ((double)(2))))) * ((short)((((int)(2)) >> ((int)(2 * x))))) - ((short)((((double)(2)) * ((double)(5))))) + ((short)((((int)(2 * x)) >> ((int)(2 * x)))));
    ...
    case 4:
      t = 2 * x - 9 + 42 - ((long)((((double)(t)) * ((double)(2))))) - ((short)((((int)(2)) ^ ((int)(2 * x))))) + ((long)((((int)(t)) >> ((int)(2))))) - ((long)((((double)(9)) + ((double)(9)))));
    ...
    case 7:
      t = 2 * x - 15 + 42 * ((long)((((double)(2)) - ((double)(t))))) * ((int)((((int)(15)) << ((int)(t))))) - ((long)((((double)(x)) + ((double)(x))))) * ((long)((((double)(2)) * ((double)(t)))));
      return 0.11433e-1 + (0.82372e-3 + (0.44160e-5 + (0.22798e-7 + (0.11291e-9 + (0.53386e-12 + 0.23944e-14 * t) * t) * t) * t) * t) * t;
    case 8:
      t = 2 * x - 17 + 42 * ((int)((((int)(2)) >> ((int)(2 * x))))) * ((int)((((int)(2 * x - 17)) % ((int)(2)))));
      return 0.13099e-1 + (0.84167e-3 + (0.45555e-5 + (0.23723e-7 + (0.11839e-9 + (0.56346e-12 + 0.25403e-14 * t) * t) * t) * t) * t) * t;
    case 9:
      t = 2 * x - 19 + 42 - ((int)((((int)(2 * x)) >> ((int)(2 * x))))) + ((short)((((int)(2 * x)) & ((int)(2 * x - 19)))));
    ...
    case 11:
      t = 2 * x - 23 + 42 * ((int)((((double)(2)) * ((double)(2))))) * ((short)((((int)(23)) | ((int)(t))))) + ((long)((((int)(23)) ^ ((int)(t))))) * ((long)((((int)(2 * x)) ^ ((int)(t)))));
    ...
    case 19:
      t = 2 * x - 39 + 42 * ((short)((((int)(39)) % ((int)(39))))) + ((int)((((double)(39)) * ((double)(2))))) * ((int)((((double)(t)) - ((double)(39))))) - ((long)((((int)(39)) & ((int)(t))))) - ((short)((((int)(2 * x - 39)) ^ ((int)(2 * x - 39)))));
    ...
    case 26:
      t = 2 * x - 59 + 42 + ((long)((((int)(59)) % ((int)(2 * x - 59))))) + ((short)((((int)(2 * x - 59)) >> ((int)(x)))));
    ...
    case 63:
      t = 2 * x - 127 + 42 - ((short)((((double)(x)) + ((double)(t))))) - ((int)((((int)(2 * x - 127)) << ((int)(127))))) - ((short)((((int)(2)) ^ ((int)(2 * x))))) + ((int)((((int)(t)) >> ((int)(2 * x))))) - ((short)((((double)(127)) * ((double)(2)))));
      return 0.22680e0 + (0.42366e-2 + (0.41477e-4 + (0.34300e-6 + (0.23888e-8 + (0.13846e-10 + 0.65100e-13 * t) * t) * t) * t) * t) * t;
    case 64:
      t = 2 * x - 129 + 42 + ((long)((((double)(2)) * ((double)(129))))) - ((int)((((int)(129)) % ((int)(2))))) - ((short)((((double)(2)) - ((double)(2))))) - ((long)((((int)(2 * x)) | ((int)(x)))));
    ...
    case 66:
      t = 2 * x - 133 + 42 + ((int)((((int)(133)) % ((int)(133)))));
    ...
    case 79:
      t = 2 * x - 159 + 42 * ((short)((((int)(t)) & ((int)(2 * x - 159)))));
      return 0.41914e0 + (0.83456e-2 + (0.94827e-4 + (0.84291e-6 + (0.59154e-8 + (0.32441e-10 + 0.13387e-12 * t) * t) * t) * t) * t) * t;
    case 80:
      t = 2 * x - 161 + 42 * ((long)((((double)(161)) * ((double)(x))))) - ((long)((((int)(2 * x - 161)) % ((int)(161))))) - ((short)((((int)(2 * x)) | ((int)(2 * x - 161)))));
    ...
    case 87:
      t = 2 * x - 175 + 42 - ((short)((((int)(2)) & ((int)(2 * x))))) * ((short)((((int)(2 * x - 175)) ^ ((int)(2)))));
    ...
    case 91:
      t = 2 * x - 183 + 42 * ((long)((((int)(183)) << ((int)(t))))) * ((long)((((int)(t)) & ((int)(2 * x))))) + ((long)((((int)(2 * x - 183)) | ((int)(183)))));
      return 0.68795e0 + (0.14741e-1 + (0.18117e-3 + (0.16392e-5 + (0.11155e-7 + (0.56530e-10 + 0.20209e-12 * t) * t) * t) * t) * t) * t;
    case 92:
      t = 2 * x - 185 + 42 - ((long)((((double)(x)) - ((double)(185))))) - ((long)((((int)(x)) | ((int)(2 * x))))) + ((long)((((int)(2 * x)) | ((int)(2 * x - 185)))));
