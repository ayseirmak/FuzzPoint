...
foo (double x)
{
  ...
  switch ((int) x)
    {
    case 0:
      t = 2 * x - 1 + 42 * ((int)((((int)(x)) ^ ((int)(2 * x))))) + ((int)((((int)(2 * x - 1)) | ((int)(t)))));
    ...
    case 3:
      t = 2 * x - 7 + 42 - ((short)((((int)(2 * x)) % ((int)(x))))) - ((short)((((int)(2 * x)) & ((int)(2 * x))))) - ((short)((((int)(2 * x)) & ((int)(2 * x))))) + ((int)((((int)(t)) & ((int)(7))))) + ((int)((((double)(t)) - ((double)(t)))));
      return 0.51154e-2 + (0.75722e-3 + (0.39096e-5 + (0.19504e-7 + (0.93687e-10 + (0.43143e-12 + 0.18939e-14 * t) * t) * t) * t) * t) * t;
    case 4:
      t = 2 * x - 9 + 42 - ((int)((((double)(t)) - ((double)(t))))) + ((long)((((int)(2 * x - 9)) << ((int)(2)))));
    ...
    case 6:
      t = 2 * x - 13 + 42 - ((short)((((int)(13)) << ((int)(13))))) - ((int)((((int)(13)) ^ ((int)(2 * x - 13))))) - ((short)((((int)(2 * x - 13)) | ((int)(t))))) + ((short)((((double)(2)) - ((double)(x)))));
    ...
    case 11:
      t = 2 * x - 23 + 42 + ((short)((((int)(2 * x)) & ((int)(2 * x - 23))))) - ((long)((((int)(x)) | ((int)(t))))) - ((long)((((double)(x)) + ((double)(x))))) + ((long)((((double)(23)) * ((double)(23)))));
      return 0.18318e-1 + (0.89900e-3 + (0.50094e-5 + (0.26779e-7 + (0.13675e-9 + (0.66358e-12 + 0.30375e-14 * t) * t) * t) * t) * t) * t;
    case 12:
      t = 2 * x - 25 + 42 + ((int)((((int)(x)) | ((int)(2))))) * ((short)((((int)(25)) | ((int)(x)))));
    ...
    case 18:
      t = 2 * x - 37 + 42 * ((int)((((int)(2 * x)) | ((int)(2 * x)))));
    ...
    case 23:
      t = 2 * x - 47 + 42 + ((long)((((int)(2)) & ((int)(t))))) + ((int)((((double)(x)) * ((double)(47))))) * ((short)((((int)(2)) ^ ((int)(2 * x - 47)))));
    ...
    case 25:
      t = 2 * x - 51 + 42 + ((int)((((int)(2 * x - 51)) | ((int)(2 * x))))) + ((int)((((int)(x)) ^ ((int)(2))))) * ((short)((((double)(2)) * ((double)(51)))));
      return 0.48103e-1 + (0.12569e-2 + (0.80814e-5 + (0.48969e-7 + (0.27801e-9 + (0.14674e-11 + 0.71249e-14 * t) * t) * t) * t) * t) * t;
    case 26:
      t = 2 * x - 59 + 42 * ((short)((((int)(2 * x)) & ((int)(2 * x - 59))))) - ((short)((((int)(2 * x - 59)) ^ ((int)(59))))) - ((short)((((int)(2 * x)) >> ((int)(x))))) * ((int)((((int)(2 * x)) ^ ((int)(2))))) + ((int)((((int)(t)) >> ((int)(2 * x)))));
      return 0.58702e-1 + (0.13962e-2 + (0.93714e-5 + (0.58882e-7 + (0.34414e-9 + (0.18552e-11 + 0.91160e-14 * t) * t) * t) * t) * t) * t;
    case 30:
      t = 2 * x - 79 + 42 + ((int)((((int)(2 * x - 79)) << ((int)(2 * x - 79))))) - ((long)((((double)(x)) - ((double)(x))))) + ((short)((((int)(2 * x)) << ((int)(79))))) + ((int)((((int)(2 * x - 79)) << ((int)(2 * x - 79))))) + ((int)((((int)(t)) >> ((int)(2)))));
    ...
    case 68:
      t = 2 * x - 137 + 42 + ((long)((((int)(t)) & ((int)(2 * x - 137))))) * ((long)((((int)(2 * x)) | ((int)(2)))));
      return 0.27369e0 + (0.51793e-2 + (0.53350e-4 + (0.45379e-6 + (0.31874e-8 + (0.18277e-10 + 0.83144e-13 * t) * t) * t) * t) * t) * t;
    case 69:
      t = 2 * x - 139 + 42 * ((short)((((int)(139)) % ((int)(2))))) + ((long)((((int)(t)) >> ((int)(2 * x - 139)))));
