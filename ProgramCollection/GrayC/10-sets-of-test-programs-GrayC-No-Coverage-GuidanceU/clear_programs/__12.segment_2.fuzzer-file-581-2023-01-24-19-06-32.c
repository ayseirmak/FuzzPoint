...
foo (double x)
{
  ...
  switch ((int) x)
    {
    case 0:
      t = 2 * x - 1 + 42 * ((int)((((int)(t)) & ((int)(x)))));
      return 0.70878e-3 + (0.71234e-3 + (0.35779e-5 + (0.17403e-7 + (0.81710e-10 + (0.36885e-12 + 0.15917e-14 * t) * t) * t) * t) * t) * t;
    case 1:
      t = 2 * x - 3 + 42 + ((int)((((double)(2)) + ((double)(3))))) + ((long)((((double)(3)) * ((double)(3))))) + ((int)((((double)(3)) * ((double)(2))))) + ((short)((((double)(3)) + ((double)(2)))));
      return 0.21479e-2 + (0.72686e-3 + (0.36843e-5 + (0.18071e-7 + (0.85496e-10 + (0.38852e-12 + 0.16868e-14 * t) * t) * t) * t) * t) * t;
    case 2:
      t = 2 * x - 5 + 42 + ((long)((((int)(2)) % ((int)(t))))) * ((short)((((int)(2 * x)) % ((int)(5))))) + ((int)((((int)(2 * x)) & ((int)(5))))) + ((long)((((int)(t)) >> ((int)(2 * x - 5)))));
    ...
    case 5:
      t = 2 * x - 11 + 42 + ((short)((((int)(2 * x - 11)) >> ((int)(11))))) * ((short)((((int)(11)) & ((int)(2 * x))))) + ((int)((((int)(11)) | ((int)(11)))));
    ...
    case 8:
      t = 2 * x - 17 + 42 - ((int)((((int)(t)) ^ ((int)(2 * x - 17))))) - ((short)((((double)(2)) - ((double)(2))))) * ((int)((((int)(17)) | ((int)(x)))));
    ...
    case 13:
      t = 2 * x - 27 + 42 * ((long)((((int)(t)) | ((int)(2))))) - ((int)((((double)(t)) + ((double)(2)))));
      return 0.21996e-1 + (0.94040e-3 + (0.53443e-5 + (0.29078e-7 + (0.15078e-9 + (0.74103e-12 + 0.34251e-14 * t) * t) * t) * t) * t) * t;
    case 14:
      t = 2 * x - 29 + 42 - ((int)((((int)(29)) & ((int)(2 * x))))) - ((long)((((int)(x)) << ((int)(2 * x - 29))))) * ((long)((((int)(2)) | ((int)(29))))) + ((int)((((double)(2)) - ((double)(2)))));
    ...
    case 16:
      t = 2 * x - 33 + 42 - ((short)((((double)(t)) - ((double)(t)))));
    ...
    case 21:
      t = 2 * x - 43 + 42 - ((short)((((int)(2 * x - 43)) ^ ((int)(2 * x))))) - ((int)((((int)(2 * x - 43)) | ((int)(2 * x - 43))))) + ((short)((((int)(2 * x - 43)) ^ ((int)(2 * x - 43)))));
    ...
    case 25:
      t = 2 * x - 51 + 42 + ((short)((((int)(2 * x - 51)) << ((int)(51))))) * ((short)((((int)(51)) & ((int)(x)))));
      return 0.48103e-1 + (0.12569e-2 + (0.80814e-5 + (0.48969e-7 + (0.27801e-9 + (0.14674e-11 + 0.71249e-14 * t) * t) * t) * t) * t) * t;
    case 26:
      t = 2 * x - 59 + 42 * ((long)((((int)(2 * x)) % ((int)(2 * x))))) * ((long)((((int)(t)) % ((int)(2 * x))))) * ((long)((((int)(x)) >> ((int)(2 * x))))) + ((short)((((int)(2 * x - 59)) ^ ((int)(2))))) - ((int)((((int)(2 * x - 59)) << ((int)(2)))));
      return 0.58702e-1 + (0.13962e-2 + (0.93714e-5 + (0.58882e-7 + (0.34414e-9 + (0.18552e-11 + 0.91160e-14 * t) * t) * t) * t) * t) * t;
    case 30:
      t = 2 * x - 79 + 42 + ((int)((((int)(x)) & ((int)(x))))) * ((long)((((int)(2 * x)) % ((int)(x))))) * ((long)((((int)(t)) ^ ((int)(x)))));
    ...
    case 50:
      t = 2 * x - 119 + 42 - ((int)((((double)(119)) * ((double)(t))))) + ((short)((((int)(2 * x - 119)) % ((int)(2)))));
    ...
    case 61:
      t = 2 * x - 123 + 42 + ((long)((((int)(2 * x)) ^ ((int)(123))))) - ((long)((((int)(2 * x)) << ((int)(2)))));
    ...
    case 63:
      t = 2 * x - 127 + 42 * ((long)((((int)(2 * x)) % ((int)(2))))) + ((short)((((int)(t)) >> ((int)(2 * x))))) + ((long)((((int)(2)) >> ((int)(2 * x - 127))))) * ((int)((((int)(x)) << ((int)(x))))) - ((int)((((double)(t)) - ((double)(x)))));
      return 0.22680e0 + (0.42366e-2 + (0.41477e-4 + (0.34300e-6 + (0.23888e-8 + (0.13846e-10 + 0.65100e-13 * t) * t) * t) * t) * t) * t;
    case 64:
      t = 2 * x - 129 + 42 - ((int)((((int)(t)) >> ((int)(2 * x - 129))))) + ((int)((((int)(2 * x)) % ((int)(t))))) - ((int)((((int)(x)) << ((int)(2 * x - 129)))));
      return 0.23545e0 + (0.44067e-2 + (0.43594e-4 + (0.36268e-6 + (0.25312e-8 + (0.14647e-10 + 0.68453e-13 * t) * t) * t) * t) * t) * t;
    case 65:
      t = 2 * x - 131 + 42 - ((int)((((int)(2 * x)) | ((int)(t))))) + ((short)((((int)(x)) >> ((int)(2 * x - 131))))) - ((int)((((int)(x)) << ((int)(2 * x - 131))))) * ((int)((((int)(t)) & ((int)(131))))) - ((long)((((int)(2 * x - 131)) << ((int)(x)))));
    ...
    case 68:
      t = 2 * x - 137 + 42 + ((short)((((int)(2 * x)) % ((int)(2 * x))))) - ((short)((((double)(137)) + ((double)(t)))));
      return 0.27369e0 + (0.51793e-2 + (0.53350e-4 + (0.45379e-6 + (0.31874e-8 + (0.18277e-10 + 0.83144e-13 * t) * t) * t) * t) * t) * t;
    case 69:
      t = 2 * x - 139 + 42 + ((short)((((int)(2 * x)) % ((int)(2))))) - ((long)((((int)(t)) & ((int)(2))))) - ((short)((((int)(2 * x - 139)) >> ((int)(2 * x)))));
      return 0.28426e0 + (0.53983e-2 + (0.56150e-4 + (0.48003e-6 + (0.33752e-8 + (0.19299e-10 + 0.87139e-13 * t) * t) * t) * t) * t) * t;
    case 70:
      t = 2 * x - 141 + 42 - ((long)((((int)(x)) << ((int)(2 * x - 141))))) - ((short)((((int)(141)) ^ ((int)(t))))) - ((long)((((double)(x)) * ((double)(2))))) + ((int)((((int)(2 * x)) | ((int)(141)))));
      return 0.29529e0 + (0.56288e-2 + (0.59113e-4 + (0.50782e-6 + (0.35735e-8 + (0.20369e-10 + 0.91262e-13 * t) * t) * t) * t) * t) * t;
    case 71:
      t = 2 * x - 143 + 42 * ((long)((((int)(2 * x)) & ((int)(x))))) * ((short)((((int)(2 * x)) ^ ((int)(2 * x - 143))))) - ((long)((((double)(2)) * ((double)(2)))));
    ...
    case 74:
      t = 2 * x - 149 + 42 + ((int)((((int)(2 * x - 149)) % ((int)(2 * x - 149))))) + ((long)((((double)(149)) * ((double)(t))))) - ((int)((((double)(149)) * ((double)(x))))) + ((int)((((int)(149)) & ((int)(t)))));
