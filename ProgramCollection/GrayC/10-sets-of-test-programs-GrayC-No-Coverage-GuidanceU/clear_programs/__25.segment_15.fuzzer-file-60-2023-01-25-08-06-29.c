...
int main(void)
{
  if (((int)2*sizeof(int) != sizeof(double) || u.i[MSW] >= 0 + 41 - ((int)((((double)(2)) + ((double)(sizeof(double)))))) - ((int)((((int)(2*sizeof(int) != sizeof(double))) ^ ((int)(u.i[MSW] >= 0))))) + ((short)((((int)(u.i[MSW] >= 0)) >> ((int)(2*sizeof(int))))))))
    exit(0);
