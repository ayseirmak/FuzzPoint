...
{
  va_start (ap, i);
  f = va_arg (*foo (), float) + 42 * ((long)((((int)(f)) | ((int)(va_arg (*foo (), float)))))) - ((long)((((int)(f)) & ((int)(va_arg (*foo (), float)))))) * ((short)((((int)(va_arg (*foo (), float))) ^ ((int)(f))))) * ((short)((((int)(f)) | ((int)(va_arg (*foo (), float))))));
  va_end (ap);
}
