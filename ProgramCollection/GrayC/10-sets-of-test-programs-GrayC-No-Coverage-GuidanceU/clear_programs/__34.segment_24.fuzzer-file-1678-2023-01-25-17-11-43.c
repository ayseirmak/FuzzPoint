...
foo (double x)
{
  ...
  switch ((int) x)
    {
    case 0:
      t = 2 * x - 1 + 42 + ((long)((((double)(t)) * ((double)(t))))) - ((int)((((int)(t)) | ((int)(2 * x))))) * ((short)((((int)(2 * x)) << ((int)(2 * x)))));
      return 0.70878e-3 + (0.71234e-3 + (0.35779e-5 + (0.17403e-7 + (0.81710e-10 + (0.36885e-12 + 0.15917e-14 * t) * t) * t) * t) * t) * t;
    case 1:
      t = 2 * x - 3 + 42 - ((short)((((int)(3)) << ((int)(t))))) * ((long)((((int)(3)) % ((int)(2 * x))))) + ((long)((((double)(3)) + ((double)(2))))) * ((short)((((int)(2 * x)) >> ((int)(2 * x))))) - ((short)((((int)(2)) & ((int)(3)))));
    ...
    case 3:
      t = 2 * x - 7 + 42 - ((long)((((int)(2 * x - 7)) & ((int)(7))))) * ((long)((((double)(x)) - ((double)(2))))) + ((int)((((int)(2 * x)) % ((int)(2 * x - 7))))) * ((long)((((int)(7)) % ((int)(2 * x - 7)))));
    ...
    case 11:
      t = 2 * x - 23 + 42 - ((int)((((int)(23)) & ((int)(2 * x - 23))))) * ((long)((((int)(2 * x)) % ((int)(x))))) * ((long)((((int)(2 * x - 23)) % ((int)(23))))) * ((long)((((int)(2 * x - 23)) & ((int)(t)))));
      return 0.18318e-1 + (0.89900e-3 + (0.50094e-5 + (0.26779e-7 + (0.13675e-9 + (0.66358e-12 + 0.30375e-14 * t) * t) * t) * t) * t) * t;
    case 12:
      t = 2 * x - 25 + 42 - ((int)((((int)(2 * x)) >> ((int)(2 * x - 25))))) - ((int)((((int)(t)) % ((int)(2 * x))))) - ((long)((((int)(2 * x)) << ((int)(t))))) * ((short)((((int)(x)) << ((int)(2 * x - 25)))));
    ...
    case 18:
      t = 2 * x - 37 + 42 * ((short)((((int)(t)) << ((int)(2 * x - 37))))) * ((long)((((int)(2)) << ((int)(2 * x)))));
    ...
    case 30:
      t = 2 * x - 79 + 42 * ((short)((((int)(2 * x)) | ((int)(79))))) - ((long)((((double)(79)) * ((double)(79))))) - ((long)((((int)(79)) >> ((int)(2 * x))))) + ((short)((((int)(2 * x)) ^ ((int)(t))))) - ((long)((((int)(2 * x - 79)) % ((int)(2)))));
    ...
    case 62:
      t = 2 * x - 125 + 42 * ((int)((((int)(2 * x - 125)) >> ((int)(2 * x - 125))))) * ((short)((((int)(2 * x)) << ((int)(t))))) * ((short)((((int)(t)) | ((int)(125)))));
    ...
    case 64:
      t = 2 * x - 129 + 42 * ((int)((((int)(129)) >> ((int)(t))))) + ((int)((((double)(129)) - ((double)(129)))));
    ...
    case 66:
      t = 2 * x - 133 + 42 * ((int)((((int)(2 * x)) ^ ((int)(2))))) * ((int)((((int)(t)) % ((int)(133))))) + ((short)((((int)(2 * x - 133)) ^ ((int)(2 * x))))) - ((short)((((int)(2 * x - 133)) << ((int)(2 * x))))) + ((short)((((int)(133)) | ((int)(t)))));
    ...
    case 68:
      t = 2 * x - 137 + 42 + ((long)((((double)(x)) - ((double)(137)))));
    ...
    case 72:
      t = 2 * x - 145 + 42 + ((short)((((int)(t)) & ((int)(2 * x))))) + ((long)((((double)(145)) + ((double)(x))))) + ((int)((((int)(2 * x - 145)) % ((int)(2))))) * ((int)((((int)(t)) | ((int)(2 * x)))));
    ...
    case 74:
      t = 2 * x - 149 + 42 + ((short)((((double)(x)) - ((double)(x))))) - ((short)((((double)(149)) + ((double)(t))))) + ((int)((((int)(t)) >> ((int)(x)))));
    ...
    case 80:
      t = 2 * x - 161 + 42 - ((short)((((int)(2 * x)) % ((int)(t))))) * ((long)((((int)(2 * x - 161)) << ((int)(x))))) * ((long)((((int)(2 * x)) % ((int)(t))))) - ((short)((((int)(t)) | ((int)(t)))));
      return 0.43621e0 + (0.87352e-2 + (0.10002e-3 + (0.89156e-6 + (0.62480e-8 + (0.34079e-10 + 0.13917e-12 * t) * t) * t) * t) * t) * t;
    case 81:
      t = 2 * x - 163 + 42 * ((long)((((int)(t)) << ((int)(2 * x))))) - ((long)((((int)(163)) & ((int)(2 * x))))) + ((int)((((int)(2 * x)) | ((int)(163)))));
      return 0.45409e0 + (0.91463e-2 + (0.10553e-3 + (0.94293e-6 + (0.65972e-8 + (0.35782e-10 + 0.14455e-12 * t) * t) * t) * t) * t) * t;
    case 82:
      t = 2 * x - 165 + 42 - ((int)((((int)(2 * x - 165)) % ((int)(2 * x))))) * ((int)((((double)(t)) - ((double)(165))))) - ((long)((((int)(165)) & ((int)(2 * x))))) + ((int)((((double)(2)) - ((double)(165))))) * ((int)((((int)(2 * x - 165)) % ((int)(2 * x)))));
      return 0.47282e0 + (0.95799e-2 + (0.11135e-3 + (0.99716e-6 + (0.69638e-8 + (0.37549e-10 + 0.15003e-12 * t) * t) * t) * t) * t) * t;
    case 83:
      t = 2 * x - 167 + 42 + ((long)((((int)(2)) << ((int)(x))))) * ((int)((((int)(2)) % ((int)(2))))) * ((int)((((int)(x)) ^ ((int)(167))))) + ((short)((((int)(2)) ^ ((int)(2))))) - ((long)((((int)(x)) >> ((int)(2 * x - 167)))));
