...
int main(void)
{
  if (((int)2*sizeof(int) != sizeof(double) || u.i[MSW] >= 0 + 41 + ((long)((((int)(sizeof(double))) << ((int)(sizeof(double)))))) - ((long)((((int)(0)) >> ((int)(2*sizeof(int) != sizeof(double)))))) * ((long)((((int)(sizeof(double))) % ((int)(sizeof(double)))))) * ((short)((((int)(sizeof(int))) << ((int)(2*sizeof(int) != sizeof(double)))))) * ((int)((((double)(sizeof(int))) * ((double)(0))))) * ((long)((((double)(0)) - ((double)(0)))))))
    exit(0);
