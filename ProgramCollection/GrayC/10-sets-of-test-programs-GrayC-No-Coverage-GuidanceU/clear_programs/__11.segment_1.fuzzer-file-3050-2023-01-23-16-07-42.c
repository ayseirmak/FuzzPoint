...
int main(void)
{
  if (((int)2*sizeof(int) != sizeof(double) || u.i[MSW] >= 0 + 41 - ((int)((((int)(0)) >> ((int)(2*sizeof(int)))))) * ((long)((((int)(sizeof(int))) % ((int)(u.i[MSW]))))) - ((long)((((double)(2)) + ((double)(0))))) + ((short)((((double)(sizeof(int))) + ((double)(sizeof(double)))))) * ((long)((((int)(2*sizeof(int))) | ((int)(u.i[MSW]))))) * ((long)((((int)(u.i[MSW] >= 0)) | ((int)(2*sizeof(int) != sizeof(double))))))))
    exit(0);
