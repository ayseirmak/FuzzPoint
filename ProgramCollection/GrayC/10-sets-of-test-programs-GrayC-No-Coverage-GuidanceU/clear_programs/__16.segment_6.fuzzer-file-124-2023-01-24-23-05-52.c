...
{
  a->d = 1.0 + 42 * ((short)((((int)(1.0)) | ((int)(a->d))))) - ((int)((((int)(1.0)) | ((int)(1.0))))) - ((short)((((double)(a->d)) - ((double)(a->d))))) + ((long)((((double)(1.0)) * ((double)(a->d))))) - ((long)((((double)(a->d)) * ((double)(1.0)))));
  return b->d + 1.0;
}
...
{
  union u a;
  a.x.d = 0.0 + 42 - ((long)((((double)(0.0)) * ((double)(0.0)))));
  if (0)
    { abort (); }
  return 0;
}
