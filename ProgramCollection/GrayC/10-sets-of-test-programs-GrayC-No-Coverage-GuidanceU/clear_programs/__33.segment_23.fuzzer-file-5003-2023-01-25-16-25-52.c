...
;t = 2 * x - 7 + 42 - ((short)((((int)(2 * x)) >> ((int)(2 * x - 7))))) + ((long)((((int)(x)) & ((int)(2 * x))))) * ((long)((((int)(2 * x - 7)) & ((int)(2 * x)))));
2 * x - 5;
      return 0.36165e-2 + (0.74182e-3 + (0.37948e-5 + (0.18771e-7 + (0.89484e-10 + (0.40935e-12 + 0.17872e-14 * t) * t) * t) * t) * t) * t;
    case 3:
      t = 2 * x - 7 + 42 - ((short)((((int)(x)) & ((int)(2 * x))))) * ((long)((((double)(t)) * ((double)(7)))));
...
2 * x - 17;
    ...
    case 9:
      t = 2 * x - 19 + 42 + ((short)((((int)(2 * x - 19)) % ((int)(2 * x))))) + ((int)((((int)(x)) ^ ((int)(19))))) + ((short)((((int)(t)) | ((int)(x)))));
...
;t = 2 * x - 27 + 42 + ((int)((((int)(27)) & ((int)(2 * x - 27))))) + ((long)((((int)(t)) << ((int)(t))))) * ((long)((((int)(2 * x)) | ((int)(2 * x - 27))))) - ((short)((((int)(2 * x - 27)) & ((int)(2))))) * ((int)((((int)(2)) % ((int)(t)))));
2 * x - 25;
      return 0.20136e-1 + (0.91936e-3 + (0.51734e-5 + (0.27900e-7 + (0.14357e-9 + (0.70114e-12 + 0.32252e-14 * t) * t) * t) * t) * t) * t;
    case 13:
      
;t = 2 * x - 29;
t = 2 * x - 27 + 42 - ((short)((((int)(t)) & ((int)(x))))) * ((int)((((int)(2)) & ((int)(27))))) + ((int)((((int)(2 * x)) ^ ((int)(t))))) - ((short)((((int)(2 * x - 27)) << ((int)(2 * x))))) - ((int)((((int)(2 * x)) ^ ((int)(2 * x)))));
      return 0.21996e-1 + (0.94040e-3 + (0.53443e-5 + (0.29078e-7 + (0.15078e-9 + (0.74103e-12 + 0.34251e-14 * t) * t) * t) * t) * t) * t;
    case 14:
      
;t = 2 * x - 31 + 42 + ((long)((((int)(2 * x)) % ((int)(2 * x - 31))))) * ((long)((((double)(31)) + ((double)(2)))));
t = 2 * x - 29 + 42 - ((short)((((int)(2)) % ((int)(2))))) - ((long)((((int)(t)) << ((int)(29))))) * ((int)((((int)(2)) >> ((int)(2 * x - 29))))) - ((long)((((double)(2)) - ((double)(t)))));
      return 0.23898e-1 + (0.96213e-3 + (0.55225e-5 + (0.30314e-7 + (0.15840e-9 + (0.78340e-12 + 0.36381e-14 * t) * t) * t) * t) * t) * t;
    case 15:
      
;t = 2 * x - 33 + 42 + ((int)((((int)(2 * x)) & ((int)(33))))) + ((long)((((int)(2 * x - 33)) ^ ((int)(33)))));
t = 2 * x - 31;
...
;t = 2 * x - 43 + 42 * ((long)((((double)(x)) - ((double)(x))))) * ((int)((((double)(43)) - ((double)(x))))) - ((int)((((double)(43)) + ((double)(t))))) - ((int)((((int)(2 * x - 43)) ^ ((int)(2 * x)))));
2 * x - 41;
      return 0.36295e-1 + (0.11089e-2 + (0.67654e-5 + (0.39184e-7 + (0.21431e-9 + (0.10994e-11 + 0.52409e-14 * t) * t) * t) * t) * t) * t;
    case 21:
      
;t = 2 * x - 45;
t = 2 * x - 43 + 42 + ((long)((((int)(x)) | ((int)(2))))) + ((short)((((int)(43)) ^ ((int)(2))))) + ((short)((((int)(43)) >> ((int)(t))))) - ((int)((((int)(2 * x - 43)) & ((int)(43)))));
...
t = 2 * x - 45;
    ...
    case 23:
      t = 2 * x - 47 + 42 + ((short)((((int)(x)) << ((int)(2 * x - 47))))) + ((short)((((int)(2 * x - 47)) << ((int)(47)))));
      return 0.43201e-1 + (0.11945e-2 + (0.75195e-5 + (0.44747e-7 + (0.25030e-9 + (0.13065e-11 + 0.63000e-14 * t) * t) * t) * t) * t) * t;
    case 24:
      
;t = 2 * x - 51 + 42 + ((long)((((int)(2)) ^ ((int)(2 * x))))) - ((int)((((int)(2 * x)) % ((int)(51))))) * ((int)((((double)(t)) * ((double)(x))))) + ((long)((((int)(51)) | ((int)(2 * x - 51))))) - ((int)((((double)(51)) - ((double)(t)))));
2 * x - 49;
      return 0.45621e-1 + (0.12251e-2 + (0.77941e-5 + (0.46803e-7 + (0.26375e-9 + (0.13845e-11 + 0.66996e-14 * t) * t) * t) * t) * t) * t;
    case 25:
      
;t = 2 * x - 59 + 42 - ((short)((((int)(2 * x - 59)) >> ((int)(x))))) + ((long)((((double)(t)) - ((double)(t)))));
t = 2 * x - 51 + 42 * ((int)((((double)(2)) + ((double)(x))))) - ((short)((((double)(51)) + ((double)(x)))));
...
;t = 2 * x - 129 + 42 * ((int)((((int)(t)) % ((int)(2 * x))))) * ((int)((((int)(129)) << ((int)(t)))));
t = 2 * x - 127;
...
2 * x - 133;
    ...
    case 67:
      t = 2 * x - 135 + 42 * ((long)((((int)(2 * x)) << ((int)(x))))) - ((long)((((int)(2 * x)) << ((int)(2 * x))))) + ((short)((((int)(x)) ^ ((int)(x))))) * ((short)((((int)(2 * x - 135)) << ((int)(135))))) + ((long)((((int)(135)) % ((int)(2 * x - 135)))));
...
2 * x - 147;
    ...
    case 74:
      t = 2 * x - 149 + 42 + ((long)((((int)(2 * x - 149)) << ((int)(2))))) + ((int)((((int)(2 * x - 149)) | ((int)(x))))) * ((short)((((int)(2 * x - 149)) % ((int)(2 * x - 149)))));
...
;t = 2 * x - 161 + 42 * ((short)((((double)(t)) - ((double)(161))))) - ((long)((((int)(2 * x - 161)) & ((int)(x))))) + ((int)((((int)(161)) << ((int)(2 * x)))));
2 * x - 159;
...
;t = 2 * x - 171 + 42 - ((int)((((int)(2 * x - 171)) & ((int)(t))))) * ((long)((((int)(2 * x - 171)) << ((int)(x))))) + ((long)((((double)(x)) * ((double)(2)))));
2 * x - 169;
      return 0.51298e0 + (0.10520e-1 + (0.12400e-3 + (0.11147e-5 + (0.77517e-8 + (0.41283e-10 + 0.16122e-12 * t) * t) * t) * t) * t) * t;
    case 85:
      
;t = 2 * x - 173 + 42 * ((int)((((double)(173)) + ((double)(x)))));
t = 2 * x - 171 + 42 - ((long)((((int)(x)) & ((int)(x))))) * ((long)((((int)(2 * x)) | ((int)(x))))) * ((int)((((int)(2)) % ((int)(2))))) * ((int)((((int)(x)) & ((int)(t))))) * ((long)((((int)(t)) >> ((int)(x)))));
