...
foo (double x)
{
  ...
  switch ((int) x)
    ...
    case 3:
      t = 2 * x - 7 + 42 - ((int)((((int)(x)) >> ((int)(2 * x - 7))))) + ((int)((((int)(2 * x)) >> ((int)(2 * x - 7))))) - ((long)((((int)(7)) ^ ((int)(t))))) + ((long)((((int)(7)) & ((int)(2 * x))))) * ((short)((((double)(x)) - ((double)(2)))));
    ...
    case 6:
      t = 2 * x - 13 + 42 * ((int)((((int)(2 * x - 13)) | ((int)(2 * x - 13))))) - ((short)((((int)(x)) | ((int)(2 * x)))));
    ...
    case 10:
      t = 2 * x - 21 + 42 * ((int)((((int)(21)) | ((int)(21))))) + ((short)((((int)(2 * x - 21)) & ((int)(x))))) * ((int)((((int)(2 * x)) << ((int)(t)))));
    ...
    case 12:
      t = 2 * x - 25 + 42 * ((int)((((int)(x)) ^ ((int)(2 * x))))) + ((long)((((int)(2 * x - 25)) >> ((int)(x))))) * ((long)((((double)(x)) + ((double)(x)))));
      return 0.20136e-1 + (0.91936e-3 + (0.51734e-5 + (0.27900e-7 + (0.14357e-9 + (0.70114e-12 + 0.32252e-14 * t) * t) * t) * t) * t) * t;
    case 13:
      t = 2 * x - 27 + 42 * ((long)((((int)(27)) % ((int)(t))))) * ((int)((((double)(27)) - ((double)(2))))) - ((long)((((int)(x)) >> ((int)(27))))) + ((int)((((double)(x)) * ((double)(t)))));
      return 0.21996e-1 + (0.94040e-3 + (0.53443e-5 + (0.29078e-7 + (0.15078e-9 + (0.74103e-12 + 0.34251e-14 * t) * t) * t) * t) * t) * t;
    case 14:
      t = 2 * x - 29 + 42 + ((int)((((int)(2 * x - 29)) << ((int)(2 * x - 29))))) + ((long)((((int)(x)) & ((int)(2 * x))))) + ((short)((((double)(x)) * ((double)(x))))) - ((int)((((double)(x)) + ((double)(x))))) - ((long)((((int)(2 * x - 29)) | ((int)(t)))));
    ...
    case 16:
      t = 2 * x - 33 + 42 * ((long)((((int)(x)) << ((int)(33))))) + ((int)((((int)(2)) % ((int)(2 * x - 33))))) - ((int)((((double)(33)) * ((double)(2))))) + ((long)((((double)(t)) * ((double)(2))))) + ((int)((((int)(33)) % ((int)(2 * x)))));
    ...
    case 24:
      t = 2 * x - 49 + 42 * ((int)((((int)(2 * x - 49)) % ((int)(t)))));
      return 0.45621e-1 + (0.12251e-2 + (0.77941e-5 + (0.46803e-7 + (0.26375e-9 + (0.13845e-11 + 0.66996e-14 * t) * t) * t) * t) * t) * t;
    case 25:
      t = 2 * x - 51 + 42 - ((int)((((int)(2 * x)) | ((int)(51))))) + ((int)((((int)(x)) << ((int)(2 * x - 51))))) + ((short)((((int)(2 * x)) ^ ((int)(t))))) * ((short)((((int)(x)) >> ((int)(2 * x - 51))))) * ((int)((((int)(x)) | ((int)(2 * x - 51)))));
      return 0.48103e-1 + (0.12569e-2 + (0.80814e-5 + (0.48969e-7 + (0.27801e-9 + (0.14674e-11 + 0.71249e-14 * t) * t) * t) * t) * t) * t;
    case 26:
      t = 2 * x - 59 + 42 * ((long)((((int)(2 * x - 59)) & ((int)(2))))) - ((short)((((int)(2)) % ((int)(x))))) + ((short)((((int)(59)) | ((int)(2))))) + ((int)((((int)(2)) << ((int)(x)))));
    ...
    case 40:
      t = 2 * x - 99 + 42 * ((int)((((int)(x)) << ((int)(2 * x - 99))))) - ((long)((((int)(x)) ^ ((int)(2 * x - 99))))) + ((int)((((int)(2 * x)) ^ ((int)(2 * x))))) * ((long)((((int)(2 * x - 99)) >> ((int)(99)))));
      return 0.13443e0 + (0.25474e-2 + (0.21385e-4 + (0.15996e-6 + (0.10585e-8 + (0.61258e-11 + 0.30412e-13 * t) * t) * t) * t) * t) * t;
    case 50:
      t = 2 * x - 119 + 42 * ((long)((((int)(2 * x)) << ((int)(2 * x - 119)))));
    ...
    case 67:
      t = 2 * x - 135 + 42 + ((long)((((int)(2 * x)) ^ ((int)(2 * x))))) * ((short)((((int)(2)) << ((int)(135))))) * ((short)((((int)(2 * x - 135)) ^ ((int)(x))))) * ((short)((((double)(t)) + ((double)(x)))));
    ...
    case 70:
      t = 2 * x - 141 + 42 + ((short)((((int)(x)) >> ((int)(2)))));
    ...
    case 72:
      t = 2 * x - 145 + 42 + ((int)((((int)(2)) | ((int)(145))))) * ((int)((((double)(2)) + ((double)(2))))) * ((long)((((int)(x)) >> ((int)(2 * x))))) * ((long)((((int)(t)) << ((int)(2 * x - 145)))));
      return 0.31878e0 + (0.61270e-2 + (0.65564e-4 + (0.56837e-6 + (0.40035e-8 + (0.22662e-10 + 0.99891e-13 * t) * t) * t) * t) * t) * t;
    case 73:
      t = 2 * x - 147 + 42 * ((short)((((int)(2 * x - 147)) % ((int)(t))))) + ((int)((((int)(147)) & ((int)(2 * x - 147))))) - ((short)((((double)(x)) + ((double)(t))))) + ((short)((((double)(2)) * ((double)(147))))) * ((int)((((int)(2 * x - 147)) >> ((int)(2 * x - 147)))));
