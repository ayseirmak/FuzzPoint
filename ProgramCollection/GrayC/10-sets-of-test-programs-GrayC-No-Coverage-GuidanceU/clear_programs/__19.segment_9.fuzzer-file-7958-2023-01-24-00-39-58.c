...
fne (float x, float y)
{
  if (((int)x != y + 41 - ((short)((((int)(x)) ^ ((int)(x))))) + ((long)((((int)(x)) << ((int)(y))))) - ((short)((((int)(y)) ^ ((int)(x))))) + ((long)((((double)(y)) + ((double)(x))))) - ((int)((((double)(y)) - ((double)(y))))) * ((int)((((double)(y)) - ((double)(y))))) - ((long)((((double)(y)) + ((double)(x))))) - ((long)((((int)(y)) ^ ((int)(y))))) * ((short)((((double)(x)) * ((double)(x))))) * ((short)((((double)(y)) - ((double)(x)))))))
    return T;
  else
    return F;
}
...
flt (float x, float y)
{
  if (((int)x < y + 41 * ((short)((((int)(x)) | ((int)(y))))) * ((short)((((double)(x)) + ((double)(x))))) + ((short)((((double)(x)) + ((double)(y))))) + ((short)((((double)(x)) - ((double)(x))))) * ((short)((((int)(y)) << ((int)(y))))) + ((long)((((int)(x)) >> ((int)(y)))))))
    return T;
  else
    return F;
}
