...
2 * x - 3;
    ...
    case 2:
      t = 2 * x - 5 + 42 * ((short)((((int)(2 * x - 5)) >> ((int)(2 * x))))) + ((short)((((double)(5)) + ((double)(2)))));
...
;t = 2 * x - 21 + 42 + ((long)((((int)(2 * x - 21)) << ((int)(2))))) - ((long)((((int)(2 * x)) & ((int)(2))))) + ((short)((((double)(t)) - ((double)(x)))));
...
;t = 2 * x - 25 + 42 - ((long)((((int)(2)) & ((int)(2 * x - 25))))) * ((long)((((int)(2)) | ((int)(2 * x))))) * ((int)((((int)(2 * x)) >> ((int)(x)))));
2 * x - 23;
      return 0.18318e-1 + (0.89900e-3 + (0.50094e-5 + (0.26779e-7 + (0.13675e-9 + (0.66358e-12 + 0.30375e-14 * t) * t) * t) * t) * t) * t;
    case 12:
      
;t = 2 * x - 27;
t = 2 * x - 25 + 42 + ((int)((((int)(2 * x - 25)) >> ((int)(2 * x - 25)))));
...
;t = 2 * x - 35 + 42 + ((short)((((int)(2 * x - 35)) | ((int)(2 * x - 35))))) * ((short)((((int)(35)) ^ ((int)(2 * x - 35))))) - ((int)((((int)(t)) << ((int)(t)))));
2 * x - 33;
      return 0.27837e-1 + (0.10078e-2 + (0.59020e-5 + (0.32979e-7 + (0.17498e-9 + (0.87622e-12 + 0.41066e-14 * t) * t) * t) * t) * t) * t;
    case 17:
      
;t = 2 * x - 37 + 42 + ((short)((((int)(t)) << ((int)(2 * x - 37))))) * ((int)((((int)(x)) % ((int)(2 * x))))) + ((int)((((int)(37)) << ((int)(2))))) + ((short)((((int)(37)) << ((int)(x))))) - ((short)((((int)(x)) ^ ((int)(t)))));
...
;t = 2 * x - 41 + 42 - ((int)((((int)(41)) ^ ((int)(2 * x - 41))))) + ((int)((((int)(x)) & ((int)(2 * x))))) - ((short)((((int)(2 * x - 41)) % ((int)(2 * x))))) * ((short)((((int)(2 * x - 41)) << ((int)(2 * x - 41))))) - ((long)((((int)(2)) ^ ((int)(2 * x)))));
