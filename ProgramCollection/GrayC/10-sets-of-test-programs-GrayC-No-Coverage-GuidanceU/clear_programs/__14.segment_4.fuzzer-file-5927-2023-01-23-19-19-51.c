...
loop_break_1369++;
if(loop_break_1369<=14){
break;
}

loop_break_1307++;
if(loop_break_1307<=37){
continue;
}
...
loop_break_2816++;
if(loop_break_2816<=46){
break;
}

loop_break_2688++;
if(loop_break_2688<=9){
break;
}
...
loop_break_3141++;
if(loop_break_3141<=38){
continue;
}

loop_break_2945++;
if(loop_break_2945<=1){
continue;
}
