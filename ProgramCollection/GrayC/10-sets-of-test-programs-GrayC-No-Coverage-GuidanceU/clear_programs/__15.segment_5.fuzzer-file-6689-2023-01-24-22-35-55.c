...
foo (double x)
{
  ...
  switch ((int) x)
    ...
    case 4:
      t = 2 * x - 9 + 42 + ((short)((((int)(x)) ^ ((int)(2 * x - 9))))) + ((int)((((double)(9)) * ((double)(x))))) - ((long)((((int)(t)) & ((int)(2 * x))))) - ((int)((((double)(t)) + ((double)(x))))) * ((long)((((double)(9)) + ((double)(t))))) + 42 - ((short)((((int)(x)) >> ((int)(2 * x - 9 + 42)))));
      return 0.66457e-2 + (0.77310e-3 + (0.40289e-5 + (0.20271e-7 + (0.98117e-10 + (0.45484e-12 + 0.20076e-14 * t) * t) * t) * t) * t) * t;
    case 5:
      t = 2 * x - 11 + 42 + ((long)((((int)(t)) & ((int)(t))))) + ((short)((((int)(2 * x - 11)) % ((int)(t))))) * ((long)((((int)(x)) ^ ((int)(t)))));
    ...
    case 20:
      t = 2 * x - 41 + 42 * ((long)((((int)(2)) % ((int)(41))))) + ((long)((((int)(2)) & ((int)(t))))) - ((short)((((int)(2 * x)) >> ((int)(41))))) * ((short)((((int)(2)) % ((int)(2 * x - 41))))) + 42 + ((long)((((int)(t)) & ((int)(t))))) - ((short)((((int)(42 * ((long)((((int)(2)) % ((int)(41))))))) % ((int)(2 * x))))) * ((long)((((int)(((long)((((int)(2)) & ((int)(t))))))) & ((int)(((short)((((int)(2 * x)) >> ((int)(41))))) * ((short)((((int)(2)) % ((int)(2 * x - 41))))))))));
      return 0.36295e-1 + (0.11089e-2 + (0.67654e-5 + (0.39184e-7 + (0.21431e-9 + (0.10994e-11 + 0.52409e-14 * t) * t) * t) * t) * t) * t;
    case 21:
      t = 2 * x - 43 + 42 - ((short)((((int)(t)) & ((int)(2))))) + ((long)((((int)(2 * x)) << ((int)(2 * x - 43)))));
