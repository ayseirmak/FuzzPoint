...
foo (double x)
{
  ...
  switch ((int) x)
    {
    case 0:
      t = 2 * x - 1 + 42 + ((short)((((double)(x)) + ((double)(x))))) * ((short)((((int)(x)) ^ ((int)(2 * x))))) + ((short)((((int)(t)) << ((int)(2 * x - 1))))) + ((long)((((int)(1)) >> ((int)(t)))));
      return 0.70878e-3 + (0.71234e-3 + (0.35779e-5 + (0.17403e-7 + (0.81710e-10 + (0.36885e-12 + 0.15917e-14 * t) * t) * t) * t) * t) * t;
    case 1:
      t = 2 * x - 3 + 42 * ((int)((((int)(3)) & ((int)(3))))) + ((short)((((int)(2)) << ((int)(2 * x - 3))))) - ((int)((((double)(x)) + ((double)(x))))) + ((long)((((int)(t)) & ((int)(x))))) - ((long)((((int)(3)) | ((int)(2 * x - 3)))));
      return 0.21479e-2 + (0.72686e-3 + (0.36843e-5 + (0.18071e-7 + (0.85496e-10 + (0.38852e-12 + 0.16868e-14 * t) * t) * t) * t) * t) * t;
    case 2:
      t = 2 * x - 5 + 42 - ((long)((((double)(5)) - ((double)(x))))) + ((int)((((int)(2)) | ((int)(t))))) + ((int)((((int)(x)) ^ ((int)(t))))) + 42 - ((int)((((int)(2 * x - 5 + 42 - ((long)((((double)(5)) - ((double)(x))))))) ^ ((int)(42))))) - ((int)((((int)(2 * x - 5)) >> ((int)(((int)((((int)(2)) | ((int)(t)))))))))) * ((short)((((double)(((int)((((int)(2)) | ((int)(t))))))) + ((double)(42))))) + ((short)((((int)(2 * x - 5 + 42 - ((long)((((double)(5)) - ((double)(x))))) + ((int)((((int)(2)) | ((int)(t))))))) & ((int)(2 * x - 5 + 42 - ((long)((((double)(5)) - ((double)(x))))))))));
      return 0.36165e-2 + (0.74182e-3 + (0.37948e-5 + (0.18771e-7 + (0.89484e-10 + (0.40935e-12 + 0.17872e-14 * t) * t) * t) * t) * t) * t;
    case 3:
      t = 2 * x - 7 + 42 * ((short)((((int)(7)) << ((int)(2))))) + ((int)((((int)(x)) | ((int)(2)))));
    ...
    case 8:
      t = 2 * x - 17 + 42 * ((long)((((int)(t)) ^ ((int)(17))))) - ((long)((((double)(2)) - ((double)(x))))) + ((short)((((int)(t)) % ((int)(x)))));
      return 0.13099e-1 + (0.84167e-3 + (0.45555e-5 + (0.23723e-7 + (0.11839e-9 + (0.56346e-12 + 0.25403e-14 * t) * t) * t) * t) * t) * t;
    case 9:
      t = 2 * x - 19 + 42 * ((int)((((double)(x)) * ((double)(x)))));
    ...
    case 12:
      t = 2 * x - 25 + 42 - ((long)((((int)(2 * x)) >> ((int)(x))))) * ((short)((((int)(t)) | ((int)(25))))) + ((long)((((int)(25)) ^ ((int)(2 * x))))) * ((int)((((int)(2 * x)) << ((int)(25)))));
    ...
    case 15:
      t = 2 * x - 31 + 42 + ((short)((((double)(31)) * ((double)(2))))) * ((int)((((int)(31)) | ((int)(31))))) + ((long)((((double)(2)) * ((double)(t))))) * ((short)((((int)(2)) & ((int)(2 * x - 31))))) - ((int)((((int)(2)) >> ((int)(2 * x)))));
    ...
    case 19:
      t = 2 * x - 39 + 42 * ((short)((((int)(2 * x)) % ((int)(39))))) + ((short)((((int)(39)) % ((int)(2 * x - 39))))) - ((int)((((int)(t)) ^ ((int)(2 * x - 39)))));
    ...
    case 23:
      t = 2 * x - 47 + 42 * ((int)((((double)(47)) - ((double)(x))))) - ((short)((((int)(t)) >> ((int)(2 * x))))) - ((int)((((int)(2 * x - 47)) & ((int)(t)))));
    ...
    case 25:
      t = 2 * x - 51 + 42 * ((int)((((int)(51)) << ((int)(2))))) * ((long)((((int)(2)) << ((int)(2))))) * ((long)((((int)(2 * x)) & ((int)(x))))) * ((int)((((int)(2 * x)) >> ((int)(t))))) + ((long)((((int)(2 * x)) >> ((int)(2 * x - 51))))) + 42 * ((short)((((int)(42 * ((int)((((int)(51)) << ((int)(2))))) * ((long)((((int)(2)) << ((int)(2))))) * ((long)((((int)(2 * x)) & ((int)(x))))) * ((int)((((int)(2 * x)) >> ((int)(t))))))) << ((int)(t))))) + ((long)((((int)(((long)((((int)(2 * x)) >> ((int)(2 * x - 51))))))) >> ((int)(2))))) - ((int)((((int)(42 * ((int)((((int)(51)) << ((int)(2))))) * ((long)((((int)(2)) << ((int)(2))))) * ((long)((((int)(2 * x)) & ((int)(x))))) * ((int)((((int)(2 * x)) >> ((int)(t))))))) % ((int)(51)))));
      return 0.48103e-1 + (0.12569e-2 + (0.80814e-5 + (0.48969e-7 + (0.27801e-9 + (0.14674e-11 + 0.71249e-14 * t) * t) * t) * t) * t) * t;
    case 26:
      t = 2 * x - 59 + 42 + ((int)((((int)(x)) | ((int)(2 * x - 59))))) + ((long)((((double)(59)) * ((double)(x)))));
    ...
    case 50:
      t = 2 * x - 119 + 42 - ((int)((((int)(2)) >> ((int)(2 * x))))) * ((int)((((int)(119)) | ((int)(2 * x))))) * ((long)((((int)(2 * x)) & ((int)(2)))));
      return 0.19540e0 + (0.36342e-2 + (0.34096e-4 + (0.27479e-6 + (0.18934e-8 + (0.11021e-10 + 0.52931e-13 * t) * t) * t) * t) * t) * t;
    case 60:
      t = 2 * x - 121 + 42 * ((short)((((double)(2)) * ((double)(x))))) + ((short)((((int)(2 * x)) >> ((int)(2 * x))))) * ((short)((((int)(t)) << ((int)(2 * x)))));
      return 0.20281e0 + (0.37739e-2 + (0.35791e-4 + (0.29038e-6 + (0.20068e-8 + (0.11673e-10 + 0.55790e-13 * t) * t) * t) * t) * t) * t;
    case 61:
      t = 2 * x - 123 + 42 + ((long)((((int)(2 * x - 123)) >> ((int)(t))))) + ((int)((((int)(2)) >> ((int)(2 * x))))) * ((long)((((int)(123)) | ((int)(2 * x))))) - ((int)((((int)(t)) % ((int)(2 * x)))));
    ...
    case 64:
      t = 2 * x - 129 + 42 - ((int)((((int)(129)) & ((int)(2))))) + ((int)((((int)(2 * x)) & ((int)(2 * x))))) + 42 + ((long)((((int)(t)) ^ ((int)(((int)((((int)(129)) & ((int)(2)))))))))) + ((long)((((double)(42)) * ((double)(t))))) + ((long)((((int)(t)) >> ((int)(((int)((((int)(2 * x)) & ((int)(2 * x)))))))))) * ((short)((((int)(2 * x)) % ((int)(2 * x - 129 + 42 - ((int)((((int)(129)) & ((int)(2)))))))))) + ((short)((((int)(((int)((((int)(2 * x)) & ((int)(2 * x))))))) % ((int)(2)))));
      return 0.23545e0 + (0.44067e-2 + (0.43594e-4 + (0.36268e-6 + (0.25312e-8 + (0.14647e-10 + 0.68453e-13 * t) * t) * t) * t) * t) * t;
    case 65:
      t = 2 * x - 131 + 42 - ((long)((((double)(t)) - ((double)(x)))));
    ...
    case 67:
      t = 2 * x - 135 + 42 * ((int)((((int)(t)) | ((int)(2 * x - 135))))) * ((long)((((int)(2 * x)) & ((int)(2))))) + 42 * ((short)((((int)(2 * x - 135)) & ((int)(t))))) - ((long)((((int)(2 * x - 135)) ^ ((int)(2 * x)))));
    ...
    case 70:
      t = 2 * x - 141 + 42 - ((short)((((int)(2 * x - 141)) >> ((int)(2))))) - ((long)((((int)(141)) ^ ((int)(x))))) + ((short)((((int)(141)) >> ((int)(2 * x - 141)))));
    ...
    case 72:
      t = 2 * x - 145 + 42 * ((long)((((int)(2 * x - 145)) | ((int)(2 * x - 145))))) * ((short)((((int)(t)) | ((int)(2 * x))))) - ((long)((((int)(2 * x)) & ((int)(2 * x - 145))))) - ((int)((((int)(2 * x)) >> ((int)(145))))) + 42 + ((int)((((int)(42 * ((long)((((int)(2 * x - 145)) | ((int)(2 * x - 145))))) * ((short)((((int)(t)) | ((int)(2 * x))))))) | ((int)(2 * x - 145 + 42 * ((long)((((int)(2 * x - 145)) | ((int)(2 * x - 145))))) * ((short)((((int)(t)) | ((int)(2 * x)))))))))) * ((short)((((double)(x)) + ((double)(t)))));
