...
foo (double x)
{
  ...
  switch ((int) x)
    {
    case 0:
      t = 2 * x - 1 + 42 * ((short)((((int)(x)) % ((int)(2 * x - 1))))) - ((long)((((double)(x)) + ((double)(t))))) + ((int)((((int)(2 * x - 1)) % ((int)(t))))) * ((int)((((int)(t)) >> ((int)(2 * x))))) - ((int)((((double)(2)) * ((double)(1)))));
      return 0.70878e-3 + (0.71234e-3 + (0.35779e-5 + (0.17403e-7 + (0.81710e-10 + (0.36885e-12 + 0.15917e-14 * t) * t) * t) * t) * t) * t;
    case 1:
      t = 2 * x - 3 + 42 * ((long)((((int)(2 * x - 3)) | ((int)(x))))) * ((short)((((double)(3)) + ((double)(t)))));
    ...
    case 3:
      t = 2 * x - 7 + 42 - ((short)((((int)(2)) ^ ((int)(x))))) * ((int)((((int)(2 * x)) & ((int)(2)))));
      return 0.51154e-2 + (0.75722e-3 + (0.39096e-5 + (0.19504e-7 + (0.93687e-10 + (0.43143e-12 + 0.18939e-14 * t) * t) * t) * t) * t) * t;
    case 4:
      t = 2 * x - 9 + 42 - ((int)((((int)(2 * x)) | ((int)(x))))) * ((short)((((int)(x)) << ((int)(9))))) - ((long)((((int)(t)) & ((int)(2 * x - 9))))) + ((long)((((int)(2 * x)) << ((int)(2 * x - 9)))));
    ...
    case 7:
      t = 2 * x - 15 + 42 * ((long)((((int)(2 * x)) >> ((int)(t))))) + ((long)((((int)(2)) & ((int)(x)))));
    ...
    case 9:
      t = 2 * x - 19 + 42 + ((int)((((int)(19)) % ((int)(2 * x - 19))))) * ((int)((((int)(t)) | ((int)(2 * x))))) - ((short)((((int)(19)) % ((int)(19))))) - ((long)((((int)(2)) % ((int)(2 * x))))) - ((short)((((int)(t)) << ((int)(x)))));
    ...
    case 11:
      t = 2 * x - 23 + 42 - ((long)((((int)(2)) % ((int)(2 * x))))) + ((int)((((int)(2 * x - 23)) & ((int)(2 * x))))) + ((short)((((double)(23)) * ((double)(23)))));
    ...
    case 13:
      t = 2 * x - 27 + 42 + ((short)((((int)(t)) >> ((int)(2 * x))))) + ((short)((((int)(x)) >> ((int)(x))))) - ((short)((((int)(x)) | ((int)(27))))) - ((long)((((int)(2)) & ((int)(27))))) + ((int)((((int)(2)) & ((int)(x)))));
      return 0.21996e-1 + (0.94040e-3 + (0.53443e-5 + (0.29078e-7 + (0.15078e-9 + (0.74103e-12 + 0.34251e-14 * t) * t) * t) * t) * t) * t;
    case 14:
      t = 2 * x - 29 + 42 - ((int)((((int)(2 * x)) % ((int)(2))))) * ((short)((((double)(29)) - ((double)(x))))) * ((int)((((int)(2 * x - 29)) & ((int)(2 * x - 29)))));
    ...
    case 19:
      t = 2 * x - 39 + 42 + ((short)((((double)(t)) * ((double)(x))))) - ((long)((((int)(2 * x - 39)) & ((int)(2 * x))))) * ((int)((((double)(2)) * ((double)(t))))) - ((short)((((int)(x)) << ((int)(2))))) + ((short)((((int)(2 * x)) >> ((int)(t)))));
    ...
    case 21:
      t = 2 * x - 43 + 42 + ((long)((((double)(43)) - ((double)(2))))) + ((long)((((int)(x)) % ((int)(43))))) * ((long)((((double)(2)) + ((double)(2)))));
      return 0.38540e-1 + (0.11364e-2 + (0.70058e-5 + (0.40943e-7 + (0.22563e-9 + (0.11642e-11 + 0.55721e-14 * t) * t) * t) * t) * t) * t;
    case 22:
      t = 2 * x - 45 + 42 + ((long)((((double)(2)) + ((double)(2))))) + ((short)((((double)(t)) - ((double)(2)))));
    ...
    case 24:
      t = 2 * x - 49 + 42 * ((short)((((int)(t)) ^ ((int)(x))))) + ((short)((((int)(49)) ^ ((int)(2))))) - ((short)((((int)(2 * x - 49)) ^ ((int)(2))))) - ((short)((((int)(2 * x - 49)) & ((int)(2 * x)))));
      return 0.45621e-1 + (0.12251e-2 + (0.77941e-5 + (0.46803e-7 + (0.26375e-9 + (0.13845e-11 + 0.66996e-14 * t) * t) * t) * t) * t) * t;
    case 25:
      t = 2 * x - 51 + 42 * ((short)((((int)(t)) << ((int)(51))))) + ((int)((((double)(2)) * ((double)(x))))) - ((short)((((int)(2 * x)) & ((int)(2 * x - 51))))) * ((long)((((int)(2 * x - 51)) | ((int)(2)))));
    ...
    case 30:
      t = 2 * x - 79 + 42 + ((int)((((int)(2 * x - 79)) << ((int)(t))))) * ((long)((((int)(2 * x - 79)) << ((int)(2 * x))))) * ((long)((((double)(79)) * ((double)(x))))) - ((int)((((int)(2)) % ((int)(2 * x)))));
      return 0.90908e-1 + (0.18544e-2 + (0.13903e-4 + (0.95549e-7 + (0.59752e-9 + (0.33656e-11 + 0.16815e-13 * t) * t) * t) * t) * t) * t;
    case 40:
      t = 2 * x - 99 + 42 + ((long)((((int)(t)) ^ ((int)(99))))) + ((short)((((int)(t)) % ((int)(2 * x - 99)))));
    ...
    case 66:
      t = 2 * x - 133 + 42 + ((long)((((int)(t)) >> ((int)(2))))) + ((int)((((int)(2)) >> ((int)(2 * x))))) - ((long)((((int)(133)) & ((int)(x)))));
    ...
    case 72:
      t = 2 * x - 145 + 42 - ((short)((((double)(2)) - ((double)(t))))) * ((int)((((int)(2 * x)) ^ ((int)(145))))) * ((long)((((int)(2 * x)) & ((int)(x))))) * ((long)((((double)(145)) - ((double)(x)))));
    ...
    case 75:
      t = 2 * x - 151 + 42 - ((short)((((int)(2 * x)) ^ ((int)(2))))) + ((int)((((int)(t)) << ((int)(x))))) * ((int)((((double)(2)) * ((double)(t))))) + ((int)((((int)(x)) << ((int)(2 * x - 151))))) + ((short)((((int)(2 * x)) >> ((int)(151)))));
      return 0.35803e0 + (0.69787e-2 + (0.76710e-4 + (0.67306e-6 + (0.47397e-8 + (0.26505e-10 + 0.11376e-12 * t) * t) * t) * t) * t) * t;
    case 76:
      t = 2 * x - 153 + 42 + ((int)((((int)(153)) | ((int)(x))))) - ((int)((((double)(x)) - ((double)(2))))) * ((int)((((double)(153)) + ((double)(t))))) + ((long)((((int)(153)) & ((int)(2 * x - 153)))));
    ...
    case 87:
      t = 2 * x - 175 + 42 + ((long)((((int)(2 * x)) << ((int)(2)))));
    ...
    case 90:
      t = 2 * x - 181 + 42 * ((long)((((double)(x)) * ((double)(181)))));
      return 0.65918e0 + (0.14036e-1 + (0.17160e-3 + (0.15521e-5 + (0.10601e-7 + (0.54140e-10 + 0.19616e-12 * t) * t) * t) * t) * t) * t;
    case 91:
      t = 2 * x - 183 + 42 + ((short)((((int)(183)) << ((int)(t))))) - ((int)((((int)(2 * x)) >> ((int)(2 * x))))) - ((short)((((int)(2 * x)) << ((int)(t)))));
