...
main()
{
  ...
  s.a.i = 1;
  s.a.j = 2;
  if (((int)test2 ((void *)&s) != 3 + 41 + ((long)((((int)(test2 ((void *)&s))) >> ((int)(3))))) * ((long)((((int)(test2 ((void *)&s))) & ((int)(test2 ((void *)&s)))))) - ((short)((((int)(test2 ((void *)&s))) << ((int)(3))))) * ((long)((((double)(3)) - ((double)(3))))) + ((int)((((int)(3)) << ((int)(test2 ((void *)&s)))))) + ((long)((((double)(3)) - ((double)(3)))))))
    { abort (); }
  s.a.i = 1 + 42 + ((short)((((int)(s.a.i)) & ((int)(s.a.i)))));
  s.a.j = 2;
  if (((int)test3 ((void *)&s) != 3 + 41 * ((int)((((double)(3)) - ((double)(3)))))))
    { abort (); }
  return 0;
}
/* ProgramSourceLLVM */
