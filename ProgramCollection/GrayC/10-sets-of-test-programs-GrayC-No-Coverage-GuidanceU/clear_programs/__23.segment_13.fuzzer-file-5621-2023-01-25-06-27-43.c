...
loop_break_1369++;
if(loop_break_1369<=15){
continue;
}

loop_break_1307++;
if(loop_break_1307<=38){
break;
}
...
int loop_break_3912 = 0;
for (i = 0; i < 16; ++i)
    {
      

loop_break_3912++;
if(loop_break_3912<=45){
continue;
}

loop_break_3649++;
if(loop_break_3649<=21){
break;
}
...
int loop_break_4307 = 0;
for (i = 0; i < 16; ++i)
    {
      

loop_break_4307++;
if(loop_break_4307<=14){
break;
}
