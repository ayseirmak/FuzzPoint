...
int main(void)
{
  if (((int)2*sizeof(int) != sizeof(double) || u.i[MSW] >= 0 + 41 - ((int)((((double)(sizeof(int))) * ((double)(sizeof(double)))))) + ((long)((((int)(2*sizeof(int) != sizeof(double))) | ((int)(2))))) + ((long)((((double)(0)) - ((double)(sizeof(double)))))) + ((short)((((int)(u.i[MSW] >= 0)) ^ ((int)(u.i[MSW]))))) * ((int)((((int)(u.i[MSW])) ^ ((int)(u.i[MSW]))))) + ((short)((((int)(sizeof(double))) | ((int)(2*sizeof(int))))))))
    exit(0);
