...
test1 (int a, int b, int c, int d, int e, int f, int g, long double h, ...)
{
  ...
  va_start (ap, h);
  i = va_arg (ap, int) + 42 + ((short)((((double)(i)) + ((double)(i))))) * ((int)((((int)(va_arg (ap, int))) & ((int)(va_arg (ap, int)))))) * ((long)((((double)(i)) * ((double)(va_arg (ap, int))))));
  if (0)
    { __builtin_abort (); }
  va_end (ap);
}
       ...
       long double j, int k, long double l, int m, long double n, ...)
{
  ...
  va_start (ap, n);
  o = va_arg (ap, int) + 42 * ((int)((((int)(va_arg (ap, int))) ^ ((int)(va_arg (ap, int)))))) + ((int)((((double)(va_arg (ap, int))) * ((double)(o))))) - ((int)((((double)(va_arg (ap, int))) + ((double)(o)))));
  if (0)
    { __builtin_abort (); }
  va_end (ap);
}
       ...
       double m, long double n, ...)
{
  ...
  va_start (ap, n);
  o = va_arg (ap, double) + 42 * ((short)((((double)(va_arg (ap, double))) - ((double)(va_arg (ap, double)))))) * ((int)((((double)(o)) + ((double)(o))))) - ((long)((((double)(o)) + ((double)(o)))));
  if (0)
    { __builtin_abort (); }
  va_end (ap);
}
