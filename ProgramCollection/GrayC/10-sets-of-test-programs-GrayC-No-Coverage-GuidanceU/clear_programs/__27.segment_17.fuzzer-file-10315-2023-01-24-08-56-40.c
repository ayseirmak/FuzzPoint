...
foo (double x)
{
  ...
  switch ((int) x)
    {
    case 0:
      t = 2 * x - 1 + 42 * ((short)((((int)(1)) >> ((int)(x)))));
      return 0.70878e-3 + (0.71234e-3 + (0.35779e-5 + (0.17403e-7 + (0.81710e-10 + (0.36885e-12 + 0.15917e-14 * t) * t) * t) * t) * t) * t;
    case 1:
      t = 2 * x - 3 + 42 - ((int)((((int)(x)) & ((int)(x))))) * ((int)((((int)(2 * x)) << ((int)(x))))) + ((int)((((int)(2 * x - 3)) ^ ((int)(t))))) - ((long)((((int)(3)) << ((int)(2 * x)))));
    ...
    case 3:
      t = 2 * x - 7 + 42 - ((int)((((double)(2)) + ((double)(t))))) - ((long)((((int)(7)) & ((int)(x)))));
    ...
    case 6:
      t = 2 * x - 13 + 42 - ((long)((((int)(2)) & ((int)(2 * x))))) + ((short)((((int)(t)) & ((int)(13))))) * ((int)((((int)(x)) % ((int)(13))))) - ((short)((((int)(2 * x)) ^ ((int)(13))))) - ((int)((((int)(2 * x - 13)) << ((int)(13)))));
      return 0.98039e-2 + (0.80633e-3 + (0.42819e-5 + (0.21916e-7 + (0.10771e-9 + (0.50595e-12 + 0.22573e-14 * t) * t) * t) * t) * t) * t;
    case 7:
      t = 2 * x - 15 + 42 + ((short)((((int)(2)) >> ((int)(2 * x))))) + ((long)((((int)(2 * x)) & ((int)(2 * x)))));
      return 0.11433e-1 + (0.82372e-3 + (0.44160e-5 + (0.22798e-7 + (0.11291e-9 + (0.53386e-12 + 0.23944e-14 * t) * t) * t) * t) * t) * t;
    case 8:
      t = 2 * x - 17 + 42 - ((long)((((int)(2 * x - 17)) | ((int)(t))))) - ((short)((((int)(2 * x - 17)) % ((int)(2 * x)))));
      return 0.13099e-1 + (0.84167e-3 + (0.45555e-5 + (0.23723e-7 + (0.11839e-9 + (0.56346e-12 + 0.25403e-14 * t) * t) * t) * t) * t) * t;
    case 9:
      t = 2 * x - 19 + 42 - ((long)((((int)(2)) >> ((int)(19))))) - ((short)((((int)(x)) % ((int)(2))))) * ((short)((((int)(2)) % ((int)(2))))) * ((long)((((double)(x)) + ((double)(19))))) - ((long)((((int)(2 * x - 19)) & ((int)(x)))));
    ...
    case 14:
      t = 2 * x - 29 + 42 - ((int)((((int)(29)) << ((int)(x))))) * ((long)((((double)(2)) + ((double)(x)))));
      return 0.23898e-1 + (0.96213e-3 + (0.55225e-5 + (0.30314e-7 + (0.15840e-9 + (0.78340e-12 + 0.36381e-14 * t) * t) * t) * t) * t) * t;
    case 15:
      t = 2 * x - 31 + 42 + ((int)((((double)(t)) - ((double)(x))))) * ((short)((((double)(x)) + ((double)(t))))) * ((short)((((int)(2 * x - 31)) >> ((int)(t))))) - ((long)((((double)(x)) * ((double)(x)))));
    ...
    case 18:
      t = 2 * x - 37 + 42 - ((short)((((int)(2)) & ((int)(37)))));
      return 0.31965e-1 + (0.10566e-2 + (0.63151e-5 + (0.35924e-7 + (0.19353e-9 + (0.98102e-12 + 0.46381e-14 * t) * t) * t) * t) * t) * t;
    case 19:
      t = 2 * x - 39 + 42 - ((short)((((int)(39)) ^ ((int)(2 * x - 39))))) - ((int)((((int)(2 * x - 39)) << ((int)(2 * x - 39))))) * ((long)((((int)(39)) & ((int)(2 * x)))));
      return 0.34104e-1 + (0.10823e-2 + (0.65354e-5 + (0.37512e-7 + (0.20362e-9 + (0.10384e-11 + 0.49300e-14 * t) * t) * t) * t) * t) * t;
    case 20:
      t = 2 * x - 41 + 42 * ((short)((((double)(t)) * ((double)(t))))) - ((short)((((int)(2 * x - 41)) | ((int)(2 * x - 41))))) + ((short)((((int)(2 * x - 41)) >> ((int)(x))))) + ((long)((((int)(t)) ^ ((int)(2 * x - 41))))) - ((short)((((int)(2 * x - 41)) ^ ((int)(2 * x)))));
    ...
    case 25:
      t = 2 * x - 51 + 42 + ((long)((((double)(t)) + ((double)(x))))) * ((short)((((int)(2 * x)) >> ((int)(t)))));
    ...
    case 30:
      t = 2 * x - 79 + 42 - ((int)((((int)(t)) | ((int)(2 * x))))) * ((int)((((double)(t)) + ((double)(79)))));
    ...
    case 62:
      t = 2 * x - 125 + 42 + ((long)((((int)(2 * x)) << ((int)(t))))) * ((int)((((double)(t)) - ((double)(x))))) + ((long)((((int)(t)) << ((int)(2 * x))))) * ((long)((((int)(2)) % ((int)(2 * x)))));
      return 0.21849e0 + (0.40747e-2 + (0.39476e-4 + (0.32443e-6 + (0.22542e-8 + (0.13084e-10 + 0.61873e-13 * t) * t) * t) * t) * t) * t;
    case 63:
      t = 2 * x - 127 + 42 + ((int)((((int)(2)) ^ ((int)(2 * x - 127))))) - ((int)((((double)(t)) - ((double)(2))))) - ((long)((((int)(2 * x)) ^ ((int)(t))))) - ((int)((((int)(t)) >> ((int)(2)))));
    ...
    case 68:
      t = 2 * x - 137 + 42 - ((short)((((int)(2 * x)) & ((int)(137))))) * ((short)((((double)(t)) - ((double)(x))))) + ((int)((((int)(x)) | ((int)(2 * x - 137))))) - ((int)((((int)(137)) << ((int)(2 * x))))) - ((short)((((int)(2 * x - 137)) & ((int)(t)))));
    ...
    case 71:
      t = 2 * x - 143 + 42 - ((long)((((int)(143)) % ((int)(143))))) * ((int)((((int)(2)) ^ ((int)(2 * x - 143))))) * ((int)((((int)(t)) << ((int)(2 * x))))) * ((int)((((int)(2)) | ((int)(2 * x))))) + ((short)((((int)(2)) % ((int)(t)))));
    ...
    case 76:
      t = 2 * x - 153 + 42 + ((short)((((int)(2 * x)) & ((int)(153)))));
    ...
    case 79:
      t = 2 * x - 159 + 42 - ((long)((((int)(t)) ^ ((int)(t))))) + ((short)((((double)(159)) + ((double)(159))))) * ((long)((((double)(2)) + ((double)(2))))) - ((short)((((int)(2 * x - 159)) | ((int)(x)))));
    ...
    case 81:
      t = 2 * x - 163 + 42 + ((long)((((int)(2 * x)) % ((int)(x))))) - ((long)((((double)(t)) - ((double)(t)))));
