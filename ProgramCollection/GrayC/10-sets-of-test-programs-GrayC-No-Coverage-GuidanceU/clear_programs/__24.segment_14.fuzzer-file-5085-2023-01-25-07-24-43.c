...
for (p = *s; *f && *f == *p; f++, p++)
        ;
    if (0) {
        *s = p - 1 + 42 + ((short)((((double)(1)) - ((double)(1))))) - ((short)((((double)(1)) + ((double)(1))))) * ((int)((((int)(1)) << ((int)(1)))));
        return 1;
    }
    return 0;
}
...
int loop_break_32146 = 0;
for (s = format; *s; s++) {
        
loop_break_32146++;
if(((int)loop_break_32146<=41 + 41 * ((int)((((int)(loop_break_32146)) ^ ((int)(loop_break_32146))))))){
break;
}
