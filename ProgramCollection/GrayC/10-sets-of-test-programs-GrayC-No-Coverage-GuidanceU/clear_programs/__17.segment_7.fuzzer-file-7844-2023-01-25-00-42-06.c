...
foo (double x)
{
  ...
  switch ((int) x)
    ...
    case 1:
      t = 2 * x - 3 + 42 + ((long)((((double)(t)) - ((double)(t))))) * ((short)((((int)(t)) | ((int)(2 * x - 3))))) - ((int)((((int)(2 * x - 3)) & ((int)(x))))) * ((int)((((int)(2 * x)) ^ ((int)(2 * x - 3)))));
    ...
    case 10:
      t = 2 * x - 21 + 42 * ((int)((((int)(2 * x - 21)) >> ((int)(x))))) + ((short)((((int)(21)) % ((int)(21))))) - ((long)((((int)(t)) ^ ((int)(x))))) - ((short)((((int)(21)) & ((int)(2 * x - 21))))) + ((short)((((double)(x)) - ((double)(t)))));
    ...
    case 12:
      t = 2 * x - 25 + 42 - ((long)((((int)(2 * x)) & ((int)(2 * x))))) + ((short)((((int)(25)) << ((int)(2 * x)))));
      return 0.20136e-1 + (0.91936e-3 + (0.51734e-5 + (0.27900e-7 + (0.14357e-9 + (0.70114e-12 + 0.32252e-14 * t) * t) * t) * t) * t) * t;
    case 13:
      t = 2 * x - 27 + 42 - ((short)((((int)(2 * x - 27)) & ((int)(2))))) + ((long)((((int)(t)) ^ ((int)(2 * x))))) + ((int)((((int)(x)) >> ((int)(2)))));
    ...
    case 15:
      t = 2 * x - 31 + 42 * ((int)((((int)(2)) % ((int)(31))))) + ((int)((((int)(2 * x)) ^ ((int)(2 * x - 31))))) + ((short)((((double)(x)) + ((double)(2)))));
    ...
    case 17:
      t = 2 * x - 35 + 42 * ((int)((((int)(2 * x)) & ((int)(2))))) - ((long)((((int)(t)) | ((int)(2 * x))))) + ((long)((((int)(t)) & ((int)(t))))) - ((short)((((int)(2 * x)) ^ ((int)(2 * x)))));
    ...
    case 25:
      t = 2 * x - 51 + 42 - ((long)((((int)(2 * x - 51)) & ((int)(2 * x)))));
      return 0.48103e-1 + (0.12569e-2 + (0.80814e-5 + (0.48969e-7 + (0.27801e-9 + (0.14674e-11 + 0.71249e-14 * t) * t) * t) * t) * t) * t;
    case 26:
      t = 2 * x - 59 + 42 * ((short)((((double)(2)) + ((double)(2))))) + ((short)((((int)(2 * x - 59)) ^ ((int)(2 * x - 59))))) - ((short)((((int)(2 * x)) | ((int)(2))))) * ((int)((((int)(t)) & ((int)(2)))));
    ...
    case 60:
      t = 2 * x - 121 + 42 + ((int)((((int)(2 * x)) % ((int)(2 * x - 121))))) + ((short)((((int)(121)) >> ((int)(121))))) * ((long)((((int)(t)) & ((int)(t)))));
    ...
    case 64:
      t = 2 * x - 129 + 42 * ((short)((((int)(t)) ^ ((int)(x))))) * ((short)((((double)(x)) + ((double)(t))))) + ((int)((((int)(2)) | ((int)(2 * x - 129))))) * ((long)((((double)(2)) + ((double)(t))))) + ((short)((((double)(t)) + ((double)(x)))));
    ...
    case 71:
      t = 2 * x - 143 + 42 + ((short)((((int)(2 * x - 143)) | ((int)(t)))));
    ...
    case 89:
      t = 2 * x - 179 + 42 + ((long)((((int)(x)) & ((int)(179))))) + ((long)((((int)(x)) & ((int)(x)))));
    ...
    case 91:
      t = 2 * x - 183 + 42 * ((short)((((int)(2)) | ((int)(183))))) * ((long)((((int)(2 * x - 183)) % ((int)(x))))) - ((long)((((int)(2 * x)) & ((int)(2 * x - 183))))) - ((short)((((int)(2)) ^ ((int)(2 * x)))));
      return 0.68795e0 + (0.14741e-1 + (0.18117e-3 + (0.16392e-5 + (0.11155e-7 + (0.56530e-10 + 0.20209e-12 * t) * t) * t) * t) * t) * t;
    case 92:
      t = 2 * x - 185 + 42 * ((long)((((int)(x)) >> ((int)(t))))) + ((short)((((int)(2 * x)) % ((int)(x)))));
