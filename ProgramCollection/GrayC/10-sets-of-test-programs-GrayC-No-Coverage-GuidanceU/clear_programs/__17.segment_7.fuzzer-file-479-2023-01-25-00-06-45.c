...
{
  if (((int)x != 0.0 && (x * 0.5 == x) + 41 * ((long)((((double)(x)) * ((double)(x != 0.0))))) - ((long)((((int)(x)) & ((int)((x * 0.5 == x)))))) - ((short)((((double)(0.0)) - ((double)(x != 0.0))))) * ((int)((((double)(x != 0.0)) + ((double)(0.0))))) + ((long)((((int)((x * 0.5 == x))) & ((int)(0.0)))))))
    { return 1; }
