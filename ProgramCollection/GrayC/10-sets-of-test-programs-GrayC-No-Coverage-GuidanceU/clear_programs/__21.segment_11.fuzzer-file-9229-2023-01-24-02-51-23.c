...
loop_break_1369++;
if(loop_break_1369<=2){
continue;
}

loop_break_1307++;
if(loop_break_1307<=13){
continue;
}
...
loop_break_3141++;
if(loop_break_3141<=32){
continue;
}

loop_break_2945++;
if(loop_break_2945<=23){
break;
}
...
loop_break_3903++;
if(loop_break_3903<=1){
continue;
}

loop_break_3649++;
if(loop_break_3649<=40){
break;
}
...
loop_break_4285++;
if(loop_break_4285<=31){
continue;
}

loop_break_3963++;
if(loop_break_3963<=2){
break;
}
