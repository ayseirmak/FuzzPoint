...
foo (double x)
{
  ...
  switch ((int) x)
    ...
    case 2:
      t = 2 * x - 5 + 42 + ((short)((((int)(2 * x)) % ((int)(2 * x))))) * ((int)((((int)(2)) | ((int)(2 * x - 5)))));
      return 0.36165e-2 + (0.74182e-3 + (0.37948e-5 + (0.18771e-7 + (0.89484e-10 + (0.40935e-12 + 0.17872e-14 * t) * t) * t) * t) * t) * t;
    case 3:
      t = 2 * x - 7 + 42 * ((short)((((int)(t)) % ((int)(2 * x - 7))))) + ((int)((((int)(2 * x - 7)) >> ((int)(7))))) * ((int)((((int)(2 * x - 7)) % ((int)(2))))) - ((short)((((int)(x)) ^ ((int)(x))))) * ((short)((((int)(2 * x - 7)) ^ ((int)(x)))));
    ...
    case 10:
      t = 2 * x - 21 + 42 * ((short)((((int)(2 * x)) << ((int)(2))))) * ((int)((((int)(21)) | ((int)(2 * x)))));
    ...
    case 12:
      t = 2 * x - 25 + 42 - ((short)((((int)(2 * x)) >> ((int)(25))))) * ((long)((((int)(2 * x)) % ((int)(2 * x - 25))))) * ((short)((((int)(2 * x)) >> ((int)(2)))));
    ...
    case 18:
      t = 2 * x - 37 + 42 * ((long)((((int)(37)) >> ((int)(2 * x))))) * ((int)((((int)(2 * x - 37)) << ((int)(x)))));
    ...
    case 23:
      t = 2 * x - 47 + 42 + ((short)((((int)(47)) << ((int)(x))))) * ((long)((((int)(t)) | ((int)(2 * x))))) + ((int)((((int)(2)) | ((int)(2 * x - 47))))) - ((short)((((int)(t)) & ((int)(2 * x - 47))))) * ((short)((((int)(2 * x)) % ((int)(2)))));
    ...
    case 64:
      t = 2 * x - 129 + 42 + ((short)((((int)(x)) << ((int)(2 * x - 129)))));
      return 0.23545e0 + (0.44067e-2 + (0.43594e-4 + (0.36268e-6 + (0.25312e-8 + (0.14647e-10 + 0.68453e-13 * t) * t) * t) * t) * t) * t;
    case 65:
      t = 2 * x - 131 + 42 * ((int)((((int)(2)) % ((int)(2 * x))))) - ((short)((((double)(2)) - ((double)(2))))) - ((short)((((int)(x)) ^ ((int)(2))))) - ((short)((((int)(2)) & ((int)(2 * x - 131))))) - ((long)((((int)(2 * x - 131)) ^ ((int)(131)))));
      return 0.24444e0 + (0.45855e-2 + (0.45832e-4 + (0.38352e-6 + (0.26819e-8 + (0.15489e-10 + 0.71933e-13 * t) * t) * t) * t) * t) * t;
    case 66:
      t = 2 * x - 133 + 42 + ((long)((((int)(2 * x)) ^ ((int)(133))))) + ((long)((((int)(x)) | ((int)(2 * x - 133))))) + ((int)((((int)(133)) ^ ((int)(t))))) + ((long)((((int)(2 * x)) & ((int)(2)))));
      return 0.25379e0 + (0.47735e-2 + (0.48199e-4 + (0.40561e-6 + (0.28411e-8 + (0.16374e-10 + 0.75541e-13 * t) * t) * t) * t) * t) * t;
    case 67:
      t = 2 * x - 135 + 42 * ((int)((((double)(2)) * ((double)(2))))) * ((int)((((int)(x)) | ((int)(x))))) * ((short)((((double)(t)) * ((double)(x))))) - ((short)((((int)(2 * x - 135)) % ((int)(2 * x))))) + ((int)((((double)(t)) - ((double)(t)))));
    ...
    case 74:
      t = 2 * x - 149 + 42 * ((int)((((int)(2 * x - 149)) | ((int)(2))))) * ((short)((((int)(2 * x)) >> ((int)(2))))) + ((int)((((int)(2 * x - 149)) << ((int)(149)))));
    ...
    case 77:
      t = 2 * x - 155 + 42 - ((int)((((int)(2 * x - 155)) ^ ((int)(2 * x))))) + ((long)((((int)(x)) << ((int)(2 * x - 155))))) * ((short)((((int)(2 * x)) % ((int)(2 * x))))) + ((short)((((double)(2)) - ((double)(t)))));
    ...
    case 79:
      t = 2 * x - 159 + 42 + ((long)((((int)(2)) % ((int)(2 * x - 159))))) + ((long)((((int)(2 * x)) << ((int)(2 * x)))));
    ...
    case 84:
      t = 2 * x - 169 + 42 + ((long)((((int)(t)) | ((int)(2 * x))))) * ((long)((((int)(169)) << ((int)(x)))));
    ...
    case 88:
      t = 2 * x - 177 + 42 + ((long)((((int)(t)) & ((int)(2 * x - 177))))) + ((long)((((int)(2 * x - 177)) | ((int)(x))))) - ((long)((((int)(2 * x)) ^ ((int)(t))))) - ((short)((((double)(177)) - ((double)(x)))));
    ...
    case 92:
      t = 2 * x - 185 + 42 + ((short)((((int)(t)) << ((int)(2))))) + ((short)((((int)(2 * x)) >> ((int)(t))))) + ((long)((((int)(2 * x)) ^ ((int)(185))))) + ((long)((((int)(2 * x)) >> ((int)(2 * x - 185))))) - ((short)((((int)(2 * x)) % ((int)(2 * x - 185)))));
