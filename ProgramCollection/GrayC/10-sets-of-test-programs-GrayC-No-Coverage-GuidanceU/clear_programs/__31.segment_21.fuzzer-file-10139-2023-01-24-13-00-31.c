...
foo (double x)
{
  ...
  switch ((int) x)
    ...
    case 2:
      t = 2 * x - 5 + 42 - ((long)((((int)(2 * x)) % ((int)(2))))) - ((long)((((double)(x)) + ((double)(5)))));
      return 0.36165e-2 + (0.74182e-3 + (0.37948e-5 + (0.18771e-7 + (0.89484e-10 + (0.40935e-12 + 0.17872e-14 * t) * t) * t) * t) * t) * t;
    case 3:
      t = 2 * x - 7 + 42 - ((long)((((int)(2 * x - 7)) | ((int)(t))))) - ((int)((((int)(2 * x - 7)) | ((int)(2 * x))))) * ((short)((((int)(7)) ^ ((int)(2 * x))))) + 42 - ((int)((((int)(2)) >> ((int)(7))))) - ((int)((((double)(42)) * ((double)(2)))));
      return 0.51154e-2 + (0.75722e-3 + (0.39096e-5 + (0.19504e-7 + (0.93687e-10 + (0.43143e-12 + 0.18939e-14 * t) * t) * t) * t) * t) * t;
    case 4:
      t = 2 * x - 9 + 42 * ((short)((((int)(t)) | ((int)(2 * x - 9))))) + ((long)((((int)(2 * x)) ^ ((int)(2 * x - 9))))) * ((long)((((double)(9)) + ((double)(t))))) * ((short)((((double)(t)) * ((double)(2))))) * ((short)((((int)(x)) | ((int)(2 * x)))));
      return 0.66457e-2 + (0.77310e-3 + (0.40289e-5 + (0.20271e-7 + (0.98117e-10 + (0.45484e-12 + 0.20076e-14 * t) * t) * t) * t) * t) * t;
    case 5:
      t = 2 * x - 11 + 42 * ((int)((((int)(11)) % ((int)(2 * x - 11))))) + ((long)((((int)(2 * x)) << ((int)(2 * x))))) - ((long)((((int)(2)) ^ ((int)(2 * x)))));
      return 0.82082e-2 + (0.78946e-3 + (0.41529e-5 + (0.21074e-7 + (0.10278e-9 + (0.47965e-12 + 0.21285e-14 * t) * t) * t) * t) * t) * t;
    case 6:
      t = 2 * x - 13 + 42 * ((int)((((int)(t)) >> ((int)(t))))) + 42 - ((short)((((int)(13)) % ((int)(2 * x))))) - ((int)((((int)(13)) % ((int)(x))))) - ((int)((((int)(x)) | ((int)(2 * x - 13))))) + ((int)((((int)(2 * x - 13 + 42 * ((int)((((int)(t)) >> ((int)(t))))))) | ((int)(2)))));
    ...
    case 9:
      t = 2 * x - 19 + 42 * ((long)((((int)(2 * x)) << ((int)(x))))) * ((short)((((int)(2)) % ((int)(2))))) + ((long)((((int)(19)) << ((int)(2 * x - 19)))));
      return 0.14800e-1 + (0.86018e-3 + (0.47008e-5 + (0.24694e-7 + (0.12418e-9 + (0.59486e-12 + 0.26957e-14 * t) * t) * t) * t) * t) * t;
    case 10:
      t = 2 * x - 21 + 42 + ((short)((((int)(2 * x - 21)) | ((int)(2 * x))))) + ((short)((((int)(2 * x - 21)) << ((int)(21))))) + ((short)((((int)(2 * x - 21)) | ((int)(2))))) * ((long)((((int)(2 * x)) & ((int)(2 * x - 21)))));
      return 0.16540e-1 + (0.87928e-3 + (0.48520e-5 + (0.25711e-7 + (0.13030e-9 + (0.62820e-12 + 0.28612e-14 * t) * t) * t) * t) * t) * t;
    case 11:
      t = 2 * x - 23 + 42 * ((long)((((double)(23)) * ((double)(23))))) + ((short)((((int)(t)) << ((int)(x))))) * ((int)((((int)(t)) % ((int)(2 * x - 23))))) + ((long)((((double)(2)) + ((double)(2)))));
    ...
    case 13:
      t = 2 * x - 27 + 42 - ((int)((((int)(2)) | ((int)(2 * x - 27))))) - ((int)((((int)(2 * x)) & ((int)(x))))) + ((int)((((int)(2 * x)) | ((int)(2 * x))))) + ((short)((((int)(2 * x)) & ((int)(27))))) + ((int)((((double)(t)) * ((double)(27))))) + 42 * ((short)((((int)(2 * x - 27)) & ((int)(t))))) - ((long)((((int)(2)) % ((int)(2 * x))))) * ((long)((((int)(2 * x - 27 + 42 - ((int)((((int)(2)) | ((int)(2 * x - 27))))) - ((int)((((int)(2 * x)) & ((int)(x))))) + ((int)((((int)(2 * x)) | ((int)(2 * x))))) + ((short)((((int)(2 * x)) & ((int)(27))))) + ((int)((((double)(t)) * ((double)(27))))))) | ((int)(2 * x))))) - ((int)((((int)(t)) >> ((int)(2 * x - 27 + 42 - ((int)((((int)(2)) | ((int)(2 * x - 27)))))))))) + ((long)((((int)(2 * x - 27 + 42 - ((int)((((int)(2)) | ((int)(2 * x - 27))))) - ((int)((((int)(2 * x)) & ((int)(x))))) + ((int)((((int)(2 * x)) | ((int)(2 * x))))))) & ((int)(27)))));
      return 0.21996e-1 + (0.94040e-3 + (0.53443e-5 + (0.29078e-7 + (0.15078e-9 + (0.74103e-12 + 0.34251e-14 * t) * t) * t) * t) * t) * t;
    case 14:
      t = 2 * x - 29 + 42 + ((short)((((int)(2 * x - 29)) << ((int)(x))))) - ((short)((((int)(2 * x)) | ((int)(29))))) * ((short)((((int)(x)) << ((int)(2))))) - ((int)((((int)(2)) >> ((int)(2 * x - 29))))) * ((int)((((int)(2 * x)) >> ((int)(2)))));
    ...
    case 16:
      t = 2 * x - 33 + 42 * ((int)((((int)(x)) >> ((int)(2 * x - 33))))) + ((long)((((double)(x)) * ((double)(33))))) + 42 + ((int)((((int)(42 * ((int)((((int)(x)) >> ((int)(2 * x - 33))))))) ^ ((int)(42 * ((int)((((int)(x)) >> ((int)(2 * x - 33)))))))))) - ((short)((((int)(33)) >> ((int)(((long)((((double)(x)) * ((double)(33))))))))));
    ...
    case 18:
      t = 2 * x - 37 + 42 + ((int)((((double)(x)) + ((double)(2))))) - ((int)((((int)(2 * x - 37)) % ((int)(37))))) - ((int)((((double)(2)) - ((double)(x))))) - ((int)((((double)(37)) * ((double)(37)))));
    ...
    case 40:
      t = 2 * x - 99 + 42 * ((int)((((int)(t)) << ((int)(x))))) * ((short)((((double)(x)) * ((double)(99)))));
      return 0.13443e0 + (0.25474e-2 + (0.21385e-4 + (0.15996e-6 + (0.10585e-8 + (0.61258e-11 + 0.30412e-13 * t) * t) * t) * t) * t) * t;
    case 50:
      t = 2 * x - 119 + 42 * ((long)((((int)(119)) << ((int)(2))))) * ((int)((((double)(t)) * ((double)(x))))) + ((int)((((int)(2 * x - 119)) >> ((int)(2 * x))))) + ((int)((((double)(x)) + ((double)(119))))) * ((int)((((double)(t)) + ((double)(t)))));
    ...
    case 61:
      t = 2 * x - 123 + 42 + ((int)((((int)(x)) << ((int)(2 * x - 123))))) - ((short)((((int)(2 * x - 123)) & ((int)(123))))) * ((long)((((int)(2 * x - 123)) ^ ((int)(x)))));
    ...
    case 64:
      t = 2 * x - 129 + 42 + ((int)((((int)(2 * x - 129)) % ((int)(2 * x - 129))))) * ((short)((((int)(129)) >> ((int)(2 * x - 129))))) * ((long)((((int)(t)) << ((int)(2 * x))))) * ((int)((((int)(2)) ^ ((int)(2 * x)))));
      return 0.23545e0 + (0.44067e-2 + (0.43594e-4 + (0.36268e-6 + (0.25312e-8 + (0.14647e-10 + 0.68453e-13 * t) * t) * t) * t) * t) * t;
    case 65:
      t = 2 * x - 131 + 42 * ((short)((((double)(131)) - ((double)(131))))) - ((long)((((int)(2 * x - 131)) >> ((int)(2 * x - 131)))));
    ...
    case 67:
      t = 2 * x - 135 + 42 + ((long)((((int)(x)) % ((int)(x))))) - ((int)((((int)(135)) ^ ((int)(2 * x - 135))))) * ((int)((((double)(2)) + ((double)(t))))) + 42 + ((short)((((int)(((int)((((int)(135)) ^ ((int)(2 * x - 135))))) * ((int)((((double)(2)) + ((double)(t))))))) & ((int)(2 * x - 135)))));
    ...
    case 70:
      t = 2 * x - 141 + 42 - ((short)((((int)(141)) | ((int)(2 * x - 141))))) - ((short)((((int)(2 * x)) >> ((int)(2 * x)))));
    ...
    case 75:
      t = 2 * x - 151 + 42 + ((long)((((int)(2)) | ((int)(t))))) + ((short)((((double)(151)) - ((double)(2))))) - ((long)((((int)(2 * x - 151)) % ((int)(151))))) + ((long)((((int)(151)) << ((int)(2 * x - 151))))) - ((long)((((int)(2)) << ((int)(2 * x - 151)))));
    ...
    case 81:
      t = 2 * x - 163 + 42 - ((int)((((int)(2 * x)) & ((int)(163))))) - ((int)((((double)(t)) * ((double)(x))))) + ((short)((((int)(2)) << ((int)(163))))) - ((long)((((int)(2 * x)) % ((int)(2 * x)))));
    ...
    case 84:
      t = 2 * x - 169 + 42 + ((short)((((int)(169)) | ((int)(169)))));
    ...
    case 88:
      t = 2 * x - 177 + 42 * ((short)((((double)(t)) - ((double)(t)))));
      return 0.60569e0 + (0.12735e-1 + (0.15396e-3 + (0.13909e-5 + (0.95651e-8 + (0.49574e-10 + 0.18435e-12 * t) * t) * t) * t) * t) * t;
    case 89:
      t = 2 * x - 179 + 42 - ((long)((((int)(x)) | ((int)(t))))) * ((long)((((int)(x)) & ((int)(2 * x - 179))))) + ((short)((((int)(2 * x)) >> ((int)(t))))) * ((int)((((int)(2)) & ((int)(x)))));
