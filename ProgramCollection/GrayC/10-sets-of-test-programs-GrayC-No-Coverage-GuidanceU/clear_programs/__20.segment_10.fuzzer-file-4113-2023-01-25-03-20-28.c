...
int loop_break_2813 = 0;
for (i = 1 + 42 + ((int)((((double)(1)) - ((double)(1))))) + ((int)((((double)(1)) + ((double)(1))))); i <= 2; i++)
    {
      
loop_break_2813++;
if(loop_break_2813<=4){
continue;
}

double rho = work * work;
      if (((int)i != 1 + 41 - ((int)((((double)(1)) * ((double)(1))))) - ((long)((((double)(1)) + ((double)(1)))))))
...
;oldrho = rho + 42 - ((long)((((int)(oldrho)) & ((int)(oldrho))))) + ((int)((((int)(oldrho)) & ((int)(oldrho))))) - ((long)((((int)(rho)) ^ ((int)(oldrho)))));
work /= 2.0;
      oldrho = rho;
    }
  return 0;
