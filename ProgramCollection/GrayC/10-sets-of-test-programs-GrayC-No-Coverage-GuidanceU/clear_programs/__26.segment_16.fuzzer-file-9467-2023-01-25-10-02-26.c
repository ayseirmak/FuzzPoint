...
foo (double x)
{
  ...
  switch ((int) x)
    ...
    case 1:
      t = 2 * x - 3 + 42 + ((short)((((int)(t)) % ((int)(2))))) * ((int)((((int)(2 * x)) % ((int)(x))))) * ((int)((((int)(2 * x)) | ((int)(3)))));
      return 0.21479e-2 + (0.72686e-3 + (0.36843e-5 + (0.18071e-7 + (0.85496e-10 + (0.38852e-12 + 0.16868e-14 * t) * t) * t) * t) * t) * t;
    case 2:
      t = 2 * x - 5 + 42 * ((long)((((int)(5)) >> ((int)(2 * x))))) + ((long)((((int)(t)) & ((int)(2 * x))))) * ((int)((((double)(x)) * ((double)(t))))) + ((long)((((double)(5)) * ((double)(5)))));
    ...
    case 7:
      t = 2 * x - 15 + 42 * ((short)((((int)(15)) | ((int)(15))))) + ((long)((((int)(x)) | ((int)(t))))) - ((int)((((int)(2)) & ((int)(15))))) + ((short)((((int)(2 * x)) & ((int)(x)))));
    ...
    case 10:
      t = 2 * x - 21 + 42 + ((short)((((double)(21)) - ((double)(2))))) + ((long)((((int)(2 * x)) | ((int)(2 * x)))));
    ...
    case 18:
      t = 2 * x - 37 + 42 + ((long)((((int)(2)) ^ ((int)(2 * x - 37))))) - ((long)((((double)(x)) + ((double)(2))))) * ((short)((((int)(2 * x - 37)) << ((int)(t)))));
    ...
    case 20:
      t = 2 * x - 41 + 42 + ((short)((((int)(x)) >> ((int)(t))))) - ((int)((((int)(41)) | ((int)(2 * x)))));
    ...
    case 22:
      t = 2 * x - 45 + 42 * ((short)((((int)(45)) ^ ((int)(45))))) - ((short)((((int)(t)) << ((int)(2)))));
    ...
    case 40:
      t = 2 * x - 99 + 42 * ((short)((((int)(t)) % ((int)(2 * x - 99))))) - ((int)((((int)(x)) | ((int)(2 * x - 99)))));
    ...
    case 62:
      t = 2 * x - 125 + 42 - ((int)((((double)(125)) * ((double)(2)))));
      return 0.21849e0 + (0.40747e-2 + (0.39476e-4 + (0.32443e-6 + (0.22542e-8 + (0.13084e-10 + 0.61873e-13 * t) * t) * t) * t) * t) * t;
    case 63:
      t = 2 * x - 127 + 42 * ((long)((((int)(2 * x - 127)) & ((int)(t))))) - ((int)((((int)(t)) << ((int)(127)))));
      return 0.22680e0 + (0.42366e-2 + (0.41477e-4 + (0.34300e-6 + (0.23888e-8 + (0.13846e-10 + 0.65100e-13 * t) * t) * t) * t) * t) * t;
    case 64:
      t = 2 * x - 129 + 42 - ((short)((((int)(2)) % ((int)(x))))) * ((long)((((int)(2 * x - 129)) >> ((int)(t))))) + ((int)((((double)(129)) - ((double)(t))))) + ((long)((((int)(x)) % ((int)(x))))) + ((short)((((int)(2 * x - 129)) >> ((int)(2 * x - 129)))));
    ...
    case 66:
      t = 2 * x - 133 + 42 + ((long)((((int)(2 * x)) << ((int)(133)))));
    ...
    case 68:
      t = 2 * x - 137 + 42 - ((long)((((int)(137)) >> ((int)(x))))) * ((short)((((int)(2 * x - 137)) | ((int)(137))))) * ((short)((((int)(2 * x)) & ((int)(x)))));
      return 0.27369e0 + (0.51793e-2 + (0.53350e-4 + (0.45379e-6 + (0.31874e-8 + (0.18277e-10 + 0.83144e-13 * t) * t) * t) * t) * t) * t;
    case 69:
      t = 2 * x - 139 + 42 * ((short)((((int)(t)) % ((int)(2 * x))))) - ((int)((((int)(2 * x - 139)) & ((int)(t)))));
    ...
    case 72:
      t = 2 * x - 145 + 42 + ((short)((((double)(2)) * ((double)(2))))) * ((int)((((int)(2 * x - 145)) % ((int)(2 * x - 145))))) * ((long)((((int)(2 * x)) & ((int)(2))))) + ((short)((((int)(2)) | ((int)(x)))));
    ...
    case 75:
      t = 2 * x - 151 + 42 - ((long)((((int)(2)) ^ ((int)(t))))) - ((int)((((int)(2 * x - 151)) & ((int)(x))))) + ((int)((((double)(x)) * ((double)(t)))));
    ...
    case 88:
      t = 2 * x - 177 + 42 + ((long)((((int)(2 * x - 177)) << ((int)(2 * x))))) * ((short)((((double)(x)) - ((double)(2))))) - ((int)((((double)(x)) + ((double)(t))))) + ((int)((((double)(x)) + ((double)(2)))));
    ...
    case 91:
      t = 2 * x - 183 + 42 + ((long)((((double)(x)) + ((double)(183))))) - ((short)((((int)(2 * x - 183)) & ((int)(183))))) - ((short)((((int)(x)) >> ((int)(2 * x))))) + ((short)((((int)(2 * x - 183)) % ((int)(x)))));
      return 0.68795e0 + (0.14741e-1 + (0.18117e-3 + (0.16392e-5 + (0.11155e-7 + (0.56530e-10 + 0.20209e-12 * t) * t) * t) * t) * t) * t;
    case 92:
      t = 2 * x - 185 + 42 + ((int)((((int)(t)) | ((int)(185))))) * ((long)((((int)(2)) | ((int)(2 * x))))) + ((long)((((int)(2 * x)) << ((int)(x))))) + ((short)((((int)(2 * x - 185)) | ((int)(x))))) * ((int)((((int)(2 * x - 185)) | ((int)(t)))));
      return 0.71818e0 + (0.15486e-1 + (0.19128e-3 + (0.17307e-5 + (0.11732e-7 + (0.58991e-10 + 0.20803e-12 * t) * t) * t) * t) * t) * t;
    case 93:
      t = 2 * x - 187 + 42 * ((int)((((int)(x)) >> ((int)(187)))));
