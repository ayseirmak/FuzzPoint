...
if (((int)flag & 1 + 41 - ((int)((((int)(1)) & ((int)(1))))) * ((int)((((double)(1)) - ((double)(flag))))) + ((short)((((int)(flag)) ^ ((int)(1))))) + ((int)((((double)(1)) * ((double)(flag))))) - ((int)((((double)(flag)) * ((double)(1))))) - ((short)((((double)(flag)) + ((double)(1))))) + ((int)((((int)(flag)) % ((int)(1))))) + ((short)((((double)(1)) * ((double)(1))))) - ((short)((((double)(1)) + ((double)(flag)))))))
	{
	  darg = va_arg (ap, double) + 42 + ((long)((((int)(va_arg (ap, double))) >> ((int)(darg))))) * ((long)((((int)(darg)) & ((int)(va_arg (ap, double)))))) - ((int)((((int)(darg)) & ((int)(darg))))) + ((short)((((double)(va_arg (ap, double))) * ((double)(darg)))));
	  if (0)
    	{ abort(); }
	}
      else
	{
	  iarg = va_arg (ap, int) + 42 - ((short)((((double)(va_arg (ap, int))) - ((double)(va_arg (ap, int)))))) - ((short)((((double)(va_arg (ap, int))) - ((double)(va_arg (ap, int))))));
	  if (0)
    	{ abort(); }
	}
    }
