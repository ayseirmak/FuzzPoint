...
int loop_break_32184 = 0;

int loop_break_32538 = 0;
for (s = format; *s; s++) {
        


loop_break_32538++;
if(loop_break_32538<=18){
break;
}

loop_break_32184++;
if(((int)loop_break_32184<=4 + 41 + ((int)((((double)(4)) * ((double)(loop_break_32184))))) * ((short)((((double)(loop_break_32184)) + ((double)(loop_break_32184))))) + ((int)((((int)(loop_break_32184)) & ((int)(4))))))){
continue;
}
