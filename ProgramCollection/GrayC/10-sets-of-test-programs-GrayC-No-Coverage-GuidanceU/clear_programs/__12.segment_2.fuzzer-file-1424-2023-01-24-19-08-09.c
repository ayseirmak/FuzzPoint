...
foo (double x)
{
  ...
  switch ((int) x)
    {
    case 0:
      t = 2 * x - 1 + 42 * ((long)((((int)(t)) % ((int)(t))))) + ((long)((((int)(2)) % ((int)(x))))) * ((int)((((int)(x)) | ((int)(x))))) + ((short)((((double)(t)) * ((double)(1))))) + ((long)((((int)(2)) << ((int)(2 * x - 1)))));
    ...
    case 2:
      t = 2 * x - 5 + 42 * ((int)((((double)(x)) + ((double)(2)))));
    ...
    case 4:
      t = 2 * x - 9 + 42 + ((short)((((int)(2 * x - 9)) & ((int)(9))))) - ((int)((((int)(9)) << ((int)(2 * x - 9))))) - ((short)((((int)(9)) % ((int)(t))))) + ((int)((((int)(2)) % ((int)(2 * x - 9))))) - ((long)((((int)(x)) & ((int)(2)))));
    ...
    case 11:
      t = 2 * x - 23 + 42 + ((long)((((int)(2 * x - 23)) | ((int)(2 * x))))) * ((int)((((int)(x)) >> ((int)(x)))));
      return 0.18318e-1 + (0.89900e-3 + (0.50094e-5 + (0.26779e-7 + (0.13675e-9 + (0.66358e-12 + 0.30375e-14 * t) * t) * t) * t) * t) * t;
    case 12:
      t = 2 * x - 25 + 42 * ((short)((((int)(2)) | ((int)(2))))) - ((long)((((double)(t)) * ((double)(2)))));
      return 0.20136e-1 + (0.91936e-3 + (0.51734e-5 + (0.27900e-7 + (0.14357e-9 + (0.70114e-12 + 0.32252e-14 * t) * t) * t) * t) * t) * t;
    case 13:
      t = 2 * x - 27 + 42 - ((short)((((double)(t)) - ((double)(2))))) * ((short)((((int)(27)) & ((int)(t))))) + ((short)((((int)(2 * x)) << ((int)(x))))) * ((long)((((int)(x)) % ((int)(27))))) - ((short)((((int)(2 * x - 27)) << ((int)(2 * x)))));
    ...
    case 18:
      t = 2 * x - 37 + 42 - ((int)((((int)(2 * x - 37)) >> ((int)(37))))) * ((long)((((int)(2 * x - 37)) | ((int)(2 * x - 37))))) + ((int)((((int)(2 * x)) & ((int)(x))))) - ((short)((((int)(37)) >> ((int)(2 * x - 37))))) + ((int)((((int)(2 * x)) << ((int)(37)))));
    ...
    case 20:
      t = 2 * x - 41 + 42 + ((short)((((double)(41)) - ((double)(t))))) + ((long)((((int)(41)) & ((int)(t))))) * ((int)((((int)(41)) & ((int)(2 * x - 41)))));
    ...
    case 22:
      t = 2 * x - 45 + 42 * ((int)((((double)(2)) + ((double)(t))))) + ((short)((((int)(2 * x - 45)) | ((int)(2 * x - 45))))) * ((short)((((int)(2 * x - 45)) >> ((int)(2 * x - 45)))));
    ...
    case 24:
      t = 2 * x - 49 + 42 - ((short)((((double)(x)) + ((double)(2))))) + ((long)((((int)(2 * x - 49)) | ((int)(2)))));
      return 0.45621e-1 + (0.12251e-2 + (0.77941e-5 + (0.46803e-7 + (0.26375e-9 + (0.13845e-11 + 0.66996e-14 * t) * t) * t) * t) * t) * t;
    case 25:
      t = 2 * x - 51 + 42 + ((short)((((double)(x)) + ((double)(2))))) * ((int)((((int)(x)) | ((int)(2 * x))))) - ((short)((((int)(2 * x - 51)) >> ((int)(2 * x)))));
    ...
    case 30:
      t = 2 * x - 79 + 42 * ((int)((((int)(2)) >> ((int)(79))))) * ((short)((((int)(2)) | ((int)(t))))) + ((short)((((int)(x)) | ((int)(79))))) + ((short)((((int)(x)) ^ ((int)(2 * x - 79)))));
      return 0.90908e-1 + (0.18544e-2 + (0.13903e-4 + (0.95549e-7 + (0.59752e-9 + (0.33656e-11 + 0.16815e-13 * t) * t) * t) * t) * t) * t;
    case 40:
      t = 2 * x - 99 + 42 * ((long)((((int)(2 * x)) | ((int)(2 * x - 99))))) - ((long)((((int)(2 * x - 99)) & ((int)(t))))) - ((short)((((double)(2)) * ((double)(x))))) - ((long)((((int)(2 * x)) | ((int)(2))))) - ((long)((((int)(2)) >> ((int)(99)))));
    ...
    case 61:
      t = 2 * x - 123 + 42 * ((short)((((double)(123)) * ((double)(123))))) - ((int)((((int)(2 * x)) % ((int)(2)))));
    ...
    case 63:
      t = 2 * x - 127 + 42 - ((int)((((int)(2 * x)) << ((int)(2 * x))))) - ((long)((((int)(2)) >> ((int)(2)))));
    ...
    case 67:
      t = 2 * x - 135 + 42 + ((int)((((int)(2 * x)) >> ((int)(135))))) - ((short)((((int)(2 * x - 135)) ^ ((int)(2 * x - 135))))) * ((int)((((int)(2 * x - 135)) ^ ((int)(135)))));
    ...
    case 71:
      t = 2 * x - 143 + 42 * ((int)((((int)(x)) % ((int)(2 * x))))) * ((long)((((double)(t)) * ((double)(t))))) - ((short)((((int)(2 * x)) | ((int)(x))))) * ((short)((((double)(x)) * ((double)(t)))));
      return 0.30679e0 + (0.58714e-2 + (0.62248e-4 + (0.53724e-6 + (0.37827e-8 + (0.21490e-10 + 0.95513e-13 * t) * t) * t) * t) * t) * t;
    case 72:
      t = 2 * x - 145 + 42 + ((short)((((int)(x)) | ((int)(t))))) - ((int)((((int)(145)) ^ ((int)(2)))));
    ...
    case 75:
      t = 2 * x - 151 + 42 * ((short)((((int)(151)) << ((int)(2))))) * ((short)((((int)(2 * x)) % ((int)(2 * x - 151)))));
      return 0.35803e0 + (0.69787e-2 + (0.76710e-4 + (0.67306e-6 + (0.47397e-8 + (0.26505e-10 + 0.11376e-12 * t) * t) * t) * t) * t) * t;
    case 76:
      t = 2 * x - 153 + 42 + ((long)((((double)(t)) * ((double)(153))))) + ((int)((((int)(2 * x)) >> ((int)(153))))) - ((long)((((int)(2)) >> ((int)(2))))) * ((long)((((int)(2 * x - 153)) << ((int)(153))))) * ((int)((((int)(2 * x)) << ((int)(2 * x - 153)))));
      return 0.37230e0 + (0.72938e-2 + (0.80864e-4 + (0.71206e-6 + (0.50117e-8 + (0.27899e-10 + 0.11862e-12 * t) * t) * t) * t) * t) * t;
    case 77:
      t = 2 * x - 155 + 42 * ((short)((((double)(x)) + ((double)(155))))) + ((int)((((int)(2)) ^ ((int)(2 * x)))));
