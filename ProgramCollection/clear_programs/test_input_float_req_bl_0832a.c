...
static const float one_exp = 1.0f,
                   ...
                   huge_exp = 1.0e+30f, twom100_exp = 7.8886090522e-31f,
                   ln2HI_exp[2] = {6.9313812256e-01f, -6.9313812256e-01f},
                   ln2LO_exp[2] = {9.0580006145e-06f, -9.0580006145e-06f},
                   invln2_exp = 1.4426950216e+00f, P1_exp = 1.6666667163e-01f,
                   P2_exp = -2.7777778450e-03f, P3_exp = 6.6137559770e-05f,
                   P4_exp = -1.6533901999e-06f, P5_exp = 4.1381369442e-08f;
...
int main() {
  ...
  printf("Test passed. The result is as expected: %.1f\n", res);
  return 0;
}