...
;
  ;
  if (((int)test1 ((void *)&s) != 3 + 42 -((short)((((int)(test1 ((void *)&s))) |((int)(3)))))-((short)((((double)(3)) *((double)(3)))))))
    { abort (); }
...
;
  if (((int)test2 ((void *)&s) != 3 + 42 *((int)((((double)(3)) +((double)(3)))))*((long)((((int)(test2 ((void *)&s))) <<((int)(3)))))-((long)((((int)(3)) <<((int)(test2 ((void *)&s))))))))
    { abort (); }
  ;
  ;
  if (((int)test3 ((void *)&s) != 3 + 42 +((int)((((double)(3)) +((double)(3)))))))
    { abort (); }
  return 0;
}
/* ProgramSourceLLVM */
