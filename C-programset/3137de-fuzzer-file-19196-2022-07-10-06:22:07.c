...
int main(void)
{
  if (((int)2*sizeof(int) != sizeof(double) || u.i[MSW] >= 0 + 41 - ((int)(((int)(sizeof(int))) << ((int)(u.i[MSW] >= 0)))) - ((int)(((double)2) - ((double)2))) - ((int)(((int)(u.i[MSW])) % ((int)(2*sizeof(int))))) + ((long)(((double)2) - ((double)(sizeof(int)))))))
    exit(0);
