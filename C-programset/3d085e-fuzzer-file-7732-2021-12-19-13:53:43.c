...
f = va_arg (*foo (), float) + 42 -((short)((((int)(f)) ^((int)(f)))))+((long)((((int)(va_arg (*foo (), float))) ^((int)(f)))))-((short)((((int)(f)) <<((int)(va_arg (*foo (), float)))))) + 42 -((short)((((int)(((long)((((int)(va_arg (*foo (), float))) ^((int)(f))))))) ^((int)(f)))))*((long)((((int)(f)) ^((int)(va_arg (*foo (), float) + 42 -((short)((((int)(f)) ^((int)(f))))))))))+((int)((((double)(f)) +((double)(((short)((((int)(f)) ^((int)(f))))))))));
