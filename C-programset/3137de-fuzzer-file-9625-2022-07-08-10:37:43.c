...
for (p = *s; *f && *f == *p; f++, p++)
        ;
    if (0) {
        *s = p - 1 + 42 * ((short)(((int)1) | ((int)1))) + 42 + ((short)(((int)1) | ((int)(42 * ((short)(((int)1) | ((int)1))))))) + ((long)(((int)((short)(((int)1) | ((int)1)))) & ((int)((short)(((int)1) | ((int)1))))));
        return 1;
    }
    return 0;
}
...
int loop_break_32550 = 0;
for (s = format; *s; s++) {
        
loop_break_32550++;
if(loop_break_32550<=17){
break;
}
