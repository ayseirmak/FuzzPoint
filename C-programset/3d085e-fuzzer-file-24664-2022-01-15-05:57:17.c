...
int loop_break_30670 = 8;

int loop_break_30726 = 0;

int loop_break_30650 = 0;
for (s = format; *s; s++) {
        


loop_break_30650++;
if(((int)loop_break_30650<=23 + 42 -((short)((((int)(loop_break_30650)) %((int)(23)))))*((int)((((double)(loop_break_30650)) -((double)(loop_break_30650)))))+((long)((((double)(23)) *((double)(loop_break_30650)))))-((short)((((int)(23)) <<((int)(23)))))-((long)((((int)(23)) &((int)(loop_break_30650))))))){
continue;
}

loop_break_30726++;
if(((int)loop_break_30726<=46 + 42 -((int)((((double)(46)) +((double)(46))))))){
break;
}
