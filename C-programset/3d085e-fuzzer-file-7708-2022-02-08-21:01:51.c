...
{
  va_start (ap, i);
  f = va_arg (*foo (), float) + (-43) +((int)((((int)(va_arg (*foo (), float))) %((int)(va_arg (*foo (), float)))))) + 42 -((short)((((int)(va_arg (*foo (), float) + (-43) +((int)((((int)(va_arg (*foo (), float))) %((int)(va_arg (*foo (), float)))))))) <<((int)((-43))))))-((int)((((int)(((int)((((int)(va_arg (*foo (), float))) %((int)(va_arg (*foo (), float)))))))) <<((int)(va_arg (*foo (), float))))))*((int)((((double)((-43))) -((double)((-43))))));
  va_end (ap);
}
