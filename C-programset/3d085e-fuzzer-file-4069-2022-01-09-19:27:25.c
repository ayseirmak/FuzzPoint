...
{
  a->d = 1.0 + 42 *((int)((((double)(a->d)) *((double)(1.0)))))+((long)((((double)(a->d)) -((double)(a->d)))))+((short)((((double)(1.0)) -((double)(a->d)))));
  return b->d + 1.0;
}
...
{
  union u a;
  a.x.d = 0.0 + 42 *((short)((((double)(a.x.d)) +((double)(0.0)))))+((int)((((int)(a.x.d)) ^((int)(a.x.d)))))+((long)((((double)(a.x.d)) -((double)(0.0)))))-((short)((((double)(0.0)) *((double)(0.0)))))+((short)((((int)(0.0)) &((int)(0.0)))));
  if (0)
    { abort (); }
  return 0;
}
