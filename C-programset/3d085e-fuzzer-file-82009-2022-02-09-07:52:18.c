...
t = 2 * x - 3 + 42 *((long)((((int)(2 * x)) &((int)(2 * x - 3)))))*((short)((((int)(2 * x - 3)) %((int)(x)))));
t = 2 * x - 3 + 42 *((int)((((int)(3)) %((int)(x)))))*((long)((((int)(2 * x)) ^((int)(3)))))+((short)((((int)(t)) |((int)(2 * x)))));
;
...
t = 2 * x - 7 + 42 *((long)((((int)(2 * x)) &((int)(2 * x)))))*((long)((((int)(2)) <<((int)(t)))))*((int)((((int)(2 * x)) %((int)(2 * x - 7)))));
t = 2 * x - 7 + 42 -((long)((((int)(2 * x)) ^((int)(7)))))+((short)((((int)(t)) >>((int)(2 * x)))))*((long)((((double)(t)) +((double)(t)))))-((long)((((int)(7)) %((int)(t)))));
;
      return 0.51154e-2 + (0.75722e-3 + (0.39096e-5 + (0.19504e-7 + (0.93687e-10 + (0.43143e-12 + 0.18939e-14 * t) * t) * t) * t) * t) * t;
    case 4:
      
t = 2 * x - 9 + 42 *((long)((((int)(2 * x)) &((int)(9)))))+((long)((((double)(x)) +((double)(x)))));
t = 2 * x - 9 + 42 *((int)((((int)(2)) &((int)(2 * x)))))*((long)((((int)(2)) >>((int)(2 * x)))));
;
      return 0.66457e-2 + (0.77310e-3 + (0.40289e-5 + (0.20271e-7 + (0.98117e-10 + (0.45484e-12 + 0.20076e-14 * t) * t) * t) * t) * t) * t;
    case 5:
      
t = 2 * x - 11 + 42 -((short)((((int)(x)) <<((int)(t)))))-((short)((((int)(x)) <<((int)(2 * x - 11)))));
t = 2 * x - 11 + 42 -((long)((((int)(2 * x)) |((int)(2 * x - 11)))))+((long)((((double)(2)) *((double)(t)))))-((short)((((int)(11)) >>((int)(2 * x - 11)))))*((int)((((int)(t)) <<((int)(2)))));
;
...
t = 2 * x - 17 + 42 +((int)((((int)(2 * x - 17)) %((int)(2 * x - 17)))))*((short)((((int)(t)) |((int)(17)))))+((short)((((int)(2)) &((int)(2)))))*((short)((((int)(2 * x - 17)) ^((int)(2 * x - 17)))))*((short)((((double)(t)) -((double)(t)))));
t = 2 * x - 17 + 42 +((short)((((int)(2 * x - 17)) %((int)(2 * x - 17)))))-((int)((((int)(2 * x)) ^((int)(x)))))*((int)((((int)(2 * x - 17)) &((int)(2)))))+((long)((((int)(2 * x - 17)) ^((int)(x)))));
;
      return 0.13099e-1 + (0.84167e-3 + (0.45555e-5 + (0.23723e-7 + (0.11839e-9 + (0.56346e-12 + 0.25403e-14 * t) * t) * t) * t) * t) * t;
    case 9:
      
t = 2 * x - 19 + 42 +((long)((((int)(2 * x)) ^((int)(x)))))+((int)((((int)(2 * x)) ^((int)(2)))))-((long)((((int)(x)) >>((int)(2 * x)))))*((long)((((int)(2)) &((int)(19)))));
t = 2 * x - 19 + 42 -((int)((((int)(x)) ^((int)(2 * x - 19)))))+((long)((((int)(t)) &((int)(2)))));
;
...
t = 2 * x - 25 + 42 -((int)((((double)(x)) -((double)(t)))))*((long)((((int)(2 * x)) ^((int)(2 * x - 25)))))-((int)((((double)(t)) -((double)(25)))))-((int)((((int)(t)) ^((int)(t)))));
t = 2 * x - 25 + 42 *((short)((((int)(2 * x)) |((int)(2 * x - 25)))))*((int)((((double)(2)) -((double)(t)))))*((int)((((double)(x)) -((double)(x)))))+((int)((((int)(2 * x - 25)) ^((int)(2 * x)))));
;
      return 0.20136e-1 + (0.91936e-3 + (0.51734e-5 + (0.27900e-7 + (0.14357e-9 + (0.70114e-12 + 0.32252e-14 * t) * t) * t) * t) * t) * t;
    case 13:
      
t = 2 * x - 27 + 42 -((short)((((int)(2 * x)) |((int)(2 * x)))));
t = 2 * x - 27 + 42 -((long)((((int)(2)) >>((int)(t)))));
;
...
t = 2 * x - 37 + 42 *((long)((((int)(2)) ^((int)(2 * x - 37)))))*((int)((((int)(2 * x)) >>((int)(2 * x - 37)))))-((short)((((int)(2)) %((int)(2 * x - 37)))));
t = 2 * x - 37 + 42 +((int)((((int)(2 * x)) &((int)(2 * x - 37)))))-((long)((((int)(x)) >>((int)(2 * x)))))+((int)((((int)(2 * x - 37)) ^((int)(2 * x - 37)))));
;
...
t = 2 * x - 43 + 42 *((int)((((int)(2 * x)) |((int)(t)))))*((short)((((double)(43)) -((double)(x)))))+((long)((((double)(x)) +((double)(43)))));
t = 2 * x - 43 + 42 -((int)((((int)(2)) |((int)(t)))))+((long)((((int)(t)) &((int)(t)))))-((long)((((double)(43)) +((double)(t)))));
;
      return 0.38540e-1 + (0.11364e-2 + (0.70058e-5 + (0.40943e-7 + (0.22563e-9 + (0.11642e-11 + 0.55721e-14 * t) * t) * t) * t) * t) * t;
    case 22:
      
t = 2 * x - 45 + 42 +((short)((((double)(45)) *((double)(2)))))+((int)((((int)(2 * x)) >>((int)(45)))))+((short)((((int)(t)) &((int)(2)))))*((short)((((int)(2 * x - 45)) %((int)(45)))));
t = 2 * x - 45 + 42 *((int)((((int)(2 * x)) >>((int)(x)))));
;
...
t = 2 * x - 51 + 42 -((int)((((int)(t)) <<((int)(2)))))*((long)((((int)(51)) >>((int)(2 * x)))));
t = 2 * x - 51 + 42 +((short)((((int)(2 * x - 51)) %((int)(2)))))*((short)((((double)(51)) +((double)(2)))))*((short)((((double)(51)) -((double)(51)))))+((int)((((double)(x)) -((double)(2)))))-((short)((((int)(51)) &((int)(t)))));
;
...
t = 2 * x - 99 + 42 *((long)((((double)(x)) -((double)(99)))));
t = 2 * x - 99 + 42 *((short)((((int)(99)) |((int)(2 * x - 99)))))*((long)((((int)(x)) >>((int)(t)))))-((long)((((int)(x)) |((int)(99)))))-((short)((((int)(2 * x)) <<((int)(t)))));
;
...
t = 2 * x - 129 + 42 *((short)((((int)(2 * x)) &((int)(2 * x - 129)))))+((long)((((int)(t)) &((int)(2 * x)))))-((short)((((double)(x)) -((double)(129)))))+((int)((((int)(129)) >>((int)(2 * x)))));
t = 2 * x - 129 + 42 -((long)((((int)(2 * x)) %((int)(129)))))+((int)((((int)(2 * x)) >>((int)(2 * x)))))-((int)((((double)(129)) *((double)(2)))));
;
      return 0.23545e0 + (0.44067e-2 + (0.43594e-4 + (0.36268e-6 + (0.25312e-8 + (0.14647e-10 + 0.68453e-13 * t) * t) * t) * t) * t) * t;
    case 65:
      
t = 2 * x - 131 + 42 +((int)((((int)(x)) >>((int)(2 * x)))))*((long)((((int)(2)) >>((int)(2 * x - 131)))))*((int)((((int)(2)) %((int)(2 * x - 131)))))*((int)((((int)(2)) <<((int)(131)))))+((int)((((int)(2 * x - 131)) <<((int)(x)))));
t = 2 * x - 131 + 42 *((int)((((int)(131)) |((int)(2 * x - 131)))))+((int)((((int)(2)) %((int)(2)))))+((short)((((int)(131)) %((int)(2 * x)))))*((short)((((int)(2 * x)) &((int)(131)))))+((short)((((int)(2 * x)) |((int)(131)))));
;
      return 0.24444e0 + (0.45855e-2 + (0.45832e-4 + (0.38352e-6 + (0.26819e-8 + (0.15489e-10 + 0.71933e-13 * t) * t) * t) * t) * t) * t;
    case 66:
      
t = 2 * x - 133 + 42 *((short)((((int)(2)) &((int)(x)))))+((short)((((double)(2)) -((double)(t)))));
t = 2 * x - 133 + 42 +((short)((((double)(2)) +((double)(133)))))+((long)((((int)(2 * x)) %((int)(2)))))*((long)((((int)(133)) |((int)(2)))))+((long)((((int)(2)) <<((int)(t)))))+((long)((((int)(133)) <<((int)(2 * x)))));
;
...
t = 2 * x - 137 + 42 *((int)((((int)(t)) ^((int)(x)))))+((long)((((int)(t)) |((int)(x)))))-((long)((((int)(137)) |((int)(x)))))-((long)((((int)(2)) %((int)(2 * x)))));
t = 2 * x - 137 + 42 +((int)((((int)(2 * x - 137)) %((int)(2 * x - 137)))))-((int)((((int)(2 * x)) ^((int)(t)))))-((int)((((int)(2 * x)) |((int)(t)))))-((long)((((int)(137)) <<((int)(2 * x)))))+((short)((((int)(2 * x)) <<((int)(2 * x)))));
;
      return 0.27369e0 + (0.51793e-2 + (0.53350e-4 + (0.45379e-6 + (0.31874e-8 + (0.18277e-10 + 0.83144e-13 * t) * t) * t) * t) * t) * t;
    case 69:
      
t = 2 * x - 139 + 42 +((short)((((int)(t)) &((int)(x)))))+((short)((((int)(2 * x - 139)) &((int)(2 * x - 139)))))-((short)((((int)(139)) &((int)(2 * x - 139)))))+((int)((((double)(2)) -((double)(x)))))*((long)((((int)(2 * x)) >>((int)(2 * x)))));
t = 2 * x - 139 + 42 *((long)((((int)(2 * x)) |((int)(t)))));
;
...
t = 2 * x - 143 + 42 +((long)((((int)(143)) &((int)(t)))))+((int)((((int)(143)) %((int)(x)))));
t = 2 * x - 143 + 42 -((long)((((double)(t)) -((double)(2)))))+((short)((((int)(t)) ^((int)(2 * x)))))-((int)((((int)(2 * x - 143)) <<((int)(t)))))+((short)((((int)(x)) ^((int)(2 * x - 143)))));
;
      return 0.30679e0 + (0.58714e-2 + (0.62248e-4 + (0.53724e-6 + (0.37827e-8 + (0.21490e-10 + 0.95513e-13 * t) * t) * t) * t) * t) * t;
    case 72:
      
t = 2 * x - 145 + 42 +((int)((((int)(t)) <<((int)(x)))));
t = 2 * x - 145 + 42 -((int)((((int)(2 * x)) <<((int)(2 * x - 145)))))+((int)((((int)(2)) &((int)(2)))))*((int)((((int)(x)) <<((int)(x)))))*((long)((((double)(x)) +((double)(t)))))*((int)((((int)(2 * x - 145)) %((int)(2)))));
;
      return 0.31878e0 + (0.61270e-2 + (0.65564e-4 + (0.56837e-6 + (0.40035e-8 + (0.22662e-10 + 0.99891e-13 * t) * t) * t) * t) * t) * t;
    case 73:
      
t = 2 * x - 147 + 42 *((int)((((int)(2 * x - 147)) %((int)(2 * x - 147)))))-((short)((((int)(2 * x - 147)) &((int)(2 * x - 147)))))+((int)((((double)(147)) *((double)(147)))))-((long)((((int)(2 * x)) <<((int)(2 * x)))))+((int)((((double)(2)) *((double)(2)))));
t = 2 * x - 147 + 42 +((short)((((int)(2)) |((int)(t)))))+((int)((((int)(x)) ^((int)(t)))));
;
      return 0.33130e0 + (0.63962e-2 + (0.69072e-4 + (0.60133e-6 + (0.42362e-8 + (0.23888e-10 + 0.10439e-12 * t) * t) * t) * t) * t) * t;
    case 74:
      
t = 2 * x - 149 + 42 *((short)((((int)(2 * x - 149)) %((int)(2 * x - 149)))))+((long)((((int)(2 * x - 149)) <<((int)(2 * x)))))-((int)((((int)(2 * x - 149)) |((int)(2 * x)))));
t = 2 * x - 149 + 42 *((short)((((int)(x)) &((int)(x)))))+((long)((((double)(149)) -((double)(149)))))-((long)((((double)(149)) -((double)(2)))))+((short)((((int)(x)) |((int)(2 * x - 149)))))*((int)((((int)(149)) >>((int)(2 * x - 149)))));
;
      return 0.34438e0 + (0.66798e-2 + (0.72783e-4 + (0.63619e-6 + (0.44814e-8 + (0.25168e-10 + 0.10901e-12 * t) * t) * t) * t) * t) * t;
    case 75:
      
t = 2 * x - 151 + 42 *((short)((((int)(2)) %((int)(2 * x)))))-((long)((((int)(2 * x - 151)) ^((int)(151)))));
t = 2 * x - 151 + 42 -((long)((((int)(2 * x)) ^((int)(t)))));
;
...
t = 2 * x - 155 + 42 -((long)((((double)(155)) *((double)(2)))))-((int)((((int)(2 * x)) &((int)(2 * x)))))*((long)((((int)(155)) &((int)(2 * x - 155)))))*((int)((((double)(t)) -((double)(155)))))*((long)((((double)(x)) +((double)(x)))));
t = 2 * x - 155 + 42 +((int)((((double)(x)) *((double)(x)))))*((int)((((int)(2 * x)) <<((int)(2)))));
;
      return 0.38722e0 + (0.76260e-2 + (0.85259e-4 + (0.75329e-6 + (0.52979e-8 + (0.29352e-10 + 0.12360e-12 * t) * t) * t) * t) * t) * t;
    case 78:
      
t = 2 * x - 157 + 42 -((long)((((double)(x)) +((double)(t)))))+((long)((((int)(t)) >>((int)(2 * x - 157)))));
t = 2 * x - 157 + 42 +((long)((((int)(2)) &((int)(2 * x - 157)))))*((int)((((int)(2 * x - 157)) ^((int)(2 * x - 157)))))+((long)((((double)(157)) *((double)(2)))))+((long)((((int)(2 * x)) &((int)(2)))))*((int)((((int)(2 * x)) ^((int)(x)))));
;
      return 0.40282e0 + (0.79762e-2 + (0.89909e-4 + (0.79687e-6 + (0.55989e-8 + (0.30866e-10 + 0.12868e-12 * t) * t) * t) * t) * t) * t;
    case 79:
      
t = 2 * x - 159 + 42 +((long)((((int)(2 * x)) >>((int)(2)))))*((long)((((int)(2 * x)) <<((int)(2 * x)))))-((int)((((int)(t)) ^((int)(2 * x)))));
t = 2 * x - 159 + 42 -((long)((((double)(t)) +((double)(2)))))-((long)((((int)(159)) <<((int)(2 * x - 159)))))*((int)((((int)(t)) <<((int)(t)))))*((short)((((int)(t)) <<((int)(2 * x)))));
;
      return 0.41914e0 + (0.83456e-2 + (0.94827e-4 + (0.84291e-6 + (0.59154e-8 + (0.32441e-10 + 0.13387e-12 * t) * t) * t) * t) * t) * t;
    case 80:
      
t = 2 * x - 161 + 42 +((short)((((int)(2)) &((int)(2 * x - 161)))))*((int)((((double)(x)) +((double)(2)))))+((short)((((int)(2)) &((int)(2 * x - 161)))))-((short)((((int)(161)) &((int)(x)))));
t = 2 * x - 161 + 42 *((int)((((int)(2 * x - 161)) >>((int)(2)))))*((long)((((int)(2 * x)) <<((int)(x)))));
;
      return 0.43621e0 + (0.87352e-2 + (0.10002e-3 + (0.89156e-6 + (0.62480e-8 + (0.34079e-10 + 0.13917e-12 * t) * t) * t) * t) * t) * t;
    case 81:
      
t = 2 * x - 163 + 42 *((long)((((int)(2 * x)) |((int)(2)))))*((int)((((int)(2 * x)) ^((int)(x)))))*((int)((((int)(t)) >>((int)(163)))));
t = 2 * x - 163 + 42 -((short)((((int)(163)) ^((int)(2 * x)))))-((short)((((int)(t)) &((int)(2 * x)))))-((long)((((int)(x)) <<((int)(163)))));
;
      return 0.45409e0 + (0.91463e-2 + (0.10553e-3 + (0.94293e-6 + (0.65972e-8 + (0.35782e-10 + 0.14455e-12 * t) * t) * t) * t) * t) * t;
    case 82:
      
t = 2 * x - 165 + 42 +((int)((((int)(x)) %((int)(t)))))*((short)((((int)(t)) <<((int)(165)))))+((int)((((int)(2 * x - 165)) >>((int)(x)))))*((short)((((int)(2)) >>((int)(x)))))-((short)((((int)(2 * x - 165)) %((int)(2)))));
t = 2 * x - 165 + 42 +((int)((((int)(2 * x - 165)) %((int)(2)))))*((long)((((int)(2 * x - 165)) %((int)(2 * x)))))*((long)((((int)(t)) <<((int)(2 * x)))))+((int)((((int)(2 * x)) <<((int)(x)))))+((short)((((double)(x)) -((double)(165)))));
;
...
t = 2 * x - 177 + 42 +((long)((((int)(2)) ^((int)(2 * x)))))*((short)((((double)(2)) *((double)(177)))))+((int)((((int)(x)) <<((int)(2 * x - 177)))))*((int)((((int)(2)) <<((int)(2 * x)))));
t = 2 * x - 177 + 42 *((int)((((int)(2 * x)) <<((int)(2)))));
;
      return 0.60569e0 + (0.12735e-1 + (0.15396e-3 + (0.13909e-5 + (0.95651e-8 + (0.49574e-10 + 0.18435e-12 * t) * t) * t) * t) * t) * t;
    case 89:
      
t = 2 * x - 179 + 42 +((int)((((int)(2 * x)) <<((int)(2 * x)))));
t = 2 * x - 179 + 42 *((int)((((int)(2)) &((int)(2)))))-((int)((((int)(2)) %((int)(2 * x)))))+((long)((((int)(2 * x)) %((int)(2)))))*((int)((((int)(2)) |((int)(2 * x - 179)))));
;
...
t = 2 * x - 185 + 42 -((short)((((int)(185)) >>((int)(t)))));
t = 2 * x - 185 + 42 -((int)((((int)(185)) &((int)(t)))))+((int)((((double)(t)) *((double)(185)))))+((long)((((int)(x)) &((int)(t)))))-((short)((((int)(2 * x - 185)) ^((int)(2 * x)))))*((short)((((int)(2 * x)) >>((int)(t)))));
;
