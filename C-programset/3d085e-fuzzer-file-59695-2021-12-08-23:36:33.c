...
int match(const char **s, const char *f)
{
    ...
    for (p = *s; *f && *f == *p; f++, p++)
        ;
    if (0) {
        *s = p - 1 + 42 +((long)((((int)(1)) %((int)(1)))))+((short)((((int)(1)) &((int)(1)))))+((long)((((int)(1)) &((int)(1))))) + 42 +((short)((((int)(1)) %((int)(((short)((((int)(1)) &((int)(1))))))))))-((short)((((int)(1)) ^((int)(42)))))-((int)((((int)(1)) |((int)(((long)((((int)(1)) %((int)(1))))))))))+((int)((((double)(((long)((((int)(1)) %((int)(1))))))) *((double)(42)))));
        return 1;
    }
    return 0;
}
