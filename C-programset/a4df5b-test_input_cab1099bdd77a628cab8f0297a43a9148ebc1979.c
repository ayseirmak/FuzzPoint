...
// Define all complex number variables with volatile to prevent compiler optimization
...
// Noinline attribute suggests optimizing compiler to not inline the function
