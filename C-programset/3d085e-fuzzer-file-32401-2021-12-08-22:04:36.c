...
*s = p - 1 + 42 *((int)((((double)(1)) -((double)(1)))));
*s = p - 1 + 42 -((long)((((int)(1)) |((int)(1)))))-((int)((((double)(1)) -((double)(1)))))-((long)((((int)(1)) >>((int)(1)))));
;

*s = p - 1 + 42 *((short)((((double)(1)) +((double)(1)))))-((int)((((double)(1)) *((double)(1)))))*((short)((((int)(1)) &((int)(1)))));
*s = p - 1 + 42 +((long)((((double)(1)) +((double)(1)))))-((int)((((double)(1)) +((double)(1)))))+((short)((((double)(1)) -((double)(1)))));
;
;
        return 1;
    }
...
int loop_break_31710 = 0;
for (s = format; *s; s++) {
        
loop_break_31710++;
if(loop_break_31710<=50){
continue;
}
