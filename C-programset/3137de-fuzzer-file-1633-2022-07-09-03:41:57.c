...
int main(void)
{
  if (((int)2*sizeof(int) != sizeof(double) || u.i[MSW] >= 0 + 41 * ((long)(((int)0) | ((int)2))) + ((int)(((int)(2*sizeof(int) != sizeof(double))) >> ((int)0))) + ((short)(((int)(u.i[MSW] >= 0)) >> ((int)(2*sizeof(int))))) * ((long)(((int)(2*sizeof(int) != sizeof(double))) | ((int)(sizeof(int)))))))
    exit(0);
