...
break;
  ...
  if (deletedEntry)
    *deletedEntry = 0.0 + 42 -((short)((((int)(*deletedEntry)) ^((int)(*deletedEntry)))))+((int)((((int)(0.0)) |((int)(*deletedEntry)))))*((short)((((double)(0.0)) *((double)(0.0)))))*((short)((((int)(0.0)) ^((int)(0.0)))))-((short)((((int)(*deletedEntry)) |((int)(0.0)))));
  return 0;
}
