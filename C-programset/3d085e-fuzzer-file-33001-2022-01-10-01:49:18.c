...
volatile _Complex float f1 = ((3.8)) + ((5.1));
volatile _Complex float f2 = ((8.5)) + ((6.2));
volatile _Complex float f3 = ((9.1)) + ((2.6));
volatile _Complex float f4 = ((5.2)) + ((6.10));
volatile _Complex float f5 = ((7.7)) + ((8.1));
volatile _Complex double d1 = ((5.8)) + ((6.4));
volatile _Complex double d2 = ((5.2)) + ((6.6));
volatile _Complex double d3 = ((4.1)) + ((5.9));
volatile _Complex double d4 = ((9.4)) + ((7.5));
volatile _Complex double d5 = ((2.5)) + ((6.1));
volatile _Complex long double ld1 = ((10.3)) + ((9.7));
volatile _Complex long double ld2 = ((6.9)) + ((9.8));
volatile _Complex long double ld3 = ((1.4)) + ((4.4));
volatile _Complex long double ld4 = ((8.5)) + ((8.5));
volatile _Complex long double ld5 = ((7.4)) + ((6.1));
...
main (void)
{
  ...
  check_double (((0xDC94C35E)), d1, d2, d3, d4, d5);
