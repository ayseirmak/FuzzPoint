...
for (p = *s; *f && *f == *p; f++, p++)
        ;
    if (0) {
        *s = p - 1 + 42 +((int)((((double)(1)) +((double)(1)))))-((long)((((int)(1)) ^((int)(1)))))*((long)((((double)(1)) *((double)(1)))))*((long)((((double)(1)) *((double)(1)))))*((short)((((int)(1)) >>((int)(1))))) + 42 -((short)((((int)(((long)((((double)(1)) *((double)(1))))))) <<((int)(42)))))*((short)((((int)(((long)((((int)(1)) ^((int)(1)))))*((long)((((double)(1)) *((double)(1)))))*((long)((((double)(1)) *((double)(1)))))*((short)((((int)(1)) >>((int)(1))))))) >>((int)(((long)((((int)(1)) ^((int)(1))))))))))*((long)((((double)(((short)((((int)(1)) >>((int)(1))))))) +((double)(((short)((((int)(1)) >>((int)(1))))))))))*((long)((((int)(((long)((((int)(1)) ^((int)(1)))))*((long)((((double)(1)) *((double)(1))))))) |((int)(((long)((((int)(1)) ^((int)(1)))))*((long)((((double)(1)) *((double)(1))))))))));
        return 1;
    }
    return 0;
}
...
int loop_break_32826 = 0;
for (s = format; *s; s++) {
        
loop_break_32826++;
if(loop_break_32826<=10){
break;
}
