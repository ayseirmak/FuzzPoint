...
t = 2 * x - 1 + 42 +((int)((((int)(2 * x)) &((int)(x)))))-((long)((((int)(t)) ^((int)(1)))))+((int)((((int)(2 * x - 1)) ^((int)(2)))));
t = 2 * x - 1 + 42 -((long)((((int)(t)) |((int)(2 * x - 1)))))*((long)((((int)(2 * x)) ^((int)(2 * x)))));
;
...
t = 2 * x - 7 + 42 -((long)((((int)(x)) ^((int)(2 * x - 7)))))+((short)((((int)(2 * x)) &((int)(7)))))*((long)((((int)(7)) >>((int)(t)))));
t = 2 * x - 7 + 42 -((int)((((int)(2 * x - 7)) <<((int)(2)))))-((int)((((int)(t)) >>((int)(2 * x - 7)))))+((long)((((int)(7)) ^((int)(2 * x)))))+((long)((((int)(x)) >>((int)(x)))))-((int)((((int)(2 * x - 7)) &((int)(7)))));
;
      return 0.51154e-2 + (0.75722e-3 + (0.39096e-5 + (0.19504e-7 + (0.93687e-10 + (0.43143e-12 + 0.18939e-14 * t) * t) * t) * t) * t) * t;
    case 4:
      
t = 2 * x - 9 + 42 *((long)((((int)(2 * x)) <<((int)(x)))))+((long)((((int)(2 * x - 9)) &((int)(2)))))+((short)((((int)(2 * x)) &((int)(2 * x - 9)))));
t = 2 * x - 9 + 42 +((short)((((int)(9)) <<((int)(2 * x - 9)))))*((long)((((double)(t)) *((double)(2)))));
;
...
t = 2 * x - 19 + 42 +((short)((((int)(2 * x - 19)) &((int)(2 * x)))))+((short)((((int)(2 * x - 19)) %((int)(2)))));
t = 2 * x - 19 + 42 +((long)((((int)(2 * x - 19)) <<((int)(2 * x - 19)))))+((int)((((int)(19)) |((int)(t)))))*((long)((((int)(2 * x)) %((int)(2 * x - 19)))))-((long)((((int)(x)) >>((int)(2 * x - 19)))))+((int)((((int)(x)) <<((int)(19)))));
;
      return 0.14800e-1 + (0.86018e-3 + (0.47008e-5 + (0.24694e-7 + (0.12418e-9 + (0.59486e-12 + 0.26957e-14 * t) * t) * t) * t) * t) * t;
    case 10:
      
t = 2 * x - 21 + 42 -((short)((((int)(2 * x)) %((int)(2 * x)))));
t = 2 * x - 21 + 42 *((long)((((int)(2)) |((int)(2 * x - 21)))))-((int)((((int)(x)) &((int)(21)))))-((long)((((int)(2 * x)) %((int)(x)))));
;
      return 0.16540e-1 + (0.87928e-3 + (0.48520e-5 + (0.25711e-7 + (0.13030e-9 + (0.62820e-12 + 0.28612e-14 * t) * t) * t) * t) * t) * t;
    case 11:
      
t = 2 * x - 23 + 42 *((long)((((int)(x)) ^((int)(23)))))*((short)((((int)(2 * x - 23)) &((int)(2 * x - 23)))))+((int)((((double)(23)) *((double)(23)))))+((int)((((int)(x)) >>((int)(x)))))-((long)((((int)(23)) ^((int)(2 * x - 23)))));
t = 2 * x - 23 + 42 -((int)((((int)(2 * x)) <<((int)(2)))))*((short)((((int)(2 * x)) <<((int)(23)))))-((short)((((int)(2)) &((int)(2 * x)))))-((int)((((double)(23)) *((double)(2)))))-((int)((((int)(x)) %((int)(2)))));
;
      return 0.18318e-1 + (0.89900e-3 + (0.50094e-5 + (0.26779e-7 + (0.13675e-9 + (0.66358e-12 + 0.30375e-14 * t) * t) * t) * t) * t) * t;
    case 12:
      
t = 2 * x - 25 + 42 *((long)((((int)(x)) |((int)(2 * x - 25)))))*((short)((((int)(25)) |((int)(2 * x)))));
t = 2 * x - 25 + 42 -((int)((((int)(t)) >>((int)(x)))));
;
      return 0.20136e-1 + (0.91936e-3 + (0.51734e-5 + (0.27900e-7 + (0.14357e-9 + (0.70114e-12 + 0.32252e-14 * t) * t) * t) * t) * t) * t;
    case 13:
      
t = 2 * x - 27 + 42 +((int)((((double)(27)) -((double)(t)))))-((int)((((double)(2)) *((double)(t)))))-((int)((((double)(t)) +((double)(x)))))+((int)((((int)(x)) %((int)(2 * x - 27)))))+((int)((((double)(x)) *((double)(x)))));
t = 2 * x - 27 + 42 -((long)((((int)(27)) ^((int)(2 * x - 27)))))*((long)((((int)(2)) &((int)(2 * x)))))-((short)((((int)(27)) <<((int)(2 * x)))))*((long)((((int)(2)) <<((int)(27)))))+((long)((((int)(x)) |((int)(2 * x)))));
;
      return 0.21996e-1 + (0.94040e-3 + (0.53443e-5 + (0.29078e-7 + (0.15078e-9 + (0.74103e-12 + 0.34251e-14 * t) * t) * t) * t) * t) * t;
    case 14:
      
t = 2 * x - 29 + 42 -((long)((((int)(2 * x - 29)) <<((int)(x)))))+((short)((((int)(29)) &((int)(t)))))*((int)((((int)(2 * x - 29)) %((int)(2)))));
t = 2 * x - 29 + 42 *((int)((((int)(29)) |((int)(29)))))-((long)((((double)(x)) -((double)(29)))))+((short)((((int)(2 * x)) ^((int)(2 * x)))))*((short)((((int)(2 * x - 29)) |((int)(t)))))+((int)((((int)(x)) ^((int)(2 * x - 29)))));
;
...
t = 2 * x - 35 + 42 +((short)((((int)(x)) %((int)(2)))))-((long)((((int)(2 * x - 35)) |((int)(2 * x - 35)))))-((short)((((double)(x)) -((double)(t)))))*((long)((((int)(35)) &((int)(2 * x - 35)))))*((short)((((double)(2)) *((double)(2)))));
t = 2 * x - 35 + 42 +((short)((((int)(2 * x)) ^((int)(2 * x - 35)))))*((long)((((int)(2 * x)) <<((int)(2 * x - 35)))))*((long)((((int)(2 * x)) &((int)(35)))))-((int)((((int)(x)) <<((int)(35)))))-((long)((((int)(2 * x)) &((int)(t)))));
;
      return 0.29877e-1 + (0.10318e-2 + (0.61041e-5 + (0.34414e-7 + (0.18399e-9 + (0.92703e-12 + 0.43639e-14 * t) * t) * t) * t) * t) * t;
    case 18:
      
t = 2 * x - 37 + 42 +((int)((((int)(37)) %((int)(2 * x)))));
t = 2 * x - 37 + 42 +((int)((((int)(x)) &((int)(37)))));
;
...
t = 2 * x - 45 + 42 -((long)((((int)(2)) &((int)(t)))))-((short)((((double)(t)) +((double)(x)))))-((long)((((double)(2)) -((double)(x)))))*((int)((((int)(2 * x)) >>((int)(45)))))*((long)((((int)(2 * x)) ^((int)(2 * x - 45)))));
t = 2 * x - 45 + 42 -((int)((((double)(x)) *((double)(t)))))-((int)((((int)(2)) ^((int)(45)))))+((int)((((int)(t)) &((int)(2 * x)))));
;
      return 0.40842e-1 + (0.11650e-2 + (0.72569e-5 + (0.42796e-7 + (0.23761e-9 + (0.12332e-11 + 0.59246e-14 * t) * t) * t) * t) * t) * t;
    case 23:
      
t = 2 * x - 47 + 42 +((short)((((int)(x)) %((int)(2 * x - 47)))));
t = 2 * x - 47 + 42 -((short)((((double)(t)) -((double)(x)))))-((short)((((int)(x)) >>((int)(2 * x - 47)))))+((int)((((int)(2 * x)) &((int)(47)))))*((long)((((int)(2 * x - 47)) ^((int)(2 * x)))));
;
...
t = 2 * x - 79 + 42 -((long)((((int)(2 * x - 79)) %((int)(79)))));
t = 2 * x - 79 + 42 *((long)((((double)(79)) *((double)(t)))));
;
...
t = 2 * x - 119 + 42 +((short)((((double)(119)) +((double)(t)))))-((int)((((int)(2 * x)) %((int)(2)))))*((short)((((int)(2 * x)) >>((int)(119)))))*((short)((((int)(2 * x)) <<((int)(119)))));
t = 2 * x - 119 + 42 -((long)((((int)(t)) &((int)(2 * x)))))+((long)((((int)(2 * x - 119)) >>((int)(x)))))+((short)((((int)(2 * x - 119)) %((int)(119)))))+((short)((((double)(t)) -((double)(x)))));
;
      return 0.19540e0 + (0.36342e-2 + (0.34096e-4 + (0.27479e-6 + (0.18934e-8 + (0.11021e-10 + 0.52931e-13 * t) * t) * t) * t) * t) * t;
    case 60:
      
t = 2 * x - 121 + 42 -((long)((((double)(121)) -((double)(121)))))-((long)((((double)(2)) *((double)(121)))))-((int)((((int)(121)) &((int)(2 * x)))))-((long)((((double)(t)) *((double)(x)))));
t = 2 * x - 121 + 42 -((short)((((int)(x)) &((int)(2 * x)))))+((int)((((int)(2)) >>((int)(2 * x - 121)))));
;
...
t = 2 * x - 127 + 42 -((short)((((int)(2 * x - 127)) |((int)(127)))))*((long)((((int)(t)) >>((int)(2)))));
t = 2 * x - 127 + 42 -((short)((((int)(2 * x - 127)) <<((int)(t)))))+((long)((((int)(2 * x - 127)) ^((int)(2)))))-((long)((((int)(2 * x - 127)) |((int)(127)))));
;
...
t = 2 * x - 131 + 42 -((long)((((int)(x)) &((int)(2 * x - 131)))))+((short)((((double)(x)) -((double)(x)))))-((short)((((int)(t)) <<((int)(131)))));
t = 2 * x - 131 + 42 *((long)((((int)(2)) &((int)(2 * x)))))*((short)((((int)(2)) <<((int)(t)))));
;
      return 0.24444e0 + (0.45855e-2 + (0.45832e-4 + (0.38352e-6 + (0.26819e-8 + (0.15489e-10 + 0.71933e-13 * t) * t) * t) * t) * t) * t;
    case 66:
      
t = 2 * x - 133 + 42 +((short)((((int)(2 * x)) >>((int)(2 * x)))))*((long)((((double)(x)) -((double)(133)))))+((short)((((double)(2)) -((double)(t)))))-((short)((((double)(2)) +((double)(x)))))+((long)((((int)(2)) &((int)(2 * x)))));
t = 2 * x - 133 + 42 -((int)((((int)(2 * x - 133)) %((int)(133)))));
;
...
t = 2 * x - 141 + 42 +((int)((((int)(2)) <<((int)(141)))));
t = 2 * x - 141 + 42 -((long)((((int)(2 * x)) &((int)(2 * x)))));
;
      return 0.29529e0 + (0.56288e-2 + (0.59113e-4 + (0.50782e-6 + (0.35735e-8 + (0.20369e-10 + 0.91262e-13 * t) * t) * t) * t) * t) * t;
    case 71:
      
t = 2 * x - 143 + 42 *((long)((((double)(x)) *((double)(143)))))+((short)((((int)(143)) ^((int)(x)))))+((short)((((int)(2)) <<((int)(t)))))+((long)((((double)(x)) *((double)(t)))))-((long)((((int)(t)) <<((int)(x)))));
t = 2 * x - 143 + 42 -((int)((((double)(t)) -((double)(t)))));
;
      return 0.30679e0 + (0.58714e-2 + (0.62248e-4 + (0.53724e-6 + (0.37827e-8 + (0.21490e-10 + 0.95513e-13 * t) * t) * t) * t) * t) * t;
    case 72:
      
t = 2 * x - 145 + 42 -((long)((((int)(2 * x)) &((int)(2 * x - 145)))))-((short)((((double)(2)) +((double)(x)))))*((long)((((int)(2)) ^((int)(2 * x - 145)))))*((short)((((int)(2 * x - 145)) %((int)(2)))))+((long)((((int)(2 * x)) ^((int)(145)))));
t = 2 * x - 145 + 42 +((long)((((int)(2 * x - 145)) >>((int)(t)))))+((short)((((double)(145)) *((double)(2)))))*((long)((((int)(2)) ^((int)(2 * x - 145)))))-((short)((((int)(t)) |((int)(145)))))*((short)((((int)(2 * x)) %((int)(x)))));
;
...
t = 2 * x - 153 + 42 +((long)((((int)(153)) |((int)(2 * x)))))+((int)((((int)(x)) >>((int)(x)))))*((long)((((int)(x)) <<((int)(2 * x)))));
t = 2 * x - 153 + 42 -((long)((((int)(153)) <<((int)(x)))))*((short)((((int)(2)) <<((int)(x)))))*((long)((((double)(153)) *((double)(t)))));
;
      return 0.37230e0 + (0.72938e-2 + (0.80864e-4 + (0.71206e-6 + (0.50117e-8 + (0.27899e-10 + 0.11862e-12 * t) * t) * t) * t) * t) * t;
    case 77:
      
t = 2 * x - 155 + 42 *((short)((((int)(2 * x)) |((int)(155)))))*((int)((((int)(2 * x - 155)) |((int)(155)))))-((long)((((int)(t)) %((int)(2 * x)))))+((int)((((int)(2 * x)) |((int)(2)))))-((int)((((int)(2 * x - 155)) >>((int)(2 * x)))));
t = 2 * x - 155 + 42 +((int)((((int)(155)) &((int)(2 * x)))))+((short)((((int)(2)) >>((int)(2 * x)))))+((int)((((int)(2 * x)) >>((int)(155)))));
;
      return 0.38722e0 + (0.76260e-2 + (0.85259e-4 + (0.75329e-6 + (0.52979e-8 + (0.29352e-10 + 0.12360e-12 * t) * t) * t) * t) * t) * t;
    case 78:
      
t = 2 * x - 157 + 42 *((short)((((int)(t)) |((int)(2)))));
t = 2 * x - 157 + 42 +((int)((((int)(2 * x - 157)) >>((int)(2)))))*((long)((((int)(2 * x)) &((int)(t)))));
;
...
t = 2 * x - 163 + 42 -((long)((((int)(163)) <<((int)(2 * x - 163)))))*((short)((((int)(163)) ^((int)(x)))))+((short)((((int)(2 * x)) &((int)(163)))))*((long)((((int)(163)) >>((int)(x)))));
t = 2 * x - 163 + 42 +((int)((((int)(2 * x)) |((int)(2 * x)))))*((int)((((int)(2 * x - 163)) &((int)(t)))))*((long)((((int)(t)) |((int)(t)))))+((short)((((double)(t)) -((double)(x)))));
;
      return 0.45409e0 + (0.91463e-2 + (0.10553e-3 + (0.94293e-6 + (0.65972e-8 + (0.35782e-10 + 0.14455e-12 * t) * t) * t) * t) * t) * t;
    case 82:
      
t = 2 * x - 165 + 42 -((long)((((int)(2 * x)) %((int)(2 * x - 165)))))*((long)((((int)(165)) <<((int)(2)))))-((int)((((int)(2 * x)) %((int)(x)))))-((long)((((int)(2)) &((int)(x)))));
t = 2 * x - 165 + 42 *((short)((((int)(t)) <<((int)(2 * x)))))-((long)((((int)(165)) &((int)(165)))))*((int)((((int)(t)) &((int)(2 * x - 165)))))*((long)((((int)(2 * x)) %((int)(2 * x - 165)))));
;
...
t = 2 * x - 169 + 42 +((int)((((double)(t)) *((double)(x)))));
t = 2 * x - 169 + 42 +((int)((((int)(2 * x)) >>((int)(x)))));
;
      return 0.51298e0 + (0.10520e-1 + (0.12400e-3 + (0.11147e-5 + (0.77517e-8 + (0.41283e-10 + 0.16122e-12 * t) * t) * t) * t) * t) * t;
    case 85:
      
t = 2 * x - 171 + 42 -((short)((((int)(2 * x)) >>((int)(x)))))*((short)((((int)(t)) >>((int)(2)))))*((int)((((int)(2)) |((int)(x)))));
t = 2 * x - 171 + 42 -((long)((((int)(2 * x)) &((int)(t)))));
;
...
t = 2 * x - 175 + 42 +((long)((((int)(2 * x)) >>((int)(2 * x - 175)))))*((short)((((int)(2 * x)) ^((int)(2 * x - 175)))))-((int)((((double)(x)) +((double)(x)))))+((int)((((int)(2)) ^((int)(2 * x)))))+((int)((((int)(2 * x - 175)) &((int)(2 * x)))));
t = 2 * x - 175 + 42 -((long)((((double)(175)) -((double)(t)))))+((long)((((int)(175)) %((int)(175)))));
;
...
t = 2 * x - 181 + 42 *((short)((((int)(2)) >>((int)(2 * x - 181)))))*((short)((((int)(t)) <<((int)(2)))))*((long)((((int)(2)) >>((int)(x)))))+((long)((((int)(181)) |((int)(181)))))*((long)((((int)(181)) <<((int)(181)))));
t = 2 * x - 181 + 42 +((short)((((int)(2 * x - 181)) &((int)(181)))))*((long)((((int)(x)) %((int)(2 * x)))))*((short)((((int)(t)) |((int)(181)))));
;
      return 0.65918e0 + (0.14036e-1 + (0.17160e-3 + (0.15521e-5 + (0.10601e-7 + (0.54140e-10 + 0.19616e-12 * t) * t) * t) * t) * t) * t;
    case 91:
      
t = 2 * x - 183 + 42 -((short)((((int)(t)) %((int)(2 * x)))))*((short)((((int)(2 * x)) &((int)(t)))))+((long)((((double)(t)) -((double)(t)))));
t = 2 * x - 183 + 42 *((int)((((int)(2 * x - 183)) ^((int)(2)))))+((int)((((double)(t)) +((double)(t)))))+((int)((((int)(2 * x - 183)) <<((int)(2 * x - 183)))));
;
