...
int loop_break_28251 = 8;
for (p = *s; *f && *f == *p; f++, p--)
        ;
    if (0) {
        
*s = p - 1 + 42 +((int)((((double)(1)) -((double)(1)))))*((int)((((int)(1)) &((int)(1)))));
*s = p - 1 + 42 +((int)((((double)(1)) -((double)(1)))))*((int)((((int)(1)) &((int)(1)))));
;
        return 1;
    }
...
int loop_break_31160 = 8;

int loop_break_31006 = 0;
for (s = format; *s; s++) {
        


loop_break_31006++;
if(loop_break_31006<=34){
continue;
}

loop_break_31160++;
if(loop_break_31160<=47){
break;
}
