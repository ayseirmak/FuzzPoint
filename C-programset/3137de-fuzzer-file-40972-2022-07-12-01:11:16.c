...
2 * x - 3;
    ...
    case 2:
      t = 2 * x - 5 + 42 + ((short)(((int)(x)) % ((int)(2 * x)))) + ((long)(((double)2) + ((double)2)));
...
;t = 2 * x - 19 + 42 - ((int)(((int)(t)) << ((int)19))) - ((long)(((int)(x)) & ((int)(2 * x - 19))));
2 * x - 17;
      return 0.13099e-1 + (0.84167e-3 + (0.45555e-5 + (0.23723e-7 + (0.11839e-9 + (0.56346e-12 + 0.25403e-14 * t) * t) * t) * t) * t) * t;
    case 9:
      
;t = 2 * x - 21;
t = 2 * x - 19 + 42 - ((short)(((int)2) | ((int)2))) - ((long)(((int)(2 * x)) ^ ((int)(t)))) - ((int)(((int)(x)) % ((int)(2 * x - 19)))) + ((short)(((int)(t)) & ((int)(2 * x))));
...
;t = 2 * x - 25 + 42 - ((int)(((int)(t)) & ((int)(x)))) + ((long)(((double)(t)) * ((double)25))) - ((int)(((double)(x)) - ((double)(x)))) - ((int)(((double)25) + ((double)2)));
2 * x - 23;
...
;t = 2 * x - 29 + 42 - ((long)(((int)(2 * x - 29)) | ((int)(2 * x - 29))));
t = 2 * x - 27;
...
;t = 2 * x - 37 + 42 - ((long)(((double)2) * ((double)37))) - ((int)(((int)2) << ((int)(2 * x)))) - ((short)(((double)37) - ((double)(x)))) - ((long)(((double)2) - ((double)2)));
2 * x - 35;
      return 0.29877e-1 + (0.10318e-2 + (0.61041e-5 + (0.34414e-7 + (0.18399e-9 + (0.92703e-12 + 0.43639e-14 * t) * t) * t) * t) * t) * t;
    case 18:
      
;t = 2 * x - 39 + 42 - ((int)(((int)39) % ((int)(t)))) - ((long)(((int)(t)) | ((int)(2 * x - 39)))) + ((long)(((int)39) >> ((int)(2 * x)))) * ((int)(((int)39) | ((int)(2 * x - 39)))) * ((int)(((int)(t)) >> ((int)(2 * x))));
t = 2 * x - 37 + 42 * ((long)(((double)(x)) - ((double)(t)))) - ((short)(((int)(t)) << ((int)(2 * x)))) * ((int)(((int)(x)) & ((int)37))) + ((short)(((int)2) >> ((int)(2 * x)))) - ((long)(((int)2) ^ ((int)(2 * x - 37))));
      return 0.31965e-1 + (0.10566e-2 + (0.63151e-5 + (0.35924e-7 + (0.19353e-9 + (0.98102e-12 + 0.46381e-14 * t) * t) * t) * t) * t) * t;
    case 19:
      
;t = 2 * x - 41 + 42 * ((long)(((int)(2 * x - 41)) | ((int)(t)))) + ((long)(((double)41) - ((double)(t)))) + ((int)(((int)(x)) % ((int)(2 * x - 41))));
t = 2 * x - 39 + 42 + ((int)(((double)2) - ((double)39))) * ((short)(((int)(2 * x - 39)) << ((int)2))) * ((int)(((int)39) % ((int)39)));
...
t;
    ...
    case 24:
      t = 2 * x - 49 + 42 + ((int)(((int)(t)) << ((int)(2 * x - 49)))) * ((int)(((int)2) & ((int)(2 * x - 49)))) * ((long)(((int)2) ^ ((int)(2 * x)))) - ((short)(((int)(2 * x - 49)) ^ ((int)49)));
...
;t = 2 * x - 127 + 42 - ((int)(((double)(x)) - ((double)(t)))) * ((int)(((int)2) % ((int)(2 * x - 127)))) - ((short)(((int)(2 * x)) | ((int)(2 * x)))) - ((long)(((int)127) | ((int)(2 * x)))) * ((short)(((double)127) + ((double)(t))));
t = 2 * x - 125;
...
;t = 2 * x - 133 + 42 + ((short)(((int)2) | ((int)(x)))) - ((int)(((int)(2 * x)) >> ((int)(2 * x)))) * ((int)(((int)133) | ((int)(2 * x)))) * ((short)(((int)(2 * x)) ^ ((int)133))) + ((int)(((int)133) % ((int)(2 * x))));
2 * x - 131;
...
t = 2 * x - 133;
    ...
    case 67:
      t = 2 * x - 135 + 42 * ((int)(((int)(2 * x - 135)) % ((int)(2 * x - 135))));
...
2 * x - 139;
    ...
    case 70:
      t = 2 * x - 141 + 42 - ((int)(((double)(t)) * ((double)141))) * ((int)(((int)(t)) >> ((int)(2 * x - 141)))) + ((long)(((int)(2 * x)) | ((int)2)));
...
t = 2 * x - 151;
    ...
    case 76:
      t = 2 * x - 153 + 42 + ((short)(((int)(2 * x)) % ((int)(x)))) + ((long)(((int)(2 * x - 153)) >> ((int)153))) - ((int)(((int)(t)) % ((int)2)));
...
;t = 2 * x - 159;
t = 2 * x - 157 + 42 * ((long)(((int)157) >> ((int)(2 * x - 157))));
...
;t = 2 * x - 165 + 42 * ((int)(((int)(t)) % ((int)2))) * ((int)(((int)(t)) & ((int)(2 * x - 165)))) * ((long)(((int)(2 * x)) << ((int)2))) * ((long)(((double)(t)) - ((double)165)));
2 * x - 163;
...
2 * x - 179;
    ...
    case 90:
      t = 2 * x - 181 + 42 * ((short)(((int)(2 * x)) ^ ((int)(2 * x))));
...
;t = 2 * x - 187 + 42 * ((long)(((int)2) & ((int)2))) + ((short)(((int)(2 * x - 187)) % ((int)(t))));
2 * x - 185;
