...
{
  va_start (ap, i);
  f = va_arg (*foo (), float) + (0x398C) +((int)((((int)(va_arg (*foo (), float))) %((int)(va_arg (*foo (), float)))))) + (0x8C65) +((int)((((int)(((int)((((int)(va_arg (*foo (), float))) %((int)(va_arg (*foo (), float)))))))) %((int)(f)))))-((long)((((int)(va_arg (*foo (), float) + (0x848))) %((int)(va_arg (*foo (), float) + (0xD2))))))+((long)((((int)((58))) <<((int)(va_arg (*foo (), float))))));
  va_end (ap);
}
