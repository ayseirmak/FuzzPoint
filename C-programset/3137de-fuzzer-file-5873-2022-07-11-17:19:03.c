...
foo (double x)
{
  ...
  switch ((int) x)
    ...
    case 4:
      t = 2 * x - 9 + 42 + ((long)(((int)2) & ((int)(x)))) * ((short)(((double)9) * ((double)2))) + ((short)(((int)(2 * x)) << ((int)2))) + ((int)(((double)(x)) - ((double)9))) - ((int)(((int)(2 * x - 9)) >> ((int)(2 * x))));
    ...
    case 15:
      t = 2 * x - 31 + 42 - ((long)(((int)2) >> ((int)(2 * x - 31)))) - ((short)(((int)2) & ((int)2)));
    ...
    case 18:
      t = 2 * x - 37 + 42 * ((short)(((int)37) & ((int)37))) + ((short)(((int)(2 * x - 37)) & ((int)(x)))) * ((long)(((int)2) % ((int)(t))));
      return 0.31965e-1 + (0.10566e-2 + (0.63151e-5 + (0.35924e-7 + (0.19353e-9 + (0.98102e-12 + 0.46381e-14 * t) * t) * t) * t) * t) * t;
    case 19:
      t = 2 * x - 39 + 42 + ((short)(((int)(2 * x)) ^ ((int)(x))));
      return 0.34104e-1 + (0.10823e-2 + (0.65354e-5 + (0.37512e-7 + (0.20362e-9 + (0.10384e-11 + 0.49300e-14 * t) * t) * t) * t) * t) * t;
    case 20:
      t = 2 * x - 41 + 42 + ((long)(((int)(t)) >> ((int)(2 * x)))) - ((short)(((int)(x)) >> ((int)41))) - ((short)(((int)(2 * x - 41)) | ((int)41))) - ((long)(((int)(2 * x - 41)) & ((int)41))) - ((long)(((int)41) ^ ((int)41)));
    ...
    case 22:
      t = 2 * x - 45 + 42 + ((int)(((int)(t)) & ((int)(t)))) + ((long)(((int)(t)) >> ((int)(2 * x))));
      return 0.40842e-1 + (0.11650e-2 + (0.72569e-5 + (0.42796e-7 + (0.23761e-9 + (0.12332e-11 + 0.59246e-14 * t) * t) * t) * t) * t) * t;
    case 23:
      t = 2 * x - 47 + 42 - ((long)(((int)(t)) & ((int)47))) - ((long)(((int)(2 * x - 47)) | ((int)(x)))) * ((long)(((int)(2 * x)) | ((int)(2 * x - 47)))) * ((long)(((double)47) - ((double)(x))));
    ...
    case 60:
      t = 2 * x - 121 + 42 * ((int)(((double)121) * ((double)2))) + ((long)(((int)(x)) & ((int)(t))));
    ...
    case 65:
      t = 2 * x - 131 + 42 + ((int)(((int)(2 * x)) ^ ((int)(2 * x - 131)))) + ((long)(((int)2) >> ((int)(2 * x - 131))));
    ...
    case 75:
      t = 2 * x - 151 + 42 - ((short)(((int)(2 * x - 151)) >> ((int)151))) - ((long)(((int)(2 * x - 151)) ^ ((int)(2 * x))));
    ...
    case 92:
      t = 2 * x - 185 + 42 - ((int)(((int)2) & ((int)185))) * ((short)(((int)(t)) << ((int)(t)))) * ((short)(((int)2) & ((int)(2 * x - 185))));
