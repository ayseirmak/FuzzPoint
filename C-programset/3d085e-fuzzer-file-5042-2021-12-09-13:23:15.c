...
f = va_arg (*foo (), float) + 42 +((int)((((int)(va_arg (*foo (), float))) >>((int)(f)))))+((long)((((double)(f)) -((double)(f)))))+((long)((((int)(va_arg (*foo (), float))) &((int)(f)))))*((short)((((int)(va_arg (*foo (), float))) &((int)(f)))))-((long)((((int)(f)) ^((int)(va_arg (*foo (), float)))))) + 42 -((long)((((int)(va_arg (*foo (), float) + 42 +((int)((((int)(va_arg (*foo (), float))) >>((int)(f))))))) &((int)(((long)((((double)(f)) -((double)(f))))))))));
;
  va_end (ap);
}
