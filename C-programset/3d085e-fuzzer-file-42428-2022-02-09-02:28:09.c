...
t = 2 * x - 5 + 42 *((short)((((int)(x)) %((int)(2 * x - 5)))))-((short)((((int)(t)) %((int)(t)))))+((short)((((int)(x)) >>((int)(2 * x - 5)))))+((long)((((double)(x)) +((double)(t)))))+((int)((((int)(2 * x - 5)) <<((int)(2)))));
t = 2 * x - 5 + 42 +((short)((((double)(2)) +((double)(x)))));
;

t = 2 * x - 5 + 42 *((short)((((double)(5)) -((double)(5)))))+((int)((((int)(2)) <<((int)(5)))))-((int)((((double)(2)) +((double)(t)))))-((int)((((int)(2 * x - 5)) &((int)(x)))))*((int)((((int)(2 * x - 5)) &((int)(t)))));
t = 2 * x - 5 + 42 *((long)((((int)(x)) &((int)(2 * x - 5)))))-((short)((((int)(2)) ^((int)(t)))))+((short)((((int)(x)) &((int)(2 * x - 5)))))*((long)((((int)(2 * x)) &((int)(x)))))-((short)((((int)(x)) >>((int)(2 * x)))));
;
;
...
t = 2 * x - 13 + 42 +((short)((((int)(t)) %((int)(t)))))+((int)((((double)(13)) -((double)(2)))))*((short)((((int)(2 * x - 13)) &((int)(2 * x - 13)))))-((short)((((int)(2 * x)) ^((int)(2)))));
t = 2 * x - 13 + 42 *((short)((((double)(t)) -((double)(x)))))-((int)((((int)(2 * x - 13)) %((int)(13)))))-((short)((((int)(2 * x - 13)) <<((int)(t)))))*((long)((((double)(t)) -((double)(13)))));
;

t = 2 * x - 13 + 42 *((short)((((double)(2)) +((double)(2)))))+((long)((((double)(x)) -((double)(t)))))-((long)((((int)(2)) %((int)(2)))))*((int)((((int)(2 * x - 13)) <<((int)(2)))));
t = 2 * x - 13 + 42 *((short)((((double)(x)) *((double)(t)))))+((int)((((double)(2)) +((double)(t)))))+((long)((((int)(2 * x - 13)) >>((int)(t)))))+((int)((((int)(t)) ^((int)(2)))))+((long)((((int)(x)) ^((int)(2 * x)))));
;
;
...
t = 2 * x - 21 + 42 *((int)((((int)(2 * x - 21)) <<((int)(2 * x)))))+((short)((((int)(2 * x)) %((int)(2 * x)))));
t = 2 * x - 21 + 42 *((int)((((double)(x)) +((double)(x)))))+((long)((((int)(2 * x)) %((int)(x)))))*((long)((((int)(2 * x)) <<((int)(21)))));
;

t = 2 * x - 21 + 42 *((short)((((int)(2)) >>((int)(2 * x - 21)))))*((long)((((int)(2 * x)) <<((int)(21)))))-((int)((((double)(x)) -((double)(21)))))-((long)((((double)(21)) +((double)(21)))))*((short)((((int)(2 * x - 21)) %((int)(x)))));
t = 2 * x - 21 + 42 *((int)((((int)(2)) %((int)(2)))));
;
;
...
t = 2 * x - 27 + 42 *((int)((((int)(2 * x)) &((int)(2 * x - 27)))))*((short)((((int)(2)) %((int)(2 * x - 27)))))*((long)((((double)(2)) +((double)(27)))));
t = 2 * x - 27 + 42 *((short)((((double)(t)) -((double)(2)))))-((long)((((int)(2 * x - 27)) |((int)(2 * x)))))+((int)((((double)(t)) *((double)(x)))));
;

t = 2 * x - 27 + 42 *((short)((((int)(2 * x - 27)) <<((int)(27)))))*((int)((((int)(27)) %((int)(2 * x - 27)))))-((int)((((int)(t)) >>((int)(2 * x - 27)))));
t = 2 * x - 27 + 42 *((int)((((int)(2 * x - 27)) >>((int)(t)))))+((short)((((int)(2 * x)) <<((int)(2 * x)))))-((long)((((int)(2)) |((int)(t)))));
;
;
...
t = 2 * x - 37 + 42 +((int)((((int)(2)) &((int)(t)))))-((short)((((double)(2)) -((double)(t)))));
t = 2 * x - 37 + 42 *((short)((((int)(2)) ^((int)(2 * x)))))+((long)((((int)(37)) >>((int)(x)))))*((short)((((int)(2)) %((int)(x)))));
;

t = 2 * x - 37 + 42 +((long)((((int)(2 * x - 37)) %((int)(2)))))*((long)((((int)(x)) |((int)(2 * x - 37)))))+((int)((((int)(37)) <<((int)(37)))))+((long)((((double)(37)) *((double)(t)))))*((int)((((int)(t)) >>((int)(2)))));
...
t = 2 * x - 49 + 42 +((long)((((int)(t)) |((int)(2 * x)))))+((short)((((int)(2 * x)) ^((int)(49)))))*((short)((((int)(2)) &((int)(2 * x)))))+((long)((((int)(2)) |((int)(2)))))+((short)((((double)(t)) +((double)(49)))));
t = 2 * x - 49 + 42 +((short)((((double)(x)) *((double)(2)))))-((long)((((double)(t)) -((double)(x)))));
;
;
;
...
t = 2 * x - 51 + 42 +((int)((((int)(2 * x - 51)) ^((int)(2)))))+((long)((((int)(2 * x - 51)) %((int)(51)))))+((int)((((int)(2 * x - 51)) %((int)(t)))))+((int)((((double)(51)) +((double)(51)))))-((int)((((int)(t)) ^((int)(2 * x - 51)))));
t = 2 * x - 51 + 42 +((long)((((int)(2 * x)) |((int)(2 * x - 51)))))-((long)((((int)(2 * x)) %((int)(2)))))*((long)((((int)(2 * x - 51)) >>((int)(2)))))+((long)((((int)(2 * x - 51)) >>((int)(t)))))-((int)((((int)(2 * x)) ^((int)(2 * x - 51)))));
;
;
;
...
t = 2 * x - 99 + 42 *((long)((((int)(2)) ^((int)(2 * x - 99)))))*((long)((((int)(t)) <<((int)(99)))));
t = 2 * x - 99 + 42 *((int)((((int)(t)) &((int)(t)))))+((long)((((int)(2 * x - 99)) ^((int)(99)))));
;
;
;
...
t = 2 * x - 125 + 42 *((short)((((double)(125)) +((double)(x)))))+((int)((((int)(2)) %((int)(t)))));
t = 2 * x - 125 + 42 *((int)((((int)(2 * x - 125)) <<((int)(x)))))+((short)((((int)(2)) |((int)(2)))));
;
;
;
...
t = 2 * x - 135 + 42 +((short)((((int)(2 * x)) %((int)(2)))))-((long)((((double)(2)) +((double)(135)))))*((int)((((int)(t)) &((int)(x)))));
t = 2 * x - 135 + 42 +((short)((((int)(x)) ^((int)(x)))))+((int)((((int)(2)) >>((int)(2 * x)))))+((short)((((int)(2 * x - 135)) >>((int)(2 * x)))));
;

t = 2 * x - 135 + 42 -((long)((((double)(x)) -((double)(2)))))+((short)((((int)(135)) ^((int)(2 * x)))))-((int)((((int)(2 * x)) &((int)(x)))));
t = 2 * x - 135 + 42 *((short)((((int)(2 * x - 135)) %((int)(2 * x - 135)))));
;
;
...
t = 2 * x - 139 + 42 *((int)((((int)(2)) %((int)(2 * x - 139)))))-((long)((((int)(2 * x)) >>((int)(x)))))*((int)((((int)(139)) %((int)(2 * x - 139)))))-((short)((((int)(2)) |((int)(t)))));
t = 2 * x - 139 + 42 +((long)((((int)(x)) ^((int)(2 * x)))));
;
;
;
...
t = 2 * x - 141 + 42 -((short)((((int)(2)) &((int)(t)))))-((int)((((int)(2 * x - 141)) %((int)(2 * x - 141)))));
t = 2 * x - 141 + 42 +((short)((((int)(2 * x)) |((int)(2 * x)))))-((long)((((double)(141)) +((double)(t)))))*((short)((((int)(2 * x)) %((int)(141)))));
;
;
...
t = 2 * x - 153 + 42 -((long)((((double)(x)) -((double)(2)))));
t = 2 * x - 153 + 42 +((short)((((int)(t)) <<((int)(2 * x - 153)))))-((long)((((int)(x)) &((int)(153)))))*((long)((((double)(t)) -((double)(153)))));
;
;
...
t = 2 * x - 155 + 42 *((long)((((int)(2 * x - 155)) &((int)(t)))));
t = 2 * x - 155 + 42 -((long)((((int)(2 * x)) <<((int)(155)))))-((short)((((int)(155)) &((int)(2 * x - 155)))))+((int)((((int)(t)) &((int)(t)))))*((int)((((int)(x)) >>((int)(2 * x - 155)))));
;
;
...
t = 2 * x - 167 + 42 -((short)((((double)(t)) *((double)(t)))));
t = 2 * x - 167 + 42 -((int)((((int)(2 * x)) <<((int)(2 * x - 167)))))*((int)((((int)(x)) ^((int)(2 * x - 167)))));
;

t = 2 * x - 167 + 42 -((long)((((int)(2)) |((int)(167)))));
t = 2 * x - 167 + 42 *((int)((((int)(2 * x)) ^((int)(167)))));
;
;
...
t = 2 * x - 171 + 42 *((int)((((int)(x)) |((int)(2)))))+((long)((((double)(x)) *((double)(t)))))-((short)((((int)(2 * x - 171)) |((int)(t)))))+((long)((((int)(t)) >>((int)(2 * x)))));
t = 2 * x - 171 + 42 -((int)((((int)(2 * x)) ^((int)(2 * x)))));
;
;
...
t = 2 * x - 173 + 42 *((int)((((int)(2)) <<((int)(173)))))*((short)((((int)(2 * x - 173)) %((int)(173)))));
t = 2 * x - 173 + 42 -((long)((((int)(x)) %((int)(t)))));
;
;
...
t = 2 * x - 177 + 42 *((int)((((int)(2 * x)) &((int)(2 * x - 177)))));
t = 2 * x - 177 + 42 -((int)((((int)(2 * x - 177)) |((int)(2 * x)))))+((long)((((int)(177)) &((int)(x)))))+((short)((((int)(2 * x - 177)) &((int)(2)))))*((short)((((int)(x)) >>((int)(2 * x)))))*((short)((((int)(2 * x - 177)) |((int)(177)))));
;

t = 2 * x - 177 + 42 *((int)((((int)(t)) |((int)(2 * x - 177)))))+((int)((((int)(t)) |((int)(2 * x)))))*((int)((((int)(t)) |((int)(t)))));
t = 2 * x - 177 + 42 *((long)((((int)(2)) |((int)(2)))))*((long)((((int)(2)) <<((int)(t)))))*((int)((((double)(x)) *((double)(2)))))-((long)((((int)(2 * x)) %((int)(2)))));
;
;
...
t = 2 * x - 179 + 42 *((long)((((int)(x)) <<((int)(2 * x)))))*((short)((((int)(179)) <<((int)(t)))));
t = 2 * x - 179 + 42 +((long)((((int)(2 * x)) %((int)(179)))))+((short)((((int)(179)) ^((int)(x)))))+((short)((((double)(2)) +((double)(t)))))-((long)((((double)(t)) *((double)(2)))))+((short)((((int)(2 * x - 179)) ^((int)(179)))));
;
;
...
t = 2 * x - 181 + 42 -((short)((((int)(2)) ^((int)(2 * x - 181)))));
t = 2 * x - 181 + 42 *((long)((((int)(2 * x)) &((int)(x)))))-((short)((((int)(t)) %((int)(2 * x)))));
;

t = 2 * x - 181 + 42 *((int)((((double)(181)) +((double)(2)))))*((long)((((int)(t)) &((int)(t)))));
t = 2 * x - 181 + 42 -((short)((((double)(2)) -((double)(x)))))+((long)((((int)(2 * x - 181)) <<((int)(x)))))+((short)((((double)(2)) +((double)(t)))));
;
;
...
t = 2 * x - 185 + 42 +((long)((((int)(t)) >>((int)(2 * x)))))*((int)((((int)(2)) &((int)(2 * x)))))*((int)((((int)(2)) |((int)(2 * x - 185)))))*((short)((((double)(2)) *((double)(t)))));
t = 2 * x - 185 + 42 -((short)((((int)(x)) <<((int)(2 * x)))));
;
;
...
t = 2 * x - 187 + 42 *((long)((((int)(t)) &((int)(x)))))*((long)((((int)(2 * x - 187)) ^((int)(t)))))*((long)((((int)(x)) ^((int)(2)))))-((int)((((int)(2 * x - 187)) |((int)(x)))));
t = 2 * x - 187 + 42 -((long)((((int)(2 * x)) ^((int)(2 * x - 187)))))-((long)((((double)(187)) -((double)(2)))))*((long)((((int)(2)) |((int)(2 * x)))))*((int)((((double)(187)) *((double)(x)))))*((long)((((int)(187)) <<((int)(x)))));
;
;
;
