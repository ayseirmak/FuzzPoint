...
volatile _Complex float f1 = (8.1) + (5.3);
volatile _Complex float f2 = (1.7) + (9.10);
volatile _Complex float f3 = (8.3) + (7.8);
volatile _Complex float f4 = (10.10) + (1.10);
volatile _Complex float f5 = (1.2) + (1.7);
volatile _Complex double d1 = (1.6) + (9.3);
volatile _Complex double d2 = (3.4) + (8.5);
volatile _Complex double d3 = (9.8) + (1.8);
volatile _Complex double d4 = (9.7) + (2.2);
volatile _Complex double d5 = (9.1) + (8.9);
volatile _Complex long double ld1 = (5.1) + (1.2);
volatile _Complex long double ld2 = (6.4) + (3.3);
volatile _Complex long double ld3 = (10.5) + (1.5);
volatile _Complex long double ld4 = (3.3) + (8.9);
volatile _Complex long double ld5 = (4.3) + (4.4);
...
main (void)
{
  check_float ((0x68784), f1, f2, f3, f4, f5);
