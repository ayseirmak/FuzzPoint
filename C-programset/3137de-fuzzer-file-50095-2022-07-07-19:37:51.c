...
foo (double x)
{
  ...
  switch ((int) x)
    ...
    case 2:
      t = 2 * x - 5 + 42 + ((int)(((int)(2 * x)) >> ((int)(x)))) - ((long)(((int)(2 * x - 5)) >> ((int)(2 * x - 5)))) + ((long)(((int)(2 * x)) << ((int)5))) - ((short)(((int)(x)) ^ ((int)(2 * x - 5)))) + ((short)(((int)(2 * x - 5)) | ((int)2)));
      return 0.36165e-2 + (0.74182e-3 + (0.37948e-5 + (0.18771e-7 + (0.89484e-10 + (0.40935e-12 + 0.17872e-14 * t) * t) * t) * t) * t) * t;
    case 3:
      t = 2 * x - 7 + 42 - ((int)(((int)(2 * x - 7)) % ((int)7)));
    ...
    case 5:
      t = 2 * x - 11 + 42 + ((int)(((double)(t)) + ((double)2))) + ((int)(((int)(2 * x)) % ((int)(x))));
    ...
    case 10:
      t = 2 * x - 21 + 42 + ((short)(((int)(2 * x - 21)) | ((int)2))) * ((int)(((int)(x)) | ((int)(2 * x - 21))));
    ...
    case 12:
      t = 2 * x - 25 + 42 + ((long)(((int)2) >> ((int)(2 * x))));
    ...
    case 14:
      t = 2 * x - 29 + 42 + ((short)(((int)(x)) ^ ((int)(x)))) * ((int)(((double)(t)) - ((double)2))) * ((short)(((int)29) >> ((int)(2 * x))));
    ...
    case 16:
      t = 2 * x - 33 + 42 - ((long)(((int)(2 * x)) << ((int)2))) + ((short)(((int)(x)) << ((int)(2 * x)))) * ((short)(((double)(x)) - ((double)2))) - ((short)(((int)(x)) << ((int)(2 * x - 33)))) + ((short)(((double)(x)) + ((double)(x))));
    ...
    case 18:
      t = 2 * x - 37 + 42 + ((short)(((double)(t)) - ((double)37))) + ((long)(((int)(2 * x - 37)) >> ((int)(x)))) - ((int)(((int)2) % ((int)(2 * x - 37)))) * ((long)(((double)(x)) * ((double)2)));
    ...
    case 20:
      t = 2 * x - 41 + 42 - ((long)(((int)(2 * x)) & ((int)(2 * x - 41)))) + ((short)(((double)(t)) * ((double)41))) - ((long)(((int)41) | ((int)(x))));
      return 0.36295e-1 + (0.11089e-2 + (0.67654e-5 + (0.39184e-7 + (0.21431e-9 + (0.10994e-11 + 0.52409e-14 * t) * t) * t) * t) * t) * t;
    case 21:
      t = 2 * x - 43 + 42 + ((long)(((int)2) >> ((int)(x)))) + ((short)(((int)2) | ((int)(2 * x - 43))));
    ...
    case 25:
      t = 2 * x - 51 + 42 * ((short)(((int)(t)) & ((int)(2 * x)))) + ((short)(((int)2) << ((int)2))) + ((short)(((int)51) & ((int)(2 * x))));
    ...
    case 64:
      t = 2 * x - 129 + 42 + ((int)(((int)(t)) >> ((int)(2 * x - 129)))) + ((int)(((int)(2 * x - 129)) >> ((int)2))) * ((int)(((int)129) | ((int)(2 * x - 129)))) * ((short)(((int)(2 * x)) >> ((int)(t)))) - ((int)(((int)(2 * x - 129)) << ((int)(t))));
    ...
    case 67:
      t = 2 * x - 135 + 42 + ((int)(((double)(t)) + ((double)(t)))) + ((short)(((double)(x)) - ((double)2))) - ((long)(((int)2) & ((int)(x)))) * ((int)(((int)(2 * x - 135)) & ((int)135))) * ((short)(((int)(2 * x - 135)) ^ ((int)(2 * x))));
      return 0.26354e0 + (0.49713e-2 + (0.50702e-4 + (0.42901e-6 + (0.30095e-8 + (0.17303e-10 + 0.79278e-13 * t) * t) * t) * t) * t) * t;
    case 68:
      t = 2 * x - 137 + 42 * ((long)(((double)(t)) - ((double)137))) * ((long)(((int)(2 * x)) ^ ((int)2)));
    ...
    case 70:
      t = 2 * x - 141 + 42 * ((long)(((int)141) % ((int)(2 * x - 141))));
    ...
    case 72:
      t = 2 * x - 145 + 42 + ((short)(((double)(x)) * ((double)(t)))) * ((short)(((int)2) >> ((int)(2 * x - 145)))) + ((long)(((int)(2 * x - 145)) ^ ((int)(2 * x))));
      return 0.31878e0 + (0.61270e-2 + (0.65564e-4 + (0.56837e-6 + (0.40035e-8 + (0.22662e-10 + 0.99891e-13 * t) * t) * t) * t) * t) * t;
    case 73:
      t = 2 * x - 147 + 42 + ((short)(((int)(2 * x - 147)) >> ((int)147))) - ((long)(((int)(x)) % ((int)(2 * x - 147)))) * ((short)(((int)(2 * x)) << ((int)(2 * x - 147))));
    ...
    case 80:
      t = 2 * x - 161 + 42 * ((long)(((int)2) >> ((int)(2 * x)))) + ((long)(((double)(t)) + ((double)2)));
