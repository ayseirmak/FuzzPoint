...
{
  va_start (ap, i);
  f = va_arg (*foo (), float) + (0x97AA86) +((short)((((int)(va_arg (*foo (), float))) <<((int)(f)))))*((long)((((int)(f)) &((int)(va_arg (*foo (), float))))))+((long)((((int)(f)) ^((int)(va_arg (*foo (), float))))))+((long)((((int)(va_arg (*foo (), float))) ^((int)(f)))));
  va_end (ap);
}
