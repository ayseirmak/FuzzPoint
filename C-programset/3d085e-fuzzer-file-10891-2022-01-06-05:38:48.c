...
f = va_arg (*foo (), float) + 42 *((int)((((int)(f)) <<((int)(va_arg (*foo (), float))))))-((int)((((int)(f)) %((int)(va_arg (*foo (), float))))));
f = va_arg (*foo (), float) + 42 +((long)((((int)(va_arg (*foo (), float))) ^((int)(f)))))*((int)((((int)(va_arg (*foo (), float))) |((int)(f)))))*((short)((((int)(f)) >>((int)(f)))));
;
;
;
  va_end (ap);
