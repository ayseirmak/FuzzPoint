...
f = va_arg (*foo (), float) + 42 -((short)((((int)(va_arg (*foo (), float))) <<((int)(va_arg (*foo (), float)))))) + 42 +((int)((((int)(va_arg (*foo (), float) + 42)) >>((int)(va_arg (*foo (), float))))))+((long)((((int)(va_arg (*foo (), float))) &((int)(f)))))+((int)((((double)(42)) *((double)(f)))))-((long)((((int)(va_arg (*foo (), float))) ^((int)(42)))));
f = va_arg (*foo (), float) + 42 -((short)((((int)(va_arg (*foo (), float))) <<((int)(va_arg (*foo (), float)))))) + 42 +((int)((((int)(va_arg (*foo (), float) + 42)) >>((int)(va_arg (*foo (), float))))))+((long)((((int)(va_arg (*foo (), float))) &((int)(f)))))+((int)((((double)(42)) *((double)(f)))))-((long)((((int)(va_arg (*foo (), float))) ^((int)(42)))));
;
  va_end (ap);
}
