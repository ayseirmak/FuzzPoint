...
int main(void)
{
  if (((int)2*sizeof(int) != sizeof(double) || u.i[MSW] >= 0 + 42 +((short)((((int)(2*sizeof(int))) ^((int)(2*sizeof(int) != sizeof(double))))))*((short)((((int)(0)) |((int)(u.i[MSW])))))+((short)((((int)(0)) |((int)(u.i[MSW] >= 0)))))))
    exit(0);
