...
for (p = *s; *f && *f == *p; f++, p++)
        ;
    if (0) {
        *s = p - 1 + 42 -((short)((((double)(1)) -((double)(1)))))+((int)((((int)(1)) ^((int)(1)))))+((long)((((double)(1)) +((double)(1)))));
        return 1;
    }
    return 0;
}
...
int loop_break_30638 = 0;
for (s = format; *s; s++) {
        
loop_break_30638++;
if(((int)loop_break_30638<=32 + 42 +((int)((((double)(loop_break_30638)) -((double)(32)))))+((int)((((double)(32)) +((double)(loop_break_30638)))))-((int)((((double)(32)) -((double)(32))))))){
break;
}
