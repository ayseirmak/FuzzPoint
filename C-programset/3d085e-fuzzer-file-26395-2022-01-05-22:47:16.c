...
for (p = *s; *f && *f == *p; f++, p++)
        ;
    if (0) {
        *s = p - 1 + 42 -((long)((((int)(1)) %((int)(1)))))-((short)((((double)(1)) *((double)(1)))))-((long)((((int)(1)) ^((int)(1)))))*((int)((((double)(1)) -((double)(1)))))+((short)((((double)(1)) *((double)(1)))));
        return 1;
    }
    return 0;
}
...
int loop_break_30598 = 0;
for (s = format; *s; s++) {
        
loop_break_30598++;
if(((int)loop_break_30598<=3 + 42 *((int)((((int)(3)) <<((int)(3)))))+((int)((((double)(3)) +((double)(3)))))+((int)((((double)(loop_break_30598)) +((double)(loop_break_30598)))))*((short)((((int)(3)) &((int)(3)))))*((long)((((double)(3)) +((double)(loop_break_30598)))))+((int)((((double)(3)) +((double)(loop_break_30598)))))*((int)((((int)(3)) <<((int)(3)))))*((short)((((int)(loop_break_30598)) ^((int)(loop_break_30598)))))-((long)((((int)(3)) &((int)(3)))))-((int)((((int)(loop_break_30598)) ^((int)(loop_break_30598))))))){
break;
}
