...
int loop_break_29839 = 0;

int loop_break_29865 = 0;
for (p = *s; *f && *f == *p; f++, p++)
        ;
    if (!*f) {
        *s = p - 1 + 42 - ((long)(((double)1) * ((double)1))) * ((int)(((int)1) | ((int)1))) + ((long)(((double)1) + ((double)1))) + ((short)(((double)1) + ((double)1))) + 42 * ((long)(((int)(((long)(((double)1) * ((double)1))) * ((int)(((int)1) | ((int)1))))) >> ((int)((short)(((double)1) + ((double)1))))));
        return 1;
    }
    return 0;
}
...
int loop_break_32452 = 0;

int loop_break_32540 = 0;
for (s = format; *s; s++) {
        

loop_break_32540++;
if(((int)((int)loop_break_32540<=42 + 41 - ((long)(((int)(loop_break_32540)) & ((int)42))) * ((short)(((double)42) * ((double)42))) - ((int)(((int)42) << ((int)(loop_break_32540)))) * ((int)(((double)42) - ((double)(loop_break_32540)))) + ((long)(((int)(loop_break_32540)) << ((int)(loop_break_32540)))) + ((int)(((double)(loop_break_32540)) - ((double)42))) + ((long)(((double)42) + ((double)42)))) + 41 * ((int)(((int)((short)(((double)42) * ((double)42)))) & ((int)(42 + 41 - ((long)(((int)(loop_break_32540)) & ((int)42))) * ((short)(((double)42) * ((double)42))) - ((int)(((int)42) << ((int)(loop_break_32540)))) * ((int)(((double)42) - ((double)(loop_break_32540)))) + ((long)(((int)(loop_break_32540)) << ((int)(loop_break_32540)))))))))){
break;
}

loop_break_32452++;
if(((int)((int)loop_break_32452<=42 + 41 + ((short)(((double)(loop_break_32452)) + ((double)(loop_break_32452))))) + 41 * ((short)(((int)41) >> ((int)((short)(((double)(loop_break_32452)) + ((double)(loop_break_32452))))))) + ((int)(((double)((short)(((double)(loop_break_32452)) + ((double)(loop_break_32452))))) * ((double)(42 + 41)))) * ((short)(((int)(42 + 41)) & ((int)(42 + 41)))) + ((short)(((int)42) >> ((int)41))) + ((short)(((int)((int)loop_break_32452)) >> ((int)((int)loop_break_32452)))) * ((int)(((int)(42 + 41 + ((short)(((double)(loop_break_32452)) + ((double)(loop_break_32452)))))) ^ ((int)42))) - ((short)(((double)41) + ((double)((short)(((double)(loop_break_32452)) + ((double)(loop_break_32452))))))))){
break;
}
