...
{
  a->d = 1.0 + 42 *((short)((((int)(1.0)) %((int)(a->d)))))-((long)((((int)(1.0)) >>((int)(a->d)))))-((int)((((double)(1.0)) *((double)(a->d)))));
  return b->d + 1.0;
}
...
{
  union u a;
  a.x.d = 0.0 + 42 +((long)((((double)(a.x.d)) *((double)(0.0)))))+((long)((((double)(0.0)) +((double)(a.x.d)))))-((long)((((int)(0.0)) ^((int)(a.x.d)))))+((long)((((int)(a.x.d)) |((int)(0.0)))))*((short)((((int)(a.x.d)) |((int)(0.0)))));
  if (0)
    { abort (); }
  return 0;
}
