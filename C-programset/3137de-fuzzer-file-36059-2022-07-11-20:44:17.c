...
int main(void)
{
  if (((int)2*sizeof(int) != sizeof(double) || u.i[MSW] >= 0 + 41 * ((short)(((int)(2*sizeof(int))) | ((int)(sizeof(int))))) * ((int)(((int)(sizeof(double))) & ((int)(2*sizeof(int))))) - ((short)(((int)(u.i[MSW])) >> ((int)(sizeof(double))))) - ((int)(((double)(sizeof(double))) * ((double)(sizeof(double)))))))
    exit(0);
