...
{
  va_start (ap, i);
  f = va_arg (*foo (), float) + 42 +((long)((((int)(f)) &((int)(f)))))+((int)((((double)(f)) +((double)(f)))))+((short)((((int)(va_arg (*foo (), float))) <<((int)(f)))))-((long)((((int)(va_arg (*foo (), float))) >>((int)(va_arg (*foo (), float))))))-((int)((((int)(f)) &((int)(va_arg (*foo (), float))))));
  va_end (ap);
}
