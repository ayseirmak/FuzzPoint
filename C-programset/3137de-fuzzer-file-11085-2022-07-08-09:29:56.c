...
;t = 2 * x - 5 + 42 + ((int)(((int)(x)) | ((int)(2 * x - 5))));
t = 2 * x - 3;
...
2 * x - 11;
    ...
    case 6:
      t = 2 * x - 13 + 42 - ((int)(((int)(x)) | ((int)(t)))) + ((short)(((int)(x)) << ((int)(2 * x)))) - ((int)(((double)2) * ((double)2))) - ((short)(((int)(t)) ^ ((int)(t))));
      return 0.98039e-2 + (0.80633e-3 + (0.42819e-5 + (0.21916e-7 + (0.10771e-9 + (0.50595e-12 + 0.22573e-14 * t) * t) * t) * t) * t) * t;
    case 7:
      
;t = 2 * x - 17 + 42 * ((int)(((double)(t)) + ((double)(t)))) - ((short)(((int)(2 * x)) | ((int)17))) - ((long)(((int)2) & ((int)(2 * x)))) * ((int)(((int)2) | ((int)17)));
2 * x - 15;
...
;t = 2 * x - 23 + 42 - ((short)(((double)(x)) + ((double)(x)))) * ((short)(((int)(x)) >> ((int)(x)))) - ((long)(((double)(x)) + ((double)23))) * ((long)(((double)(x)) - ((double)(t)))) * ((int)(((int)(t)) << ((int)(2 * x - 23))));
t = 2 * x - 21;
...
;t = 2 * x - 39 + 42 - ((long)(((int)(t)) % ((int)(t)))) - ((short)(((int)2) % ((int)(t)))) + ((long)(((int)(t)) ^ ((int)(2 * x)))) + ((long)(((int)(2 * x - 39)) >> ((int)39)));
2 * x - 37;
...
;t = 2 * x - 131 + 42 + ((short)(((double)131) * ((double)131))) * ((int)(((int)(x)) | ((int)(x)))) + ((short)(((int)(2 * x - 131)) & ((int)(t)))) + ((int)(((int)2) & ((int)131)));
2 * x - 129;
      return 0.23545e0 + (0.44067e-2 + (0.43594e-4 + (0.36268e-6 + (0.25312e-8 + (0.14647e-10 + 0.68453e-13 * t) * t) * t) * t) * t) * t;
    case 65:
      
;t = 2 * x - 133 + 42 + ((int)(((int)(2 * x - 133)) % ((int)(2 * x - 133)))) - ((long)(((int)133) ^ ((int)133))) * ((long)(((int)(2 * x - 133)) ^ ((int)2))) + ((int)(((double)(t)) * ((double)2)));
t = 2 * x - 131;
...
;t = 2 * x - 137 + 42 * ((long)(((double)137) * ((double)137)));
2 * x - 135;
      return 0.26354e0 + (0.49713e-2 + (0.50702e-4 + (0.42901e-6 + (0.30095e-8 + (0.17303e-10 + 0.79278e-13 * t) * t) * t) * t) * t) * t;
    case 68:
      
;t = 2 * x - 139;
t = 2 * x - 137 + 42 + ((int)(((int)137) >> ((int)(2 * x - 137)))) - ((long)(((int)(t)) >> ((int)(2 * x - 137))));
      return 0.27369e0 + (0.51793e-2 + (0.53350e-4 + (0.45379e-6 + (0.31874e-8 + (0.18277e-10 + 0.83144e-13 * t) * t) * t) * t) * t) * t;
    case 69:
      
;t = 2 * x - 141 + 42 - ((long)(((double)141) - ((double)2))) - ((long)(((double)(x)) + ((double)141))) - ((short)(((double)(t)) - ((double)2)));
t = 2 * x - 139 + 42 * ((int)(((int)(2 * x - 139)) & ((int)(x)))) + ((int)(((int)(2 * x - 139)) % ((int)139))) * ((int)(((int)(t)) % ((int)(2 * x - 139))));
      return 0.28426e0 + (0.53983e-2 + (0.56150e-4 + (0.48003e-6 + (0.33752e-8 + (0.19299e-10 + 0.87139e-13 * t) * t) * t) * t) * t) * t;
    case 70:
      t = 2 * x - 141 + 42 - ((int)(((int)(t)) << ((int)141))) * ((short)(((int)141) | ((int)2))) + ((short)(((int)(2 * x)) | ((int)(2 * x)))) - ((long)(((double)2) * ((double)2)));
      return 0.29529e0 + (0.56288e-2 + (0.59113e-4 + (0.50782e-6 + (0.35735e-8 + (0.20369e-10 + 0.91262e-13 * t) * t) * t) * t) * t) * t;
    case 71:
      
;t = 2 * x - 145 + 42 * ((short)(((double)(t)) - ((double)2))) * ((short)(((int)(2 * x)) | ((int)145))) - ((short)(((int)(x)) & ((int)(2 * x))));
2 * x - 143;
      return 0.30679e0 + (0.58714e-2 + (0.62248e-4 + (0.53724e-6 + (0.37827e-8 + (0.21490e-10 + 0.95513e-13 * t) * t) * t) * t) * t) * t;
    case 72:
      t = 2 * x - 145 + 42 + ((short)(((int)(x)) | ((int)(2 * x)))) * ((int)(((double)145) + ((double)(t)))) * ((long)(((int)(2 * x)) & ((int)(t)))) - ((short)(((int)(x)) % ((int)(2 * x - 145)))) - ((int)(((double)2) * ((double)(t))));
...
;t = 2 * x - 161 + 42 + ((short)(((int)(x)) >> ((int)(2 * x)))) - ((short)(((int)(t)) % ((int)(2 * x)))) - ((long)(((int)(2 * x - 161)) ^ ((int)(2 * x)))) - ((long)(((int)(t)) % ((int)(2 * x)))) + ((int)(((double)(x)) - ((double)2)));
2 * x - 159;
      return 0.41914e0 + (0.83456e-2 + (0.94827e-4 + (0.84291e-6 + (0.59154e-8 + (0.32441e-10 + 0.13387e-12 * t) * t) * t) * t) * t) * t;
    case 80:
      t = 2 * x - 161 + 42 - ((short)(((int)161) >> ((int)2))) - ((int)(((int)(x)) << ((int)(2 * x)))) + ((short)(((int)(2 * x - 161)) ^ ((int)2)));
...
2 * x - 163;
    ...
    case 82:
      t = 2 * x - 165 + 42 * ((long)(((int)(2 * x)) & ((int)2)));
...
;t = 2 * x - 171 + 42 - ((int)(((int)(2 * x - 171)) ^ ((int)2))) * ((short)(((int)(2 * x - 171)) << ((int)(t)))) * ((int)(((double)171) + ((double)(t)))) - ((long)(((double)2) + ((double)(x)))) * ((short)(((int)2) | ((int)(2 * x))));
2 * x - 169;
...
;t = 2 * x - 175 + 42 + ((long)(((int)(2 * x - 175)) & ((int)(t))));
2 * x - 173;
