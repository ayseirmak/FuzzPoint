...
foo (double x)
{
  ...
  switch ((int) x)
    ...
    case 1:
      t = 2 * x - 3 + 42 + ((short)(((int)(2 * x - 3)) ^ ((int)(2 * x - 3)))) + ((short)(((int)(2 * x - 3)) >> ((int)2))) - ((long)(((double)(t)) - ((double)2))) + ((int)(((int)(2 * x)) << ((int)3))) - ((long)(((int)3) % ((int)(t))));
    ...
    case 6:
      t = 2 * x - 13 + 42 + ((short)(((int)(2 * x - 13)) & ((int)(x)))) * ((long)(((int)(t)) >> ((int)(2 * x - 13)))) + ((short)(((int)(x)) | ((int)(2 * x - 13)))) + ((long)(((int)(2 * x)) | ((int)(2 * x - 13)))) - ((short)(((int)(2 * x)) << ((int)13)));
    ...
    case 8:
      t = 2 * x - 17 + 42 - ((long)(((double)(t)) - ((double)(x)))) * ((long)(((int)17) ^ ((int)(2 * x)))) + ((long)(((double)(t)) - ((double)2))) - ((long)(((int)(2 * x - 17)) | ((int)(x))));
    ...
    case 10:
      t = 2 * x - 21 + 42 - ((int)(((int)(2 * x)) & ((int)2))) + ((short)(((int)(2 * x)) >> ((int)21)));
    ...
    case 12:
      t = 2 * x - 25 + 42 + ((long)(((double)(t)) + ((double)2))) - ((long)(((int)(2 * x - 25)) ^ ((int)(2 * x)))) * ((int)(((double)2) + ((double)(x))));
    ...
    case 14:
      t = 2 * x - 29 + 42 * ((short)(((double)29) * ((double)29))) * ((long)(((int)(x)) << ((int)29))) * ((short)(((int)2) | ((int)2)));
      return 0.23898e-1 + (0.96213e-3 + (0.55225e-5 + (0.30314e-7 + (0.15840e-9 + (0.78340e-12 + 0.36381e-14 * t) * t) * t) * t) * t) * t;
    case 15:
      t = 2 * x - 31 + 42 * ((long)(((int)(2 * x)) << ((int)(2 * x)))) + ((int)(((int)(2 * x - 31)) << ((int)(t)))) * ((int)(((int)31) % ((int)(x)))) - ((int)(((int)(t)) % ((int)(2 * x - 31))));
    ...
    case 22:
      t = 2 * x - 45 + 42 + ((int)(((int)(2 * x - 45)) & ((int)(t)))) - ((long)(((double)(t)) - ((double)2))) - ((int)(((int)(2 * x - 45)) % ((int)(2 * x - 45)))) + ((short)(((int)(2 * x - 45)) & ((int)(t))));
    ...
    case 24:
      t = 2 * x - 49 + 42 - ((short)(((int)(2 * x)) ^ ((int)2))) - ((long)(((int)(2 * x)) >> ((int)2)));
    ...
    case 26:
      t = 2 * x - 59 + 42 - ((long)(((int)59) | ((int)(2 * x - 59)))) + ((short)(((int)(2 * x - 59)) % ((int)(2 * x)))) - ((short)(((int)(x)) << ((int)59))) + ((long)(((int)59) >> ((int)(2 * x)))) * ((int)(((double)2) * ((double)2)));
      return 0.58702e-1 + (0.13962e-2 + (0.93714e-5 + (0.58882e-7 + (0.34414e-9 + (0.18552e-11 + 0.91160e-14 * t) * t) * t) * t) * t) * t;
    case 30:
      t = 2 * x - 79 + 42 + ((int)(((int)2) & ((int)(2 * x - 79)))) * ((short)(((int)(2 * x)) & ((int)2))) + ((short)(((int)(t)) << ((int)(2 * x - 79))));
      return 0.90908e-1 + (0.18544e-2 + (0.13903e-4 + (0.95549e-7 + (0.59752e-9 + (0.33656e-11 + 0.16815e-13 * t) * t) * t) * t) * t) * t;
    case 40:
      t = 2 * x - 99 + 42 + ((long)(((int)(2 * x - 99)) | ((int)(t)))) * ((short)(((int)(2 * x)) & ((int)(2 * x)))) + ((short)(((double)99) - ((double)(t)))) + ((long)(((int)(t)) << ((int)(2 * x - 99)))) - ((short)(((int)2) >> ((int)2)));
    ...
    case 63:
      t = 2 * x - 127 + 42 - ((short)(((int)(x)) << ((int)127))) + ((short)(((int)(t)) << ((int)(x)))) * ((long)(((int)(2 * x - 127)) & ((int)(2 * x)))) + ((long)(((double)127) * ((double)2))) - ((int)(((double)(x)) - ((double)127)));
      return 0.22680e0 + (0.42366e-2 + (0.41477e-4 + (0.34300e-6 + (0.23888e-8 + (0.13846e-10 + 0.65100e-13 * t) * t) * t) * t) * t) * t;
    case 64:
      t = 2 * x - 129 + 42 + ((long)(((double)2) - ((double)(t)))) - ((short)(((int)(2 * x)) >> ((int)(2 * x)))) * ((int)(((int)(2 * x)) ^ ((int)(t))));
    ...
    case 67:
      t = 2 * x - 135 + 42 - ((int)(((int)(2 * x - 135)) >> ((int)135))) * ((long)(((int)(2 * x - 135)) & ((int)(2 * x - 135)))) + ((int)(((int)(x)) | ((int)(x)))) * ((short)(((int)135) | ((int)2)));
    ...
    case 69:
      t = 2 * x - 139 + 42 + ((long)(((int)2) >> ((int)(2 * x - 139)))) + ((long)(((int)139) % ((int)139)));
    ...
    case 71:
      t = 2 * x - 143 + 42 + ((short)(((double)143) - ((double)143))) - ((short)(((double)2) * ((double)143))) + ((long)(((int)2) & ((int)(x)))) - ((long)(((int)(x)) >> ((int)(t)))) - ((int)(((int)2) % ((int)2)));
    ...
    case 73:
      t = 2 * x - 147 + 42 - ((short)(((int)147) & ((int)(x)))) * ((long)(((int)(2 * x)) >> ((int)(2 * x - 147)))) + ((long)(((int)(2 * x - 147)) >> ((int)(2 * x)))) - ((short)(((int)(2 * x - 147)) << ((int)(t)))) - ((short)(((int)147) << ((int)2)));
    ...
    case 76:
      t = 2 * x - 153 + 42 + ((short)(((int)153) >> ((int)(2 * x)))) * ((short)(((int)2) | ((int)2))) * ((short)(((double)(x)) * ((double)153)));
    ...
    case 79:
      t = 2 * x - 159 + 42 - ((short)(((double)(x)) - ((double)(x)))) - ((short)(((double)(x)) * ((double)159))) * ((long)(((int)(2 * x)) ^ ((int)(2 * x - 159)))) + ((int)(((int)159) >> ((int)(2 * x)))) - ((long)(((double)159) * ((double)2)));
      return 0.41914e0 + (0.83456e-2 + (0.94827e-4 + (0.84291e-6 + (0.59154e-8 + (0.32441e-10 + 0.13387e-12 * t) * t) * t) * t) * t) * t;
    case 80:
      t = 2 * x - 161 + 42 * ((long)(((int)(x)) << ((int)(2 * x)))) - ((int)(((double)(x)) - ((double)161))) + ((short)(((int)2) << ((int)2))) + ((int)(((int)(2 * x - 161)) % ((int)161))) - ((short)(((int)(2 * x)) & ((int)(2 * x - 161))));
    ...
    case 84:
      t = 2 * x - 169 + 42 * ((int)(((int)169) ^ ((int)(2 * x - 169)))) - ((long)(((int)(2 * x)) ^ ((int)(2 * x - 169)))) - ((short)(((double)(t)) + ((double)2))) - ((int)(((int)(x)) & ((int)(2 * x)))) - ((long)(((double)2) * ((double)169)));
    ...
    case 90:
      t = 2 * x - 181 + 42 - ((short)(((double)2) - ((double)181)));
      return 0.65918e0 + (0.14036e-1 + (0.17160e-3 + (0.15521e-5 + (0.10601e-7 + (0.54140e-10 + 0.19616e-12 * t) * t) * t) * t) * t) * t;
    case 91:
      t = 2 * x - 183 + 42 - ((int)(((double)2) - ((double)(t)))) * ((short)(((int)(2 * x - 183)) & ((int)(t))));
