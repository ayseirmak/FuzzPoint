...
;t = 2 * x - 11;
2 * x - 9 + 42 - ((short)(((int)(2 * x)) << ((int)(2 * x - 9)))) * ((int)(((int)(2 * x - 9)) >> ((int)(2 * x - 9))));
    ...
    case 6:
      2 * x - 13 + 42 - ((short)(((int)13) | ((int)2))) - ((short)(((double)(x)) + ((double)2)));
      return 0.98039e-2 + (0.80633e-3 + (0.42819e-5 + (0.21916e-7 + (0.10771e-9 + (0.50595e-12 + 0.22573e-14 * t) * t) * t) * t) * t) * t;
    case 7:
      2 * x - 15 + 42 - ((int)(((double)15) * ((double)15))) * ((long)(((int)(2 * x)) >> ((int)2))) + ((short)(((int)(x)) << ((int)15)));
    ...
    case 9:
      2 * x - 19 + 42 - ((long)(((int)(x)) ^ ((int)19)));
      return 0.14800e-1 + (0.86018e-3 + (0.47008e-5 + (0.24694e-7 + (0.12418e-9 + (0.59486e-12 + 0.26957e-14 * t) * t) * t) * t) * t) * t;
    case 10:
      
;t = 2 * x - 23;
2 * x - 21 + 42 + ((long)(((int)(2 * x - 21)) | ((int)2))) + 42 + ((long)(((int)(t)) | ((int)(2 * x - 21 + 42 + ((long)(((int)(2 * x - 21)) | ((int)2))))))) + ((long)(((int)(x)) | ((int)(2 * x - 21)))) - ((short)(((int)21) & ((int)(2 * x - 21 + 42 + ((long)(((int)(2 * x - 21)) | ((int)2)))))));
...
;t = 2 * x - 33;
2 * x - 31 + 42 + ((short)(((int)(t)) >> ((int)(x)))) - ((int)(((int)(x)) << ((int)(2 * x)))) + ((short)(((int)31) >> ((int)(t)))) - ((int)(((int)(2 * x)) | ((int)(2 * x)))) - ((long)(((int)2) & ((int)(t)))) + 42 + ((short)(((int)(2 * x - 31 + 42 + ((short)(((int)(t)) >> ((int)(x)))))) ^ ((int)(t)))) * ((short)(((int)(2 * x)) % ((int)(t))));
...
;t = 2 * x - 41;
2 * x - 39 + 42 * ((short)(((int)(2 * x - 39)) & ((int)2))) + ((long)(((int)(2 * x)) % ((int)(2 * x)))) + ((short)(((int)(t)) | ((int)(2 * x - 39)))) * ((short)(((int)39) << ((int)(2 * x - 39))));
      return 0.34104e-1 + (0.10823e-2 + (0.65354e-5 + (0.37512e-7 + (0.20362e-9 + (0.10384e-11 + 0.49300e-14 * t) * t) * t) * t) * t) * t;
    case 20:
      
;t = 2 * x - 43 + 42 - ((short)(((int)(2 * x - 43)) | ((int)(2 * x)))) * ((long)(((int)(2 * x - 43)) % ((int)2))) - ((long)(((double)2) + ((double)43)));
t = 2 * x - 41;
...
;t = 2 * x - 99 + 42 - ((int)(((int)2) | ((int)(2 * x)))) - ((short)(((double)2) - ((double)2))) + ((short)(((int)2) & ((int)(2 * x - 99)))) - ((short)(((double)99) + ((double)99)));
t = 2 * x - 79 + 42 * ((short)(((int)(2 * x)) >> ((int)(x)))) - ((int)(((double)(t)) - ((double)79))) - ((short)(((int)(x)) ^ ((int)(2 * x - 79)))) - ((short)(((int)(x)) & ((int)(2 * x))));
    ...
    case 60:
      2 * x - 121 + 42 + ((long)(((int)(2 * x - 121)) << ((int)(2 * x - 121)))) * ((int)(((int)121) ^ ((int)(t))));
    ...
    case 62:
      2 * x - 125 + 42 + ((long)(((int)(2 * x)) << ((int)(2 * x - 125)))) - ((long)(((int)(2 * x - 125)) & ((int)(t)))) * ((short)(((int)(2 * x)) << ((int)125)));
      return 0.21849e0 + (0.40747e-2 + (0.39476e-4 + (0.32443e-6 + (0.22542e-8 + (0.13084e-10 + 0.61873e-13 * t) * t) * t) * t) * t) * t;
    case 63:
      2 * x - 127 + 42 + ((long)(((int)(t)) << ((int)(2 * x))));
...
t = 2 * x - 141 + 42 + ((int)(((int)(t)) | ((int)(2 * x)))) * ((long)(((int)141) | ((int)(t)))) * ((long)(((int)(2 * x - 141)) >> ((int)(2 * x - 141)))) - ((int)(((double)2) + ((double)(t))));
    ...
    case 73:
      2 * x - 147 + 42 + ((long)(((int)(x)) ^ ((int)(2 * x - 147))));
