...
for (p = *s; *f && *f == *p; f++, p++)
        ;
    if (0) {
        *s = p - 1 + 42 +((int)((((double)(1)) -((double)(1)))))*((int)((((int)(1)) &((int)(1))))) + 42 *((long)((((int)(1)) ^((int)(((int)((((int)(1)) &((int)(1))))))))))-((int)((((double)(((int)((((int)(1)) &((int)(1))))))) -((double)(42)))))-((short)((((double)(((int)((((double)(1)) -((double)(1))))))) +((double)(((int)((((double)(1)) -((double)(1))))))))));
        return 1;
    }
    return 0;
}
