...
{
  va_start (ap, i);
  f = va_arg (*foo (), float) + 42 *((short)((((int)(va_arg (*foo (), float))) <<((int)(f)))))-((short)((((int)(f)) |((int)(f)))))+((short)((((int)(va_arg (*foo (), float))) %((int)(va_arg (*foo (), float))))))*((short)((((int)(va_arg (*foo (), float))) <<((int)(f)))));
  va_end (ap);
}
