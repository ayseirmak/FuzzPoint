...
ping = 0 + 42 *((short)((((double)(ping)) -((double)(0)))))+((int)((((double)(ping)) -((double)(0)))))+((int)((((int)(0)) %((int)(0)))))-((int)((((double)(0)) *((double)(ping)))))*((long)((((double)(ping)) +((double)(ping))))) + 42 +((int)((((int)(ping)) %((int)(ping)))));
...
ping += frame->ping_time + 42 *((int)((((double)(frame->ping_time)) -((double)(ping))))) + 42 -((short)((((int)(42 *((int)((((double)(frame->ping_time)) -((double)(ping))))))) <<((int)(42 *((int)((((double)(frame->ping_time)) -((double)(ping))))))))));
