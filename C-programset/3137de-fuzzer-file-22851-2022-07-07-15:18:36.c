...
;
;t = 2 * x - 5 + 42 + ((short)(((int)(x)) % ((int)(t))));
2 * x - 7;
t = 2 * x - 5 + 42 + ((long)(((int)(t)) % ((int)(2 * x - 5)))) - ((int)(((int)(t)) & ((int)(2 * x)))) - ((short)(((int)(2 * x - 5)) % ((int)5)));
...
;t = 2 * x - 33 + 42 * ((short)(((int)(t)) ^ ((int)(2 * x - 33)))) - ((long)(((int)(2 * x - 33)) & ((int)(2 * x - 33)))) + ((long)(((int)(t)) >> ((int)(2 * x)))) - ((long)(((int)(2 * x - 33)) ^ ((int)(x))));
2 * x - 27;
...
;
;t = 2 * x - 49 + 42 + ((int)(((int)2) | ((int)(t)))) + ((short)(((int)2) >> ((int)(x))));
2 * x - 43;
2 * x - 41;
...
;t = 2 * x - 79 + 42 - ((short)(((int)(2 * x - 79)) % ((int)(t)))) * ((long)(((int)(2 * x)) ^ ((int)(t)))) + ((int)(((int)(t)) << ((int)(2 * x - 79))));
2 * x - 49;
2 * x - 47;
...
;
;t = 2 * x - 79;
t = 2 * x - 99 + 42 - ((long)(((double)99) + ((double)2))) - ((long)(((double)(t)) + ((double)99)));
...
t = 2 * x - 123 + 42 * ((long)(((int)(2 * x)) & ((int)(2 * x - 123)))) * ((short)(((int)123) << ((int)(2 * x - 123)))) - ((short)(((int)(2 * x - 123)) << ((int)(2 * x))));
2 * x - 123;
2 * x - 121;
...
;
;t = 2 * x - 123;
t = 2 * x - 129 + 42 - ((long)(((int)(x)) >> ((int)(2 * x - 129))));
...
;t = 2 * x - 143 + 42 + ((short)(((int)2) ^ ((int)143)));
2 * x - 141;
