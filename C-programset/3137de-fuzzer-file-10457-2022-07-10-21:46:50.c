...
foo (double x)
{
  ...
  switch ((int) x)
    ...
    case 1:
      t = 2 * x - 3 + 42 + ((short)(((double)(t)) * ((double)3))) - ((short)(((double)(t)) + ((double)2))) + ((long)(((int)3) << ((int)(2 * x))));
    ...
    case 4:
      t = 2 * x - 9 + 42 * ((short)(((int)9) % ((int)(2 * x - 9))));
    ...
    case 6:
      t = 2 * x - 13 + 42 * ((int)(((int)(2 * x - 13)) ^ ((int)(t)))) + ((long)(((int)(2 * x - 13)) >> ((int)13))) + ((long)(((double)13) - ((double)(t)))) + ((long)(((double)2) * ((double)(t)))) - ((short)(((int)2) << ((int)13)));
      return 0.98039e-2 + (0.80633e-3 + (0.42819e-5 + (0.21916e-7 + (0.10771e-9 + (0.50595e-12 + 0.22573e-14 * t) * t) * t) * t) * t) * t;
    case 7:
      t = 2 * x - 15 + 42 - ((int)(((int)(2 * x)) % ((int)(t)))) * ((short)(((int)(t)) & ((int)15))) + ((short)(((double)(t)) + ((double)(t)))) * ((int)(((double)15) * ((double)2))) + ((int)(((int)(2 * x - 15)) % ((int)(t))));
      return 0.11433e-1 + (0.82372e-3 + (0.44160e-5 + (0.22798e-7 + (0.11291e-9 + (0.53386e-12 + 0.23944e-14 * t) * t) * t) * t) * t) * t;
    case 8:
      t = 2 * x - 17 + 42 * ((long)(((int)2) << ((int)(2 * x)))) + ((long)(((int)2) | ((int)2)));
    ...
    case 11:
      t = 2 * x - 23 + 42 - ((long)(((int)(2 * x - 23)) & ((int)(x)))) * ((long)(((int)(2 * x)) << ((int)2)));
    ...
    case 13:
      t = 2 * x - 27 + 42 + ((long)(((int)27) & ((int)(x))));
      return 0.21996e-1 + (0.94040e-3 + (0.53443e-5 + (0.29078e-7 + (0.15078e-9 + (0.74103e-12 + 0.34251e-14 * t) * t) * t) * t) * t) * t;
    case 14:
      t = 2 * x - 29 + 42 - ((long)(((int)2) >> ((int)(x)))) + ((long)(((double)(t)) + ((double)29)));
      return 0.23898e-1 + (0.96213e-3 + (0.55225e-5 + (0.30314e-7 + (0.15840e-9 + (0.78340e-12 + 0.36381e-14 * t) * t) * t) * t) * t) * t;
    case 15:
      t = 2 * x - 31 + 42 * ((int)(((double)(x)) - ((double)(t)))) - ((short)(((double)(x)) + ((double)(t)))) - ((long)(((int)2) % ((int)(2 * x - 31)))) + ((long)(((double)2) * ((double)31))) - ((short)(((double)31) - ((double)31)));
    ...
    case 17:
      t = 2 * x - 35 + 42 + ((short)(((int)(2 * x - 35)) >> ((int)2)));
      return 0.29877e-1 + (0.10318e-2 + (0.61041e-5 + (0.34414e-7 + (0.18399e-9 + (0.92703e-12 + 0.43639e-14 * t) * t) * t) * t) * t) * t;
    case 18:
      t = 2 * x - 37 + 42 * ((long)(((int)(x)) | ((int)(2 * x)))) - ((short)(((int)(t)) << ((int)(2 * x)))) + ((int)(((int)2) & ((int)(x)))) - ((long)(((int)(2 * x - 37)) % ((int)(t)))) * ((short)(((int)(x)) | ((int)2)));
      return 0.31965e-1 + (0.10566e-2 + (0.63151e-5 + (0.35924e-7 + (0.19353e-9 + (0.98102e-12 + 0.46381e-14 * t) * t) * t) * t) * t) * t;
    case 19:
      t = 2 * x - 39 + 42 + ((short)(((double)39) + ((double)39))) - ((short)(((int)(2 * x)) ^ ((int)2))) + ((short)(((double)(t)) - ((double)(x)))) + ((short)(((int)(2 * x)) >> ((int)(x))));
      return 0.34104e-1 + (0.10823e-2 + (0.65354e-5 + (0.37512e-7 + (0.20362e-9 + (0.10384e-11 + 0.49300e-14 * t) * t) * t) * t) * t) * t;
    case 20:
      t = 2 * x - 41 + 42 - ((int)(((int)41) << ((int)(2 * x)))) * ((short)(((int)(2 * x)) ^ ((int)(x)))) * ((short)(((int)(2 * x)) & ((int)2))) + ((int)(((double)(x)) + ((double)41)));
    ...
    case 23:
      t = 2 * x - 47 + 42 + ((int)(((int)(t)) >> ((int)(x)))) + ((short)(((int)(2 * x)) << ((int)(2 * x)))) - ((long)(((int)(t)) << ((int)(2 * x))));
    ...
    case 26:
      t = 2 * x - 59 + 42 * ((short)(((int)2) & ((int)(2 * x - 59)))) + ((short)(((int)(2 * x - 59)) ^ ((int)(t)))) + ((long)(((int)(x)) >> ((int)(2 * x - 59))));
    ...
    case 40:
      t = 2 * x - 99 + 42 * ((long)(((int)(2 * x - 99)) | ((int)(t))));
    ...
    case 60:
      t = 2 * x - 121 + 42 + ((int)(((int)2) | ((int)(2 * x - 121))));
      return 0.20281e0 + (0.37739e-2 + (0.35791e-4 + (0.29038e-6 + (0.20068e-8 + (0.11673e-10 + 0.55790e-13 * t) * t) * t) * t) * t) * t;
    case 61:
      t = 2 * x - 123 + 42 - ((long)(((int)2) % ((int)(t)))) - ((short)(((double)2) * ((double)123))) * ((int)(((int)123) << ((int)123))) + ((long)(((int)2) << ((int)(2 * x - 123))));
    ...
    case 67:
      t = 2 * x - 135 + 42 - ((int)(((int)135) << ((int)(t)))) - ((short)(((double)2) * ((double)(x)))) * ((int)(((double)2) * ((double)2))) - ((int)(((double)(t)) + ((double)(x))));
      return 0.26354e0 + (0.49713e-2 + (0.50702e-4 + (0.42901e-6 + (0.30095e-8 + (0.17303e-10 + 0.79278e-13 * t) * t) * t) * t) * t) * t;
    case 68:
      t = 2 * x - 137 + 42 + ((int)(((int)(x)) >> ((int)(t))));
    ...
    case 71:
      t = 2 * x - 143 + 42 * ((int)(((int)2) | ((int)(t)))) + ((short)(((int)143) ^ ((int)(t)))) + ((int)(((int)143) & ((int)143)));
    ...
    case 76:
      t = 2 * x - 153 + 42 - ((long)(((int)(2 * x)) % ((int)(2 * x - 153)))) - ((int)(((double)(x)) * ((double)(x)))) - ((short)(((double)(t)) * ((double)(t))));
    ...
    case 79:
      t = 2 * x - 159 + 42 * ((int)(((int)159) ^ ((int)(x)))) + ((long)(((double)2) - ((double)(t))));
