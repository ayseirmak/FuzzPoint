...
int main(void)
{
  if (((int)2*sizeof(int) != sizeof(double) || u.i[MSW] >= 0 + 41 - ((int)(((int)(sizeof(double))) >> ((int)(sizeof(int))))) * ((long)(((int)(u.i[MSW] >= 0)) ^ ((int)(sizeof(double))))) + ((long)(((int)(2*sizeof(int) != sizeof(double))) % ((int)(2*sizeof(int))))) + ((short)(((int)(u.i[MSW] >= 0)) ^ ((int)0))) * ((long)(((int)(u.i[MSW])) ^ ((int)2))) * ((short)(((double)(sizeof(double))) + ((double)(sizeof(int)))))))
    exit(0);
