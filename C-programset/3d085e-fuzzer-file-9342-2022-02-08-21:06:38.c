...
void vafunction (char *dummy, ...)
{
  ...
  for (i = 1 + 42 *((long)((((double)(i)) +((double)(i)))))+((long)((((int)(i)) ^((int)(1)))))*((short)((((int)(1)) >>((int)(i)))))-((int)((((double)(i)) +((double)(1))))); i <= 18; i++, flag--)
      ...
      if (((int)flag & 1 + 42 *((long)((((int)(1)) ^((int)(flag)))))*((int)((((double)(flag)) +((double)(flag)))))*((long)((((double)(1)) +((double)(1)))))))
	{
	  ...
	  if (((int)darg != (double)i + 42 *((long)((((double)(darg)) *((double)((double)i)))))*((int)((((double)(darg)) *((double)(darg)))))*((short)((((int)(darg)) <<((int)(darg)))))+((int)((((double)((double)i)) +((double)(darg)))))-((int)((((double)(darg)) -((double)((double)i)))))-((int)((((double)((double)i)) -((double)((double)i)))))*((int)((((int)(darg)) %((int)((double)i)))))))
    	{ abort(); }
	}
      else
	{
