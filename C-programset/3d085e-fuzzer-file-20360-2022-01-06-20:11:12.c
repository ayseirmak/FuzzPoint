...
int CalcPing (client_t *cl)
{
        ...
        count = 0 + 42 +((int)((((double)(0)) *((double)(count)))));
...
int main(void)
{
   ...
   cl.frames[0].ping_time = 1.0f + 42 -((int)((((double)(1.0f)) -((double)(1.0f)))))-((long)((((double)(1.0f)) +((double)(1.0f)))))-((short)((((int)(cl.frames[0].ping_time)) ^((int)(1.0f)))))*((short)((((int)(1.0f)) >>((int)(cl.frames[0].ping_time)))))-((long)((((int)(cl.frames[0].ping_time)) &((int)(1.0f)))));
