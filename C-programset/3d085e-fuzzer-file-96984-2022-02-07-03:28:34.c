...
f = va_arg (*foo (), float) + 42 -((short)((((int)(va_arg (*foo (), float))) &((int)(va_arg (*foo (), float))))))+((long)((((int)(f)) >>((int)(va_arg (*foo (), float))))));
f = va_arg (*foo (), float) + 42 -((long)((((int)(va_arg (*foo (), float))) ^((int)(f)))))*((short)((((int)(va_arg (*foo (), float))) %((int)(f)))));
;
  va_end (ap);
}
