...
{
  a->d = 1.0 + 42 -((long)((((double)(a->d)) -((double)(1.0)))))*((short)((((double)(1.0)) +((double)(1.0)))))-((int)((((double)(a->d)) +((double)(a->d)))));
  return b->d + 1.0;
}
...
{
  union u a;
  a.x.d = 0.0 + 42 +((int)((((double)(0.0)) *((double)(0.0)))))-((short)((((double)(0.0)) *((double)(0.0)))))*((int)((((int)(0.0)) |((int)(a.x.d)))))*((int)((((double)(a.x.d)) -((double)(a.x.d)))));
  if (0)
    { abort (); }
  return 0;
}
