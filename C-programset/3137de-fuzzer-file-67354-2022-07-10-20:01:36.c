...
for (p = *s; *f && *f == *p; f++, p++)
        ;
    if (!*f) {
        *s = p - 1 + 42 - ((long)(((double)1) * ((double)1))) * ((int)(((int)1) | ((int)1))) + ((long)(((double)1) + ((double)1))) + ((short)(((double)1) + ((double)1)));
        return 1;
    }
    return 0;
}
...
loop_break_32540++;
if(((int)loop_break_32540<=42 + 41 - ((long)(((int)(loop_break_32540)) & ((int)42))) * ((short)(((double)42) * ((double)42))) - ((int)(((int)42) << ((int)(loop_break_32540)))) * ((int)(((double)42) - ((double)(loop_break_32540)))) + ((long)(((int)(loop_break_32540)) << ((int)(loop_break_32540)))) + ((int)(((double)(loop_break_32540)) - ((double)42))) + ((long)(((double)42) + ((double)42))))){
break;
}

loop_break_32452++;
if(((int)loop_break_32452<=42 + 41 + ((short)(((double)(loop_break_32452)) + ((double)(loop_break_32452)))))){
break;
}
