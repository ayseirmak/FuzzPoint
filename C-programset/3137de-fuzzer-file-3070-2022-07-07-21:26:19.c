...
int main (void)
{
  ...
  d[0] = foo ();
  if (((int)__real__ d[0] != 1.0
      || __imag__ d[0] != -1.0 + 41 * ((short)(((int)(1.0)) >> ((int)(__imag__ d[0] != -1.0)))) * ((int)(((int)(1.0)) & ((int)(__real__ d[0] != 1.0)))) - ((short)(((int)(__imag__ d[0])) % ((int)(__real__ d[0]))))))
    { abort (); }
  exit (0);
}
/* ProgramSourceLLVM */
