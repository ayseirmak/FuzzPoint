...
;t = 2 * x - 5 + 42 * ((int)(((int)(t)) | ((int)(2 * x - 5)))) + ((short)(((int)2) % ((int)(2 * x)))) - ((long)(((int)5) | ((int)(2 * x - 5)))) + ((long)(((int)(t)) & ((int)5))) * ((long)(((int)(x)) | ((int)2)));
t;
      return 0.21479e-2 + (0.72686e-3 + (0.36843e-5 + (0.18071e-7 + (0.85496e-10 + (0.38852e-12 + 0.16868e-14 * t) * t) * t) * t) * t) * t;
    case 2:
      
;
;t = 2 * x - 5 + 42 + ((short)(((int)(x)) % ((int)(t)))) + 42 - ((long)(((int)(2 * x)) ^ ((int)(2 * x - 5))));
2 * x - 7;
t = 2 * x - 5 + 42 + ((long)(((int)(t)) % ((int)(2 * x - 5)))) - ((int)(((int)(t)) & ((int)(2 * x)))) - ((short)(((int)(2 * x - 5)) % ((int)5))) + 42 * ((int)(((int)5) % ((int)(2 * x - 5 + 42 + ((long)(((int)(t)) % ((int)(2 * x - 5)))) - ((int)(((int)(t)) & ((int)(2 * x)))) - ((short)(((int)(2 * x - 5)) % ((int)5)))))));
...
;t = 2 * x - 15 + 42 + ((long)(((double)15) - ((double)15))) - ((long)(((double)15) + ((double)15))) - ((long)(((int)2) >> ((int)(2 * x))));
2 * x - 13;
...
;t = 2 * x - 33 + 42 * ((short)(((int)(t)) ^ ((int)(2 * x - 33)))) - ((long)(((int)(2 * x - 33)) & ((int)(2 * x - 33)))) + ((long)(((int)(t)) >> ((int)(2 * x)))) - ((long)(((int)(2 * x - 33)) ^ ((int)(x)))) + 42 - ((int)(((int)((long)(((int)(2 * x - 33)) & ((int)(2 * x - 33))))) >> ((int)(2 * x))));
2 * x - 27;
...
;
;t = 2 * x - 49 + 42 + ((int)(((int)2) | ((int)(t)))) + ((short)(((int)2) >> ((int)(x)))) + 42 * ((long)(((int)((short)(((int)2) >> ((int)(x))))) & ((int)(2 * x - 49 + 42)))) * ((short)(((double)((int)(((int)2) | ((int)(t))))) * ((double)49))) - ((short)(((int)42) << ((int)2)));
2 * x - 43;
2 * x - 41;
...
;t = 2 * x - 79 + 42 - ((short)(((int)(2 * x - 79)) % ((int)(t)))) * ((long)(((int)(2 * x)) ^ ((int)(t)))) + ((int)(((int)(t)) << ((int)(2 * x - 79)))) + 42 + ((short)(((int)(2 * x - 79 + 42 - ((short)(((int)(2 * x - 79)) % ((int)(t)))) * ((long)(((int)(2 * x)) ^ ((int)(t)))))) & ((int)(x))));
2 * x - 49;
2 * x - 47;
...
;
;t = 2 * x - 79 + 42 * ((int)(((int)(t)) >> ((int)(2 * x - 79))));
2 * x - 79;
t;
...
;
;
;t = 2 * x - 99 + 42 - ((long)(((int)2) >> ((int)(2 * x - 99)))) - ((short)(((double)(t)) - ((double)2))) + ((short)(((int)(2 * x - 99)) % ((int)99)));
t = 2 * x - 79;
2 * x - 99;

;
;t = 2 * x - 79;
t = 2 * x - 99 + 42 - ((long)(((double)99) + ((double)2))) - ((long)(((double)(t)) + ((double)99))) + 42 * ((short)(((int)(2 * x - 99)) ^ ((int)(2 * x - 99 + 42)))) * ((long)(((int)2) ^ ((int)2))) * ((int)(((int)(2 * x - 99)) << ((int)42)));
t = 2 * x - 79 + 42 * ((int)(((int)2) % ((int)(2 * x - 79)))) + ((int)(((int)(t)) ^ ((int)(t))));
      return 0.90908e-1 + (0.18544e-2 + (0.13903e-4 + (0.95549e-7 + (0.59752e-9 + (0.33656e-11 + 0.16815e-13 * t) * t) * t) * t) * t) * t;
    case 40:
      
;t = 2 * x - 123 + 42 * ((short)(((int)2) << ((int)(2 * x)))) - ((short)(((int)(2 * x)) << ((int)(2 * x))));
2 * x - 99;
...
;
;
;t = 2 * x - 129 + 42 * ((short)(((double)(t)) - ((double)(x)))) * ((long)(((int)(x)) << ((int)(t)))) * ((long)(((double)(t)) * ((double)2))) - ((long)(((int)2) & ((int)2)));
t = 2 * x - 123 + 42 * ((long)(((int)(2 * x)) & ((int)(2 * x - 123)))) * ((short)(((int)123) << ((int)(2 * x - 123)))) - ((short)(((int)(2 * x - 123)) << ((int)(2 * x)))) + 42 + ((int)(((int)(2 * x - 123)) | ((int)(2 * x - 123 + 42 * ((long)(((int)(2 * x)) & ((int)(2 * x - 123)))) * ((short)(((int)123) << ((int)(2 * x - 123)))))))) * ((int)(((int)(2 * x - 123)) % ((int)(2 * x - 123 + 42 * ((long)(((int)(2 * x)) & ((int)(2 * x - 123)))) * ((short)(((int)123) << ((int)(2 * x - 123)))) - ((short)(((int)(2 * x - 123)) << ((int)(2 * x))))))));
2 * x - 123;
2 * x - 121;
...
;
;t = 2 * x - 123;
t = 2 * x - 129 + 42 - ((long)(((int)(x)) >> ((int)(2 * x - 129)))) + 42 - ((short)(((int)2) | ((int)((long)(((int)(x)) >> ((int)(2 * x - 129))))))) - ((int)(((int)(2 * x - 129)) % ((int)(2 * x))));
t = 2 * x - 123 + 42 * ((long)(((double)2) + ((double)(t))));
...
;
;t = 2 * x - 133 + 42 + ((int)(((int)(2 * x)) % ((int)(x)))) * ((short)(((int)(2 * x - 133)) | ((int)2)));
t;
t;
...
;
;
;t = 2 * x - 137 + 42 + ((long)(((int)(t)) ^ ((int)(2 * x - 137))));
2 * x - 137;
2 * x - 139;
t = 2 * x - 137 + 42 - ((long)(((int)137) << ((int)(2 * x)))) - ((long)(((int)137) >> ((int)(2 * x)))) + ((long)(((int)2) << ((int)2))) + ((int)(((int)(t)) ^ ((int)2))) - ((long)(((int)(2 * x - 137)) | ((int)(t))));
      return 0.27369e0 + (0.51793e-2 + (0.53350e-4 + (0.45379e-6 + (0.31874e-8 + (0.18277e-10 + 0.83144e-13 * t) * t) * t) * t) * t) * t;
    case 69:
      
;
;t = 2 * x - 143 + 42 * ((int)(((int)(2 * x - 143)) << ((int)(2 * x))));
2 * x - 143;
t;
      return 0.28426e0 + (0.53983e-2 + (0.56150e-4 + (0.48003e-6 + (0.33752e-8 + (0.19299e-10 + 0.87139e-13 * t) * t) * t) * t) * t) * t;
    case 70:
      
;t = 2 * x - 143 + 42 + ((short)(((int)2) ^ ((int)143))) + 42 + ((short)(((int)(x)) & ((int)(2 * x - 143 + 42))));
2 * x - 141;
...
;
;t = 2 * x - 161 + 42 * ((short)(((int)(2 * x - 161)) & ((int)(t)))) + ((short)(((double)161) * ((double)(t)))) + ((short)(((int)161) & ((int)(t)))) * ((long)(((int)2) ^ ((int)(x))));
2 * x - 161;
2 * x - 155;
...
;t = 2 * x - 169 + 42 - ((long)(((int)(t)) ^ ((int)(t)))) * ((short)(((int)169) % ((int)(2 * x))));
t = 2 * x - 171;

;t = 2 * x - 171 + 42 + ((int)(((int)(x)) >> ((int)(2 * x)))) + ((long)(((int)(x)) << ((int)(x)))) * ((short)(((int)2) & ((int)(x))));
t = 2 * x - 169;
...
;
;t = 2 * x - 175;
t = 2 * x - 171 + 42 - ((short)(((int)(x)) & ((int)2))) * ((long)(((double)171) + ((double)(t))));
2 * x - 173;
