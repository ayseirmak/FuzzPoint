...
t = 2 * x - 7 + 42 -((short)((((int)(2 * x)) <<((int)(2 * x - 7)))))*((int)((((int)(t)) >>((int)(7)))))*((short)((((double)(t)) +((double)(7)))));
t = 2 * x - 7 + 42 -((short)((((int)(2 * x)) <<((int)(2 * x - 7)))))*((int)((((int)(t)) >>((int)(7)))))*((short)((((double)(t)) +((double)(7)))));
;
...
t = 2 * x - 11 + 42 -((long)((((int)(t)) &((int)(11)))))+((long)((((double)(t)) *((double)(2)))))-((int)((((double)(t)) -((double)(11)))))+((long)((((int)(2)) ^((int)(11)))))+((long)((((int)(2 * x)) &((int)(2 * x)))));
t = 2 * x - 11 + 42 -((long)((((int)(t)) &((int)(11)))))+((long)((((double)(t)) *((double)(2)))))-((int)((((double)(t)) -((double)(11)))))+((long)((((int)(2)) ^((int)(11)))))+((long)((((int)(2 * x)) &((int)(2 * x)))));
;
...
t = 2 * x - 15 + 42 -((long)((((double)(x)) *((double)(x)))))-((short)((((double)(t)) +((double)(t)))))+((int)((((int)(t)) %((int)(t)))))+((int)((((double)(15)) -((double)(x)))))*((int)((((int)(2 * x)) >>((int)(t)))));
t = 2 * x - 15 + 42 -((long)((((double)(x)) *((double)(x)))))-((short)((((double)(t)) +((double)(t)))))+((int)((((int)(t)) %((int)(t)))))+((int)((((double)(15)) -((double)(x)))))*((int)((((int)(2 * x)) >>((int)(t)))));
;
...
t = 2 * x - 21 + 42 *((long)((((int)(2 * x)) |((int)(21)))))*((short)((((int)(2 * x - 21)) <<((int)(x)))))*((short)((((int)(21)) ^((int)(2)))))*((short)((((int)(t)) |((int)(2 * x - 21)))));
t = 2 * x - 21 + 42 *((long)((((int)(2 * x)) |((int)(21)))))*((short)((((int)(2 * x - 21)) <<((int)(x)))))*((short)((((int)(21)) ^((int)(2)))))*((short)((((int)(t)) |((int)(2 * x - 21)))));
;
      return 0.16540e-1 + (0.87928e-3 + (0.48520e-5 + (0.25711e-7 + (0.13030e-9 + (0.62820e-12 + 0.28612e-14 * t) * t) * t) * t) * t) * t;
    case 11:
      
t = 2 * x - 23 + 42 -((int)((((int)(t)) >>((int)(2 * x - 23)))))+((int)((((double)(x)) *((double)(t)))))+((long)((((double)(x)) -((double)(2)))))*((long)((((int)(2)) %((int)(2)))));
t = 2 * x - 23 + 42 -((int)((((int)(t)) >>((int)(2 * x - 23)))))+((int)((((double)(x)) *((double)(t)))))+((long)((((double)(x)) -((double)(2)))))*((long)((((int)(2)) %((int)(2)))));
;
...
t = 2 * x - 27 + 42 -((long)((((int)(2 * x - 27)) >>((int)(2 * x)))))*((int)((((int)(2 * x - 27)) >>((int)(2 * x)))))-((int)((((int)(27)) &((int)(t)))))+((int)((((double)(2)) -((double)(x)))));
t = 2 * x - 27 + 42 -((long)((((int)(2 * x - 27)) >>((int)(2 * x)))))*((int)((((int)(2 * x - 27)) >>((int)(2 * x)))))-((int)((((int)(27)) &((int)(t)))))+((int)((((double)(2)) -((double)(x)))));
;
      return 0.21996e-1 + (0.94040e-3 + (0.53443e-5 + (0.29078e-7 + (0.15078e-9 + (0.74103e-12 + 0.34251e-14 * t) * t) * t) * t) * t) * t;
    case 14:
      
t = 2 * x - 29 + 42 *((short)((((int)(29)) >>((int)(2 * x - 29)))))*((short)((((int)(29)) <<((int)(29)))))-((int)((((int)(x)) <<((int)(2 * x - 29)))))*((short)((((int)(2)) ^((int)(t)))));
t = 2 * x - 29 + 42 *((short)((((int)(29)) >>((int)(2 * x - 29)))))*((short)((((int)(29)) <<((int)(29)))))-((int)((((int)(x)) <<((int)(2 * x - 29)))))*((short)((((int)(2)) ^((int)(t)))));
;
...
t = 2 * x - 39 + 42 -((short)((((double)(t)) *((double)(39)))))-((short)((((int)(2)) |((int)(x)))))-((long)((((double)(2)) *((double)(t)))))+((int)((((int)(2)) >>((int)(2 * x)))));
t = 2 * x - 39 + 42 -((short)((((double)(t)) *((double)(39)))))-((short)((((int)(2)) |((int)(x)))))-((long)((((double)(2)) *((double)(t)))))+((int)((((int)(2)) >>((int)(2 * x)))));
;
...
t = 2 * x - 43 + 42 +((short)((((int)(2 * x)) <<((int)(43)))));
t = 2 * x - 43 + 42 +((short)((((int)(2 * x)) <<((int)(43)))));
;
...
t = 2 * x - 51 + 42 +((long)((((int)(2 * x)) <<((int)(t)))))+((short)((((int)(t)) &((int)(2 * x)))));
t = 2 * x - 51 + 42 +((long)((((int)(2 * x)) <<((int)(t)))))+((short)((((int)(t)) &((int)(2 * x)))));
;
...
t = 2 * x - 79 + 42 *((int)((((double)(2)) -((double)(t)))))+((long)((((int)(2 * x - 79)) |((int)(79)))))*((long)((((int)(2)) |((int)(2 * x - 79)))));
t = 2 * x - 79 + 42 *((int)((((double)(2)) -((double)(t)))))+((long)((((int)(2 * x - 79)) |((int)(79)))))*((long)((((int)(2)) |((int)(2 * x - 79)))));
;
      return 0.90908e-1 + (0.18544e-2 + (0.13903e-4 + (0.95549e-7 + (0.59752e-9 + (0.33656e-11 + 0.16815e-13 * t) * t) * t) * t) * t) * t;
    case 40:
      
t = 2 * x - 99 + 42 *((int)((((int)(2 * x - 99)) >>((int)(2)))))+((short)((((int)(t)) |((int)(2 * x - 99)))))-((short)((((int)(2)) &((int)(2 * x)))))+((int)((((int)(2 * x - 99)) %((int)(x)))));
t = 2 * x - 99 + 42 *((int)((((int)(2 * x - 99)) >>((int)(2)))))+((short)((((int)(t)) |((int)(2 * x - 99)))))-((short)((((int)(2)) &((int)(2 * x)))))+((int)((((int)(2 * x - 99)) %((int)(x)))));
;
      return 0.13443e0 + (0.25474e-2 + (0.21385e-4 + (0.15996e-6 + (0.10585e-8 + (0.61258e-11 + 0.30412e-13 * t) * t) * t) * t) * t) * t;
    case 50:
      
t = 2 * x - 119 + 42 +((short)((((int)(2)) ^((int)(2)))))*((int)((((int)(2 * x - 119)) <<((int)(2)))))*((short)((((int)(2 * x - 119)) &((int)(x)))))*((int)((((int)(2 * x - 119)) |((int)(2 * x)))))*((short)((((double)(119)) *((double)(119)))));
t = 2 * x - 119 + 42 +((short)((((int)(2)) ^((int)(2)))))*((int)((((int)(2 * x - 119)) <<((int)(2)))))*((short)((((int)(2 * x - 119)) &((int)(x)))))*((int)((((int)(2 * x - 119)) |((int)(2 * x)))))*((short)((((double)(119)) *((double)(119)))));
;
...
t = 2 * x - 129 + 42 -((int)((((double)(129)) *((double)(2)))))*((long)((((double)(129)) +((double)(x)))))*((long)((((int)(t)) &((int)(x)))))+((int)((((int)(2 * x)) %((int)(2)))));
t = 2 * x - 129 + 42 -((int)((((double)(129)) *((double)(2)))))*((long)((((double)(129)) +((double)(x)))))*((long)((((int)(t)) &((int)(x)))))+((int)((((int)(2 * x)) %((int)(2)))));
;
...
t = 2 * x - 133 + 42 *((short)((((int)(2 * x - 133)) <<((int)(x)))))*((short)((((int)(133)) %((int)(2)))))-((long)((((int)(2 * x - 133)) >>((int)(t)))))+((int)((((int)(133)) >>((int)(133)))));
t = 2 * x - 133 + 42 *((short)((((int)(2 * x - 133)) <<((int)(x)))))*((short)((((int)(133)) %((int)(2)))))-((long)((((int)(2 * x - 133)) >>((int)(t)))))+((int)((((int)(133)) >>((int)(133)))));
;
      return 0.25379e0 + (0.47735e-2 + (0.48199e-4 + (0.40561e-6 + (0.28411e-8 + (0.16374e-10 + 0.75541e-13 * t) * t) * t) * t) * t) * t;
    case 67:
      
t = 2 * x - 135 + 42 *((long)((((int)(2 * x)) %((int)(2 * x)))))-((long)((((int)(2)) |((int)(2)))))-((int)((((double)(t)) *((double)(2)))))-((int)((((int)(2 * x - 135)) |((int)(135)))))*((long)((((double)(t)) -((double)(135)))));
t = 2 * x - 135 + 42 *((long)((((int)(2 * x)) %((int)(2 * x)))))-((long)((((int)(2)) |((int)(2)))))-((int)((((double)(t)) *((double)(2)))))-((int)((((int)(2 * x - 135)) |((int)(135)))))*((long)((((double)(t)) -((double)(135)))));
;
      return 0.26354e0 + (0.49713e-2 + (0.50702e-4 + (0.42901e-6 + (0.30095e-8 + (0.17303e-10 + 0.79278e-13 * t) * t) * t) * t) * t) * t;
    case 68:
      
t = 2 * x - 137 + 42 *((long)((((int)(137)) &((int)(2 * x)))))-((int)((((double)(x)) -((double)(137)))))*((short)((((int)(t)) <<((int)(2 * x - 137)))))+((short)((((double)(t)) -((double)(x)))));
t = 2 * x - 137 + 42 *((long)((((int)(137)) &((int)(2 * x)))))-((int)((((double)(x)) -((double)(137)))))*((short)((((int)(t)) <<((int)(2 * x - 137)))))+((short)((((double)(t)) -((double)(x)))));
;
      return 0.27369e0 + (0.51793e-2 + (0.53350e-4 + (0.45379e-6 + (0.31874e-8 + (0.18277e-10 + 0.83144e-13 * t) * t) * t) * t) * t) * t;
    case 69:
      
t = 2 * x - 139 + 42 *((int)((((int)(139)) ^((int)(t)))));
t = 2 * x - 139 + 42 *((int)((((int)(139)) ^((int)(t)))));
;
      return 0.28426e0 + (0.53983e-2 + (0.56150e-4 + (0.48003e-6 + (0.33752e-8 + (0.19299e-10 + 0.87139e-13 * t) * t) * t) * t) * t) * t;
    case 70:
      
t = 2 * x - 141 + 42 *((short)((((int)(t)) <<((int)(2 * x)))));
t = 2 * x - 141 + 42 *((short)((((int)(t)) <<((int)(2 * x)))));
;
...
t = 2 * x - 147 + 42 *((int)((((int)(2 * x)) <<((int)(2 * x)))))*((long)((((int)(x)) ^((int)(x)))))-((short)((((double)(t)) -((double)(t)))))*((long)((((int)(x)) ^((int)(t)))))*((int)((((int)(2 * x)) %((int)(147)))));
t = 2 * x - 147 + 42 *((int)((((int)(2 * x)) <<((int)(2 * x)))))*((long)((((int)(x)) ^((int)(x)))))-((short)((((double)(t)) -((double)(t)))))*((long)((((int)(x)) ^((int)(t)))))*((int)((((int)(2 * x)) %((int)(147)))));
;
...
t = 2 * x - 151 + 42 -((int)((((int)(t)) &((int)(2 * x - 151)))))-((long)((((int)(t)) &((int)(2 * x)))))*((int)((((double)(x)) +((double)(2)))))*((short)((((int)(t)) &((int)(2 * x - 151)))));
t = 2 * x - 151 + 42 -((int)((((int)(t)) &((int)(2 * x - 151)))))-((long)((((int)(t)) &((int)(2 * x)))))*((int)((((double)(x)) +((double)(2)))))*((short)((((int)(t)) &((int)(2 * x - 151)))));
;
...
t = 2 * x - 165 + 42 *((int)((((int)(t)) &((int)(x)))))-((int)((((int)(2 * x)) <<((int)(165)))))+((short)((((int)(t)) <<((int)(t)))))+((short)((((int)(2 * x)) <<((int)(2 * x - 165)))))-((short)((((double)(t)) +((double)(165)))));
t = 2 * x - 165 + 42 *((int)((((int)(t)) &((int)(x)))))-((int)((((int)(2 * x)) <<((int)(165)))))+((short)((((int)(t)) <<((int)(t)))))+((short)((((int)(2 * x)) <<((int)(2 * x - 165)))))-((short)((((double)(t)) +((double)(165)))));
;
      return 0.47282e0 + (0.95799e-2 + (0.11135e-3 + (0.99716e-6 + (0.69638e-8 + (0.37549e-10 + 0.15003e-12 * t) * t) * t) * t) * t) * t;
    case 83:
      
t = 2 * x - 167 + 42 +((long)((((int)(2 * x - 167)) &((int)(2 * x - 167)))))*((long)((((double)(167)) -((double)(t)))))*((int)((((int)(2 * x - 167)) >>((int)(t)))))*((long)((((double)(x)) +((double)(167)))));
t = 2 * x - 167 + 42 +((long)((((int)(2 * x - 167)) &((int)(2 * x - 167)))))*((long)((((double)(167)) -((double)(t)))))*((int)((((int)(2 * x - 167)) >>((int)(t)))))*((long)((((double)(x)) +((double)(167)))));
;
...
t = 2 * x - 171 + 42 *((int)((((int)(2 * x - 171)) <<((int)(171)))))+((short)((((int)(x)) >>((int)(t)))))+((short)((((int)(2 * x)) %((int)(t)))))-((int)((((int)(2 * x - 171)) |((int)(2 * x - 171)))));
t = 2 * x - 171 + 42 *((int)((((int)(2 * x - 171)) <<((int)(171)))))+((short)((((int)(x)) >>((int)(t)))))+((short)((((int)(2 * x)) %((int)(t)))))-((int)((((int)(2 * x - 171)) |((int)(2 * x - 171)))));
;
...
t = 2 * x - 179 + 42 -((long)((((int)(x)) >>((int)(2)))))*((int)((((double)(179)) *((double)(2)))))-((long)((((int)(2 * x)) |((int)(2)))))*((short)((((int)(2)) <<((int)(2 * x - 179)))))-((short)((((int)(2 * x - 179)) ^((int)(2 * x)))));
t = 2 * x - 179 + 42 -((long)((((int)(x)) >>((int)(2)))))*((int)((((double)(179)) *((double)(2)))))-((long)((((int)(2 * x)) |((int)(2)))))*((short)((((int)(2)) <<((int)(2 * x - 179)))))-((short)((((int)(2 * x - 179)) ^((int)(2 * x)))));
;
      return 0.63178e0 + (0.13368e-1 + (0.16254e-3 + (0.14695e-5 + (0.10072e-7 + (0.51822e-10 + 0.19025e-12 * t) * t) * t) * t) * t) * t;
    case 90:
      
t = 2 * x - 181 + 42 *((int)((((int)(2 * x)) &((int)(2 * x)))))*((int)((((int)(2 * x)) &((int)(x)))))*((int)((((int)(2 * x - 181)) >>((int)(x)))))-((long)((((int)(2 * x - 181)) <<((int)(2)))));
t = 2 * x - 181 + 42 *((int)((((int)(2 * x)) &((int)(2 * x)))))*((int)((((int)(2 * x)) &((int)(x)))))*((int)((((int)(2 * x - 181)) >>((int)(x)))))-((long)((((int)(2 * x - 181)) <<((int)(2)))));
;
      return 0.65918e0 + (0.14036e-1 + (0.17160e-3 + (0.15521e-5 + (0.10601e-7 + (0.54140e-10 + 0.19616e-12 * t) * t) * t) * t) * t) * t;
    case 91:
      
t = 2 * x - 183 + 42 +((long)((((double)(183)) +((double)(183)))))*((int)((((int)(2 * x)) %((int)(2)))));
t = 2 * x - 183 + 42 +((long)((((double)(183)) +((double)(183)))))*((int)((((int)(2 * x)) %((int)(2)))));
;
      return 0.68795e0 + (0.14741e-1 + (0.18117e-3 + (0.16392e-5 + (0.11155e-7 + (0.56530e-10 + 0.20209e-12 * t) * t) * t) * t) * t) * t;
    case 92:
      
t = 2 * x - 185 + 42 *((long)((((int)(2)) <<((int)(x)))))-((int)((((int)(2 * x)) %((int)(2)))))-((long)((((double)(t)) +((double)(2)))))*((int)((((double)(t)) -((double)(t)))));
t = 2 * x - 185 + 42 *((long)((((int)(2)) <<((int)(x)))))-((int)((((int)(2 * x)) %((int)(2)))))-((long)((((double)(t)) +((double)(2)))))*((int)((((double)(t)) -((double)(t)))));
;
      return 0.71818e0 + (0.15486e-1 + (0.19128e-3 + (0.17307e-5 + (0.11732e-7 + (0.58991e-10 + 0.20803e-12 * t) * t) * t) * t) * t) * t;
    case 93:
      
t = 2 * x - 187 + 42 -((int)((((int)(2 * x - 187)) |((int)(187)))))*((int)((((int)(187)) >>((int)(2 * x)))))*((int)((((int)(2 * x)) >>((int)(x)))))-((short)((((int)(187)) %((int)(2 * x)))));
t = 2 * x - 187 + 42 -((int)((((int)(2 * x - 187)) |((int)(187)))))*((int)((((int)(187)) >>((int)(2 * x)))))*((int)((((int)(2 * x)) >>((int)(x)))))-((short)((((int)(187)) %((int)(2 * x)))));
;
