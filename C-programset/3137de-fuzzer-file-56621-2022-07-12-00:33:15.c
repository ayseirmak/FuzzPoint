...
int while_condition_1300 = while_condition_1360;
while (while_condition_1300) {
...
break;
  ...
  if (0)
    *deletedEntry = 0.0 + 42 - ((long)(((int)(0.0)) & ((int)(*deletedEntry)))) - ((short)(((int)(*deletedEntry)) & ((int)(*deletedEntry))));
  return 0;
}
