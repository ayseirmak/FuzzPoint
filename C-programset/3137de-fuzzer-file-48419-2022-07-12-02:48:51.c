...
foo (double x)
{
  ...
  switch ((int) x)
    ...
    case 1:
      t = 2 * x - 3 + 42 - ((int)(((int)3) >> ((int)2)));
      return 0.21479e-2 + (0.72686e-3 + (0.36843e-5 + (0.18071e-7 + (0.85496e-10 + (0.38852e-12 + 0.16868e-14 * t) * t) * t) * t) * t) * t;
    case 2:
      t = 2 * x - 5 + 42 - ((long)(((int)(2 * x)) % ((int)(2 * x - 5)))) * ((int)(((double)(x)) * ((double)(t)))) * ((short)(((int)(2 * x)) << ((int)(t))));
    ...
    case 6:
      t = 2 * x - 13 + 42 + ((long)(((double)(x)) - ((double)13))) - ((int)(((int)2) >> ((int)13))) - ((long)(((int)2) ^ ((int)(2 * x - 13)))) - ((long)(((int)(2 * x)) << ((int)(2 * x - 13))));
    ...
    case 8:
      t = 2 * x - 17 + 42 + ((int)(((int)(2 * x - 17)) >> ((int)(2 * x - 17)))) * ((short)(((double)(t)) * ((double)(x)))) * ((int)(((int)2) % ((int)(2 * x - 17)))) * ((short)(((int)(2 * x)) | ((int)(2 * x)))) - ((int)(((int)(2 * x)) << ((int)17)));
    ...
    case 11:
      t = 2 * x - 23 + 42 - ((int)(((int)(t)) % ((int)(2 * x - 23)))) + ((long)(((double)(t)) * ((double)(t))));
    ...
    case 13:
      t = 2 * x - 27 + 42 - ((long)(((double)2) - ((double)2))) + ((short)(((int)27) << ((int)27))) - ((short)(((int)(t)) >> ((int)(t)))) * ((short)(((int)(2 * x - 27)) ^ ((int)(t)))) + ((int)(((int)(2 * x)) ^ ((int)(2 * x - 27))));
    ...
    case 19:
      t = 2 * x - 39 + 42 + ((long)(((int)(2 * x)) >> ((int)(t)))) * ((int)(((int)39) & ((int)(t)))) + ((int)(((int)(x)) ^ ((int)(2 * x - 39)))) - ((short)(((int)2) ^ ((int)(2 * x)))) * ((long)(((int)39) << ((int)(2 * x))));
    ...
    case 22:
      t = 2 * x - 45 + 42 - ((short)(((int)(2 * x)) << ((int)(x)))) * ((short)(((int)(t)) % ((int)45)));
      return 0.40842e-1 + (0.11650e-2 + (0.72569e-5 + (0.42796e-7 + (0.23761e-9 + (0.12332e-11 + 0.59246e-14 * t) * t) * t) * t) * t) * t;
    case 23:
      t = 2 * x - 47 + 42 + ((long)(((int)47) >> ((int)2))) * ((short)(((int)(x)) ^ ((int)2))) * ((int)(((int)(2 * x - 47)) ^ ((int)(x))));
    ...
    case 30:
      t = 2 * x - 79 + 42 - ((short)(((int)(2 * x - 79)) >> ((int)(x)))) + ((long)(((int)(2 * x)) << ((int)(2 * x - 79)))) - ((long)(((double)(x)) * ((double)(x)))) + ((long)(((int)(t)) & ((int)(2 * x - 79)))) - ((int)(((int)(x)) << ((int)(2 * x))));
    ...
    case 62:
      t = 2 * x - 125 + 42 * ((short)(((int)(2 * x - 125)) | ((int)(2 * x))));
      return 0.21849e0 + (0.40747e-2 + (0.39476e-4 + (0.32443e-6 + (0.22542e-8 + (0.13084e-10 + 0.61873e-13 * t) * t) * t) * t) * t) * t;
    case 63:
      t = 2 * x - 127 + 42 * ((int)(((int)(t)) | ((int)(x)))) - ((long)(((int)(2 * x)) % ((int)2))) + ((long)(((int)(x)) % ((int)(2 * x)))) + ((short)(((double)2) * ((double)(t)))) + ((int)(((int)127) >> ((int)2)));
    ...
    case 66:
      t = 2 * x - 133 + 42 - ((long)(((int)(t)) % ((int)(2 * x)))) + ((short)(((double)(x)) + ((double)(t)))) + ((short)(((double)2) * ((double)133))) - ((short)(((int)(2 * x)) % ((int)(x))));
    ...
    case 69:
      t = 2 * x - 139 + 42 * ((short)(((int)139) << ((int)(x)))) * ((long)(((int)(t)) ^ ((int)(t)))) * ((short)(((double)(t)) + ((double)2)));
      return 0.28426e0 + (0.53983e-2 + (0.56150e-4 + (0.48003e-6 + (0.33752e-8 + (0.19299e-10 + 0.87139e-13 * t) * t) * t) * t) * t) * t;
    case 70:
      t = 2 * x - 141 + 42 + ((long)(((double)141) - ((double)2))) * ((int)(((int)(2 * x - 141)) & ((int)(2 * x)))) - ((long)(((double)141) - ((double)2))) * ((short)(((int)(2 * x - 141)) | ((int)141)));
      return 0.29529e0 + (0.56288e-2 + (0.59113e-4 + (0.50782e-6 + (0.35735e-8 + (0.20369e-10 + 0.91262e-13 * t) * t) * t) * t) * t) * t;
    case 71:
      t = 2 * x - 143 + 42 * ((long)(((int)(2 * x)) ^ ((int)2))) - ((long)(((int)(2 * x)) | ((int)(t)))) - ((int)(((int)(2 * x)) & ((int)(2 * x - 143))));
      return 0.30679e0 + (0.58714e-2 + (0.62248e-4 + (0.53724e-6 + (0.37827e-8 + (0.21490e-10 + 0.95513e-13 * t) * t) * t) * t) * t) * t;
    case 72:
      t = 2 * x - 145 + 42 + ((short)(((int)(x)) >> ((int)(2 * x - 145)))) - ((long)(((double)(x)) + ((double)(t)))) + ((long)(((int)(2 * x)) | ((int)2))) * ((long)(((int)(x)) ^ ((int)(2 * x)))) - ((short)(((int)145) % ((int)145)));
      return 0.31878e0 + (0.61270e-2 + (0.65564e-4 + (0.56837e-6 + (0.40035e-8 + (0.22662e-10 + 0.99891e-13 * t) * t) * t) * t) * t) * t;
    case 73:
      t = 2 * x - 147 + 42 * ((long)(((int)(2 * x)) & ((int)2))) * ((short)(((double)(x)) - ((double)(x)))) - ((short)(((double)(t)) + ((double)2))) * ((int)(((int)(t)) % ((int)2)));
      return 0.33130e0 + (0.63962e-2 + (0.69072e-4 + (0.60133e-6 + (0.42362e-8 + (0.23888e-10 + 0.10439e-12 * t) * t) * t) * t) * t) * t;
    case 74:
      t = 2 * x - 149 + 42 + ((short)(((int)2) & ((int)(2 * x - 149))));
    ...
    case 79:
      t = 2 * x - 159 + 42 * ((long)(((int)(2 * x)) & ((int)(2 * x))));
