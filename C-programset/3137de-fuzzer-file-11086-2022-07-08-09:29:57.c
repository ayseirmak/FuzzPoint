...
;
;t = 2 * x - 17;
2 * x - 17 + 42 * ((int)(((double)(t)) + ((double)(t)))) - ((short)(((int)(2 * x)) | ((int)17))) - ((long)(((int)2) & ((int)(2 * x)))) * ((int)(((int)2) | ((int)17)));
2 * x - 15;
...
;2 * x - 23 + 42 - ((short)(((double)(x)) + ((double)(x)))) * ((short)(((int)(x)) >> ((int)(x)))) - ((long)(((double)(x)) + ((double)23))) * ((long)(((double)(x)) - ((double)(t)))) * ((int)(((int)(t)) << ((int)(2 * x - 23))));
2 * x - 21;
...
;
;t = 2 * x - 59;
2 * x - 79 + 42 * ((int)(((int)(2 * x)) ^ ((int)(2 * x - 79)))) + ((int)(((int)79) & ((int)(t)))) - ((short)(((int)79) ^ ((int)(x)))) - ((long)(((int)(x)) & ((int)(t))));
...
;t = 2 * x - 139;
2 * x - 137 + 42 + ((int)(((int)137) >> ((int)(2 * x - 137)))) - ((long)(((int)(t)) >> ((int)(2 * x - 137))));
...
t = 2 * x - 139 + 42 * ((int)(((int)(2 * x - 139)) & ((int)(x)))) + ((int)(((int)(2 * x - 139)) % ((int)139))) * ((int)(((int)(t)) % ((int)(2 * x - 139))));
    ...
    case 70:
      2 * x - 141 + 42 - ((int)(((int)(t)) << ((int)141))) * ((short)(((int)141) | ((int)2))) + ((short)(((int)(2 * x)) | ((int)(2 * x)))) - ((long)(((double)2) * ((double)2)));
      return 0.29529e0 + (0.56288e-2 + (0.59113e-4 + (0.50782e-6 + (0.35735e-8 + (0.20369e-10 + 0.91262e-13 * t) * t) * t) * t) * t) * t;
    case 71:
      
;2 * x - 145 + 42 * ((short)(((double)(t)) - ((double)2))) * ((short)(((int)(2 * x)) | ((int)145))) - ((short)(((int)(x)) & ((int)(2 * x))));
2 * x - 143;
      return 0.30679e0 + (0.58714e-2 + (0.62248e-4 + (0.53724e-6 + (0.37827e-8 + (0.21490e-10 + 0.95513e-13 * t) * t) * t) * t) * t) * t;
    case 72:
      
;t = 2 * x - 153;
2 * x - 145 + 42 + ((short)(((int)(x)) | ((int)(2 * x)))) * ((int)(((double)145) + ((double)(t)))) * ((long)(((int)(2 * x)) & ((int)(t)))) - ((short)(((int)(x)) % ((int)(2 * x - 145)))) - ((int)(((double)2) * ((double)(t))));
...
2 * x - 161 + 42 + ((short)(((int)(x)) >> ((int)(2 * x)))) - ((short)(((int)(t)) % ((int)(2 * x)))) - ((long)(((int)(2 * x - 161)) ^ ((int)(2 * x)))) - ((long)(((int)(t)) % ((int)(2 * x)))) + ((int)(((double)(x)) - ((double)2)));
2 * x - 159;
...
;2 * x - 171 + 42 - ((int)(((int)(2 * x - 171)) ^ ((int)2))) * ((short)(((int)(2 * x - 171)) << ((int)(t)))) * ((int)(((double)171) + ((double)(t)))) - ((long)(((double)2) + ((double)(x)))) * ((short)(((int)2) | ((int)(2 * x))));
2 * x - 169;
...
;2 * x - 175 + 42 + ((long)(((int)(2 * x - 175)) & ((int)(t))));
2 * x - 173;
