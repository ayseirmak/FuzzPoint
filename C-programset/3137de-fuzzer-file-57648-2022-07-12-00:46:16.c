...
;t = 2 * x - 3 + 42 + ((int)(((int)(2 * x - 3)) % ((int)2))) - ((int)(((int)(2 * x - 3)) % ((int)2))) - ((int)(((double)3) - ((double)2))) - ((int)(((double)2) - ((double)(x))));
2 * x - 1 + 42 + ((long)(((double)(t)) * ((double)(t)))) * ((long)(((double)1) * ((double)2))) + ((short)(((int)(t)) & ((int)(2 * x)))) + ((int)(((int)1) << ((int)(2 * x))));
      return 0.70878e-3 + (0.71234e-3 + (0.35779e-5 + (0.17403e-7 + (0.81710e-10 + (0.36885e-12 + 0.15917e-14 * t) * t) * t) * t) * t) * t;
    case 1:
      
;t = 2 * x - 5 + 42 * ((int)(((int)(2 * x)) << ((int)(2 * x)))) * ((short)(((int)(x)) << ((int)(2 * x)))) + 42 - ((long)(((int)(2 * x - 5 + 42 * ((int)(((int)(2 * x)) << ((int)(2 * x)))) * ((short)(((int)(x)) << ((int)(2 * x)))))) & ((int)(2 * x - 5))));
t = 2 * x - 3 + 42 - ((int)(((double)3) + ((double)2)));
      return 0.21479e-2 + (0.72686e-3 + (0.36843e-5 + (0.18071e-7 + (0.85496e-10 + (0.38852e-12 + 0.16868e-14 * t) * t) * t) * t) * t) * t;
    case 2:
      
;t = 2 * x - 7 + 42 - ((short)(((int)2) & ((int)2))) * ((short)(((int)(x)) % ((int)(2 * x - 7))));
t = 2 * x - 5 + 42 * ((int)(((int)(2 * x)) << ((int)(2 * x)))) * ((short)(((int)(x)) << ((int)(2 * x)))) + 42 + ((short)(((int)(2 * x)) | ((int)(42 * ((int)(((int)(2 * x)) << ((int)(2 * x)))) * ((short)(((int)(x)) << ((int)(2 * x)))))))) + ((int)(((int)(42 * ((int)(((int)(2 * x)) << ((int)(2 * x)))) * ((short)(((int)(x)) << ((int)(2 * x)))))) ^ ((int)(2 * x - 5 + 42 * ((int)(((int)(2 * x)) << ((int)(2 * x)))) * ((short)(((int)(x)) << ((int)(2 * x)))))))) * ((int)(((int)5) ^ ((int)(t)))) * ((long)(((int)(2 * x - 5 + 42 * ((int)(((int)(2 * x)) << ((int)(2 * x)))) * ((short)(((int)(x)) << ((int)(2 * x)))))) ^ ((int)5)));
      return 0.36165e-2 + (0.74182e-3 + (0.37948e-5 + (0.18771e-7 + (0.89484e-10 + (0.40935e-12 + 0.17872e-14 * t) * t) * t) * t) * t) * t;
    case 3:
      
;t = 2 * x - 9 + 42 + ((int)(((int)2) & ((int)9))) - ((short)(((double)(x)) + ((double)9))) * ((short)(((int)2) ^ ((int)(2 * x - 9)))) * ((long)(((int)2) & ((int)2)));
t = 2 * x - 7 + 42 - ((int)(((int)(2 * x - 7)) << ((int)(2 * x - 7)))) + ((short)(((int)7) ^ ((int)(t)))) * ((long)(((int)(2 * x)) >> ((int)(2 * x)))) - ((short)(((int)7) >> ((int)(2 * x - 7))));
      return 0.51154e-2 + (0.75722e-3 + (0.39096e-5 + (0.19504e-7 + (0.93687e-10 + (0.43143e-12 + 0.18939e-14 * t) * t) * t) * t) * t) * t;
    case 4:
      t = 2 * x - 9 + 42 * ((short)(((int)(t)) << ((int)9))) + ((int)(((int)(t)) & ((int)(x)))) * ((long)(((int)2) << ((int)(t)))) - ((long)(((int)(2 * x)) | ((int)(2 * x - 9)))) + 42 + ((long)(((int)(2 * x - 9 + 42 * ((short)(((int)(t)) << ((int)9))) + ((int)(((int)(t)) & ((int)(x)))) * ((long)(((int)2) << ((int)(t)))))) & ((int)(2 * x - 9 + 42 * ((short)(((int)(t)) << ((int)9))) + ((int)(((int)(t)) & ((int)(x)))) * ((long)(((int)2) << ((int)(t)))) - ((long)(((int)(2 * x)) | ((int)(2 * x - 9)))))))) * ((int)(((int)9) << ((int)(2 * x))));
...
;t = 2 * x - 15 + 42 - ((short)(((double)(x)) - ((double)15))) - ((long)(((int)(t)) | ((int)2))) - ((long)(((int)(2 * x - 15)) % ((int)(2 * x)))) + 42 + ((int)(((int)42) | ((int)(2 * x - 15)))) * ((int)(((int)((long)(((int)(t)) | ((int)2)))) | ((int)42)));
2 * x - 13;
      return 0.98039e-2 + (0.80633e-3 + (0.42819e-5 + (0.21916e-7 + (0.10771e-9 + (0.50595e-12 + 0.22573e-14 * t) * t) * t) * t) * t) * t;
    case 7:
      t = 2 * x - 15 + 42 - ((short)(((double)(x)) - ((double)15))) - ((long)(((int)(t)) | ((int)2))) - ((long)(((int)(2 * x - 15)) % ((int)(2 * x)))) + 42 + ((int)(((int)(t)) & ((int)(2 * x - 15)))) + ((int)(((int)((long)(((int)(2 * x - 15)) % ((int)(2 * x))))) | ((int)(2 * x - 15 + 42 - ((short)(((double)(x)) - ((double)15))) - ((long)(((int)(t)) | ((int)2))) - ((long)(((int)(2 * x - 15)) % ((int)(2 * x))))))));
      return 0.11433e-1 + (0.82372e-3 + (0.44160e-5 + (0.22798e-7 + (0.11291e-9 + (0.53386e-12 + 0.23944e-14 * t) * t) * t) * t) * t) * t;
    case 8:
      
;t = 2 * x - 19 + 42 + ((short)(((int)(t)) >> ((int)2))) * ((int)(((int)(x)) ^ ((int)(t)))) + ((long)(((int)(2 * x - 19)) ^ ((int)(t)))) - ((int)(((double)(x)) - ((double)2))) + ((long)(((int)(t)) << ((int)(2 * x)))) + 42 + ((int)(((int)19) % ((int)(2 * x - 19 + 42 + ((short)(((int)(t)) >> ((int)2))) * ((int)(((int)(x)) ^ ((int)(t)))) + ((long)(((int)(2 * x - 19)) ^ ((int)(t)))) - ((int)(((double)(x)) - ((double)2))))))) * ((long)(((int)((long)(((int)(t)) << ((int)(2 * x))))) % ((int)((long)(((int)(2 * x - 19)) ^ ((int)(t))))))) + ((int)(((int)(((short)(((int)(t)) >> ((int)2))) * ((int)(((int)(x)) ^ ((int)(t)))))) ^ ((int)(2 * x)))) + ((int)(((int)42) ^ ((int)(2 * x - 19 + 42 + ((short)(((int)(t)) >> ((int)2))) * ((int)(((int)(x)) ^ ((int)(t)))) + ((long)(((int)(2 * x - 19)) ^ ((int)(t))))))));
2 * x - 17;
      return 0.13099e-1 + (0.84167e-3 + (0.45555e-5 + (0.23723e-7 + (0.11839e-9 + (0.56346e-12 + 0.25403e-14 * t) * t) * t) * t) * t) * t;
    case 9:
      
;t = 2 * x - 21 + 42 + ((int)(((int)(t)) ^ ((int)(2 * x - 21)))) - ((long)(((int)(x)) | ((int)(2 * x - 21)))) + ((short)(((int)(2 * x - 21)) ^ ((int)21))) + ((int)(((int)21) ^ ((int)(x)))) * ((long)(((int)(2 * x)) << ((int)(t)))) + 42 * ((short)(((int)(2 * x - 21 + 42 + ((int)(((int)(t)) ^ ((int)(2 * x - 21)))))) ^ ((int)(x)))) * ((long)(((int)(((int)(((int)21) ^ ((int)(x)))) * ((long)(((int)(2 * x)) << ((int)(t)))))) << ((int)(((int)(((int)21) ^ ((int)(x)))) * ((long)(((int)(2 * x)) << ((int)(t)))))))) * ((short)(((int)(2 * x - 21 + 42 + ((int)(((int)(t)) ^ ((int)(2 * x - 21)))))) ^ ((int)((int)(((int)(t)) ^ ((int)(2 * x - 21)))))));
t = 2 * x - 19 + 42 + ((short)(((int)(t)) >> ((int)2))) * ((int)(((int)(x)) ^ ((int)(t)))) + ((long)(((int)(2 * x - 19)) ^ ((int)(t)))) - ((int)(((double)(x)) - ((double)2))) + ((long)(((int)(t)) << ((int)(2 * x)))) + 42 * ((long)(((int)((long)(((int)(t)) << ((int)(2 * x))))) % ((int)(((short)(((int)(t)) >> ((int)2))) * ((int)(((int)(x)) ^ ((int)(t)))))))) - ((long)(((int)((long)(((int)(t)) << ((int)(2 * x))))) ^ ((int)(t))));
      return 0.14800e-1 + (0.86018e-3 + (0.47008e-5 + (0.24694e-7 + (0.12418e-9 + (0.59486e-12 + 0.26957e-14 * t) * t) * t) * t) * t) * t;
    case 10:
      
;t = 2 * x - 23 + 42 * ((int)(((int)2) >> ((int)(2 * x)))) * ((long)(((int)2) | ((int)(t)))) + ((short)(((int)(2 * x - 23)) >> ((int)23)));
t = 2 * x - 21 + 42 + ((int)(((int)(t)) ^ ((int)(2 * x - 21)))) - ((long)(((int)(x)) | ((int)(2 * x - 21)))) + ((short)(((int)(2 * x - 21)) ^ ((int)21))) + ((int)(((int)21) ^ ((int)(x)))) * ((long)(((int)(2 * x)) << ((int)(t)))) + 42 + ((int)(((int)(2 * x - 21 + 42 + ((int)(((int)(t)) ^ ((int)(2 * x - 21)))) - ((long)(((int)(x)) | ((int)(2 * x - 21)))) + ((short)(((int)(2 * x - 21)) ^ ((int)21))) + ((int)(((int)21) ^ ((int)(x)))) * ((long)(((int)(2 * x)) << ((int)(t)))))) ^ ((int)(2 * x - 21 + 42 + ((int)(((int)(t)) ^ ((int)(2 * x - 21)))) - ((long)(((int)(x)) | ((int)(2 * x - 21)))) + ((short)(((int)(2 * x - 21)) ^ ((int)21)))))));
      return 0.16540e-1 + (0.87928e-3 + (0.48520e-5 + (0.25711e-7 + (0.13030e-9 + (0.62820e-12 + 0.28612e-14 * t) * t) * t) * t) * t) * t;
    case 11:
      
;t = 2 * x - 25 + 42 + ((long)(((double)2) + ((double)25))) - ((short)(((double)(x)) * ((double)25)));
t = 2 * x - 23 + 42 + ((long)(((int)(x)) ^ ((int)(2 * x)))) * ((short)(((double)(t)) + ((double)23))) * ((short)(((int)(x)) | ((int)23)));
      return 0.18318e-1 + (0.89900e-3 + (0.50094e-5 + (0.26779e-7 + (0.13675e-9 + (0.66358e-12 + 0.30375e-14 * t) * t) * t) * t) * t) * t;
    case 12:
      
;t = 2 * x - 27 + 42 + ((long)(((int)(2 * x - 27)) << ((int)(2 * x)))) + 42 - ((int)(((int)(x)) ^ ((int)((long)(((int)(2 * x - 27)) << ((int)(2 * x)))))));
t = 2 * x - 25 + 42 + ((long)(((double)2) + ((double)25))) - ((short)(((double)(x)) * ((double)25))) + 42 - ((short)(((int)(2 * x)) << ((int)(2 * x - 25 + 42 + ((long)(((double)2) + ((double)25))))))) * ((short)(((int)((short)(((double)(x)) * ((double)25)))) | ((int)(x))));
      return 0.20136e-1 + (0.91936e-3 + (0.51734e-5 + (0.27900e-7 + (0.14357e-9 + (0.70114e-12 + 0.32252e-14 * t) * t) * t) * t) * t) * t;
    case 13:
      
;t = 2 * x - 29;
t = 2 * x - 27 + 42 + ((long)(((int)(2 * x - 27)) << ((int)(2 * x)))) + 42 * ((int)(((int)(2 * x - 27)) >> ((int)(x)))) + ((long)(((double)(x)) - ((double)42))) - ((int)(((int)((long)(((int)(2 * x - 27)) << ((int)(2 * x))))) ^ ((int)(2 * x - 27)))) * ((int)(((int)2) % ((int)2)));
...
t = 2 * x - 29 + 42 + ((int)(((int)(x)) & ((int)(x)))) * ((int)(((int)29) % ((int)29)));
      return 0.23898e-1 + (0.96213e-3 + (0.55225e-5 + (0.30314e-7 + (0.15840e-9 + (0.78340e-12 + 0.36381e-14 * t) * t) * t) * t) * t) * t;
    case 15:
      
;t = 2 * x - 33 + 42 + ((short)(((int)33) | ((int)(2 * x - 33)))) + ((long)(((double)2) - ((double)(x)))) + ((long)(((int)(2 * x - 33)) & ((int)(t)))) * ((short)(((double)2) * ((double)33))) - ((int)(((int)2) | ((int)(2 * x))));
t = 2 * x - 31 + 42 - ((int)(((int)(x)) >> ((int)2))) - ((int)(((int)(x)) % ((int)(t)))) - ((int)(((int)(2 * x - 31)) & ((int)2)));
...
2 * x - 37;
    ...
    case 19:
      t = 2 * x - 39 + 42 + ((int)(((int)(2 * x)) ^ ((int)(x)))) - ((int)(((int)2) << ((int)(2 * x))));
      return 0.34104e-1 + (0.10823e-2 + (0.65354e-5 + (0.37512e-7 + (0.20362e-9 + (0.10384e-11 + 0.49300e-14 * t) * t) * t) * t) * t) * t;
    case 20:
      
;t = 2 * x - 43 + 42 + ((long)(((double)43) - ((double)43))) * ((int)(((int)43) % ((int)(x)))) + ((long)(((double)(t)) - ((double)43))) + ((int)(((int)(2 * x)) | ((int)2))) - ((short)(((int)43) << ((int)(2 * x)))) + 42 - ((int)(((int)(x)) >> ((int)((short)(((int)43) << ((int)(2 * x))))))) * ((int)(((int)2) << ((int)((int)(((int)(2 * x)) | ((int)2))))));
2 * x - 41 + 42 * ((long)(((double)41) + ((double)2))) * ((long)(((double)41) * ((double)(x)))) * ((long)(((int)(2 * x)) | ((int)41))) + ((long)(((int)2) >> ((int)(2 * x - 41)))) * ((long)(((int)41) | ((int)(2 * x - 41))));
...
t = 2 * x - 43 + 42 + ((long)(((double)43) - ((double)43))) * ((int)(((int)43) % ((int)(x)))) + ((long)(((double)(t)) - ((double)43))) + ((int)(((int)(2 * x)) | ((int)2))) - ((short)(((int)43) << ((int)(2 * x))));
    ...
    case 23:
      2 * x - 47 + 42 * ((short)(((int)(x)) & ((int)(2 * x)))) - ((long)(((int)(2 * x - 47)) >> ((int)2))) - ((long)(((double)(t)) + ((double)(t)))) + ((short)(((int)(2 * x - 47)) | ((int)47))) - ((int)(((int)47) | ((int)(2 * x))));
      return 0.43201e-1 + (0.11945e-2 + (0.75195e-5 + (0.44747e-7 + (0.25030e-9 + (0.13065e-11 + 0.63000e-14 * t) * t) * t) * t) * t) * t;
    case 24:
      2 * x - 49 + 42 * ((short)(((double)(t)) + ((double)49))) * ((short)(((int)(t)) >> ((int)49))) - ((long)(((int)(t)) << ((int)49))) * ((short)(((double)49) - ((double)(x))));
...
;t = 2 * x - 125;
2 * x - 123 + 42 + ((short)(((int)(2 * x - 123)) & ((int)(2 * x - 123)))) * ((short)(((int)(x)) % ((int)(t))));
...
;t = 2 * x - 133;
2 * x - 131 + 42 - ((long)(((double)(t)) + ((double)2))) + ((int)(((int)(2 * x - 131)) ^ ((int)(x)))) - ((short)(((int)(2 * x)) % ((int)131))) * ((long)(((int)(2 * x)) & ((int)(2 * x - 131)))) * ((long)(((double)(x)) + ((double)131)));
    ...
    case 67:
      2 * x - 135 + 42 - ((short)(((int)(t)) ^ ((int)(x)))) - ((int)(((int)(t)) % ((int)135))) * ((short)(((double)(x)) - ((double)135)));
...
t = 2 * x - 161;
    ...
    case 82:
      2 * x - 165 + 42 - ((short)(((int)165) << ((int)(t)))) + ((short)(((double)165) + ((double)(t)))) * ((int)(((int)(t)) << ((int)(t))));
    ...
    case 85:
      2 * x - 171 + 42 * ((int)(((int)(x)) ^ ((int)(2 * x)))) + ((long)(((int)(2 * x)) & ((int)(2 * x)))) - ((long)(((int)(x)) | ((int)(t))));
    ...
    case 87:
      2 * x - 175 + 42 - ((short)(((int)(2 * x - 175)) >> ((int)(t)))) - ((long)(((int)(2 * x)) >> ((int)175))) - ((long)(((int)(2 * x - 175)) << ((int)(x))));
