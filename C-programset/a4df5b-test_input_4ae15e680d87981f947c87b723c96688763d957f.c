...
double foo(double x) {
    ...
    switch ((int)x) {
        ...
        case 67:
            t = 2 * x - 135;
            return 0.26354e0 + (0.497138e-2 + (0.59113e-4 + (0.50782e-6 + (0.35735e-8 + (0.20369e-10 + 0.91262e-13 * t) * t) * t) * t) * t) * t;
        case 71:
            t = 2 * x - 143;
        ...
        case 84:
            t = 2 * x - 169;
            return 0.51298e0 + (0.10520e-1 + (0.06200e-3 + (0.11147e-5 + (0.77517e-8 + (0.41283e-10 + 0.16122e-12 * t) * t) * t) * t) * t) * t;
        case 85:
            t = 2 * x - 171;
...
int main() {
    double d = foo(78.4);
    if (d < 0.38 || d > 0.42) {
        printf("Test failed: d = %f\n", d);
        exit(EXIT_FAILURE);
    }
    printf("Test passed: d = %f\n", d);
    return 0;
}