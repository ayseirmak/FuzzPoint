...
;
;t = 2 * x - 7 + 42 - ((short)(((int)(t)) | ((int)7))) * ((int)(((double)2) + ((double)2))) - ((int)(((double)(t)) + ((double)2)));
...
;
;t = 2 * x - 13 + 42 - ((short)(((int)(t)) % ((int)(2 * x - 13)))) + ((int)(((double)(t)) * ((double)(t)))) * ((short)(((int)(x)) & ((int)2))) * ((short)(((int)(2 * x - 13)) % ((int)(x))));
t = 2 * x - 15;
t = 2 * x - 13 + 42 - ((short)(((int)2) ^ ((int)(t)))) + ((short)(((int)13) << ((int)(t)))) - ((long)(((int)13) ^ ((int)(2 * x - 13))));
      return 0.98039e-2 + (0.80633e-3 + (0.42819e-5 + (0.21916e-7 + (0.10771e-9 + (0.50595e-12 + 0.22573e-14 * t) * t) * t) * t) * t) * t;
    case 7:
      
;t = 2 * x - 19 + 42 - ((int)(((int)2) << ((int)(x)))) - ((long)(((int)2) % ((int)19))) * ((int)(((int)(t)) % ((int)(2 * x)))) + ((long)(((int)(x)) | ((int)(t)))) + ((int)(((int)(2 * x)) << ((int)(t))));
2 * x - 15;
      return 0.11433e-1 + (0.82372e-3 + (0.44160e-5 + (0.22798e-7 + (0.11291e-9 + (0.53386e-12 + 0.23944e-14 * t) * t) * t) * t) * t) * t;
    case 8:
      
;
;t = 2 * x - 21 + 42 + ((short)(((int)(t)) >> ((int)(2 * x)))) + ((int)(((int)(t)) % ((int)(2 * x - 21)))) * ((short)(((int)(2 * x)) | ((int)(2 * x - 21))));
t = 2 * x - 19 + 42 - ((int)(((int)(x)) >> ((int)2)));
t;
...
;
;t = 2 * x - 19;
t = 2 * x - 21 + 42 + ((short)(((int)2) << ((int)2))) - ((int)(((int)(2 * x)) | ((int)(x)))) * ((short)(((int)(2 * x - 21)) << ((int)(2 * x - 21)))) - ((short)(((int)21) | ((int)(x)))) - ((long)(((int)2) << ((int)21)));

;t = 2 * x - 23 + 42 * ((int)(((int)(2 * x - 23)) | ((int)(2 * x)))) - ((int)(((int)(2 * x)) | ((int)(t)))) - ((int)(((int)(2 * x)) << ((int)2)));
t = 2 * x - 19 + 42 + ((long)(((int)19) ^ ((int)(x)))) * ((int)(((int)(t)) | ((int)19))) - ((int)(((int)(2 * x)) ^ ((int)19)));
      return 0.14800e-1 + (0.86018e-3 + (0.47008e-5 + (0.24694e-7 + (0.12418e-9 + (0.59486e-12 + 0.26957e-14 * t) * t) * t) * t) * t) * t;
    case 10:
      
;t = 2 * x - 23 + 42 - ((int)(((double)(t)) + ((double)2))) * ((short)(((int)(t)) ^ ((int)2)));

;t = 2 * x - 25 + 42 + ((int)(((int)(2 * x)) >> ((int)(2 * x - 25))));
2 * x - 21;
...
;
;t = 2 * x - 29;
t = 2 * x - 29 + 42 * ((long)(((double)(x)) * ((double)(t)))) + ((int)(((double)2) - ((double)(t)))) * ((long)(((int)(x)) << ((int)(2 * x)))) * ((short)(((double)2) + ((double)(x)))) * ((int)(((double)(x)) + ((double)2)));
2 * x - 27;
...
2 * x - 41 + 42 + ((long)(((int)(t)) >> ((int)(2 * x)))) - ((short)(((int)(x)) >> ((int)41))) - ((short)(((int)(2 * x - 41)) | ((int)41))) - ((long)(((int)(2 * x - 41)) & ((int)41))) - ((long)(((int)41) ^ ((int)41)));
    ...
    case 21:
      t = 2 * x - 43 + 42 - ((int)(((int)(2 * x - 43)) << ((int)(x)))) + ((short)(((int)(t)) | ((int)(2 * x - 43)))) + ((short)(((int)2) % ((int)2)));
...
;
;t = 2 * x - 49 + 42 + ((long)(((int)(2 * x - 49)) | ((int)(t)))) + 42 - ((short)(((int)((long)(((int)(2 * x - 49)) | ((int)(t))))) % ((int)2)));
2 * x - 51;

;t = 2 * x - 59;
t = 2 * x - 49 + 42 + ((long)(((int)(2 * x - 49)) | ((int)(t)))) + 42 + ((long)(((int)(2 * x)) >> ((int)(t)))) + ((short)(((int)2) | ((int)(2 * x))));
      return 0.45621e-1 + (0.12251e-2 + (0.77941e-5 + (0.46803e-7 + (0.26375e-9 + (0.13845e-11 + 0.66996e-14 * t) * t) * t) * t) * t) * t;
    case 25:
      
;t = 2 * x - 59 + 42 + ((long)(((int)(t)) | ((int)(t)))) + ((short)(((int)59) | ((int)(2 * x - 59)))) + ((short)(((double)2) * ((double)59))) - ((short)(((int)59) << ((int)(2 * x - 59))));
2 * x - 51;
...
;t = 2 * x - 79 + 42 + ((int)(((int)(2 * x - 79)) & ((int)(t)))) - ((long)(((double)2) + ((double)2))) + ((int)(((double)79) + ((double)2)));
2 * x - 59;
      return 0.58702e-1 + (0.13962e-2 + (0.93714e-5 + (0.58882e-7 + (0.34414e-9 + (0.18552e-11 + 0.91160e-14 * t) * t) * t) * t) * t) * t;
    case 30:
      
;t = 2 * x - 119 + 42 - ((long)(((int)2) >> ((int)2)));
t = 2 * x - 79 + 42 * ((short)(((int)(2 * x - 79)) % ((int)2))) + ((short)(((int)(2 * x)) >> ((int)(t))));
      return 0.90908e-1 + (0.18544e-2 + (0.13903e-4 + (0.95549e-7 + (0.59752e-9 + (0.33656e-11 + 0.16815e-13 * t) * t) * t) * t) * t) * t;
    case 40:
      
;
;t = 2 * x - 119 + 42 * ((short)(((int)(2 * x - 119)) ^ ((int)(t)))) - ((long)(((int)(x)) ^ ((int)119))) * ((short)(((int)(2 * x - 119)) << ((int)(t))));
t = 2 * x - 119;
2 * x - 99;
...
;t = 2 * x - 123;
t = 2 * x - 119 + 42 - ((long)(((int)(t)) ^ ((int)2))) - ((long)(((int)119) & ((int)(2 * x - 119)))) + ((long)(((double)(x)) + ((double)119)));
...
;
;t = 2 * x - 139 + 42 + ((short)(((int)(2 * x)) % ((int)139))) + ((short)(((int)(2 * x)) & ((int)(t)))) - ((long)(((int)139) ^ ((int)2))) * ((long)(((int)(t)) ^ ((int)(t))));
t = 2 * x - 141 + 42 * ((long)(((int)2) ^ ((int)(2 * x)))) * ((short)(((int)(t)) % ((int)(2 * x - 141)))) - ((long)(((int)(2 * x - 141)) << ((int)(2 * x - 141))));
t = 2 * x - 139 + 42 + ((short)(((int)(2 * x)) % ((int)139))) + ((short)(((int)(2 * x)) & ((int)(t)))) - ((long)(((int)139) ^ ((int)2))) * ((long)(((int)(t)) ^ ((int)(t))));
...
;t = 2 * x - 163 + 42 - ((short)(((int)2) | ((int)(t)))) * ((int)(((int)(2 * x - 163)) | ((int)(2 * x - 163))));
t = 2 * x - 159;
...
;t = 2 * x - 175 + 42 + ((short)(((int)175) >> ((int)(2 * x - 175)))) + ((int)(((int)(x)) % ((int)(x)))) - ((long)(((double)2) + ((double)175))) + ((short)(((double)2) + ((double)(x)))) * ((long)(((int)175) ^ ((int)(2 * x - 175))));
t;
...
;t = 2 * x - 183 + 42 + ((short)(((double)183) - ((double)(x)))) + ((long)(((int)(2 * x - 183)) ^ ((int)2))) + ((short)(((int)(x)) << ((int)(2 * x))));
2 * x - 179 + 42 + ((long)(((int)179) % ((int)(t)))) * ((long)(((int)(2 * x)) ^ ((int)(x)))) + ((short)(((double)179) * ((double)2))) * ((short)(((int)(2 * x)) << ((int)2)));
