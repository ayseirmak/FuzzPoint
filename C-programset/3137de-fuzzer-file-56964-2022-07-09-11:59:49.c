...
foo (double x)
{
  ...
  switch ((int) x)
    {
    case 0:
      t = 2 * x - 1 + 42 * ((int)(((int)(t)) & ((int)(2 * x - 1))));
      return 0.70878e-3 + (0.71234e-3 + (0.35779e-5 + (0.17403e-7 + (0.81710e-10 + (0.36885e-12 + 0.15917e-14 * t) * t) * t) * t) * t) * t;
    case 1:
      t = 2 * x - 3 + 42 - ((int)(((double)(t)) * ((double)3))) + ((long)(((int)(t)) % ((int)(t)))) - ((long)(((int)(t)) & ((int)3))) + ((short)(((int)(t)) | ((int)(t)))) + ((long)(((int)(2 * x - 3)) | ((int)(2 * x - 3)))) + 42 * ((short)(((int)(2 * x - 3 + 42 - ((int)(((double)(t)) * ((double)3))) + ((long)(((int)(t)) % ((int)(t)))) - ((long)(((int)(t)) & ((int)3))) + ((short)(((int)(t)) | ((int)(t)))))) << ((int)(2 * x)))) - ((short)(((int)((int)(((double)(t)) * ((double)3)))) | ((int)((long)(((int)(t)) % ((int)(t))))))) + 42 - ((int)(((int)(2 * x)) ^ ((int)(2 * x - 3 + 42 - ((int)(((double)(t)) * ((double)3))) + ((long)(((int)(t)) % ((int)(t)))) - ((long)(((int)(t)) & ((int)3))))))) * ((long)(((int)(2 * x - 3 + 42 - ((int)(((double)(t)) * ((double)3))) + ((long)(((int)(t)) % ((int)(t)))) - ((long)(((int)(t)) & ((int)3))) + ((short)(((int)(t)) | ((int)(t)))))) << ((int)((short)(((int)(t)) | ((int)(t))))))) - ((long)(((int)(2 * x - 3 + 42)) ^ ((int)(2 * x - 3 + 42 - ((int)(((double)(t)) * ((double)3))) + ((long)(((int)(t)) % ((int)(t)))) - ((long)(((int)(t)) & ((int)3))))))) - ((short)(((int)((long)(((int)(t)) & ((int)3)))) % ((int)(x))));
    ...
    case 3:
      t = 2 * x - 7 + 42 + ((long)(((int)(2 * x - 7)) & ((int)(t)))) - ((long)(((int)2) ^ ((int)(2 * x - 7)))) + 42 * ((long)(((int)(2 * x - 7 + 42 + ((long)(((int)(2 * x - 7)) & ((int)(t)))))) >> ((int)((long)(((int)(2 * x - 7)) & ((int)(t))))))) + ((int)(((int)(2 * x - 7 + 42)) ^ ((int)((long)(((int)2) ^ ((int)(2 * x - 7))))))) + ((int)(((int)(x)) << ((int)(t)))) - ((int)(((int)((long)(((int)(2 * x - 7)) & ((int)(t))))) & ((int)(2 * x - 7 + 42 + ((long)(((int)(2 * x - 7)) & ((int)(t)))) - ((long)(((int)2) ^ ((int)(2 * x - 7)))))))) * ((int)(((int)(2 * x - 7 + 42 + ((long)(((int)(2 * x - 7)) & ((int)(t)))) - ((long)(((int)2) ^ ((int)(2 * x - 7)))))) & ((int)((long)(((int)(2 * x - 7)) & ((int)(t)))))));
    ...
    case 5:
      t = 2 * x - 11 + 42 * ((short)(((int)(2 * x)) ^ ((int)(2 * x)))) + 42 - ((int)(((int)(2 * x - 11 + 42 * ((short)(((int)(2 * x)) ^ ((int)(2 * x)))))) | ((int)(42 * ((short)(((int)(2 * x)) ^ ((int)(2 * x)))))))) - ((int)(((int)(2 * x)) ^ ((int)(2 * x - 11)))) + ((long)(((int)11) % ((int)(42 * ((short)(((int)(2 * x)) ^ ((int)(2 * x)))))))) + ((short)(((int)(x)) | ((int)11)));
      return 0.82082e-2 + (0.78946e-3 + (0.41529e-5 + (0.21074e-7 + (0.10278e-9 + (0.47965e-12 + 0.21285e-14 * t) * t) * t) * t) * t) * t;
    case 6:
      t = 2 * x - 13 + 42 - ((int)(((int)2) >> ((int)(2 * x)))) - ((short)(((int)(2 * x)) % ((int)(2 * x)))) + ((int)(((int)13) | ((int)(2 * x)))) * ((short)(((int)2) ^ ((int)(x)))) + ((long)(((double)(t)) + ((double)(x)))) + 42 - ((short)(((int)(2 * x)) ^ ((int)(x)))) + ((long)(((int)(2 * x - 13)) >> ((int)13))) - ((long)(((int)(2 * x - 13 + 42 - ((int)(((int)2) >> ((int)(2 * x)))))) | ((int)(x)))) + ((short)(((int)(2 * x - 13)) & ((int)(2 * x - 13 + 42 - ((int)(((int)2) >> ((int)(2 * x)))) - ((short)(((int)(2 * x)) % ((int)(2 * x)))) + ((int)(((int)13) | ((int)(2 * x)))) * ((short)(((int)2) ^ ((int)(x)))))))) - ((short)(((int)((short)(((int)(2 * x)) % ((int)(2 * x))))) >> ((int)(2 * x - 13 + 42 - ((int)(((int)2) >> ((int)(2 * x)))) - ((short)(((int)(2 * x)) % ((int)(2 * x)))) + ((int)(((int)13) | ((int)(2 * x)))) * ((short)(((int)2) ^ ((int)(x))))))));
      return 0.98039e-2 + (0.80633e-3 + (0.42819e-5 + (0.21916e-7 + (0.10771e-9 + (0.50595e-12 + 0.22573e-14 * t) * t) * t) * t) * t) * t;
    case 7:
      t = 2 * x - 15 + 42 * ((long)(((int)(2 * x)) << ((int)(x)))) - ((short)(((double)2) + ((double)(x)))) + ((int)(((double)(t)) * ((double)2))) + 42 - ((long)(((int)((short)(((double)2) + ((double)(x))))) ^ ((int)((int)(((double)(t)) * ((double)2))))));
      return 0.11433e-1 + (0.82372e-3 + (0.44160e-5 + (0.22798e-7 + (0.11291e-9 + (0.53386e-12 + 0.23944e-14 * t) * t) * t) * t) * t) * t;
    case 8:
      t = 2 * x - 17 + 42 * ((short)(((int)2) | ((int)17))) + 42 - ((short)(((int)(x)) | ((int)(t)))) * ((long)(((int)(42 * ((short)(((int)2) | ((int)17))))) << ((int)(2 * x)))) + ((int)(((double)(t)) * ((double)2)));
      return 0.13099e-1 + (0.84167e-3 + (0.45555e-5 + (0.23723e-7 + (0.11839e-9 + (0.56346e-12 + 0.25403e-14 * t) * t) * t) * t) * t) * t;
    case 9:
      t = 2 * x - 19 + 42 * ((short)(((int)(2 * x - 19)) ^ ((int)(t)))) + ((short)(((int)2) % ((int)(x)))) + ((long)(((int)(x)) >> ((int)(2 * x - 19)))) - ((long)(((int)(2 * x - 19)) << ((int)(t)))) + ((int)(((int)(2 * x - 19)) ^ ((int)(2 * x - 19))));
      return 0.14800e-1 + (0.86018e-3 + (0.47008e-5 + (0.24694e-7 + (0.12418e-9 + (0.59486e-12 + 0.26957e-14 * t) * t) * t) * t) * t) * t;
    case 10:
      t = 2 * x - 21 + 42 - ((long)(((double)(t)) - ((double)(t)))) * ((long)(((int)(2 * x)) ^ ((int)(2 * x)))) * ((int)(((int)2) | ((int)(2 * x)))) + ((short)(((int)(t)) >> ((int)(2 * x - 21)))) + 42 * ((int)(((int)(2 * x)) & ((int)21)));
      return 0.16540e-1 + (0.87928e-3 + (0.48520e-5 + (0.25711e-7 + (0.13030e-9 + (0.62820e-12 + 0.28612e-14 * t) * t) * t) * t) * t) * t;
    case 11:
      t = 2 * x - 23 + 42 - ((int)(((int)(t)) | ((int)(2 * x - 23)))) * ((long)(((int)(t)) % ((int)(t)))) * ((int)(((double)23) * ((double)(x)))) + ((short)(((int)2) % ((int)2)));
      return 0.18318e-1 + (0.89900e-3 + (0.50094e-5 + (0.26779e-7 + (0.13675e-9 + (0.66358e-12 + 0.30375e-14 * t) * t) * t) * t) * t) * t;
    case 12:
      t = 2 * x - 25 + 42 + ((long)(((double)(t)) + ((double)2))) - ((long)(((int)(t)) & ((int)(t)))) * ((int)(((int)(2 * x - 25)) | ((int)2))) + 42 + ((long)(((int)(2 * x)) & ((int)(t)))) - ((long)(((int)(((long)(((int)(t)) & ((int)(t)))) * ((int)(((int)(2 * x - 25)) | ((int)2))))) | ((int)(2 * x - 25 + 42 + ((long)(((double)(t)) + ((double)2))))))) + ((int)(((int)((long)(((double)(t)) + ((double)2)))) << ((int)(2 * x - 25))));
      return 0.20136e-1 + (0.91936e-3 + (0.51734e-5 + (0.27900e-7 + (0.14357e-9 + (0.70114e-12 + 0.32252e-14 * t) * t) * t) * t) * t) * t;
    case 13:
      t = 2 * x - 27 + 42 - ((short)(((double)(t)) - ((double)(x)))) + ((long)(((double)(x)) * ((double)27))) + ((int)(((double)(x)) * ((double)(x)))) - ((long)(((double)(x)) + ((double)2))) - ((long)(((int)2) % ((int)(t))));
      return 0.21996e-1 + (0.94040e-3 + (0.53443e-5 + (0.29078e-7 + (0.15078e-9 + (0.74103e-12 + 0.34251e-14 * t) * t) * t) * t) * t) * t;
    case 14:
      t = 2 * x - 29 + 42 - ((int)(((int)(x)) & ((int)(2 * x)))) * ((short)(((int)(x)) >> ((int)(2 * x)))) + 42 + ((short)(((int)(2 * x - 29 + 42 - ((int)(((int)(x)) & ((int)(2 * x)))) * ((short)(((int)(x)) >> ((int)(2 * x)))))) % ((int)29))) * ((int)(((int)(t)) % ((int)(2 * x)))) - ((long)(((int)(2 * x - 29)) << ((int)(x))));
      return 0.23898e-1 + (0.96213e-3 + (0.55225e-5 + (0.30314e-7 + (0.15840e-9 + (0.78340e-12 + 0.36381e-14 * t) * t) * t) * t) * t) * t;
    case 15:
      t = 2 * x - 31 + 42 - ((int)(((int)(x)) << ((int)(x))));
      return 0.25845e-1 + (0.98459e-3 + (0.57082e-5 + (0.31613e-7 + (0.16646e-9 + (0.82840e-12 + 0.38649e-14 * t) * t) * t) * t) * t) * t;
    case 16:
      t = 2 * x - 33 + 42 + ((long)(((int)2) << ((int)(2 * x)))) + 42 - ((int)(((int)((long)(((int)2) << ((int)(2 * x))))) >> ((int)42))) - ((long)(((double)33) - ((double)2))) - ((short)(((int)42) ^ ((int)(t))));
      return 0.27837e-1 + (0.10078e-2 + (0.59020e-5 + (0.32979e-7 + (0.17498e-9 + (0.87622e-12 + 0.41066e-14 * t) * t) * t) * t) * t) * t;
    case 17:
      t = 2 * x - 35 + 42 - ((int)(((int)(x)) | ((int)(x)))) - ((long)(((int)(2 * x - 35)) | ((int)(x)))) + 42 - ((int)(((double)2) + ((double)((int)(((int)(x)) | ((int)(x))))))) - ((short)(((int)(2 * x - 35 + 42 - ((int)(((int)(x)) | ((int)(x)))) - ((long)(((int)(2 * x - 35)) | ((int)(x)))))) >> ((int)(2 * x - 35))));
      return 0.29877e-1 + (0.10318e-2 + (0.61041e-5 + (0.34414e-7 + (0.18399e-9 + (0.92703e-12 + 0.43639e-14 * t) * t) * t) * t) * t) * t;
    case 18:
      t = 2 * x - 37 + 42 * ((int)(((int)(x)) | ((int)37))) + ((int)(((int)(x)) >> ((int)(2 * x))));
    ...
    case 21:
      t = 2 * x - 43 + 42 * ((int)(((int)(x)) ^ ((int)(x)))) * ((short)(((int)(t)) % ((int)(t))));
    ...
    case 23:
      t = 2 * x - 47 + 42 + ((long)(((int)(t)) | ((int)(t)))) - ((int)(((int)2) % ((int)(2 * x)))) + 42 - ((int)(((int)(2 * x - 47 + 42)) & ((int)(x)))) + ((int)(((int)(2 * x - 47 + 42)) >> ((int)(2 * x)))) + ((int)(((int)((int)(((int)2) % ((int)(2 * x))))) >> ((int)(2 * x))));
    ...
    case 25:
      t = 2 * x - 51 + 42 - ((short)(((int)(t)) & ((int)(2 * x)))) - ((long)(((int)(2 * x)) ^ ((int)(t)))) + ((short)(((int)51) << ((int)51))) + ((short)(((int)2) ^ ((int)51))) + ((short)(((double)51) - ((double)51))) + 42 * ((short)(((int)((short)(((int)51) << ((int)51)))) >> ((int)(2 * x - 51 + 42 - ((short)(((int)(t)) & ((int)(2 * x)))) - ((long)(((int)(2 * x)) ^ ((int)(t)))) + ((short)(((int)51) << ((int)51))))))) * ((long)(((int)(2 * x - 51 + 42 - ((short)(((int)(t)) & ((int)(2 * x)))) - ((long)(((int)(2 * x)) ^ ((int)(t)))))) | ((int)((short)(((int)51) << ((int)51))))));
    ...
    case 30:
      t = 2 * x - 79 + 42 - ((int)(((int)(x)) >> ((int)(2 * x - 79))));
      return 0.90908e-1 + (0.18544e-2 + (0.13903e-4 + (0.95549e-7 + (0.59752e-9 + (0.33656e-11 + 0.16815e-13 * t) * t) * t) * t) * t) * t;
    case 40:
      t = 2 * x - 99 + 42 + ((long)(((int)(t)) % ((int)(2 * x)))) + ((int)(((int)(2 * x - 99)) >> ((int)(2 * x)))) * ((short)(((int)(t)) >> ((int)(x)))) * ((long)(((int)2) << ((int)99)));
    ...
    case 60:
      t = 2 * x - 121 + 42 + ((long)(((int)2) % ((int)(2 * x)))) * ((int)(((double)121) * ((double)(t)))) - ((short)(((int)121) << ((int)(2 * x - 121))));
    ...
    case 62:
      t = 2 * x - 125 + 42 - ((long)(((double)2) - ((double)(t)))) + ((long)(((int)(t)) | ((int)2))) + ((int)(((int)(2 * x)) | ((int)(t)))) + ((short)(((int)2) % ((int)2)));
    ...
    case 66:
      t = 2 * x - 133 + 42 * ((long)(((int)(2 * x - 133)) ^ ((int)(x)))) + ((long)(((int)(x)) | ((int)(2 * x)))) + ((short)(((double)2) - ((double)(x))));
    ...
    case 70:
      t = 2 * x - 141 + 42 + ((int)(((int)(x)) << ((int)2)));
      return 0.29529e0 + (0.56288e-2 + (0.59113e-4 + (0.50782e-6 + (0.35735e-8 + (0.20369e-10 + 0.91262e-13 * t) * t) * t) * t) * t) * t;
    case 71:
      t = 2 * x - 143 + 42 - ((long)(((double)(x)) * ((double)(t)))) * ((long)(((int)(x)) << ((int)2))) * ((short)(((int)(2 * x)) % ((int)(2 * x)))) - ((long)(((int)(2 * x)) ^ ((int)(2 * x - 143)))) * ((long)(((int)143) % ((int)2)));
      return 0.30679e0 + (0.58714e-2 + (0.62248e-4 + (0.53724e-6 + (0.37827e-8 + (0.21490e-10 + 0.95513e-13 * t) * t) * t) * t) * t) * t;
    case 72:
      t = 2 * x - 145 + 42 + ((long)(((int)(x)) | ((int)(2 * x)))) + ((long)(((double)(t)) + ((double)(t))));
