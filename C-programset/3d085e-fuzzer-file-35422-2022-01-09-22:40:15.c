...
{
  a->d = 1.0 + 42 *((int)((((int)(a->d)) %((int)(1.0)))))+((int)((((double)(1.0)) -((double)(a->d)))))+((long)((((int)(a->d)) |((int)(1.0)))))-((long)((((double)(a->d)) +((double)(a->d)))))-((short)((((double)(1.0)) *((double)(a->d)))));
  return b->d + 1.0;
}
...
{
  union u a;
  a.x.d = 0.0 + 42 *((int)((((int)(a.x.d)) ^((int)(a.x.d)))));
  if (0)
    { abort (); }
  return 0;
}
