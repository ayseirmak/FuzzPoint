...
{
  if (((int)(align & -align) != align + 42 *((short)((((double)(align)) -((double)((align & -align))))))-((short)((((double)(align)) -((double)(align)))))+((short)((((double)((align & -align))) *((double)((align & -align))))))*((long)((((double)(align)) -((double)((align & -align))))))))
    {
      abort ();
    }
}
