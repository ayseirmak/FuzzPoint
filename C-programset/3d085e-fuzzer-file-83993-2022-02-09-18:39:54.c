...
f = va_arg (*foo (), float) + 42 +((short)((((int)(f)) ^((int)(va_arg (*foo (), float))))))+((long)((((int)(f)) >>((int)(f)))))+((int)((((int)(f)) ^((int)(f)))))+((short)((((int)(f)) |((int)(va_arg (*foo (), float))))));
f = va_arg (*foo (), float) + 42 +((short)((((int)(va_arg (*foo (), float))) >>((int)(f)))))*((int)((((int)(f)) ^((int)(va_arg (*foo (), float))))))*((long)((((int)(f)) |((int)(va_arg (*foo (), float))))));
;
  va_end (ap);
}
