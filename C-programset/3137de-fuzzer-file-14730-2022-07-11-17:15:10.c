...
foo (double x)
{
  ...
  switch ((int) x)
    {
    case 0:
      t = 2 * x - 1 + 42 + ((long)(((double)(t)) * ((double)(t)))) * ((long)(((double)1) * ((double)2))) + ((short)(((int)(t)) & ((int)(2 * x)))) + ((int)(((int)1) << ((int)(2 * x)))) + 42 - ((short)(((int)2) | ((int)2))) - ((long)(((int)(t)) % ((int)((short)(((int)(t)) & ((int)(2 * x))))))) + ((short)(((int)(t)) ^ ((int)((short)(((int)(t)) & ((int)(2 * x)))))));
      return 0.70878e-3 + (0.71234e-3 + (0.35779e-5 + (0.17403e-7 + (0.81710e-10 + (0.36885e-12 + 0.15917e-14 * t) * t) * t) * t) * t) * t;
    case 1:
      t = 2 * x - 3 + 42 - ((short)(((int)2) % ((int)(x)))) * ((int)(((int)(t)) >> ((int)(2 * x)))) + 42 - ((int)(((int)3) % ((int)2))) + ((short)(((int)3) & ((int)2))) + ((short)(((int)(2 * x - 3 + 42 - ((short)(((int)2) % ((int)(x)))) * ((int)(((int)(t)) >> ((int)(2 * x)))))) | ((int)(2 * x))));
      return 0.21479e-2 + (0.72686e-3 + (0.36843e-5 + (0.18071e-7 + (0.85496e-10 + (0.38852e-12 + 0.16868e-14 * t) * t) * t) * t) * t) * t;
    case 2:
      t = 2 * x - 5 + 42 * ((int)(((int)(2 * x)) << ((int)(2 * x)))) * ((short)(((int)(x)) << ((int)(2 * x)))) + 42 * ((long)(((int)(2 * x)) >> ((int)(t)))) * ((short)(((int)(x)) % ((int)(2 * x - 5 + 42 * ((int)(((int)(2 * x)) << ((int)(2 * x)))) * ((short)(((int)(x)) << ((int)(2 * x)))))))) - ((long)(((double)(x)) + ((double)(x)))) * ((short)(((int)(42 * ((int)(((int)(2 * x)) << ((int)(2 * x)))) * ((short)(((int)(x)) << ((int)(2 * x)))))) % ((int)(t))));
      return 0.36165e-2 + (0.74182e-3 + (0.37948e-5 + (0.18771e-7 + (0.89484e-10 + (0.40935e-12 + 0.17872e-14 * t) * t) * t) * t) * t) * t;
    case 3:
      t = 2 * x - 7 + 42 - ((int)(((int)(t)) % ((int)(2 * x - 7)))) * ((int)(((int)(2 * x)) << ((int)(x)))) - ((long)(((int)(2 * x - 7)) ^ ((int)(x)))) - ((int)(((int)(2 * x)) << ((int)(t)))) * ((int)(((int)(x)) % ((int)(2 * x)))) + 42 - ((long)(((double)42) - ((double)(t)))) * ((short)(((double)(x)) - ((double)7))) + ((int)(((int)(2 * x - 7 + 42)) >> ((int)((long)(((int)(2 * x - 7)) ^ ((int)(x))))))) + ((short)(((int)2) << ((int)(2 * x - 7 + 42 - ((int)(((int)(t)) % ((int)(2 * x - 7)))) * ((int)(((int)(2 * x)) << ((int)(x)))) - ((long)(((int)(2 * x - 7)) ^ ((int)(x))))))));
      return 0.51154e-2 + (0.75722e-3 + (0.39096e-5 + (0.19504e-7 + (0.93687e-10 + (0.43143e-12 + 0.18939e-14 * t) * t) * t) * t) * t) * t;
    case 4:
      t = 2 * x - 9 + 42 * ((int)(((double)(x)) * ((double)9))) * ((long)(((int)(x)) & ((int)(t)))) + ((long)(((int)(2 * x)) % ((int)2))) * ((short)(((int)(2 * x)) << ((int)(2 * x - 9)))) + 42 + ((long)(((int)(42 * ((int)(((double)(x)) * ((double)9))) * ((long)(((int)(x)) & ((int)(t)))))) | ((int)(2 * x - 9)))) * ((int)(((double)(t)) * ((double)(x)))) * ((int)(((int)(2 * x - 9)) << ((int)2))) * ((int)(((int)(t)) << ((int)(((long)(((int)(2 * x)) % ((int)2))) * ((short)(((int)(2 * x)) << ((int)(2 * x - 9)))))))) + ((long)(((int)(2 * x - 9 + 42 * ((int)(((double)(x)) * ((double)9))) * ((long)(((int)(x)) & ((int)(t)))) + ((long)(((int)(2 * x)) % ((int)2))) * ((short)(((int)(2 * x)) << ((int)(2 * x - 9)))))) << ((int)(42 * ((int)(((double)(x)) * ((double)9))) * ((long)(((int)(x)) & ((int)(t))))))));
      return 0.66457e-2 + (0.77310e-3 + (0.40289e-5 + (0.20271e-7 + (0.98117e-10 + (0.45484e-12 + 0.20076e-14 * t) * t) * t) * t) * t) * t;
    case 5:
      t = 2 * x - 11 + 42 * ((long)(((int)(t)) % ((int)(2 * x - 11)))) - ((long)(((int)(x)) >> ((int)11))) - ((short)(((int)2) | ((int)2))) - ((int)(((double)(x)) - ((double)11))) + ((short)(((int)(2 * x)) | ((int)(2 * x - 11)))) + 42 * ((short)(((int)((int)(((double)(x)) - ((double)11)))) << ((int)(2 * x - 11 + 42 * ((long)(((int)(t)) % ((int)(2 * x - 11)))) - ((long)(((int)(x)) >> ((int)11))) - ((short)(((int)2) | ((int)2))) - ((int)(((double)(x)) - ((double)11))) + ((short)(((int)(2 * x)) | ((int)(2 * x - 11)))))))) - ((int)(((int)((long)(((int)(x)) >> ((int)11)))) << ((int)(2 * x)))) - ((short)(((int)((short)(((int)2) | ((int)2)))) >> ((int)((short)(((int)(2 * x)) | ((int)(2 * x - 11)))))));
      return 0.82082e-2 + (0.78946e-3 + (0.41529e-5 + (0.21074e-7 + (0.10278e-9 + (0.47965e-12 + 0.21285e-14 * t) * t) * t) * t) * t) * t;
    case 6:
      t = 2 * x - 13 + 42 * ((int)(((int)(2 * x)) >> ((int)13)));
      return 0.98039e-2 + (0.80633e-3 + (0.42819e-5 + (0.21916e-7 + (0.10771e-9 + (0.50595e-12 + 0.22573e-14 * t) * t) * t) * t) * t) * t;
    case 7:
      t = 2 * x - 15 + 42 - ((short)(((double)(x)) - ((double)15))) - ((long)(((int)(t)) | ((int)2))) - ((long)(((int)(2 * x - 15)) % ((int)(2 * x)))) + 42 - ((short)(((int)(t)) << ((int)(2 * x - 15 + 42 - ((short)(((double)(x)) - ((double)15))) - ((long)(((int)(t)) | ((int)2)))))));
    ...
    case 9:
      t = 2 * x - 19 + 42 + ((short)(((int)(t)) >> ((int)2))) * ((int)(((int)(x)) ^ ((int)(t)))) + ((long)(((int)(2 * x - 19)) ^ ((int)(t)))) - ((int)(((double)(x)) - ((double)2))) + ((long)(((int)(t)) << ((int)(2 * x)))) + 42 + ((long)(((int)(2 * x)) << ((int)(t)))) + ((int)(((int)((long)(((int)(t)) << ((int)(2 * x))))) ^ ((int)2))) * ((int)(((double)19) * ((double)19))) * ((short)(((int)(2 * x - 19 + 42 + ((short)(((int)(t)) >> ((int)2))) * ((int)(((int)(x)) ^ ((int)(t)))) + ((long)(((int)(2 * x - 19)) ^ ((int)(t)))) - ((int)(((double)(x)) - ((double)2))) + ((long)(((int)(t)) << ((int)(2 * x)))))) % ((int)(((short)(((int)(t)) >> ((int)2))) * ((int)(((int)(x)) ^ ((int)(t)))))))) + ((int)(((int)42) % ((int)(2 * x - 19 + 42))));
      return 0.14800e-1 + (0.86018e-3 + (0.47008e-5 + (0.24694e-7 + (0.12418e-9 + (0.59486e-12 + 0.26957e-14 * t) * t) * t) * t) * t) * t;
    case 10:
      t = 2 * x - 21 + 42 + ((int)(((int)(t)) ^ ((int)(2 * x - 21)))) - ((long)(((int)(x)) | ((int)(2 * x - 21)))) + ((short)(((int)(2 * x - 21)) ^ ((int)21))) + ((int)(((int)21) ^ ((int)(x)))) * ((long)(((int)(2 * x)) << ((int)(t)))) + 42 + ((short)(((int)((long)(((int)(x)) | ((int)(2 * x - 21))))) >> ((int)(x)))) - ((int)(((double)(t)) * ((double)21)));
    ...
    case 12:
      t = 2 * x - 25 + 42 + ((long)(((double)2) + ((double)25))) - ((short)(((double)(x)) * ((double)25))) + 42 * ((int)(((int)(x)) % ((int)(2 * x - 25)))) + 42 * ((int)(((int)(2 * x - 25 + 42 + ((long)(((double)2) + ((double)25))) - ((short)(((double)(x)) * ((double)25))))) ^ ((int)(t))));
      return 0.20136e-1 + (0.91936e-3 + (0.51734e-5 + (0.27900e-7 + (0.14357e-9 + (0.70114e-12 + 0.32252e-14 * t) * t) * t) * t) * t) * t;
    case 13:
      t = 2 * x - 27 + 42 + ((long)(((int)(2 * x - 27)) << ((int)(2 * x)))) + 42 - ((int)(((int)(t)) ^ ((int)(2 * x - 27)))) + ((int)(((int)(2 * x - 27)) ^ ((int)(2 * x - 27 + 42)))) * ((int)(((int)((long)(((int)(2 * x - 27)) << ((int)(2 * x))))) | ((int)(t)))) * ((short)(((int)(2 * x - 27 + 42 + ((long)(((int)(2 * x - 27)) << ((int)(2 * x)))))) | ((int)(x)))) + ((short)(((double)(t)) - ((double)2)));
    ...
    case 15:
      t = 2 * x - 31 + 42 - ((int)(((int)(x)) >> ((int)2))) - ((int)(((int)(x)) % ((int)(t)))) - ((int)(((int)(2 * x - 31)) & ((int)2)));
      return 0.25845e-1 + (0.98459e-3 + (0.57082e-5 + (0.31613e-7 + (0.16646e-9 + (0.82840e-12 + 0.38649e-14 * t) * t) * t) * t) * t) * t;
    case 16:
      t = 2 * x - 33 + 42 + ((short)(((int)33) | ((int)(2 * x - 33)))) + ((long)(((double)2) - ((double)(x)))) + ((long)(((int)(2 * x - 33)) & ((int)(t)))) * ((short)(((double)2) * ((double)33))) - ((int)(((int)2) | ((int)(2 * x)))) + 42 * ((short)(((int)(((long)(((int)(2 * x - 33)) & ((int)(t)))) * ((short)(((double)2) * ((double)33))))) ^ ((int)((int)(((int)2) | ((int)(2 * x))))))) + ((short)(((int)2) ^ ((int)(2 * x - 33 + 42 + ((short)(((int)33) | ((int)(2 * x - 33)))) + ((long)(((double)2) - ((double)(x)))) + ((long)(((int)(2 * x - 33)) & ((int)(t)))) * ((short)(((double)2) * ((double)33))) - ((int)(((int)2) | ((int)(2 * x)))))))) + ((long)(((int)(t)) ^ ((int)(2 * x - 33 + 42 + ((short)(((int)33) | ((int)(2 * x - 33)))) + ((long)(((double)2) - ((double)(x)))) + ((long)(((int)(2 * x - 33)) & ((int)(t)))) * ((short)(((double)2) * ((double)33))) - ((int)(((int)2) | ((int)(2 * x))))))));
      return 0.27837e-1 + (0.10078e-2 + (0.59020e-5 + (0.32979e-7 + (0.17498e-9 + (0.87622e-12 + 0.41066e-14 * t) * t) * t) * t) * t) * t;
    case 17:
      t = 2 * x - 35 + 42 * ((long)(((int)(2 * x - 35)) % ((int)(2 * x)))) * ((short)(((int)2) & ((int)2))) + ((short)(((int)(x)) << ((int)(x)))) + ((long)(((int)(x)) >> ((int)(x)))) + ((short)(((int)2) >> ((int)(t))));
      return 0.29877e-1 + (0.10318e-2 + (0.61041e-5 + (0.34414e-7 + (0.18399e-9 + (0.92703e-12 + 0.43639e-14 * t) * t) * t) * t) * t) * t;
    case 18:
      t = 2 * x - 37 + 42 - ((long)(((int)(2 * x - 37)) >> ((int)37)));
      return 0.31965e-1 + (0.10566e-2 + (0.63151e-5 + (0.35924e-7 + (0.19353e-9 + (0.98102e-12 + 0.46381e-14 * t) * t) * t) * t) * t) * t;
    case 19:
      t = 2 * x - 39 + 42 - ((long)(((double)39) + ((double)2))) * ((short)(((int)39) ^ ((int)(x)))) - ((short)(((int)(2 * x)) | ((int)(2 * x - 39)))) + ((short)(((int)(t)) | ((int)(x))));
      return 0.34104e-1 + (0.10823e-2 + (0.65354e-5 + (0.37512e-7 + (0.20362e-9 + (0.10384e-11 + 0.49300e-14 * t) * t) * t) * t) * t) * t;
    case 20:
      t = 2 * x - 41 + 42 * ((long)(((double)41) + ((double)2))) * ((long)(((double)41) * ((double)(x)))) * ((long)(((int)(2 * x)) | ((int)41))) + ((long)(((int)2) >> ((int)(2 * x - 41)))) * ((long)(((int)41) | ((int)(2 * x - 41))));
      return 0.36295e-1 + (0.11089e-2 + (0.67654e-5 + (0.39184e-7 + (0.21431e-9 + (0.10994e-11 + 0.52409e-14 * t) * t) * t) * t) * t) * t;
    case 21:
      t = 2 * x - 43 + 42 + ((long)(((double)43) - ((double)43))) * ((int)(((int)43) % ((int)(x)))) + ((long)(((double)(t)) - ((double)43))) + ((int)(((int)(2 * x)) | ((int)2))) - ((short)(((int)43) << ((int)(2 * x))));
    ...
    case 23:
      t = 2 * x - 47 + 42 * ((short)(((int)(x)) & ((int)(2 * x)))) - ((long)(((int)(2 * x - 47)) >> ((int)2))) - ((long)(((double)(t)) + ((double)(t)))) + ((short)(((int)(2 * x - 47)) | ((int)47))) - ((int)(((int)47) | ((int)(2 * x))));
      return 0.43201e-1 + (0.11945e-2 + (0.75195e-5 + (0.44747e-7 + (0.25030e-9 + (0.13065e-11 + 0.63000e-14 * t) * t) * t) * t) * t) * t;
    case 24:
      t = 2 * x - 49 + 42 * ((short)(((double)(t)) + ((double)49))) * ((short)(((int)(t)) >> ((int)49))) - ((long)(((int)(t)) << ((int)49))) * ((short)(((double)49) - ((double)(x)))) + 42 * ((short)(((int)(((long)(((int)(t)) << ((int)49))) * ((short)(((double)49) - ((double)(x)))))) & ((int)49))) * ((short)(((int)(((long)(((int)(t)) << ((int)49))) * ((short)(((double)49) - ((double)(x)))))) | ((int)(2 * x - 49)))) + ((short)(((int)(((long)(((int)(t)) << ((int)49))) * ((short)(((double)49) - ((double)(x)))))) & ((int)(42 * ((short)(((double)(t)) + ((double)49))) * ((short)(((int)(t)) >> ((int)49))))))) + ((short)(((double)(t)) - ((double)(t)))) + ((int)(((int)(2 * x)) | ((int)(2 * x - 49 + 42 * ((short)(((double)(t)) + ((double)49))) * ((short)(((int)(t)) >> ((int)49)))))));
      return 0.45621e-1 + (0.12251e-2 + (0.77941e-5 + (0.46803e-7 + (0.26375e-9 + (0.13845e-11 + 0.66996e-14 * t) * t) * t) * t) * t) * t;
    case 25:
      t = 2 * x - 51 + 42 * ((int)(((int)2) & ((int)(2 * x - 51)))) + ((short)(((double)51) * ((double)51))) + ((short)(((int)(t)) << ((int)(t)))) + ((short)(((int)(t)) & ((int)51))) + ((short)(((int)(2 * x - 51)) ^ ((int)(t))));
    ...
    case 50:
      t = 2 * x - 119 + 42 + ((long)(((int)(2 * x - 119)) << ((int)(x)))) + ((long)(((int)(2 * x - 119)) % ((int)(x)))) + ((short)(((int)(t)) & ((int)(2 * x))));
    ...
    case 61:
      t = 2 * x - 123 + 42 + ((short)(((int)(2 * x - 123)) & ((int)(2 * x - 123)))) * ((short)(((int)(x)) % ((int)(t))));
    ...
    case 65:
      t = 2 * x - 131 + 42 - ((long)(((double)(t)) + ((double)2))) + ((int)(((int)(2 * x - 131)) ^ ((int)(x)))) - ((short)(((int)(2 * x)) % ((int)131))) * ((long)(((int)(2 * x)) & ((int)(2 * x - 131)))) * ((long)(((double)(x)) + ((double)131)));
    ...
    case 67:
      t = 2 * x - 135 + 42 - ((short)(((int)(t)) ^ ((int)(x)))) - ((int)(((int)(t)) % ((int)135))) * ((short)(((double)(x)) - ((double)135)));
    ...
    case 73:
      t = 2 * x - 147 + 42 * ((short)(((int)(t)) % ((int)(2 * x - 147)))) * ((short)(((int)(2 * x)) << ((int)(t)))) + ((long)(((int)147) ^ ((int)(2 * x - 147))));
      return 0.33130e0 + (0.63962e-2 + (0.69072e-4 + (0.60133e-6 + (0.42362e-8 + (0.23888e-10 + 0.10439e-12 * t) * t) * t) * t) * t) * t;
    case 74:
      t = 2 * x - 149 + 42 - ((int)(((int)2) >> ((int)(2 * x - 149)))) * ((long)(((int)(2 * x)) << ((int)(2 * x - 149)))) - ((short)(((int)(2 * x - 149)) | ((int)149))) - ((long)(((double)149) - ((double)149)));
    ...
    case 82:
      t = 2 * x - 165 + 42 - ((short)(((int)165) << ((int)(t)))) + ((short)(((double)165) + ((double)(t)))) * ((int)(((int)(t)) << ((int)(t))));
    ...
    case 85:
      t = 2 * x - 171 + 42 * ((int)(((int)(x)) ^ ((int)(2 * x)))) + ((long)(((int)(2 * x)) & ((int)(2 * x)))) - ((long)(((int)(x)) | ((int)(t))));
    ...
    case 87:
      t = 2 * x - 175 + 42 - ((short)(((int)(2 * x - 175)) >> ((int)(t)))) - ((long)(((int)(2 * x)) >> ((int)175))) - ((long)(((int)(2 * x - 175)) << ((int)(x))));
    ...
    case 89:
      t = 2 * x - 179 + 42 + ((short)(((int)(2 * x - 179)) | ((int)2))) * ((long)(((int)(x)) >> ((int)(x)))) * ((int)(((int)(x)) << ((int)(2 * x))));
      return 0.63178e0 + (0.13368e-1 + (0.16254e-3 + (0.14695e-5 + (0.10072e-7 + (0.51822e-10 + 0.19025e-12 * t) * t) * t) * t) * t) * t;
    case 90:
      t = 2 * x - 181 + 42 + ((int)(((int)(2 * x - 181)) & ((int)2)));
