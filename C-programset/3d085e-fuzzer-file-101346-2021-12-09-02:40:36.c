...
s += 12345 + 42 -((long)((((double)(s)) *((double)(12345)))))-((long)((((int)(12345)) |((int)(s)))))-((short)((((int)(12345)) %((int)(12345))))) + 42 -((short)((((int)(((long)((((int)(12345)) |((int)(s))))))) %((int)(12345 + 42 -((long)((((double)(s)) *((double)(12345)))))-((long)((((int)(12345)) |((int)(s))))))))));
s += 12345 + 42 -((long)((((double)(s)) *((double)(12345)))))-((long)((((int)(12345)) |((int)(s)))))-((short)((((int)(12345)) %((int)(12345))))) + 42 -((short)((((int)(((long)((((int)(12345)) |((int)(s))))))) %((int)(12345 + 42 -((long)((((double)(s)) *((double)(12345)))))-((long)((((int)(12345)) |((int)(s))))))))));
;
  return (s / 65536) % 2048;
}
