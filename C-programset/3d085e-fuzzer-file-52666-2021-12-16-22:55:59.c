...
int main (void)
{
  ...
  if (((int)__builtin_types_compatible_p (char *, int)
      ...
      || __builtin_types_compatible_p (char *, char **) + (34) *((int)((((int)(__builtin_types_compatible_p (char *, const char *))) |((int)(__builtin_types_compatible_p (typeof (dingos), typeof (cranberry)))))))-((int)((((int)(__builtin_types_compatible_p (char *, int)
      || __builtin_types_compatible_p (char *, const char *)
