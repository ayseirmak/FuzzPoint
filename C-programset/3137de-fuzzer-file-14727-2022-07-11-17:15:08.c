...
foo (double x)
{
  ...
  switch ((int) x)
    {
    case 0:
      t = 2 * x - 1 + 42 + ((long)(((double)(t)) * ((double)(t)))) * ((long)(((double)1) * ((double)2))) + ((short)(((int)(t)) & ((int)(2 * x)))) + ((int)(((int)1) << ((int)(2 * x))));
    ...
    case 5:
      t = 2 * x - 11 + 42 * ((long)(((int)(t)) % ((int)(2 * x - 11)))) - ((long)(((int)(x)) >> ((int)11))) - ((short)(((int)2) | ((int)2))) - ((int)(((double)(x)) - ((double)11))) + ((short)(((int)(2 * x)) | ((int)(2 * x - 11))));
