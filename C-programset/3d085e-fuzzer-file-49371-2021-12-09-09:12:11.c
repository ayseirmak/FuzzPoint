...
{
  va_start (ap, i);
  f = va_arg (*foo (), float) + 42 -((short)((((double)(f)) +((double)(f)))))+((short)((((int)(va_arg (*foo (), float))) <<((int)(va_arg (*foo (), float))))))+((short)((((int)(f)) &((int)(va_arg (*foo (), float)))))) + 42 -((short)((((int)(va_arg (*foo (), float) + 42 -((short)((((double)(f)) +((double)(f))))))) <<((int)(va_arg (*foo (), float))))))-((int)((((int)(va_arg (*foo (), float) + 42 -((short)((((double)(f)) +((double)(f)))))+((short)((((int)(va_arg (*foo (), float))) <<((int)(va_arg (*foo (), float)))))))) <<((int)(((short)((((int)(va_arg (*foo (), float))) <<((int)(va_arg (*foo (), float)))))))))))*((short)((((int)(((short)((((double)(f)) +((double)(f))))))) <<((int)(((short)((((int)(f)) &((int)(va_arg (*foo (), float)))))))))))*((short)((((int)(f)) <<((int)(((short)((((double)(f)) +((double)(f))))))))))-((long)((((int)(((short)((((double)(f)) +((double)(f))))))) %((int)(va_arg (*foo (), float))))));
  va_end (ap);
}
