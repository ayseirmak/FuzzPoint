...
t = 2 * x - 3 + 42 +((short)((((double)(x)) -((double)(2)))))*((int)((((int)(x)) <<((int)(2 * x - 3)))))-((long)((((int)(2 * x)) %((int)(x)))))*((int)((((double)(t)) *((double)(x)))));
t = 2 * x - 3 + 42 *((short)((((int)(t)) &((int)(3)))))-((int)((((int)(2 * x - 3)) |((int)(2 * x - 3)))));
;
...
t = 2 * x - 7 + 42 +((int)((((int)(7)) ^((int)(2 * x)))))+((short)((((int)(x)) >>((int)(x)))));
t = 2 * x - 7 + 42 *((long)((((double)(x)) *((double)(7)))))+((short)((((int)(2 * x)) ^((int)(2)))));
;
      return 0.51154e-2 + (0.75722e-3 + (0.39096e-5 + (0.19504e-7 + (0.93687e-10 + (0.43143e-12 + 0.18939e-14 * t) * t) * t) * t) * t) * t;
    case 4:
      
t = 2 * x - 9 + 42 *((int)((((int)(2)) &((int)(2)))))*((short)((((int)(2 * x)) |((int)(2 * x)))))+((short)((((double)(9)) -((double)(2)))));
t = 2 * x - 9 + 42 -((short)((((int)(2 * x)) ^((int)(2 * x - 9)))))-((int)((((int)(2)) <<((int)(2 * x - 9)))))-((long)((((int)(2 * x - 9)) >>((int)(t)))))+((int)((((int)(t)) >>((int)(2 * x)))));
;
      return 0.66457e-2 + (0.77310e-3 + (0.40289e-5 + (0.20271e-7 + (0.98117e-10 + (0.45484e-12 + 0.20076e-14 * t) * t) * t) * t) * t) * t;
    case 5:
      
t = 2 * x - 11 + 42 -((short)((((int)(2 * x - 11)) <<((int)(2 * x)))))+((int)((((int)(2 * x)) <<((int)(x)))));
t = 2 * x - 11 + 42 *((short)((((int)(t)) >>((int)(2 * x)))))*((short)((((int)(2)) <<((int)(2)))))+((int)((((int)(x)) %((int)(11)))))-((short)((((int)(2)) ^((int)(x)))))-((int)((((double)(11)) -((double)(x)))));
;
...
t = 2 * x - 17 + 42 *((short)((((double)(17)) -((double)(x)))))*((int)((((int)(2 * x)) ^((int)(t)))))+((int)((((int)(2 * x - 17)) ^((int)(17)))));
t = 2 * x - 17 + 42 +((int)((((double)(2)) *((double)(t)))))+((long)((((int)(2)) &((int)(17)))))*((int)((((int)(2 * x - 17)) |((int)(x)))))+((int)((((int)(2 * x)) ^((int)(2 * x - 17)))));
;
      return 0.13099e-1 + (0.84167e-3 + (0.45555e-5 + (0.23723e-7 + (0.11839e-9 + (0.56346e-12 + 0.25403e-14 * t) * t) * t) * t) * t) * t;
    case 9:
      
t = 2 * x - 19 + 42 -((long)((((int)(2 * x - 19)) |((int)(2)))))*((int)((((int)(2)) %((int)(2 * x)))))-((short)((((int)(2 * x - 19)) %((int)(2 * x)))));
t = 2 * x - 19 + 42 +((short)((((double)(19)) *((double)(2)))))-((short)((((int)(2 * x - 19)) %((int)(x)))))*((int)((((double)(x)) *((double)(19)))))-((long)((((int)(2 * x)) |((int)(t)))))*((int)((((int)(t)) ^((int)(2 * x - 19)))));
;
      return 0.14800e-1 + (0.86018e-3 + (0.47008e-5 + (0.24694e-7 + (0.12418e-9 + (0.59486e-12 + 0.26957e-14 * t) * t) * t) * t) * t) * t;
    case 10:
      
t = 2 * x - 21 + 42 *((int)((((double)(t)) -((double)(21)))))-((int)((((int)(x)) &((int)(x)))))+((long)((((double)(x)) *((double)(21)))))+((long)((((int)(t)) %((int)(t)))));
t = 2 * x - 21 + 42 -((short)((((int)(2 * x - 21)) <<((int)(2)))))-((short)((((double)(t)) +((double)(2)))))-((int)((((int)(t)) &((int)(2 * x - 21)))))*((int)((((double)(t)) +((double)(t)))))*((int)((((double)(21)) +((double)(t)))));
;
      return 0.16540e-1 + (0.87928e-3 + (0.48520e-5 + (0.25711e-7 + (0.13030e-9 + (0.62820e-12 + 0.28612e-14 * t) * t) * t) * t) * t) * t;
    case 11:
      
t = 2 * x - 23 + 42 +((long)((((int)(x)) &((int)(x)))))-((int)((((int)(2 * x)) &((int)(t)))))-((int)((((int)(x)) |((int)(23)))))-((long)((((int)(x)) |((int)(2 * x)))))+((long)((((int)(2 * x)) ^((int)(2)))));
t = 2 * x - 23 + 42 *((int)((((int)(x)) |((int)(2 * x - 23)))))-((long)((((int)(x)) &((int)(2 * x - 23)))))-((short)((((int)(2 * x)) <<((int)(2)))))+((int)((((int)(2 * x - 23)) %((int)(23)))))*((int)((((int)(t)) &((int)(23)))));
;
...
t = 2 * x - 27 + 42 *((long)((((int)(2)) |((int)(27)))))*((int)((((int)(2)) |((int)(x)))))*((long)((((int)(x)) %((int)(2)))))-((long)((((int)(2 * x - 27)) ^((int)(t)))))-((short)((((int)(2 * x - 27)) ^((int)(27)))));
t = 2 * x - 27 + 42 *((short)((((double)(27)) +((double)(t)))))-((short)((((int)(t)) ^((int)(27)))))-((int)((((int)(2 * x)) >>((int)(2 * x)))));
;
      return 0.21996e-1 + (0.94040e-3 + (0.53443e-5 + (0.29078e-7 + (0.15078e-9 + (0.74103e-12 + 0.34251e-14 * t) * t) * t) * t) * t) * t;
    case 14:
      
t = 2 * x - 29 + 42 *((short)((((int)(29)) >>((int)(t)))))+((long)((((int)(t)) %((int)(29)))))-((int)((((int)(2 * x)) |((int)(x)))))+((short)((((int)(2 * x - 29)) >>((int)(29)))))-((short)((((int)(t)) &((int)(2 * x - 29)))));
t = 2 * x - 29 + 42 -((int)((((int)(2)) %((int)(2 * x - 29)))));
;
      return 0.23898e-1 + (0.96213e-3 + (0.55225e-5 + (0.30314e-7 + (0.15840e-9 + (0.78340e-12 + 0.36381e-14 * t) * t) * t) * t) * t) * t;
    case 15:
      
t = 2 * x - 31 + 42 *((long)((((double)(x)) +((double)(31)))))-((short)((((double)(31)) *((double)(t)))));
t = 2 * x - 31 + 42 -((short)((((int)(x)) ^((int)(31)))))*((long)((((int)(2)) |((int)(31)))))+((short)((((int)(x)) ^((int)(2 * x - 31)))))+((short)((((int)(t)) >>((int)(2 * x - 31)))))+((int)((((double)(31)) *((double)(x)))));
;
...
t = 2 * x - 37 + 42 +((long)((((int)(x)) &((int)(2 * x)))));
t = 2 * x - 37 + 42 +((long)((((double)(t)) *((double)(x)))));
;
...
t = 2 * x - 41 + 42 +((long)((((int)(2 * x - 41)) <<((int)(41)))))+((int)((((int)(2 * x - 41)) ^((int)(t)))))+((long)((((int)(2 * x)) %((int)(41)))))*((int)((((double)(x)) *((double)(t)))))+((long)((((int)(41)) <<((int)(2 * x - 41)))));
t = 2 * x - 41 + 42 -((int)((((double)(t)) -((double)(2)))))*((short)((((int)(2 * x - 41)) &((int)(2 * x)))))-((int)((((int)(2 * x)) &((int)(2 * x - 41)))));
;
      return 0.36295e-1 + (0.11089e-2 + (0.67654e-5 + (0.39184e-7 + (0.21431e-9 + (0.10994e-11 + 0.52409e-14 * t) * t) * t) * t) * t) * t;
    case 21:
      
t = 2 * x - 43 + 42 +((short)((((int)(2)) %((int)(x)))));
t = 2 * x - 43 + 42 +((short)((((double)(2)) -((double)(x)))));
;
      return 0.38540e-1 + (0.11364e-2 + (0.70058e-5 + (0.40943e-7 + (0.22563e-9 + (0.11642e-11 + 0.55721e-14 * t) * t) * t) * t) * t) * t;
    case 22:
      
t = 2 * x - 45 + 42 -((int)((((int)(2 * x - 45)) >>((int)(x)))))-((int)((((double)(t)) -((double)(t)))))*((long)((((int)(2 * x - 45)) &((int)(2 * x - 45)))))-((long)((((int)(45)) |((int)(t)))))+((int)((((int)(2)) <<((int)(45)))));
t = 2 * x - 45 + 42 *((int)((((int)(2)) |((int)(x)))))+((int)((((int)(2 * x - 45)) %((int)(2)))))*((int)((((double)(45)) -((double)(2)))));
;
      return 0.40842e-1 + (0.11650e-2 + (0.72569e-5 + (0.42796e-7 + (0.23761e-9 + (0.12332e-11 + 0.59246e-14 * t) * t) * t) * t) * t) * t;
    case 23:
      
t = 2 * x - 47 + 42 +((int)((((int)(x)) >>((int)(47)))))+((int)((((int)(2 * x - 47)) |((int)(47)))))*((short)((((int)(x)) ^((int)(t)))));
t = 2 * x - 47 + 42 -((short)((((int)(t)) >>((int)(t)))))*((int)((((int)(2)) <<((int)(t)))))-((short)((((int)(2 * x - 47)) ^((int)(2 * x)))))*((int)((((int)(2 * x)) %((int)(2)))))*((long)((((double)(x)) +((double)(x)))));
;
...
t = 2 * x - 99 + 42 +((long)((((int)(2 * x - 99)) &((int)(2 * x)))))+((int)((((double)(t)) +((double)(t)))))-((long)((((int)(2 * x - 99)) |((int)(2 * x - 99)))))-((short)((((int)(99)) ^((int)(2 * x - 99)))))+((long)((((double)(99)) +((double)(99)))));
t = 2 * x - 99 + 42 +((int)((((int)(2 * x - 99)) &((int)(x)))))*((short)((((double)(2)) *((double)(2)))))-((int)((((int)(2 * x)) |((int)(99)))))-((short)((((int)(99)) |((int)(2 * x)))));
;
      return 0.13443e0 + (0.25474e-2 + (0.21385e-4 + (0.15996e-6 + (0.10585e-8 + (0.61258e-11 + 0.30412e-13 * t) * t) * t) * t) * t) * t;
    case 50:
      
t = 2 * x - 119 + 42 *((short)((((int)(2)) >>((int)(2 * x)))));
t = 2 * x - 119 + 42 +((long)((((double)(2)) *((double)(119)))));
;
...
t = 2 * x - 127 + 42 -((long)((((int)(2)) <<((int)(t)))));
t = 2 * x - 127 + 42 -((short)((((int)(2 * x - 127)) %((int)(t)))))-((long)((((int)(t)) |((int)(2 * x - 127)))))-((int)((((int)(2 * x - 127)) >>((int)(127)))));
;
...
t = 2 * x - 131 + 42 *((long)((((int)(t)) &((int)(2)))))+((long)((((int)(x)) >>((int)(x)))));
t = 2 * x - 131 + 42 *((short)((((double)(131)) +((double)(x)))))*((int)((((double)(t)) +((double)(t)))))-((short)((((int)(2)) %((int)(2 * x - 131)))));
;
      return 0.24444e0 + (0.45855e-2 + (0.45832e-4 + (0.38352e-6 + (0.26819e-8 + (0.15489e-10 + 0.71933e-13 * t) * t) * t) * t) * t) * t;
    case 66:
      
t = 2 * x - 133 + 42 +((int)((((int)(2)) %((int)(2 * x)))))-((short)((((int)(2)) ^((int)(133)))))+((int)((((int)(x)) <<((int)(2 * x)))));
t = 2 * x - 133 + 42 +((short)((((double)(x)) +((double)(2)))))-((int)((((int)(x)) |((int)(2 * x)))));
;
...
t = 2 * x - 139 + 42 +((int)((((int)(2 * x)) ^((int)(139)))))*((short)((((int)(t)) ^((int)(x)))));
t = 2 * x - 139 + 42 -((short)((((int)(t)) &((int)(2)))))-((int)((((double)(t)) *((double)(2)))))*((int)((((int)(139)) &((int)(2 * x - 139)))));
;
...
t = 2 * x - 143 + 42 -((int)((((int)(2 * x)) |((int)(x)))))-((int)((((int)(2 * x)) %((int)(143)))))+((short)((((double)(x)) +((double)(x)))))-((long)((((int)(2 * x - 143)) |((int)(143)))));
t = 2 * x - 143 + 42 -((long)((((int)(2 * x)) <<((int)(x)))))+((short)((((int)(2 * x - 143)) &((int)(t)))))*((short)((((int)(x)) <<((int)(2 * x - 143)))));
;
...
t = 2 * x - 149 + 42 +((int)((((int)(2 * x)) &((int)(149)))))*((int)((((int)(2 * x)) <<((int)(149)))))*((short)((((int)(t)) ^((int)(2)))));
t = 2 * x - 149 + 42 +((long)((((double)(x)) -((double)(x)))))-((int)((((int)(2 * x - 149)) >>((int)(t)))))+((long)((((int)(2 * x)) <<((int)(149)))))*((int)((((int)(2 * x)) %((int)(2 * x)))));
;
...
t = 2 * x - 155 + 42 *((short)((((int)(x)) >>((int)(155)))))*((short)((((int)(2 * x - 155)) ^((int)(2)))))*((short)((((int)(155)) >>((int)(t)))));
t = 2 * x - 155 + 42 +((long)((((int)(2 * x - 155)) &((int)(2 * x - 155)))))+((short)((((int)(t)) &((int)(2 * x - 155)))))+((short)((((double)(155)) +((double)(x)))))-((short)((((int)(2 * x)) ^((int)(2 * x)))));
;
...
t = 2 * x - 159 + 42 *((short)((((int)(2 * x)) >>((int)(2 * x)))))*((short)((((int)(159)) &((int)(2 * x)))))*((short)((((int)(x)) &((int)(159)))));
t = 2 * x - 159 + 42 *((long)((((int)(x)) <<((int)(2)))))*((int)((((int)(2)) |((int)(2 * x)))))-((short)((((int)(x)) ^((int)(2 * x)))))*((short)((((int)(2 * x - 159)) |((int)(2)))));
;
...
t = 2 * x - 163 + 42 +((short)((((int)(t)) ^((int)(x)))))*((int)((((int)(t)) %((int)(x)))))-((int)((((int)(x)) %((int)(x)))))-((int)((((int)(2 * x)) <<((int)(163)))))+((short)((((int)(2 * x - 163)) &((int)(x)))));
t = 2 * x - 163 + 42 *((short)((((double)(t)) -((double)(2)))))+((int)((((int)(2 * x)) >>((int)(2)))))+((int)((((double)(t)) +((double)(t)))));
;
...
t = 2 * x - 167 + 42 +((int)((((int)(2)) %((int)(x)))))*((int)((((int)(2 * x)) ^((int)(2 * x - 167)))))-((short)((((int)(2 * x)) |((int)(t)))))*((int)((((int)(167)) |((int)(167)))));
t = 2 * x - 167 + 42 *((int)((((int)(x)) ^((int)(2 * x)))))-((short)((((double)(2)) *((double)(t)))))+((long)((((int)(x)) >>((int)(2 * x - 167)))))-((short)((((double)(2)) *((double)(167)))));
;
...
t = 2 * x - 173 + 42 -((int)((((double)(t)) *((double)(173)))))+((int)((((int)(2 * x - 173)) &((int)(173)))))+((short)((((int)(2 * x)) |((int)(2 * x - 173)))))-((short)((((int)(173)) &((int)(2 * x - 173)))))+((short)((((double)(173)) +((double)(x)))));
t = 2 * x - 173 + 42 -((short)((((int)(2 * x - 173)) >>((int)(x)))))*((long)((((int)(2 * x - 173)) &((int)(t)))))+((short)((((int)(2)) ^((int)(2 * x)))));
;
      return 0.55712e0 + (0.11568e-1 + (0.13815e-3 + (0.12456e-5 + (0.86169e-8 + (0.45290e-10 + 0.17268e-12 * t) * t) * t) * t) * t) * t;
    case 87:
      
t = 2 * x - 175 + 42 -((short)((((int)(175)) >>((int)(t)))))-((int)((((double)(2)) -((double)(t)))))-((long)((((int)(t)) %((int)(2 * x - 175)))));
t = 2 * x - 175 + 42 -((short)((((double)(175)) +((double)(t)))))+((long)((((int)(2 * x - 175)) |((int)(t)))))-((long)((((int)(2 * x - 175)) >>((int)(175)))));
;
...
t = 2 * x - 183 + 42 +((short)((((int)(183)) >>((int)(2 * x - 183)))))+((int)((((int)(2 * x - 183)) &((int)(2)))));
t = 2 * x - 183 + 42 -((short)((((int)(2 * x - 183)) <<((int)(183)))))*((short)((((int)(183)) ^((int)(183)))));
;
...
t = 2 * x - 187 + 42 *((short)((((double)(2)) -((double)(x)))))*((long)((((int)(187)) ^((int)(2)))))*((long)((((int)(2)) |((int)(2)))))+((short)((((int)(2 * x)) ^((int)(2 * x - 187)))));
t = 2 * x - 187 + 42 *((int)((((double)(x)) *((double)(x)))))+((short)((((int)(t)) &((int)(2 * x)))))*((int)((((int)(2 * x - 187)) >>((int)(2)))))-((int)((((int)(2)) ^((int)(2 * x)))))+((int)((((int)(x)) %((int)(t)))));
;
