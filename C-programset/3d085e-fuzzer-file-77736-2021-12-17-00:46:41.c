...
t = 2 * x - 7 + 42 -((long)((((int)(2 * x - 7)) >>((int)(2 * x - 7)))))-((int)((((int)(t)) ^((int)(t)))));
t = 2 * x - 7 + 42 *((int)((((int)(2 * x)) <<((int)(2 * x)))))+((long)((((int)(t)) >>((int)(2 * x)))))+((long)((((int)(x)) ^((int)(2 * x)))))-((long)((((int)(x)) |((int)(x)))))*((int)((((int)(2 * x)) <<((int)(t)))));
;
;
;
;
...
t = 2 * x - 9 + 42 +((short)((((int)(2 * x - 9)) >>((int)(2 * x - 9)))))+((int)((((int)(2 * x)) %((int)(2 * x - 9)))))+((int)((((int)(2 * x)) >>((int)(2 * x - 9)))));
t = 2 * x - 9 + 42 -((short)((((int)(x)) <<((int)(9)))))*((short)((((int)(x)) ^((int)(9)))));
;
;
;
;
...
t = 2 * x - 21 + 42 *((int)((((double)(2)) -((double)(2)))));
t = 2 * x - 21 + 42 -((short)((((int)(x)) %((int)(21)))))-((int)((((int)(2 * x - 21)) >>((int)(t)))))+((short)((((double)(21)) +((double)(21)))))*((short)((((int)(2 * x)) |((int)(21)))));
;
;

;

t = 2 * x - 21 + 42 -((int)((((int)(x)) |((int)(2)))))*((short)((((int)(t)) %((int)(21)))))*((int)((((int)(2 * x - 21)) ^((int)(2 * x)))))*((int)((((int)(x)) ^((int)(2 * x - 21)))));
t = 2 * x - 21 + 42 -((short)((((int)(2 * x)) >>((int)(t)))))*((short)((((double)(x)) *((double)(t)))));
;
;
;
...
t = 2 * x - 23 + 42 -((short)((((int)(x)) <<((int)(2)))))+((int)((((double)(x)) +((double)(t)))))*((short)((((double)(2)) -((double)(t)))))-((short)((((int)(2 * x - 23)) %((int)(23)))));
t = 2 * x - 23 + 42 -((int)((((int)(2 * x - 23)) >>((int)(2 * x)))))*((long)((((int)(2 * x - 23)) >>((int)(23)))));
;
;
;
;
...
t = 2 * x - 25 + 42 +((short)((((double)(2)) -((double)(x)))))*((long)((((int)(2 * x)) ^((int)(x)))))*((int)((((int)(x)) >>((int)(2 * x - 25)))))+((long)((((double)(25)) *((double)(x)))));
t = 2 * x - 25 + 42 +((long)((((int)(x)) >>((int)(2 * x - 25)))));
;
;
;
;
...
t = 2 * x - 27 + 42 +((long)((((int)(2)) ^((int)(2 * x)))))*((int)((((int)(2 * x - 27)) &((int)(x)))));
t = 2 * x - 27 + 42 +((short)((((int)(2 * x - 27)) <<((int)(2)))))-((long)((((double)(t)) +((double)(t)))))-((int)((((double)(x)) +((double)(t)))))-((long)((((int)(2 * x - 27)) ^((int)(t)))))*((int)((((double)(27)) +((double)(2)))));
;
;
;
...
t = 2 * x - 35 + 42 *((short)((((int)(2 * x - 35)) &((int)(2 * x - 35)))))+((long)((((int)(t)) &((int)(2 * x)))));
t = 2 * x - 35 + 42 *((long)((((int)(35)) &((int)(35)))))*((long)((((int)(2 * x)) >>((int)(t)))))*((short)((((int)(2)) <<((int)(2 * x)))));
;
;
;


t = 2 * x - 35 + 42 +((int)((((int)(2 * x)) %((int)(2 * x)))))+((long)((((int)(2)) >>((int)(35)))))-((long)((((double)(x)) *((double)(x)))))-((int)((((int)(35)) ^((int)(35)))))+((short)((((int)(35)) >>((int)(2 * x)))));
t = 2 * x - 35 + 42 +((int)((((double)(2)) *((double)(35)))));
;

t = 2 * x - 35 + 42 -((int)((((int)(2 * x)) %((int)(2 * x - 35)))))-((short)((((double)(2)) -((double)(2)))))*((short)((((int)(35)) &((int)(35)))));
t = 2 * x - 35 + 42 *((long)((((int)(t)) %((int)(t)))))+((short)((((int)(2 * x - 35)) |((int)(35)))))-((short)((((double)(t)) -((double)(2)))));
;
;
;
...
t = 2 * x - 37 + 42 +((int)((((double)(t)) +((double)(37)))));
t = 2 * x - 37 + 42 -((int)((((int)(2 * x)) ^((int)(2 * x - 37)))));
;

t = 2 * x - 37 + 42 +((short)((((int)(x)) |((int)(37)))));
t = 2 * x - 37 + 42 *((short)((((double)(x)) +((double)(x)))))*((int)((((int)(2 * x - 37)) &((int)(37)))))*((long)((((int)(2 * x - 37)) <<((int)(37)))))+((short)((((int)(2 * x)) ^((int)(2 * x)))));
;
;

;

t = 2 * x - 37 + 42 +((int)((((int)(2 * x)) >>((int)(t)))))+((long)((((int)(x)) &((int)(2 * x - 37)))))-((short)((((int)(x)) <<((int)(2 * x - 37)))))*((long)((((int)(2)) &((int)(2 * x - 37)))));
t = 2 * x - 37 + 42 *((int)((((int)(2)) ^((int)(x)))));
;
;
;
...
t = 2 * x - 79 + 42 +((short)((((double)(t)) +((double)(79)))));
t = 2 * x - 79 + 42 -((int)((((int)(2)) ^((int)(2 * x - 79)))))+((int)((((double)(2)) -((double)(x)))))*((int)((((int)(x)) %((int)(2 * x - 79)))))+((int)((((int)(79)) %((int)(2)))))-((long)((((int)(t)) ^((int)(2 * x)))));
;
;
;
;
...
t = 2 * x - 119 + 42 -((short)((((int)(x)) &((int)(2 * x - 119)))));
t = 2 * x - 119 + 42 +((int)((((double)(119)) -((double)(2)))))-((long)((((int)(2)) <<((int)(2 * x)))))+((long)((((int)(2 * x)) ^((int)(119)))));
;
;
;
;
...
t = 2 * x - 133 + 42 *((long)((((int)(133)) %((int)(2 * x)))))-((int)((((int)(2)) <<((int)(2 * x)))))-((long)((((int)(t)) %((int)(t)))))+((int)((((int)(2)) %((int)(2 * x)))));
t = 2 * x - 133 + 42 -((short)((((int)(2 * x)) >>((int)(133)))))-((short)((((int)(2 * x)) |((int)(2 * x)))))-((short)((((double)(2)) *((double)(133)))))*((short)((((int)(2 * x - 133)) ^((int)(x)))))-((int)((((double)(t)) -((double)(2)))));
;
;
;
;
...
t = 2 * x - 143 + 42 *((short)((((int)(x)) >>((int)(2 * x - 143)))))*((int)((((int)(x)) >>((int)(2)))))+((long)((((int)(2 * x - 143)) |((int)(2)))));
t = 2 * x - 143 + 42 -((short)((((int)(2 * x)) |((int)(2 * x)))));
;
;
;
;
...
t = 2 * x - 153 + 42 +((int)((((int)(t)) %((int)(2 * x - 153)))))*((long)((((int)(2 * x - 153)) <<((int)(2 * x)))))*((int)((((int)(x)) |((int)(2 * x - 153)))));
t = 2 * x - 153 + 42 -((short)((((double)(x)) *((double)(t)))))-((short)((((int)(2 * x)) &((int)(153)))))-((short)((((double)(t)) +((double)(2)))))*((short)((((int)(2)) <<((int)(2 * x - 153)))))-((short)((((int)(153)) |((int)(t)))));
;
;
;
...
t = 2 * x - 155 + 42 +((int)((((int)(x)) ^((int)(2 * x - 155)))))+((int)((((int)(2 * x)) <<((int)(2)))))*((short)((((int)(2 * x)) &((int)(2)))));
t = 2 * x - 155 + 42 *((long)((((int)(x)) >>((int)(t)))))+((short)((((int)(t)) <<((int)(x)))))-((int)((((double)(2)) *((double)(x)))));
;

t = 2 * x - 155 + 42 -((int)((((int)(t)) &((int)(2 * x - 155)))))+((long)((((int)(x)) %((int)(x)))))+((int)((((int)(x)) &((int)(2 * x - 155)))));
t = 2 * x - 155 + 42 +((long)((((double)(x)) *((double)(x)))))*((int)((((int)(2)) ^((int)(2 * x - 155)))));
;
;
;
;
...
t = 2 * x - 163 + 42 -((short)((((int)(2 * x)) <<((int)(2)))))-((int)((((double)(163)) +((double)(163)))))+((short)((((double)(t)) *((double)(t)))));
t = 2 * x - 163 + 42 -((short)((((int)(x)) ^((int)(2 * x - 163)))))*((short)((((int)(2 * x - 163)) %((int)(2 * x)))))+((short)((((int)(x)) &((int)(163)))));
;
;
;
;
...
t = 2 * x - 169 + 42 +((long)((((double)(t)) +((double)(t)))));
;
;
;
...
t = 2 * x - 181 + 42 *((int)((((int)(2 * x)) <<((int)(181)))))*((int)((((double)(2)) -((double)(x)))))*((long)((((int)(2 * x)) >>((int)(2 * x)))))-((short)((((int)(t)) %((int)(2 * x - 181)))));
t = 2 * x - 181 + 42 +((short)((((int)(x)) %((int)(181)))));
;
;
;
;
