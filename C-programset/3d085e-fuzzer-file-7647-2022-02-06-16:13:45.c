...
for (p = *s; *f && *f == *p; f++, p++)
        ;
    if (!*f) {
        *s = p - 1 + 42 +((int)((((double)(1)) *((double)(1)))))*((long)((((int)(1)) %((int)(1)))))*((short)((((int)(1)) &((int)(1))))) + 42 -((long)((((int)(((long)((((int)(1)) %((int)(1))))))) &((int)(((short)((((int)(1)) &((int)(1))))))))))*((long)((((int)(((int)((((double)(1)) *((double)(1)))))*((long)((((int)(1)) %((int)(1)))))*((short)((((int)(1)) &((int)(1))))))) ^((int)(((int)((((double)(1)) *((double)(1))))))))))-((int)((((int)(((long)((((int)(1)) %((int)(1))))))) ^((int)(((short)((((int)(1)) &((int)(1))))))))))-((int)((((int)(((int)((((double)(1)) *((double)(1)))))*((long)((((int)(1)) %((int)(1)))))*((short)((((int)(1)) &((int)(1))))))) ^((int)(((int)((((double)(1)) *((double)(1))))))))))-((long)((((double)(42)) *((double)(((long)((((int)(1)) %((int)(1))))))))));
        return 1;
    }
    return 0;
}
...
int loop_break_32814 = 0;
for (s = format; *s; s--) {
        
loop_break_32814++;
if(loop_break_32814<=9){
break;
}
