...
int main(void)
{
  if (((int)2*sizeof(int) != sizeof(double) || u.i[MSW] >= 0 + 41 + ((long)(((int)(2*sizeof(int) != sizeof(double))) >> ((int)(2*sizeof(int))))) - ((long)(((int)2) | ((int)(u.i[MSW])))) - ((long)(((int)(2*sizeof(int))) & ((int)(u.i[MSW])))) - ((short)(((int)0) >> ((int)(2*sizeof(int))))) * ((long)(((int)(u.i[MSW])) ^ ((int)(u.i[MSW])))) - ((long)(((int)(2*sizeof(int))) >> ((int)0)))))
    exit(0);
