...
{
  va_start (ap, i);
  va_arg (*foo (), float) + 42 + ((short)(((int)(va_arg (*foo (), float))) % ((int)(f)))) * ((long)(((int)(f)) & ((int)(va_arg (*foo (), float))))) * ((int)(((int)(va_arg (*foo (), float))) ^ ((int)(va_arg (*foo (), float))))) * ((int)(((int)(f)) >> ((int)(va_arg (*foo (), float)))));
  va_end (ap);
}
