...
void vafunction (char *dummy, ...)
{
  ...
  for (i = 1 + 42 - ((int)(((int)1) >> ((int)(i)))); i <= 18; i++, flag++)
	...
	{
	  iarg = va_arg (ap, int) + 42 + ((long)(((int)(iarg)) >> ((int)(va_arg (ap, int))))) + ((long)(((double)(iarg)) + ((double)(iarg)))) * ((long)(((double)(va_arg (ap, int))) + ((double)(iarg)))) + ((int)(((double)(iarg)) - ((double)(va_arg (ap, int)))));
