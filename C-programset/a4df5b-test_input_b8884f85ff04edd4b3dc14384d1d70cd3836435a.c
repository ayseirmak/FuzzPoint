...
void movi(void) {
    ...
    pll(0xabcdU);
    pll(0xabcd0000U);
    pll(0xabcd00000000ULL);
    pll(0xabcd000000000000ULL);
    pll(0xffffabcdU);
    pll(0xabcdffffU);
    pll(0xffffffffffffabcdULL);
    pll(0xffffffffabcdffffULL);
    pll(0xffffabcdffffffffULL);
    pll(0xabcdffffffffffffULL);
    pll(0xaaaaaaaaU);
    pll(0x5555555555555555ULL);
    pll(0x77777777U);
    pll(0x3333333333333333ULL);
    pll(0xf8f8f8f8U);
    pll(0x1e1e1e1e1e1e1e1eULL);
    pll(0x3f803f80U);
    pll(0x01ff01ff01ff01ffULL);
    pll(0x007fffc0U);
    pll(0x03fff80003fff800ULL);
    pll(0x0007fffffffffe00ULL);

    pll(0xabcd1234U);
    pll(0xabcd00001234U);
    pll(0xabcd000000001234ULL);
    pll(0xabcd12340000U);
    pll(0xabcd000012340000U);
    pll(0xabcd123400000000ULL);
    pll(0xffffffffabcd1234U);
    pll(0xffffabcdffff1234U);
    pll(0xabcdffffffff1234ULL);
    pll(0xffffabcd1234ffffU);
    pll(0xabcdffff1234ffffU);
    pll(0xabcd1234ffffffffULL);

    pll(0xffffef0123456789ULL);
    pll(0xabcdef012345ffffULL);
