...
;t = 2 * x - 15 + 42 - ((int)(((int)(t)) >> ((int)(x))));
2 * x - 13 + 42 + ((int)(((int)2) & ((int)(t)))) - ((int)(((int)(2 * x - 13)) << ((int)2))) + ((long)(((int)(t)) % ((int)(t)))) + ((int)(((int)(2 * x - 13)) & ((int)(2 * x - 13))));
      return 0.98039e-2 + (0.80633e-3 + (0.42819e-5 + (0.21916e-7 + (0.10771e-9 + (0.50595e-12 + 0.22573e-14 * t) * t) * t) * t) * t) * t;
    case 7:
      2 * x - 15 + 42 - ((long)(((int)2) ^ ((int)(2 * x)))) + ((short)(((double)(t)) * ((double)(x))));
...
;2 * x - 25 + 42 * ((short)(((double)2) * ((double)(x)))) - ((int)(((int)25) >> ((int)(2 * x)))) - ((long)(((int)25) << ((int)(2 * x - 25)))) * ((short)(((int)(2 * x)) | ((int)(2 * x - 25)))) + ((long)(((int)(x)) | ((int)25)));
t;
...
;2 * x - 33 + 42 * ((long)(((double)2) + ((double)(t)))) + ((short)(((int)(2 * x)) & ((int)(2 * x)))) + ((short)(((int)(2 * x)) % ((int)(2 * x))));
2 * x - 31;
...
;2 * x - 59;
2 * x - 51 + 42 + ((int)(((double)51) * ((double)(x)))) * ((short)(((int)51) >> ((int)51))) * ((long)(((int)51) % ((int)(2 * x - 51)))) * ((int)(((int)51) << ((int)51))) * ((short)(((int)(x)) << ((int)(t))));
...
;t = 2 * x - 165 + 42 + ((int)(((double)165) + ((double)2))) + ((long)(((int)(x)) >> ((int)(t))));
2 * x - 163 + 42 * ((int)(((int)(t)) >> ((int)(2 * x)))) * ((int)(((double)2) * ((double)(t))));
