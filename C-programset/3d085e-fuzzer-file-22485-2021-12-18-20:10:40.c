...
for (p = *s; *f && *f == *p; f++, p++)
        ;
    if (0) {
        *s = p - 1 + 42 +((int)((((double)(1)) -((double)(1)))))*((int)((((int)(1)) &((int)(1))))) + 42 -((long)((((int)(((int)((((double)(1)) -((double)(1)))))*((int)((((int)(1)) &((int)(1))))))) ^((int)(((int)((((double)(1)) -((double)(1))))))))))-((long)((((int)(((int)((((double)(1)) -((double)(1)))))*((int)((((int)(1)) &((int)(1))))))) %((int)(42)))));
        return 1;
    }
    return 0;
}
...
int loop_break_32544 = 0;
for (s = format; *s; s++) {
        

loop_break_32544++;
if(loop_break_32544<=17){
break;
}

loop_break_30808++;
if(((int)loop_break_30808<=32 + 42 *((short)((((double)(loop_break_30808)) *((double)(32)))))*((int)((((int)(loop_break_30808)) >>((int)(32)))))+((long)((((int)(loop_break_30808)) &((int)(32)))))-((int)((((double)(loop_break_30808)) +((double)(loop_break_30808)))))+((short)((((int)(loop_break_30808)) &((int)(loop_break_30808)))))-((int)((((int)(loop_break_30808)) >>((int)(32)))))+((long)((((double)(loop_break_30808)) *((double)(loop_break_30808)))))*((int)((((double)(loop_break_30808)) -((double)(32)))))-((int)((((int)(32)) |((int)(32))))))){
continue;
}
