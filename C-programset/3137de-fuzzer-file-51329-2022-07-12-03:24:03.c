...
foo (double x)
{
  ...
  switch ((int) x)
    ...
    case 2:
      t = 2 * x - 5 + 42 * ((int)(((int)(2 * x)) >> ((int)(2 * x))));
    ...
    case 10:
      t = 2 * x - 21 + 42 + ((int)(((double)(x)) - ((double)2))) + ((long)(((int)(2 * x - 21)) << ((int)(t)))) - ((short)(((int)(t)) ^ ((int)(2 * x - 21)))) + ((short)(((int)21) >> ((int)21)));
      return 0.16540e-1 + (0.87928e-3 + (0.48520e-5 + (0.25711e-7 + (0.13030e-9 + (0.62820e-12 + 0.28612e-14 * t) * t) * t) * t) * t) * t;
    case 11:
      t = 2 * x - 23 + 42 - ((long)(((int)(2 * x)) % ((int)(2 * x)))) * ((short)(((double)2) + ((double)2))) * ((long)(((int)(2 * x - 23)) << ((int)2))) + ((short)(((int)(2 * x - 23)) ^ ((int)(t)))) * ((short)(((int)23) ^ ((int)(2 * x - 23))));
    ...
    case 18:
      t = 2 * x - 37 + 42 + ((int)(((double)(x)) * ((double)2))) + ((int)(((double)(t)) * ((double)37)));
    ...
    case 40:
      t = 2 * x - 99 + 42 * ((int)(((double)99) + ((double)99))) - ((long)(((int)(2 * x - 99)) << ((int)(x)))) - ((short)(((int)(t)) ^ ((int)(x)))) - ((short)(((int)2) & ((int)(t))));
    ...
    case 60:
      t = 2 * x - 121 + 42 - ((int)(((int)(2 * x - 121)) % ((int)(2 * x)))) + ((short)(((int)121) % ((int)(2 * x - 121)))) * ((long)(((double)(t)) - ((double)2))) * ((short)(((int)(2 * x)) | ((int)(x)))) - ((int)(((int)(x)) | ((int)121)));
      return 0.20281e0 + (0.37739e-2 + (0.35791e-4 + (0.29038e-6 + (0.20068e-8 + (0.11673e-10 + 0.55790e-13 * t) * t) * t) * t) * t) * t;
    case 61:
      t = 2 * x - 123 + 42 * ((short)(((double)2) * ((double)(t)))) * ((int)(((double)(t)) - ((double)(x)))) * ((short)(((int)(2 * x - 123)) << ((int)(2 * x))));
    ...
    case 67:
      t = 2 * x - 135 + 42 - ((int)(((double)135) + ((double)2)));
    ...
    case 71:
      t = 2 * x - 143 + 42 * ((long)(((int)(2 * x)) % ((int)2))) * ((long)(((int)(2 * x - 143)) | ((int)143))) + ((long)(((double)(t)) + ((double)143))) + ((int)(((double)(x)) * ((double)2)));
      return 0.30679e0 + (0.58714e-2 + (0.62248e-4 + (0.53724e-6 + (0.37827e-8 + (0.21490e-10 + 0.95513e-13 * t) * t) * t) * t) * t) * t;
    case 72:
      t = 2 * x - 145 + 42 * ((int)(((int)145) >> ((int)(2 * x)))) * ((short)(((int)145) >> ((int)(2 * x))));
    ...
    case 77:
      t = 2 * x - 155 + 42 + ((short)(((int)155) ^ ((int)(2 * x - 155)))) - ((int)(((int)155) % ((int)2)));
    ...
    case 84:
      t = 2 * x - 169 + 42 + ((short)(((int)(2 * x - 169)) | ((int)(2 * x)))) - ((long)(((int)169) | ((int)(2 * x)))) + ((int)(((int)2) << ((int)(2 * x - 169))));
      return 0.51298e0 + (0.10520e-1 + (0.12400e-3 + (0.11147e-5 + (0.77517e-8 + (0.41283e-10 + 0.16122e-12 * t) * t) * t) * t) * t) * t;
    case 85:
      t = 2 * x - 171 + 42 + ((long)(((int)(x)) | ((int)2)));
    ...
    case 88:
      t = 2 * x - 177 + 42 * ((short)(((double)2) + ((double)2))) * ((long)(((double)(t)) + ((double)(x)))) - ((short)(((int)(2 * x)) ^ ((int)177)));
