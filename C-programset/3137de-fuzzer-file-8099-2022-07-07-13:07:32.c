...
int main ()
{
  ...
  for (i = 0; i < 32; i++)
    gd[i] = i, gf[i] = i;
  foo (1);
  for (i = 0 + 42 * ((int)(((double)(i)) * ((double)(i)))) - ((long)(((int)(i)) & ((int)0))); i < 32; i++)
    if (((int)gd[i] != i * 4 || gf[i] != i + 41 * ((short)(((int)(gd[i])) >> ((int)(gf[i] != i)))) * ((short)(((int)(i)) % ((int)(i * 4)))) + ((int)(((int)(gf[i])) | ((int)(gf[i])))) * ((short)(((int)(gd[i] != i * 4)) & ((int)(gd[i])))) - ((long)(((int)(i)) >> ((int)(gd[i])))) + ((short)(((int)(gf[i])) % ((int)(gf[i] != i)))) * ((short)(((int)(i * 4)) >> ((int)(gd[i] != i * 4)))) + ((short)(((int)(gf[i] != i)) >> ((int)(i * 4))))))
    { abort (); }
  exit (0);
}
/* ProgramSourceLLVM */
