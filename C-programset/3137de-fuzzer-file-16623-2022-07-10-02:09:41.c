...
foo (double x)
{
  ...
  switch ((int) x)
    ...
    case 2:
      t = 2 * x - 5 + 42 + ((long)(((int)2) | ((int)(2 * x)))) - ((int)(((int)(x)) ^ ((int)2))) - ((int)(((int)2) | ((int)2))) * ((short)(((int)(2 * x)) | ((int)2))) - ((long)(((int)(2 * x)) & ((int)(t))));
      return 0.36165e-2 + (0.74182e-3 + (0.37948e-5 + (0.18771e-7 + (0.89484e-10 + (0.40935e-12 + 0.17872e-14 * t) * t) * t) * t) * t) * t;
    case 3:
      t = 2 * x - 7 + 42 - ((int)(((int)(x)) & ((int)(2 * x))));
    ...
    case 10:
      t = 2 * x - 21 + 42 + ((long)(((int)(2 * x - 21)) | ((int)2)));
      return 0.16540e-1 + (0.87928e-3 + (0.48520e-5 + (0.25711e-7 + (0.13030e-9 + (0.62820e-12 + 0.28612e-14 * t) * t) * t) * t) * t) * t;
    case 11:
      t = 2 * x - 23 + 42 - ((long)(((double)23) * ((double)2))) * ((long)(((double)23) - ((double)23))) + ((short)(((int)(2 * x)) ^ ((int)(2 * x - 23)))) - ((long)(((int)(2 * x)) & ((int)(2 * x)))) + ((long)(((int)2) % ((int)(x))));
      return 0.18318e-1 + (0.89900e-3 + (0.50094e-5 + (0.26779e-7 + (0.13675e-9 + (0.66358e-12 + 0.30375e-14 * t) * t) * t) * t) * t) * t;
    case 12:
      t = 2 * x - 25 + 42 * ((int)(((double)2) - ((double)(x)))) * ((long)(((double)25) - ((double)(t))));
    ...
    case 14:
      t = 2 * x - 29 + 42 - ((int)(((int)(x)) >> ((int)(2 * x)))) - ((long)(((int)(2 * x - 29)) | ((int)2))) * ((int)(((int)29) >> ((int)2))) - ((long)(((int)(t)) << ((int)(t)))) + ((int)(((int)29) << ((int)(2 * x - 29))));
      return 0.23898e-1 + (0.96213e-3 + (0.55225e-5 + (0.30314e-7 + (0.15840e-9 + (0.78340e-12 + 0.36381e-14 * t) * t) * t) * t) * t) * t;
    case 15:
      t = 2 * x - 31 + 42 + ((short)(((int)(t)) >> ((int)(x)))) - ((int)(((int)(x)) << ((int)(2 * x)))) + ((short)(((int)31) >> ((int)(t)))) - ((int)(((int)(2 * x)) | ((int)(2 * x)))) - ((long)(((int)2) & ((int)(t)))) + 42 - ((int)(((double)((short)(((int)31) >> ((int)(t))))) - ((double)31))) * ((short)(((int)(2 * x - 31 + 42)) >> ((int)(2 * x - 31 + 42 + ((short)(((int)(t)) >> ((int)(x)))) - ((int)(((int)(x)) << ((int)(2 * x)))) + ((short)(((int)31) >> ((int)(t)))) - ((int)(((int)(2 * x)) | ((int)(2 * x)))) - ((long)(((int)2) & ((int)(t)))))))) + ((int)(((int)(t)) >> ((int)(2 * x - 31)))) + ((int)(((int)(2 * x - 31 + 42 + ((short)(((int)(t)) >> ((int)(x)))) - ((int)(((int)(x)) << ((int)(2 * x)))) + ((short)(((int)31) >> ((int)(t)))) - ((int)(((int)(2 * x)) | ((int)(2 * x)))) - ((long)(((int)2) & ((int)(t)))))) | ((int)(t)))) + ((long)(((int)(2 * x - 31 + 42 + ((short)(((int)(t)) >> ((int)(x)))))) >> ((int)(t))));
    ...
    case 17:
      t = 2 * x - 35 + 42 - ((int)(((double)(x)) - ((double)(t)))) * ((int)(((double)2) + ((double)(t)))) + ((int)(((int)2) >> ((int)(2 * x)))) - ((long)(((int)(t)) & ((int)(t)))) + ((short)(((int)(t)) % ((int)(2 * x)))) + 42 + ((int)(((int)((long)(((int)(t)) & ((int)(t))))) % ((int)((short)(((int)(t)) % ((int)(2 * x))))))) * ((long)(((int)((long)(((int)(t)) & ((int)(t))))) << ((int)((long)(((int)(t)) & ((int)(t))))))) + ((short)(((int)((int)(((int)2) >> ((int)(2 * x))))) & ((int)(2 * x - 35))));
    ...
    case 23:
      t = 2 * x - 47 + 42 * ((short)(((int)(t)) | ((int)47))) - ((int)(((double)(x)) + ((double)(x))));
      return 0.43201e-1 + (0.11945e-2 + (0.75195e-5 + (0.44747e-7 + (0.25030e-9 + (0.13065e-11 + 0.63000e-14 * t) * t) * t) * t) * t) * t;
    case 24:
      t = 2 * x - 49 + 42 - ((short)(((int)(t)) >> ((int)(2 * x - 49)))) + ((int)(((int)(2 * x)) & ((int)(x))));
    ...
    case 30:
      t = 2 * x - 79 + 42 * ((short)(((int)(2 * x)) >> ((int)(x)))) - ((int)(((double)(t)) - ((double)79))) - ((short)(((int)(x)) ^ ((int)(2 * x - 79)))) - ((short)(((int)(x)) & ((int)(2 * x))));
    ...
    case 50:
      t = 2 * x - 119 + 42 * ((long)(((int)(x)) | ((int)119))) * ((long)(((int)(2 * x - 119)) << ((int)2))) + ((short)(((double)119) * ((double)2))) * ((short)(((int)(x)) >> ((int)(2 * x)))) * ((short)(((int)119) << ((int)(2 * x))));
    ...
    case 61:
      t = 2 * x - 123 + 42 + ((short)(((int)(t)) << ((int)(2 * x)))) * ((int)(((double)123) + ((double)2))) + ((int)(((double)(x)) * ((double)2))) * ((int)(((int)(t)) << ((int)2))) + 42 + ((short)(((int)(t)) << ((int)(2 * x)))) * ((long)(((int)(2 * x - 123 + 42 + ((short)(((int)(t)) << ((int)(2 * x)))) * ((int)(((double)123) + ((double)2))))) << ((int)(((int)(((double)(x)) * ((double)2))) * ((int)(((int)(t)) << ((int)2))))))) * ((int)(((int)(((short)(((int)(t)) << ((int)(2 * x)))) * ((int)(((double)123) + ((double)2))))) ^ ((int)(2 * x))));
    ...
    case 64:
      t = 2 * x - 129 + 42 - ((long)(((double)129) * ((double)(t)))) - ((long)(((int)129) & ((int)(2 * x)))) - ((int)(((int)129) << ((int)(t))));
      return 0.23545e0 + (0.44067e-2 + (0.43594e-4 + (0.36268e-6 + (0.25312e-8 + (0.14647e-10 + 0.68453e-13 * t) * t) * t) * t) * t) * t;
    case 65:
      t = 2 * x - 131 + 42 - ((int)(((double)2) + ((double)2))) - ((short)(((int)(t)) | ((int)131))) * ((long)(((int)2) ^ ((int)(x)))) + 42 + ((long)(((int)(2 * x)) ^ ((int)(t)))) - ((int)(((int)(2 * x - 131 + 42)) | ((int)2))) + ((int)(((double)2) + ((double)2))) + ((int)(((int)2) >> ((int)(2 * x - 131))));
      return 0.24444e0 + (0.45855e-2 + (0.45832e-4 + (0.38352e-6 + (0.26819e-8 + (0.15489e-10 + 0.71933e-13 * t) * t) * t) * t) * t) * t;
    case 66:
      t = 2 * x - 133 + 42 * ((int)(((int)(2 * x)) | ((int)(2 * x - 133)))) + ((long)(((double)2) * ((double)2))) - ((short)(((double)133) - ((double)(x)))) * ((short)(((int)(x)) & ((int)133))) * ((long)(((int)(2 * x)) | ((int)(2 * x - 133))));
      return 0.25379e0 + (0.47735e-2 + (0.48199e-4 + (0.40561e-6 + (0.28411e-8 + (0.16374e-10 + 0.75541e-13 * t) * t) * t) * t) * t) * t;
    case 67:
      t = 2 * x - 135 + 42 + ((short)(((double)(t)) * ((double)(t))));
