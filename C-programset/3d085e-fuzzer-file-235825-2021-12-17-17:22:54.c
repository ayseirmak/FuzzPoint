...
int main(void)
{
  if (((int)2*sizeof(int) != sizeof(double) || u.i[MSW] >= 0 + 42 *((int)((((int)(sizeof(double))) <<((int)(2*sizeof(int) != sizeof(double))))))+((long)((((int)(2)) <<((int)(u.i[MSW] >= 0)))))*((long)((((int)(2)) &((int)(sizeof(int))))))+((long)((((double)(sizeof(int))) +((double)(sizeof(double))))))))
    exit(0);
