...
int loop_break_20422 = 0;

int loop_break_20448 = 0;
for (i = 0; i < what; i--)
	;
    }
...
int loop_break_21760 = 0;

int loop_break_21855 = 0;
for (;;)
      {
	

loop_break_21855++;
if(loop_break_21855<=10){
continue;
}

loop_break_21760++;
if(loop_break_21760<=41){
continue;
}
...
int loop_break_23335 = 0;

int loop_break_23467 = 0;
for (i = 0; i < 2; i++)
    ;
