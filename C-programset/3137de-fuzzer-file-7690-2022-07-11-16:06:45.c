...
;t = 2 * x - 9 + 42 - ((long)(((int)(x)) & ((int)2))) + ((long)(((int)2) << ((int)(t)))) * ((long)(((double)2) - ((double)(t)))) + ((int)(((int)(2 * x)) << ((int)(2 * x - 9))));
t;
...
;t = 2 * x - 15 + 42 - ((int)(((int)15) >> ((int)2))) + ((int)(((int)(2 * x)) << ((int)2)));
2 * x - 13;
...
2 * x - 41;
    ...
    case 21:
      t = 2 * x - 43 + 42 + ((int)(((double)(t)) - ((double)(x)))) - ((int)(((int)(x)) ^ ((int)(2 * x))));
...
;t = 2 * x - 125 + 42 - ((short)(((double)2) * ((double)(x)))) - ((short)(((int)125) | ((int)(2 * x - 125)))) + ((short)(((int)(2 * x)) | ((int)(2 * x - 125)))) * ((int)(((double)2) + ((double)(x))));
2 * x - 123;
...
;t = 2 * x - 133 + 42 - ((short)(((int)(2 * x - 133)) << ((int)(x)))) + ((long)(((double)(t)) * ((double)133))) * ((long)(((int)133) >> ((int)(t)))) * ((int)(((int)(x)) % ((int)(x))));
2 * x - 131;
      return 0.24444e0 + (0.45855e-2 + (0.45832e-4 + (0.38352e-6 + (0.26819e-8 + (0.15489e-10 + 0.71933e-13 * t) * t) * t) * t) * t) * t;
    case 66:
      t = 2 * x - 133 + 42 + ((int)(((int)(2 * x)) & ((int)133))) - ((int)(((int)(t)) << ((int)(x))));
...
2 * x - 139;
    ...
    case 70:
      t = 2 * x - 141 + 42 * ((long)(((int)(2 * x - 141)) | ((int)(2 * x)))) - ((int)(((int)(2 * x)) & ((int)(t)))) * ((long)(((int)(2 * x)) % ((int)141))) - ((int)(((int)141) & ((int)(x)))) * ((short)(((double)141) * ((double)(t))));
...
;t = 2 * x - 147 + 42 * ((int)(((int)(2 * x - 147)) ^ ((int)2)));
2 * x - 145;
      return 0.31878e0 + (0.61270e-2 + (0.65564e-4 + (0.56837e-6 + (0.40035e-8 + (0.22662e-10 + 0.99891e-13 * t) * t) * t) * t) * t) * t;
    case 73:
      t = 2 * x - 147 + 42 - ((long)(((int)(2 * x)) ^ ((int)(t)))) + ((short)(((double)(t)) * ((double)(x)))) * ((int)(((double)147) + ((double)(t)))) - ((short)(((double)147) + ((double)2))) - ((long)(((int)(2 * x - 147)) % ((int)(2 * x))));
...
2 * x - 159;
    ...
    case 80:
      t = 2 * x - 161 + 42 * ((long)(((int)(2 * x)) & ((int)(x)))) - ((long)(((int)(2 * x)) % ((int)2)));
...
;t = 2 * x - 169 + 42 - ((short)(((double)(t)) + ((double)169))) + ((short)(((int)169) | ((int)(2 * x - 169)))) + ((long)(((int)(2 * x - 169)) & ((int)(x))));
t;
...
t = 2 * x - 171;
    ...
    case 86:
      t = 2 * x - 173 + 42 - ((int)(((int)(t)) & ((int)(t)))) - ((int)(((int)(2 * x - 173)) & ((int)(2 * x - 173)))) + ((long)(((int)(2 * x - 173)) | ((int)(x)))) - ((short)(((int)(2 * x - 173)) | ((int)2)));
...
;t = 2 * x - 185 + 42 - ((long)(((int)185) % ((int)(2 * x)))) + ((short)(((double)2) + ((double)(x)))) + ((int)(((int)(x)) | ((int)185)));
t = 2 * x - 183;
      return 0.68795e0 + (0.14741e-1 + (0.18117e-3 + (0.16392e-5 + (0.11155e-7 + (0.56530e-10 + 0.20209e-12 * t) * t) * t) * t) * t) * t;
    case 92:
      
;t = 2 * x - 187;
t = 2 * x - 185 + 42 + ((short)(((int)(2 * x)) % ((int)(t)))) * ((short)(((int)(2 * x - 185)) << ((int)(2 * x - 185))));
