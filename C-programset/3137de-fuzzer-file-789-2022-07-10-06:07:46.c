...
foo (double x)
{
  ...
  switch ((int) x)
    ...
    case 5:
      t = 2 * x - 11 + 42 * ((int)(((int)(2 * x - 11)) | ((int)2))) + ((long)(((int)(t)) % ((int)(2 * x)))) + ((short)(((int)(t)) % ((int)(2 * x - 11)))) + ((int)(((int)2) << ((int)(x)))) + ((short)(((double)11) + ((double)(x))));
    ...
    case 7:
      t = 2 * x - 15 + 42 - ((long)(((int)(2 * x)) % ((int)15))) - ((short)(((double)15) - ((double)(x)))) + ((int)(((double)(x)) + ((double)(x))));
      return 0.11433e-1 + (0.82372e-3 + (0.44160e-5 + (0.22798e-7 + (0.11291e-9 + (0.53386e-12 + 0.23944e-14 * t) * t) * t) * t) * t) * t;
    case 8:
      t = 2 * x - 17 + 42 * ((long)(((int)2) >> ((int)(t)))) + ((short)(((int)(x)) % ((int)(2 * x)))) + ((long)(((int)17) | ((int)(2 * x))));
    ...
    case 13:
      t = 2 * x - 27 + 42 * ((int)(((int)27) % ((int)27)));
      return 0.21996e-1 + (0.94040e-3 + (0.53443e-5 + (0.29078e-7 + (0.15078e-9 + (0.74103e-12 + 0.34251e-14 * t) * t) * t) * t) * t) * t;
    case 14:
      t = 2 * x - 29 + 42 + ((long)(((int)(x)) & ((int)(x)))) - ((int)(((int)29) & ((int)(2 * x - 29)))) + ((int)(((int)(x)) % ((int)(2 * x)))) - ((int)(((int)(t)) >> ((int)(x))));
    ...
    case 23:
      t = 2 * x - 47 + 42 - ((long)(((int)47) << ((int)(x)))) + ((short)(((int)(t)) & ((int)(t)))) - ((short)(((int)(x)) ^ ((int)(2 * x)))) - ((int)(((int)(x)) | ((int)(t)))) - ((long)(((int)(t)) ^ ((int)(2 * x))));
    ...
    case 26:
      t = 2 * x - 59 + 42 - ((short)(((int)(2 * x - 59)) % ((int)(t)))) * ((short)(((int)(t)) >> ((int)(2 * x - 59)))) * ((short)(((int)2) << ((int)(x))));
    ...
    case 40:
      t = 2 * x - 99 + 42 * ((int)(((double)99) * ((double)2)));
    ...
    case 63:
      t = 2 * x - 127 + 42 - ((int)(((int)(t)) & ((int)(2 * x)))) - ((short)(((int)2) ^ ((int)2))) * ((long)(((int)(2 * x)) << ((int)(2 * x - 127))));
    ...
    case 71:
      t = 2 * x - 143 + 42 * ((long)(((int)143) % ((int)(2 * x - 143)))) + ((long)(((int)143) & ((int)2)));
    ...
    case 75:
      t = 2 * x - 151 + 42 - ((int)(((int)(2 * x)) & ((int)(x)))) * ((long)(((int)2) ^ ((int)(2 * x))));
    ...
    case 77:
      t = 2 * x - 155 + 42 - ((short)(((int)(2 * x)) ^ ((int)155))) + ((short)(((int)(2 * x - 155)) % ((int)(2 * x - 155)))) * ((short)(((int)(x)) ^ ((int)(2 * x - 155)))) + ((short)(((int)(2 * x - 155)) | ((int)(t)))) * ((short)(((double)(t)) + ((double)155)));
    ...
    case 79:
      t = 2 * x - 159 + 42 * ((long)(((int)(t)) ^ ((int)(2 * x))));
    ...
    case 81:
      t = 2 * x - 163 + 42 * ((int)(((int)(x)) % ((int)(2 * x - 163))));
    ...
    case 84:
      t = 2 * x - 169 + 42 + ((long)(((int)2) >> ((int)(2 * x)))) + ((short)(((int)(2 * x - 169)) % ((int)(2 * x - 169)))) + ((int)(((int)2) >> ((int)(2 * x - 169)))) * ((int)(((int)(2 * x)) << ((int)(2 * x))));
    ...
    case 90:
      t = 2 * x - 181 + 42 - ((int)(((int)181) << ((int)2))) * ((long)(((int)(t)) | ((int)(t)))) + ((long)(((int)(2 * x)) ^ ((int)2))) + ((long)(((int)2) << ((int)(2 * x - 181))));
