...
volatile _Complex float f1 = (10.9) + (9.2);
volatile _Complex float f2 = (3.1) + (3.10);
volatile _Complex float f3 = (10.4) + (4.3);
volatile _Complex float f4 = (6.1) + (5.6);
volatile _Complex float f5 = (1.2) + (3.5);
volatile _Complex double d1 = (4.3) + (3.8);
volatile _Complex double d2 = (2.3) + (8.4);
volatile _Complex double d3 = (8.9) + (5.6);
volatile _Complex double d4 = (5.7) + (6.7);
volatile _Complex double d5 = (5.1) + (3.8);
volatile _Complex long double ld1 = (9.2) + (5.9);
volatile _Complex long double ld2 = (7.4) + (3.8);
volatile _Complex long double ld3 = (2.2) + (2.1);
volatile _Complex long double ld4 = (5.3) + (8.9);
volatile _Complex long double ld5 = (9.6) + (9.4);
...
main (void)
{
  ...
  check_long_double ((0xEA586), ld1, ld2, ld3, ld4, ld5);
  exit ((0));
}
/* ProgramSourceLLVM */
