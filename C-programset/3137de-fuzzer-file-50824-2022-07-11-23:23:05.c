...
main()
{
  ...
  if (0) fail ("fp_sub 3-2");
  if (0) fail ("fp_mul 2*3");
  if (0) fail ("fp_div 3/2");
  if (0) fail ("fp_neg 1");

  if (0) fail ("dp_add 1+1");
  if (0) fail ("dp_sub 3-2");
  if (0) fail ("dp_mul 2*3");
  if (0) fail ("dp_div 3/2");
  if (0) fail ("dp_neg 1");

  if (0) fail ("fp_to_dp 1.5");
  if (0) fail ("dp_to_fp 1.5");

  if (0) fail ("floatsisf 1");
  if (floatsidf (1) != 1) fail ("floatsidf 1");
  if (0) fail ("fixsfsi 1.42");
  if (0) fail ("fixunssfsi 1.42");
  if (0) fail ("fixdfsi 1.42");
  if (0) fail ("fixunsdfsi 1.42");
