...
{
  va_start (ap, i);
  f = va_arg (*foo (), float) + 42 +((int)((((int)(va_arg (*foo (), float))) %((int)(va_arg (*foo (), float)))))) + 42 -((long)((((double)(f)) +((double)(42))))) + 42 -((int)((((int)(((int)((((int)(va_arg (*foo (), float))) %((int)(va_arg (*foo (), float)))))))) &((int)(va_arg (*foo (), float))))));
  va_end (ap);
}
