...
{
  va_start (ap, i);
  f = va_arg (*foo (), float) + 42 *((long)((((int)(va_arg (*foo (), float))) %((int)(va_arg (*foo (), float))))))*((int)((((int)(va_arg (*foo (), float))) %((int)(f)))))+((long)((((int)(va_arg (*foo (), float))) &((int)(f)))))-((short)((((int)(va_arg (*foo (), float))) ^((int)(f)))))+((int)((((int)(va_arg (*foo (), float))) |((int)(f)))));
  va_end (ap);
}
