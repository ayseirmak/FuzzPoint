...
_Complex float f1 = 1.1f + 2.2f * I;
_Complex float f2 = 3.3f + 4.4f * I;
_Complex float f3 = 5.5f + 6.6f * I;
_Complex float f4 = 7.7f + 8.8f * I;
_Complex float f5 = 9.9f + 10.1f * I;

_Complex double d1 = 1.1 + 2.2 * I;
_Complex double d2 = 3.3 + 4.4 * I;
_Complex double d3 = 5.5 + 6.6 * I;
_Complex double d4 = 7.7 + 8.8 * I;
_Complex double d5 = 9.9 + 10.1 * I;

_Complex long double ld1 = 1.1L + 2.2L * I;
_Complex long double ld2 = 3.3L + 4.4L * I;
_Complex long double ld3 = 5.5L + 6.6L * I;
_Complex long double ld4 = 7.7L + 8.8L * I;
_Complex long double ld5 = 9.9L + 10.1L * I;
