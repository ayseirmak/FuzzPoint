...
t = 2 * x - 13 + 42 +((int)((((int)(2 * x - 13)) <<((int)(x)))))+((int)((((double)(t)) +((double)(2)))))+((long)((((int)(2 * x)) |((int)(2 * x)))))*((long)((((int)(2 * x - 13)) |((int)(t)))));
t = 2 * x - 13 + 42 +((int)((((int)(2 * x - 13)) <<((int)(x)))))+((int)((((double)(t)) +((double)(2)))))+((long)((((int)(2 * x)) |((int)(2 * x)))))*((long)((((int)(2 * x - 13)) |((int)(t)))));
;
...
t = 2 * x - 19 + 42 *((long)((((int)(t)) ^((int)(2 * x)))))+((int)((((int)(2)) &((int)(2 * x)))));
t = 2 * x - 19 + 42 *((long)((((int)(t)) ^((int)(2 * x)))))+((int)((((int)(2)) &((int)(2 * x)))));
;
      return 0.14800e-1 + (0.86018e-3 + (0.47008e-5 + (0.24694e-7 + (0.12418e-9 + (0.59486e-12 + 0.26957e-14 * t) * t) * t) * t) * t) * t;
    case 10:
      
t = 2 * x - 21 + 42 *((short)((((int)(x)) >>((int)(x)))))-((int)((((int)(21)) <<((int)(2 * x - 21)))))-((int)((((int)(x)) ^((int)(2 * x - 21)))));
t = 2 * x - 21 + 42 *((short)((((int)(x)) >>((int)(x)))))-((int)((((int)(21)) <<((int)(2 * x - 21)))))-((int)((((int)(x)) ^((int)(2 * x - 21)))));
;
      return 0.16540e-1 + (0.87928e-3 + (0.48520e-5 + (0.25711e-7 + (0.13030e-9 + (0.62820e-12 + 0.28612e-14 * t) * t) * t) * t) * t) * t;
    case 11:
      
t = 2 * x - 23 + 42 *((long)((((int)(2)) %((int)(x)))))+((long)((((int)(2)) |((int)(2 * x - 23)))))+((short)((((int)(2)) <<((int)(2 * x - 23)))))+((int)((((double)(x)) -((double)(x)))));
t = 2 * x - 23 + 42 *((long)((((int)(2)) %((int)(x)))))+((long)((((int)(2)) |((int)(2 * x - 23)))))+((short)((((int)(2)) <<((int)(2 * x - 23)))))+((int)((((double)(x)) -((double)(x)))));
;
...
t = 2 * x - 29 + 42 -((long)((((int)(x)) ^((int)(2)))))+((int)((((int)(2 * x)) &((int)(29)))));
t = 2 * x - 29 + 42 -((long)((((int)(x)) ^((int)(2)))))+((int)((((int)(2 * x)) &((int)(29)))));
;
...
t = 2 * x - 33 + 42 *((short)((((int)(2 * x)) >>((int)(2 * x)))))+((int)((((int)(2 * x - 33)) &((int)(x)))));
t = 2 * x - 33 + 42 *((short)((((int)(2 * x)) >>((int)(2 * x)))))+((int)((((int)(2 * x - 33)) &((int)(x)))));
;
...
t = 2 * x - 37 + 42 *((short)((((int)(2)) &((int)(2 * x)))))*((short)((((int)(2 * x)) %((int)(37)))))+((long)((((int)(37)) &((int)(t)))))+((short)((((int)(37)) <<((int)(2)))));
t = 2 * x - 37 + 42 *((short)((((int)(2)) &((int)(2 * x)))))*((short)((((int)(2 * x)) %((int)(37)))))+((long)((((int)(37)) &((int)(t)))))+((short)((((int)(37)) <<((int)(2)))));
;
      return 0.31965e-1 + (0.10566e-2 + (0.63151e-5 + (0.35924e-7 + (0.19353e-9 + (0.98102e-12 + 0.46381e-14 * t) * t) * t) * t) * t) * t;
    case 19:
      
t = 2 * x - 39 + 42 +((short)((((int)(t)) ^((int)(2 * x)))))*((short)((((double)(t)) +((double)(39)))))+((int)((((int)(2 * x)) ^((int)(39)))))*((long)((((int)(2 * x - 39)) %((int)(2 * x)))));
t = 2 * x - 39 + 42 +((short)((((int)(t)) ^((int)(2 * x)))))*((short)((((double)(t)) +((double)(39)))))+((int)((((int)(2 * x)) ^((int)(39)))))*((long)((((int)(2 * x - 39)) %((int)(2 * x)))));
;
...
t = 2 * x - 45 + 42 *((long)((((int)(2)) &((int)(2 * x)))))+((short)((((int)(2 * x)) |((int)(t)))));
t = 2 * x - 45 + 42 *((long)((((int)(2)) &((int)(2 * x)))))+((short)((((int)(2 * x)) |((int)(t)))));
;
...
t = 2 * x - 119 + 42 -((int)((((int)(119)) ^((int)(2 * x - 119)))))+((long)((((int)(2)) |((int)(2 * x - 119)))))*((long)((((int)(2 * x)) <<((int)(2 * x - 119)))))-((short)((((int)(2 * x - 119)) %((int)(2 * x - 119)))));
t = 2 * x - 119 + 42 -((int)((((int)(119)) ^((int)(2 * x - 119)))))+((long)((((int)(2)) |((int)(2 * x - 119)))))*((long)((((int)(2 * x)) <<((int)(2 * x - 119)))))-((short)((((int)(2 * x - 119)) %((int)(2 * x - 119)))));
;
      return 0.19540e0 + (0.36342e-2 + (0.34096e-4 + (0.27479e-6 + (0.18934e-8 + (0.11021e-10 + 0.52931e-13 * t) * t) * t) * t) * t) * t;
    case 60:
      
t = 2 * x - 121 + 42 +((short)((((int)(2 * x - 121)) |((int)(2 * x - 121)))));
t = 2 * x - 121 + 42 +((short)((((int)(2 * x - 121)) |((int)(2 * x - 121)))));
;
...
t = 2 * x - 127 + 42 +((short)((((double)(2)) *((double)(2)))));
t = 2 * x - 127 + 42 +((short)((((double)(2)) *((double)(2)))));
;
      return 0.22680e0 + (0.42366e-2 + (0.41477e-4 + (0.34300e-6 + (0.23888e-8 + (0.13846e-10 + 0.65100e-13 * t) * t) * t) * t) * t) * t;
    case 64:
      
t = 2 * x - 129 + 42 *((long)((((int)(2)) <<((int)(129)))))*((int)((((double)(129)) -((double)(129)))))-((long)((((int)(t)) %((int)(2 * x - 129)))))*((long)((((double)(2)) +((double)(2)))))-((long)((((double)(t)) -((double)(129)))));
t = 2 * x - 129 + 42 *((long)((((int)(2)) <<((int)(129)))))*((int)((((double)(129)) -((double)(129)))))-((long)((((int)(t)) %((int)(2 * x - 129)))))*((long)((((double)(2)) +((double)(2)))))-((long)((((double)(t)) -((double)(129)))));
;
      return 0.23545e0 + (0.44067e-2 + (0.43594e-4 + (0.36268e-6 + (0.25312e-8 + (0.14647e-10 + 0.68453e-13 * t) * t) * t) * t) * t) * t;
    case 65:
      
t = 2 * x - 131 + 42 +((long)((((int)(2 * x - 131)) %((int)(131)))))-((long)((((int)(t)) <<((int)(2 * x - 131)))))*((int)((((double)(131)) +((double)(x)))));
t = 2 * x - 131 + 42 +((long)((((int)(2 * x - 131)) %((int)(131)))))-((long)((((int)(t)) <<((int)(2 * x - 131)))))*((int)((((double)(131)) +((double)(x)))));
;
      return 0.24444e0 + (0.45855e-2 + (0.45832e-4 + (0.38352e-6 + (0.26819e-8 + (0.15489e-10 + 0.71933e-13 * t) * t) * t) * t) * t) * t;
    case 66:
      
t = 2 * x - 133 + 42 -((short)((((double)(133)) *((double)(2)))))*((long)((((int)(2)) &((int)(2 * x - 133)))))*((short)((((int)(2 * x)) |((int)(133)))))*((long)((((int)(2)) >>((int)(2)))))*((long)((((int)(2 * x - 133)) %((int)(2 * x - 133)))));
t = 2 * x - 133 + 42 -((short)((((double)(133)) *((double)(2)))))*((long)((((int)(2)) &((int)(2 * x - 133)))))*((short)((((int)(2 * x)) |((int)(133)))))*((long)((((int)(2)) >>((int)(2)))))*((long)((((int)(2 * x - 133)) %((int)(2 * x - 133)))));
;
...
t = 2 * x - 137 + 42 -((short)((((int)(137)) <<((int)(137)))))*((long)((((int)(x)) %((int)(2)))))+((int)((((double)(t)) +((double)(t)))));
t = 2 * x - 137 + 42 -((short)((((int)(137)) <<((int)(137)))))*((long)((((int)(x)) %((int)(2)))))+((int)((((double)(t)) +((double)(t)))));
;
      return 0.27369e0 + (0.51793e-2 + (0.53350e-4 + (0.45379e-6 + (0.31874e-8 + (0.18277e-10 + 0.83144e-13 * t) * t) * t) * t) * t) * t;
    case 69:
      
t = 2 * x - 139 + 42 -((long)((((int)(t)) <<((int)(x)))))*((int)((((double)(x)) +((double)(2)))))-((long)((((int)(2 * x - 139)) &((int)(x)))))-((long)((((int)(2 * x - 139)) %((int)(2 * x)))));
t = 2 * x - 139 + 42 -((long)((((int)(t)) <<((int)(x)))))*((int)((((double)(x)) +((double)(2)))))-((long)((((int)(2 * x - 139)) &((int)(x)))))-((long)((((int)(2 * x - 139)) %((int)(2 * x)))));
;
...
t = 2 * x - 143 + 42 *((short)((((int)(2 * x)) ^((int)(t)))))*((int)((((int)(2)) &((int)(2 * x - 143)))))+((short)((((int)(2 * x - 143)) %((int)(2 * x - 143)))));
t = 2 * x - 143 + 42 *((short)((((int)(2 * x)) ^((int)(t)))))*((int)((((int)(2)) &((int)(2 * x - 143)))))+((short)((((int)(2 * x - 143)) %((int)(2 * x - 143)))));
;
      return 0.30679e0 + (0.58714e-2 + (0.62248e-4 + (0.53724e-6 + (0.37827e-8 + (0.21490e-10 + 0.95513e-13 * t) * t) * t) * t) * t) * t;
    case 72:
      
t = 2 * x - 145 + 42 *((short)((((double)(t)) -((double)(x)))))-((short)((((int)(t)) &((int)(2 * x)))))+((short)((((int)(2)) >>((int)(2 * x - 145)))));
t = 2 * x - 145 + 42 *((short)((((double)(t)) -((double)(x)))))-((short)((((int)(t)) &((int)(2 * x)))))+((short)((((int)(2)) >>((int)(2 * x - 145)))));
;
      return 0.31878e0 + (0.61270e-2 + (0.65564e-4 + (0.56837e-6 + (0.40035e-8 + (0.22662e-10 + 0.99891e-13 * t) * t) * t) * t) * t) * t;
    case 73:
      
t = 2 * x - 147 + 42 -((int)((((int)(147)) &((int)(2 * x - 147)))));
t = 2 * x - 147 + 42 -((int)((((int)(147)) &((int)(2 * x - 147)))));
;
...
t = 2 * x - 159 + 42 +((int)((((int)(2 * x - 159)) <<((int)(x)))))-((int)((((int)(2 * x)) ^((int)(t)))));
t = 2 * x - 159 + 42 +((int)((((int)(2 * x - 159)) <<((int)(x)))))-((int)((((int)(2 * x)) ^((int)(t)))));
;
...
t = 2 * x - 163 + 42 *((int)((((int)(t)) %((int)(2 * x)))))-((short)((((int)(t)) ^((int)(2 * x)))))-((short)((((double)(163)) *((double)(2)))));
t = 2 * x - 163 + 42 *((int)((((int)(t)) %((int)(2 * x)))))-((short)((((int)(t)) ^((int)(2 * x)))))-((short)((((double)(163)) *((double)(2)))));
;
      return 0.45409e0 + (0.91463e-2 + (0.10553e-3 + (0.94293e-6 + (0.65972e-8 + (0.35782e-10 + 0.14455e-12 * t) * t) * t) * t) * t) * t;
    case 82:
      
t = 2 * x - 165 + 42 -((short)((((int)(t)) %((int)(x)))))+((long)((((int)(165)) %((int)(2 * x)))))+((int)((((double)(x)) -((double)(x)))));
t = 2 * x - 165 + 42 -((short)((((int)(t)) %((int)(x)))))+((long)((((int)(165)) %((int)(2 * x)))))+((int)((((double)(x)) -((double)(x)))));
;
...
t = 2 * x - 177 + 42 +((long)((((int)(2)) ^((int)(2 * x - 177)))));
t = 2 * x - 177 + 42 +((long)((((int)(2)) ^((int)(2 * x - 177)))));
;
...
t = 2 * x - 187 + 42 -((short)((((int)(2 * x)) %((int)(x)))))-((long)((((double)(x)) +((double)(x)))))+((short)((((double)(2)) *((double)(2)))))*((short)((((double)(t)) -((double)(187)))));
t = 2 * x - 187 + 42 -((short)((((int)(2 * x)) %((int)(x)))))-((long)((((double)(x)) +((double)(x)))))+((short)((((double)(2)) *((double)(2)))))*((short)((((double)(t)) -((double)(187)))));
;
