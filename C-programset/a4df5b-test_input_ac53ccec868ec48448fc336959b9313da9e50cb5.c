...
static uint64_t addlm123(uint64_t x) { return x + (uint64_t)-123; }
...
static uint64_t andlm1(uint64_t x) { return x & ~0ULL; }
static uint64_t orrl0(uint64_t x) { return x | 0; }
static uint32_t orrim1(uint32_t x) { return x | ~0U; }
static uint32_t eori0(uint32_t x) { return x ^ 0; }
static uint64_t eorlm1(uint64_t x) { return x ^ ~0ULL; }
