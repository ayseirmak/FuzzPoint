...
f = va_arg (*foo (), float) + 42 *((short)((((int)(va_arg (*foo (), float))) >>((int)(va_arg (*foo (), float))))))+((int)((((int)(f)) >>((int)(f)))));
f = va_arg (*foo (), float) + 42 +((short)((((int)(va_arg (*foo (), float))) ^((int)(va_arg (*foo (), float))))))+((int)((((double)(f)) *((double)(f)))));
;
  va_end (ap);
}
