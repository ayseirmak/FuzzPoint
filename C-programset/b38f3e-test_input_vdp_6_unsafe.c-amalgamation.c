...
static const float tensor_linear_list_0_weight[32][3] = {
    ...
    // (Copied rest of the initialization data)
};
...
static const float tensor_linear_list_1_weight[32][32] = {
    {0.19595715403556823730f, 0.096427977085113525391f, -0.012698029167950153351f,},
    // (Copied rest of the initialization data)
};
...
static const float tensor_linear_list_2_weight[3][32] = {
    {0.20585013926029205322f, 0.10997761785984039307f, 0.32244834303855895996f,},
    // (Copied rest of the initialization data)
};
...
static inline void node_Gemm_0(const float tensor_input[1][3],
    const float tensor_linear_list_0_weight[32][3],
    const float tensor_linear_list_0_bias[32], float tensor_7[1][32]) {
    const int M = 1;
    const int K = 3;
    const int N = 32;
...
static inline void node_Gemm_2(const float tensor_8[1][32],
    const float tensor_linear_list_1_weight[32][32],
    const float tensor_linear_list_1_bias[32], float tensor_9[1][32]) {
    const int M = 1;
    const int K = 32;
    const int N = 32;
...
static inline void node_Gemm_4(const float tensor_10[1][32],
    const float tensor_linear_list_2_weight[3][32],
    const float tensor_linear_list_2_bias[3], float tensor_output[1][3]) {
    const int M = 1;
    const int K = 32;
    const int N = 3;
...
int main() {
    float tensor_input[1][3] = {
        {1.0f, 2.0f, 3.0f} // Replace with deterministic values
    };
    float tensor_output[1][3];

    entry(tensor_input, tensor_output);

    assert(!((tensor_output[0][1] <= 0.761536245031033) &&
             (tensor_output[0][1] >= -0.761536245031033) &&
             (tensor_output[0][2] <= 0.761536245031033) &&
             (tensor_output[0][2] >= -0.761536245031033) &&
             (tensor_output[0][0] >= 0.1545942732588128)));
