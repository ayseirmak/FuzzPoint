...
static union at6 callee_af6(struct _t6 ap6, double bp6, long long int cp6, int dp6) {
...
static gt7 bbv7 = { 47875.491954 };
static long int bcv7[1] = { 1732133482L };
static long long int bdv7 = 381678602L;

static unsigned char callee_af7(float ap7, double bp7, union ct7 cp7, et7 dp7,
                                union ft7 ep7, int fp7, gt7 gp7, long int hp7[1],
                                long long int ip7) {
    A (vv7 == ap7);
    A (wv7 == bp7);
