...
volatile _Complex float f1 = ((6.6)) + ((2.1));
volatile _Complex float f2 = ((3.2)) + ((9.10));
volatile _Complex float f3 = ((3.4)) + ((10.5));
volatile _Complex float f4 = ((5.5)) + ((1.7));
volatile _Complex float f5 = ((9.6)) + ((10.1));
volatile _Complex double d1 = ((9.6)) + ((3.3));
volatile _Complex double d2 = ((7.2)) + ((9.5));
volatile _Complex double d3 = ((9.10)) + ((4.8));
volatile _Complex double d4 = ((4.9)) + ((10.8));
volatile _Complex double d5 = ((8.10)) + ((1.1));
volatile _Complex long double ld1 = ((4.3)) + ((2.6));
volatile _Complex long double ld2 = ((3.6)) + ((3.5));
volatile _Complex long double ld3 = ((6.4)) + ((5.2));
volatile _Complex long double ld4 = ((10.1)) + ((6.2));
volatile _Complex long double ld5 = ((7.2)) + ((6.8));
